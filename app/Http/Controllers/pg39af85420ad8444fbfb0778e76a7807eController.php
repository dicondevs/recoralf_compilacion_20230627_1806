...
/**
 * semanaForm - semanaForm.
 */
class pg39af85420ad8444fbfb0778e76a7807eController extends Controller
{
    /**
    ...
    public function post(Request $request)
    {
        ...
        // Guardar Semana - Guardar Semana
        if (null != $request->input('ctl19b1bedba7d546529c0aa54c7e4d2040_e23d042fbfed423aa5c32207cf8577c0') && null != $request->input('hide23d042fbfed423aa5c32207cf8577c0') && 'e23d042fbfed423aa5c32207cf8577c0' == $request->input('hide23d042fbfed423aa5c32207cf8577c0')) {
            $key = 0;
            $isNew = false;
            ...
            $tb = \App\tb5fe6fec8e3d0400186be9324e445fa75::where('PK_SEMANAS', $key)->first();
            if (null == $tb) {
                $isNew = true;
                $tb = new \App\tb5fe6fec8e3d0400186be9324e445fa75();
            }

            if (null != $request->input('ctl263d485730e145209c2848a360339e48_e23d042fbfed423aa5c32207cf8577c0') && '' != $request->input('ctl263d485730e145209c2848a360339e48_e23d042fbfed423aa5c32207cf8577c0')) {
                $tb->FL_FECHA_FIN = \DateTime::createFromFormat(str_replace('%', '', \Lang::get('resourceff2b12513d1a44948a7e7fbabde0697a.msgSystemShortDatetimeFormat')), $request->input('ctl263d485730e145209c2848a360339e48_e23d042fbfed423aa5c32207cf8577c0'))->format('Y-m-d H:i'); //FL_FECHA_FIN
            } elseif (null != $request->input('ctl263d485730e145209c2848a360339e48_e23d042fbfed423aa5c32207cf8577c0') && '' == $request->input('ctl263d485730e145209c2848a360339e48_e23d042fbfed423aa5c32207cf8577c0')) {
                $tb->FL_FECHA_FIN = null;
            }

            if (null != $request->input('ctld38af91d717e44188a493faea2a667c2_e23d042fbfed423aa5c32207cf8577c0') && '' != $request->input('ctld38af91d717e44188a493faea2a667c2_e23d042fbfed423aa5c32207cf8577c0')) {
                $tb->FL_FECHA_INICIO = \DateTime::createFromFormat(str_replace('%', '', \Lang::get('resourceff2b12513d1a44948a7e7fbabde0697a.msgSystemShortDatetimeFormat')), $request->input('ctld38af91d717e44188a493faea2a667c2_e23d042fbfed423aa5c32207cf8577c0'))->format('Y-m-d H:i'); //FL_FECHA_INICIO
            } elseif (null != $request->input('ctld38af91d717e44188a493faea2a667c2_e23d042fbfed423aa5c32207cf8577c0') && '' == $request->input('ctld38af91d717e44188a493faea2a667c2_e23d042fbfed423aa5c32207cf8577c0')) {
                $tb->FL_FECHA_INICIO = null;
            }

            if (null != $request->input('ctl3607329572c440d9b68ef4a6c13f5921_e23d042fbfed423aa5c32207cf8577c0')) {
                $tb->FL_NOMBRE = $request->input('ctl3607329572c440d9b68ef4a6c13f5921_e23d042fbfed423aa5c32207cf8577c0'); //FL_NOMBRE
            } elseif (null == $request->input('ctl3607329572c440d9b68ef4a6c13f5921_e23d042fbfed423aa5c32207cf8577c0')) {
                $tb->FL_NOMBRE = null;
            }
    ...
    public function index(Request $request)
    {
        ...
        $parebb357c1d5a94b67bfdc20efe2bfff0a = $request->input('u');

        if (null == $parebb357c1d5a94b67bfdc20efe2bfff0a) {
            $parebb357c1d5a94b67bfdc20efe2bfff0a = '0';
        }

        $par6185a7056560433494dba94e9ae5910735ad13b5a7c2461d887a25dc8f1c2cbc = 0;

        if (null == $par6185a7056560433494dba94e9ae5910735ad13b5a7c2461d887a25dc8f1c2cbc) {
            $par6185a7056560433494dba94e9ae5910735ad13b5a7c2461d887a25dc8f1c2cbc = '0';
        }

        $par0a0ce2af85ab462a808e0270326fb86035ad13b5a7c2461d887a25dc8f1c2cbc = 0;

        if (null == $par0a0ce2af85ab462a808e0270326fb86035ad13b5a7c2461d887a25dc8f1c2cbc) {
            $par0a0ce2af85ab462a808e0270326fb86035ad13b5a7c2461d887a25dc8f1c2cbc = '0';
        }

        $par5551ae677d6b488ebd38625d0f5d9fce35ad13b5a7c2461d887a25dc8f1c2cbc = '';

        if ('-' == $par5551ae677d6b488ebd38625d0f5d9fce35ad13b5a7c2461d887a25dc8f1c2cbc) {
            $par5551ae677d6b488ebd38625d0f5d9fce35ad13b5a7c2461d887a25dc8f1c2cbc = null;
        }

        if (null == $par5551ae677d6b488ebd38625d0f5d9fce35ad13b5a7c2461d887a25dc8f1c2cbc) {
            $par5551ae677d6b488ebd38625d0f5d9fce35ad13b5a7c2461d887a25dc8f1c2cbc = '';
        }

        $par8fce8a73ac264e4a8f3b56d8b991b8a535ad13b5a7c2461d887a25dc8f1c2cbc = '';

        if ('-' == $par8fce8a73ac264e4a8f3b56d8b991b8a535ad13b5a7c2461d887a25dc8f1c2cbc) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a535ad13b5a7c2461d887a25dc8f1c2cbc = null;
        }

        if (null == $par8fce8a73ac264e4a8f3b56d8b991b8a535ad13b5a7c2461d887a25dc8f1c2cbc) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a535ad13b5a7c2461d887a25dc8f1c2cbc = '';
        }

        $v35ad13b5a7c2461d887a25dc8f1c2cbc = \App\repf782f923fd0247bd9f4010b717e52999::mt2297e140658b4393b6336f1c5bba0ba6($parebb357c1d5a94b67bfdc20efe2bfff0a, $par6185a7056560433494dba94e9ae5910735ad13b5a7c2461d887a25dc8f1c2cbc, $par0a0ce2af85ab462a808e0270326fb86035ad13b5a7c2461d887a25dc8f1c2cbc, $par5551ae677d6b488ebd38625d0f5d9fce35ad13b5a7c2461d887a25dc8f1c2cbc, $par8fce8a73ac264e4a8f3b56d8b991b8a535ad13b5a7c2461d887a25dc8f1c2cbc);

        $v35ad13b5a7c2461d887a25dc8f1c2cbcAjax = \URL::to('/').'/api/2297e140658b4393b6336f1c5bba0ba6/'.(null == $parebb357c1d5a94b67bfdc20efe2bfff0a ? '-' : ('' == $parebb357c1d5a94b67bfdc20efe2bfff0a ? '-' : $parebb357c1d5a94b67bfdc20efe2bfff0a)).'/{page}/{pagesize}/{orderColumn}/{orderType}';

        // Modelador Recuperar Semanas - Modelador Recuperar Semanas

        $v35ad13b5a7c2461d887a25dc8f1c2cbcCount = \App\repf782f923fd0247bd9f4010b717e52999::mt2297e140658b4393b6336f1c5bba0ba6Count($parebb357c1d5a94b67bfdc20efe2bfff0a, $par6185a7056560433494dba94e9ae5910735ad13b5a7c2461d887a25dc8f1c2cbc, $par0a0ce2af85ab462a808e0270326fb86035ad13b5a7c2461d887a25dc8f1c2cbc, $par5551ae677d6b488ebd38625d0f5d9fce35ad13b5a7c2461d887a25dc8f1c2cbc, $par8fce8a73ac264e4a8f3b56d8b991b8a535ad13b5a7c2461d887a25dc8f1c2cbc);

        //$v35ad13b5a7c2461d887a25dc8f1c2cbcCountAjax =  \URL::to('/')."/api/2297e140658b4393b6336f1c5bba0ba6Count{ParametersAjax}/{page}/{pagesize}/{orderColumn}/{orderType}";
        ...
        $arrWiths['v35ad13b5a7c2461d887a25dc8f1c2cbc'] = isset($v35ad13b5a7c2461d887a25dc8f1c2cbc) ? $v35ad13b5a7c2461d887a25dc8f1c2cbc : '';
        $arrWiths['v35ad13b5a7c2461d887a25dc8f1c2cbcCount'] = isset($v35ad13b5a7c2461d887a25dc8f1c2cbcCount) ? $v35ad13b5a7c2461d887a25dc8f1c2cbcCount : '';
        $arrWiths['v35ad13b5a7c2461d887a25dc8f1c2cbcAjax'] = isset($v35ad13b5a7c2461d887a25dc8f1c2cbcAjax) ? $v35ad13b5a7c2461d887a25dc8f1c2cbcAjax : '';
        ...
        $response = new \Illuminate\Http\Response(view('39af85420ad8444fbfb0778e76a7807e.Index', $arrWiths)->with('title', $arrWiths['title'])->with('vSessionTimeout', \Config::get('session.lifetime') * 60));
