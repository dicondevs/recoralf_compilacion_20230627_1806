 ...
 */
class pg624d61c5b05646d6b559baadef8deb03Controller extends Controller
{
    /**
    ...
    public function post(Request $request)
    {
        ...
        // Guardar - Guardar
        if (null != $request->input('ctl3f4c37c6271849e1afdcbaa396e78f3f_b0d6248f233b4d728101fd875b73b460') && null != $request->input('hidb0d6248f233b4d728101fd875b73b460') && 'b0d6248f233b4d728101fd875b73b460' == $request->input('hidb0d6248f233b4d728101fd875b73b460')) {
            $key = 0;
            $isNew = false;
            ...
            $tb = \App\tb29c3576675124e9a946c62c945744f16::where('PK_PERFIL', $key)->first();
            if (null == $tb) {
                $isNew = true;
                $tb = new \App\tb29c3576675124e9a946c62c945744f16();
            }

            if (null != $request->input('ctlb847eb04392d433686683daec7887c6f_b0d6248f233b4d728101fd875b73b460')) {
                $tb->FL_NOMBRE = $request->input('ctlb847eb04392d433686683daec7887c6f_b0d6248f233b4d728101fd875b73b460'); //FL_NOMBRE
            } elseif (null == $request->input('ctlb847eb04392d433686683daec7887c6f_b0d6248f233b4d728101fd875b73b460')) {
                $tb->FL_NOMBRE = null;
            }
    ...
    public function index(Request $request)
    {
        ...
        $pareabc3d8393444d4e9019ef6fdd121969 = $request->input('u');

        if (null == $pareabc3d8393444d4e9019ef6fdd121969) {
            $pareabc3d8393444d4e9019ef6fdd121969 = '0';
        }

        $par6185a7056560433494dba94e9ae591070e95a0b4f2b149b4b0c51731a6e51d05 = 0;

        if (null == $par6185a7056560433494dba94e9ae591070e95a0b4f2b149b4b0c51731a6e51d05) {
            $par6185a7056560433494dba94e9ae591070e95a0b4f2b149b4b0c51731a6e51d05 = '0';
        }

        $par0a0ce2af85ab462a808e0270326fb8600e95a0b4f2b149b4b0c51731a6e51d05 = 0;

        if (null == $par0a0ce2af85ab462a808e0270326fb8600e95a0b4f2b149b4b0c51731a6e51d05) {
            $par0a0ce2af85ab462a808e0270326fb8600e95a0b4f2b149b4b0c51731a6e51d05 = '0';
        }

        $par5551ae677d6b488ebd38625d0f5d9fce0e95a0b4f2b149b4b0c51731a6e51d05 = '';

        if ('-' == $par5551ae677d6b488ebd38625d0f5d9fce0e95a0b4f2b149b4b0c51731a6e51d05) {
            $par5551ae677d6b488ebd38625d0f5d9fce0e95a0b4f2b149b4b0c51731a6e51d05 = null;
        }

        if (null == $par5551ae677d6b488ebd38625d0f5d9fce0e95a0b4f2b149b4b0c51731a6e51d05) {
            $par5551ae677d6b488ebd38625d0f5d9fce0e95a0b4f2b149b4b0c51731a6e51d05 = '';
        }

        $par8fce8a73ac264e4a8f3b56d8b991b8a50e95a0b4f2b149b4b0c51731a6e51d05 = '';

        if ('-' == $par8fce8a73ac264e4a8f3b56d8b991b8a50e95a0b4f2b149b4b0c51731a6e51d05) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a50e95a0b4f2b149b4b0c51731a6e51d05 = null;
        }

        if (null == $par8fce8a73ac264e4a8f3b56d8b991b8a50e95a0b4f2b149b4b0c51731a6e51d05) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a50e95a0b4f2b149b4b0c51731a6e51d05 = '';
        }

        $v0e95a0b4f2b149b4b0c51731a6e51d05 = \App\repf782f923fd0247bd9f4010b717e52999::mt030959dde9594057af1f65fba7d27120($pareabc3d8393444d4e9019ef6fdd121969, $par6185a7056560433494dba94e9ae591070e95a0b4f2b149b4b0c51731a6e51d05, $par0a0ce2af85ab462a808e0270326fb8600e95a0b4f2b149b4b0c51731a6e51d05, $par5551ae677d6b488ebd38625d0f5d9fce0e95a0b4f2b149b4b0c51731a6e51d05, $par8fce8a73ac264e4a8f3b56d8b991b8a50e95a0b4f2b149b4b0c51731a6e51d05);

        $v0e95a0b4f2b149b4b0c51731a6e51d05Ajax = \URL::to('/').'/api/030959dde9594057af1f65fba7d27120/'.(null == $pareabc3d8393444d4e9019ef6fdd121969 ? '-' : ('' == $pareabc3d8393444d4e9019ef6fdd121969 ? '-' : $pareabc3d8393444d4e9019ef6fdd121969)).'/{page}/{pagesize}/{orderColumn}/{orderType}';
        ...
        $arrWiths['v0e95a0b4f2b149b4b0c51731a6e51d05'] = isset($v0e95a0b4f2b149b4b0c51731a6e51d05) ? $v0e95a0b4f2b149b4b0c51731a6e51d05 : '';
        $arrWiths['v0e95a0b4f2b149b4b0c51731a6e51d05Ajax'] = isset($v0e95a0b4f2b149b4b0c51731a6e51d05Ajax) ? $v0e95a0b4f2b149b4b0c51731a6e51d05Ajax : '';
        ...
        $response = new \Illuminate\Http\Response(view('624d61c5b05646d6b559baadef8deb03.Index', $arrWiths)->with('title', $arrWiths['title'])->with('vSessionTimeout', \Config::get('session.lifetime') * 60));
