...
// Creado               martes, 27 de junio de 2023 17:56:33
...
/**
 * boletasemanal - boletasemanal.
 */
class pg006435b4029e439d8aefe2d1254e146bController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        // Boleta semanal - Boleta semanal

        $par5b05acb7ef34496f8a0c891bce8c76041 = $request->session()->get('ses5e122755c3a24f5d8789755168e9de27');

        if (null == $par5b05acb7ef34496f8a0c891bce8c76041) {
            $par5b05acb7ef34496f8a0c891bce8c76041 = '0';
        }

        $par8706a5f9f68d45d29bec3875d1355e9b1 = $request->input('p');

        if (null == $par8706a5f9f68d45d29bec3875d1355e9b1) {
            $par8706a5f9f68d45d29bec3875d1355e9b1 = '0';
        }

        $parddd888859df74263b2ecfc55398336661 = $request->input('s');

        if (null == $parddd888859df74263b2ecfc55398336661) {
            $parddd888859df74263b2ecfc55398336661 = '0';
        }

        $parff5b14ba483b4b28892d000d703ce5f21 = $request->input('fi');

        if ('-' == $parff5b14ba483b4b28892d000d703ce5f21) {
            $parff5b14ba483b4b28892d000d703ce5f21 = null;
        }

        if (null == $parff5b14ba483b4b28892d000d703ce5f21) {
            $parff5b14ba483b4b28892d000d703ce5f21 = '-';
        }

        $par5e45418d512f459e94e298fbdd87b4e81 = $request->input('ff');

        if ('-' == $par5e45418d512f459e94e298fbdd87b4e81) {
            $par5e45418d512f459e94e298fbdd87b4e81 = null;
        }

        if (null == $par5e45418d512f459e94e298fbdd87b4e81) {
            $par5e45418d512f459e94e298fbdd87b4e81 = '-';
        }

        $par60a97cd872814244b61a7319c624c7d11 = $request->input('tl');

        if (null == $par60a97cd872814244b61a7319c624c7d11) {
            $par60a97cd872814244b61a7319c624c7d11 = '0';
        }

        $par6185a7056560433494dba94e9ae59107c244a917560f4ea787be638752b55359 = $request->input('pag');

        if (null == $par6185a7056560433494dba94e9ae59107c244a917560f4ea787be638752b55359) {
            $par6185a7056560433494dba94e9ae59107c244a917560f4ea787be638752b55359 = '0';
        }

        $par0a0ce2af85ab462a808e0270326fb860c244a917560f4ea787be638752b55359 = $request->input('count');

        if (null == $par0a0ce2af85ab462a808e0270326fb860c244a917560f4ea787be638752b55359) {
            $par0a0ce2af85ab462a808e0270326fb860c244a917560f4ea787be638752b55359 = '0';
        }

        $par5551ae677d6b488ebd38625d0f5d9fcec244a917560f4ea787be638752b55359 = '';

        if ('-' == $par5551ae677d6b488ebd38625d0f5d9fcec244a917560f4ea787be638752b55359) {
            $par5551ae677d6b488ebd38625d0f5d9fcec244a917560f4ea787be638752b55359 = null;
        }

        if (null == $par5551ae677d6b488ebd38625d0f5d9fcec244a917560f4ea787be638752b55359) {
            $par5551ae677d6b488ebd38625d0f5d9fcec244a917560f4ea787be638752b55359 = '';
        }

        $par8fce8a73ac264e4a8f3b56d8b991b8a5c244a917560f4ea787be638752b55359 = '';

        if ('-' == $par8fce8a73ac264e4a8f3b56d8b991b8a5c244a917560f4ea787be638752b55359) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a5c244a917560f4ea787be638752b55359 = null;
        }

        if (null == $par8fce8a73ac264e4a8f3b56d8b991b8a5c244a917560f4ea787be638752b55359) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a5c244a917560f4ea787be638752b55359 = '';
        }

        $vc244a917560f4ea787be638752b55359 = \App\repf782f923fd0247bd9f4010b717e52999::mt6a24cf2b5ed2483aa37458a4192f5d79($par5b05acb7ef34496f8a0c891bce8c76041, $par8706a5f9f68d45d29bec3875d1355e9b1, $parddd888859df74263b2ecfc55398336661, $parff5b14ba483b4b28892d000d703ce5f21, $par5e45418d512f459e94e298fbdd87b4e81, $par60a97cd872814244b61a7319c624c7d11, $par6185a7056560433494dba94e9ae59107c244a917560f4ea787be638752b55359, $par0a0ce2af85ab462a808e0270326fb860c244a917560f4ea787be638752b55359, $par5551ae677d6b488ebd38625d0f5d9fcec244a917560f4ea787be638752b55359, $par8fce8a73ac264e4a8f3b56d8b991b8a5c244a917560f4ea787be638752b55359);

        $vc244a917560f4ea787be638752b55359Ajax = \URL::to('/').'/api/6a24cf2b5ed2483aa37458a4192f5d79/'.(null == $par5b05acb7ef34496f8a0c891bce8c76041 ? '-' : ('' == $par5b05acb7ef34496f8a0c891bce8c76041 ? '-' : $par5b05acb7ef34496f8a0c891bce8c76041)).'/'.(null == $par8706a5f9f68d45d29bec3875d1355e9b1 ? '-' : ('' == $par8706a5f9f68d45d29bec3875d1355e9b1 ? '-' : $par8706a5f9f68d45d29bec3875d1355e9b1)).'/'.(null == $parddd888859df74263b2ecfc55398336661 ? '-' : ('' == $parddd888859df74263b2ecfc55398336661 ? '-' : $parddd888859df74263b2ecfc55398336661)).'/'.(null == $parff5b14ba483b4b28892d000d703ce5f21 ? '-' : ('' == $parff5b14ba483b4b28892d000d703ce5f21 ? '-' : $parff5b14ba483b4b28892d000d703ce5f21)).'/'.(null == $par5e45418d512f459e94e298fbdd87b4e81 ? '-' : ('' == $par5e45418d512f459e94e298fbdd87b4e81 ? '-' : $par5e45418d512f459e94e298fbdd87b4e81)).'/'.(null == $par60a97cd872814244b61a7319c624c7d11 ? '-' : ('' == $par60a97cd872814244b61a7319c624c7d11 ? '-' : $par60a97cd872814244b61a7319c624c7d11)).'/{page}/{pagesize}/{orderColumn}/{orderType}';

        // Boleta semanal - Boleta semanal

        $vc244a917560f4ea787be638752b55359Count = \App\repf782f923fd0247bd9f4010b717e52999::mt6a24cf2b5ed2483aa37458a4192f5d79Count($par5b05acb7ef34496f8a0c891bce8c76041, $par8706a5f9f68d45d29bec3875d1355e9b1, $parddd888859df74263b2ecfc55398336661, $parff5b14ba483b4b28892d000d703ce5f21, $par5e45418d512f459e94e298fbdd87b4e81, $par60a97cd872814244b61a7319c624c7d11, $par6185a7056560433494dba94e9ae59107c244a917560f4ea787be638752b55359, $par0a0ce2af85ab462a808e0270326fb860c244a917560f4ea787be638752b55359, $par5551ae677d6b488ebd38625d0f5d9fcec244a917560f4ea787be638752b55359, $par8fce8a73ac264e4a8f3b56d8b991b8a5c244a917560f4ea787be638752b55359);

        //$vc244a917560f4ea787be638752b55359CountAjax =  \URL::to('/')."/api/6a24cf2b5ed2483aa37458a4192f5d79Count{ParametersAjax}/{page}/{pagesize}/{orderColumn}/{orderType}";

        // Lista de porductores codigo - Lista de porductores codigo
        ...
        $par6185a7056560433494dba94e9ae591079b4bbccf73b84691bf7d0887a82c7ccc = 0;

        if (null == $par6185a7056560433494dba94e9ae591079b4bbccf73b84691bf7d0887a82c7ccc) {
            $par6185a7056560433494dba94e9ae591079b4bbccf73b84691bf7d0887a82c7ccc = '0';
        }

        $par0a0ce2af85ab462a808e0270326fb8609b4bbccf73b84691bf7d0887a82c7ccc = 0;

        if (null == $par0a0ce2af85ab462a808e0270326fb8609b4bbccf73b84691bf7d0887a82c7ccc) {
            $par0a0ce2af85ab462a808e0270326fb8609b4bbccf73b84691bf7d0887a82c7ccc = '0';
        }

        $par5551ae677d6b488ebd38625d0f5d9fce9b4bbccf73b84691bf7d0887a82c7ccc = '';

        if ('-' == $par5551ae677d6b488ebd38625d0f5d9fce9b4bbccf73b84691bf7d0887a82c7ccc) {
            $par5551ae677d6b488ebd38625d0f5d9fce9b4bbccf73b84691bf7d0887a82c7ccc = null;
        }

        if (null == $par5551ae677d6b488ebd38625d0f5d9fce9b4bbccf73b84691bf7d0887a82c7ccc) {
            $par5551ae677d6b488ebd38625d0f5d9fce9b4bbccf73b84691bf7d0887a82c7ccc = '';
        }

        $par8fce8a73ac264e4a8f3b56d8b991b8a59b4bbccf73b84691bf7d0887a82c7ccc = '';

        if ('-' == $par8fce8a73ac264e4a8f3b56d8b991b8a59b4bbccf73b84691bf7d0887a82c7ccc) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a59b4bbccf73b84691bf7d0887a82c7ccc = null;
        }

        if (null == $par8fce8a73ac264e4a8f3b56d8b991b8a59b4bbccf73b84691bf7d0887a82c7ccc) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a59b4bbccf73b84691bf7d0887a82c7ccc = '';
        }

        $v9b4bbccf73b84691bf7d0887a82c7ccc = \App\repf782f923fd0247bd9f4010b717e52999::mt78425363b8964e69b078a6c87a0bf345($par4a3af8ffced0440a861dfc0a64a7df881, $par00626c2ae46a478aa2100971433ea90d1, $par6185a7056560433494dba94e9ae591079b4bbccf73b84691bf7d0887a82c7ccc, $par0a0ce2af85ab462a808e0270326fb8609b4bbccf73b84691bf7d0887a82c7ccc, $par5551ae677d6b488ebd38625d0f5d9fce9b4bbccf73b84691bf7d0887a82c7ccc, $par8fce8a73ac264e4a8f3b56d8b991b8a59b4bbccf73b84691bf7d0887a82c7ccc);

        $v9b4bbccf73b84691bf7d0887a82c7cccAjax = \URL::to('/').'/api/78425363b8964e69b078a6c87a0bf345/'.(null == $par4a3af8ffced0440a861dfc0a64a7df881 ? '-' : ('' == $par4a3af8ffced0440a861dfc0a64a7df881 ? '-' : $par4a3af8ffced0440a861dfc0a64a7df881)).'/'.(null == $par00626c2ae46a478aa2100971433ea90d1 ? '-' : ('' == $par00626c2ae46a478aa2100971433ea90d1 ? '-' : $par00626c2ae46a478aa2100971433ea90d1)).'/{page}/{pagesize}/{orderColumn}/{orderType}';

        // Lista de Semanas - Lista de Semanas

        $par6185a7056560433494dba94e9ae591073c3bad30715644d3a5cfc609e4bcfe94 = 0;

        if (null == $par6185a7056560433494dba94e9ae591073c3bad30715644d3a5cfc609e4bcfe94) {
            $par6185a7056560433494dba94e9ae591073c3bad30715644d3a5cfc609e4bcfe94 = '0';
        }

        $par0a0ce2af85ab462a808e0270326fb8603c3bad30715644d3a5cfc609e4bcfe94 = 0;

        if (null == $par0a0ce2af85ab462a808e0270326fb8603c3bad30715644d3a5cfc609e4bcfe94) {
            $par0a0ce2af85ab462a808e0270326fb8603c3bad30715644d3a5cfc609e4bcfe94 = '0';
        }

        $par5551ae677d6b488ebd38625d0f5d9fce3c3bad30715644d3a5cfc609e4bcfe94 = '';

        if ('-' == $par5551ae677d6b488ebd38625d0f5d9fce3c3bad30715644d3a5cfc609e4bcfe94) {
            $par5551ae677d6b488ebd38625d0f5d9fce3c3bad30715644d3a5cfc609e4bcfe94 = null;
        }

        if (null == $par5551ae677d6b488ebd38625d0f5d9fce3c3bad30715644d3a5cfc609e4bcfe94) {
            $par5551ae677d6b488ebd38625d0f5d9fce3c3bad30715644d3a5cfc609e4bcfe94 = '';
        }

        $par8fce8a73ac264e4a8f3b56d8b991b8a53c3bad30715644d3a5cfc609e4bcfe94 = '';

        if ('-' == $par8fce8a73ac264e4a8f3b56d8b991b8a53c3bad30715644d3a5cfc609e4bcfe94) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a53c3bad30715644d3a5cfc609e4bcfe94 = null;
        }

        if (null == $par8fce8a73ac264e4a8f3b56d8b991b8a53c3bad30715644d3a5cfc609e4bcfe94) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a53c3bad30715644d3a5cfc609e4bcfe94 = '';
        }

        $v3c3bad30715644d3a5cfc609e4bcfe94 = \App\repf782f923fd0247bd9f4010b717e52999::mtf3b6d1a392b14ca986fa6ded0a35c490($par6185a7056560433494dba94e9ae591073c3bad30715644d3a5cfc609e4bcfe94, $par0a0ce2af85ab462a808e0270326fb8603c3bad30715644d3a5cfc609e4bcfe94, $par5551ae677d6b488ebd38625d0f5d9fce3c3bad30715644d3a5cfc609e4bcfe94, $par8fce8a73ac264e4a8f3b56d8b991b8a53c3bad30715644d3a5cfc609e4bcfe94);

        $v3c3bad30715644d3a5cfc609e4bcfe94Ajax = \URL::to('/').'/api/f3b6d1a392b14ca986fa6ded0a35c490/{page}/{pagesize}/{orderColumn}/{orderType}';

        // Lista Tipo Leche - Lista Tipo Leche

        $par6185a7056560433494dba94e9ae5910758c766cedf5d4096af7a3689be7633fb = 0;

        if (null == $par6185a7056560433494dba94e9ae5910758c766cedf5d4096af7a3689be7633fb) {
            $par6185a7056560433494dba94e9ae5910758c766cedf5d4096af7a3689be7633fb = '0';
        }

        $par0a0ce2af85ab462a808e0270326fb86058c766cedf5d4096af7a3689be7633fb = 0;

        if (null == $par0a0ce2af85ab462a808e0270326fb86058c766cedf5d4096af7a3689be7633fb) {
            $par0a0ce2af85ab462a808e0270326fb86058c766cedf5d4096af7a3689be7633fb = '0';
        }

        $par5551ae677d6b488ebd38625d0f5d9fce58c766cedf5d4096af7a3689be7633fb = '';

        if ('-' == $par5551ae677d6b488ebd38625d0f5d9fce58c766cedf5d4096af7a3689be7633fb) {
            $par5551ae677d6b488ebd38625d0f5d9fce58c766cedf5d4096af7a3689be7633fb = null;
        }

        if (null == $par5551ae677d6b488ebd38625d0f5d9fce58c766cedf5d4096af7a3689be7633fb) {
            $par5551ae677d6b488ebd38625d0f5d9fce58c766cedf5d4096af7a3689be7633fb = '';
        }

        $par8fce8a73ac264e4a8f3b56d8b991b8a558c766cedf5d4096af7a3689be7633fb = '';

        if ('-' == $par8fce8a73ac264e4a8f3b56d8b991b8a558c766cedf5d4096af7a3689be7633fb) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a558c766cedf5d4096af7a3689be7633fb = null;
        }

        if (null == $par8fce8a73ac264e4a8f3b56d8b991b8a558c766cedf5d4096af7a3689be7633fb) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a558c766cedf5d4096af7a3689be7633fb = '';
        }

        $v58c766cedf5d4096af7a3689be7633fb = \App\repf782f923fd0247bd9f4010b717e52999::mt48e61ec9722046979c8bb305a6922ac3($par6185a7056560433494dba94e9ae5910758c766cedf5d4096af7a3689be7633fb, $par0a0ce2af85ab462a808e0270326fb86058c766cedf5d4096af7a3689be7633fb, $par5551ae677d6b488ebd38625d0f5d9fce58c766cedf5d4096af7a3689be7633fb, $par8fce8a73ac264e4a8f3b56d8b991b8a558c766cedf5d4096af7a3689be7633fb);

        $v58c766cedf5d4096af7a3689be7633fbAjax = \URL::to('/').'/api/48e61ec9722046979c8bb305a6922ac3/{page}/{pagesize}/{orderColumn}/{orderType}';

        // sp_boleta_semanal_title - sp_boleta_semanal_title

        $parc41f66df5ee8429a895b1dd2867d5b651 = $request->session()->get('ses5e122755c3a24f5d8789755168e9de27');

        if (null == $parc41f66df5ee8429a895b1dd2867d5b651) {
            $parc41f66df5ee8429a895b1dd2867d5b651 = '0';
        }

        $v14389e3dedca4fc7a1751d44fb0fd3cc = \App\repf782f923fd0247bd9f4010b717e52999::mtfad84b1b05cb4cc8abb32ee5533e983c($parc41f66df5ee8429a895b1dd2867d5b651);

        $v14389e3dedca4fc7a1751d44fb0fd3ccAjax = \URL::to('/').'/api/fad84b1b05cb4cc8abb32ee5533e983c/'.(null == $parc41f66df5ee8429a895b1dd2867d5b651 ? '-' : ('' == $parc41f66df5ee8429a895b1dd2867d5b651 ? '-' : $parc41f66df5ee8429a895b1dd2867d5b651)).'/{page}/{pagesize}/{orderColumn}/{orderType}';
        ...
        $par6185a7056560433494dba94e9ae59107caaf034fd17b4e4495845b17cfee0626 = 0;

        if (null == $par6185a7056560433494dba94e9ae59107caaf034fd17b4e4495845b17cfee0626) {
            $par6185a7056560433494dba94e9ae59107caaf034fd17b4e4495845b17cfee0626 = '0';
        }

        $par0a0ce2af85ab462a808e0270326fb860caaf034fd17b4e4495845b17cfee0626 = 0;

        if (null == $par0a0ce2af85ab462a808e0270326fb860caaf034fd17b4e4495845b17cfee0626) {
            $par0a0ce2af85ab462a808e0270326fb860caaf034fd17b4e4495845b17cfee0626 = '0';
        }

        $par5551ae677d6b488ebd38625d0f5d9fcecaaf034fd17b4e4495845b17cfee0626 = '';

        if ('-' == $par5551ae677d6b488ebd38625d0f5d9fcecaaf034fd17b4e4495845b17cfee0626) {
            $par5551ae677d6b488ebd38625d0f5d9fcecaaf034fd17b4e4495845b17cfee0626 = null;
        }

        if (null == $par5551ae677d6b488ebd38625d0f5d9fcecaaf034fd17b4e4495845b17cfee0626) {
            $par5551ae677d6b488ebd38625d0f5d9fcecaaf034fd17b4e4495845b17cfee0626 = '';
        }

        $par8fce8a73ac264e4a8f3b56d8b991b8a5caaf034fd17b4e4495845b17cfee0626 = '';

        if ('-' == $par8fce8a73ac264e4a8f3b56d8b991b8a5caaf034fd17b4e4495845b17cfee0626) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a5caaf034fd17b4e4495845b17cfee0626 = null;
        }

        if (null == $par8fce8a73ac264e4a8f3b56d8b991b8a5caaf034fd17b4e4495845b17cfee0626) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a5caaf034fd17b4e4495845b17cfee0626 = '';
        }

        $vcaaf034fd17b4e4495845b17cfee0626 = \App\repf782f923fd0247bd9f4010b717e52999::mtd1203cac9e0a4d2b8d8d3ac5e285d428($par8e9cfc8933a449af80f5fd2fdaf0c7461, $par949ac6762f824f589aa55df91c654a401, $par6185a7056560433494dba94e9ae59107caaf034fd17b4e4495845b17cfee0626, $par0a0ce2af85ab462a808e0270326fb860caaf034fd17b4e4495845b17cfee0626, $par5551ae677d6b488ebd38625d0f5d9fcecaaf034fd17b4e4495845b17cfee0626, $par8fce8a73ac264e4a8f3b56d8b991b8a5caaf034fd17b4e4495845b17cfee0626);

        $vcaaf034fd17b4e4495845b17cfee0626Ajax = \URL::to('/').'/api/d1203cac9e0a4d2b8d8d3ac5e285d428/'.(null == $par8e9cfc8933a449af80f5fd2fdaf0c7461 ? '-' : ('' == $par8e9cfc8933a449af80f5fd2fdaf0c7461 ? '-' : $par8e9cfc8933a449af80f5fd2fdaf0c7461)).'/'.(null == $par949ac6762f824f589aa55df91c654a401 ? '-' : ('' == $par949ac6762f824f589aa55df91c654a401 ? '-' : $par949ac6762f824f589aa55df91c654a401)).'/{page}/{pagesize}/{orderColumn}/{orderType}';
        ...
        // Paginador Boletas - Paginador Boletas
      $pgBd2b5d655698746aa975fd88691d8aaba = 0; // Page bottom
      $pgTd2b5d655698746aa975fd88691d8aaba = 0; // Page top
      $pgRd2b5d655698746aa975fd88691d8aaba = (isset($vc244a917560f4ea787be638752b55359Count) ? $vc244a917560f4ea787be638752b55359Count : 0); // Total rows
      $pgAd2b5d655698746aa975fd88691d8aaba = $par6185a7056560433494dba94e9ae59107c244a917560f4ea787be638752b55359; // Current page
      $pgSd2b5d655698746aa975fd88691d8aaba = $par0a0ce2af85ab462a808e0270326fb860c244a917560f4ea787be638752b55359; // Page size
      $pgHd2b5d655698746aa975fd88691d8aaba = 5; // Pages to show
      $pgPd2b5d655698746aa975fd88691d8aaba = ceil((isset($vc244a917560f4ea787be638752b55359Count) ? $vc244a917560f4ea787be638752b55359Count : 0) / $pgSd2b5d655698746aa975fd88691d8aaba); // Total pages
      $resd2b5d655698746aa975fd88691d8aaba = '';

        if ($pgPd2b5d655698746aa975fd88691d8aaba > 0 && $pgPd2b5d655698746aa975fd88691d8aaba >= $pgAd2b5d655698746aa975fd88691d8aaba) {
            $pgBd2b5d655698746aa975fd88691d8aaba = $pgAd2b5d655698746aa975fd88691d8aaba - (int) ($pgHd2b5d655698746aa975fd88691d8aaba / 2);

            if ($pgBd2b5d655698746aa975fd88691d8aaba <= 1) {
                $pgBd2b5d655698746aa975fd88691d8aaba = 0;
            }

            $pgTd2b5d655698746aa975fd88691d8aaba = $pgBd2b5d655698746aa975fd88691d8aaba + $pgHd2b5d655698746aa975fd88691d8aaba;

            if ($pgTd2b5d655698746aa975fd88691d8aaba >= $pgPd2b5d655698746aa975fd88691d8aaba) {
                $pgTd2b5d655698746aa975fd88691d8aaba = $pgPd2b5d655698746aa975fd88691d8aaba;
                $pgBd2b5d655698746aa975fd88691d8aaba = $pgPd2b5d655698746aa975fd88691d8aaba - $pgHd2b5d655698746aa975fd88691d8aaba;
            }

            $resd2b5d655698746aa975fd88691d8aaba .= '<li';
            if ($pgAd2b5d655698746aa975fd88691d8aaba > 1) {
                $resd2b5d655698746aa975fd88691d8aaba .= '';
            } else {
                $resd2b5d655698746aa975fd88691d8aaba .= ' class="disabled" ';
            }
            $resd2b5d655698746aa975fd88691d8aaba .= '>';
            if ($pgAd2b5d655698746aa975fd88691d8aaba > 1) {
                $resd2b5d655698746aa975fd88691d8aaba .= '<a href="';
                $resd2b5d655698746aa975fd88691d8aaba .= \URL::to('/').str_replace('{pagesize}', $pgSd2b5d655698746aa975fd88691d8aaba, str_replace('{pagenumber}', '1', '/boletasemanal/'.(null == $request->input('p') ? '-' : $request->input('p')).'/'.(null == $request->input('s') ? '-' : $request->input('s')).'/'.(null == $request->input('fi') ? '-' : $request->input('fi')).'/'.(null == $request->input('ff') ? '-' : $request->input('ff')).'/'.(null == $request->input('tl') ? '-' : $request->input('tl')).'/{pagenumber}/{pagesize}/'.(null == $request->input('t') ? '-' : $request->input('t')).''));
                $resd2b5d655698746aa975fd88691d8aaba .= '">';
            }
            $resd2b5d655698746aa975fd88691d8aaba .= str_replace('{Localization}', \Lang::get('resourceff2b12513d1a44948a7e7fbabde0697a.msg673755107d9e4f5cb0eef6837c91b302'), '<span aria-hidden="true">&laquo; {Localization}</span>');

            if ($pgAd2b5d655698746aa975fd88691d8aaba > 1) {
                $resd2b5d655698746aa975fd88691d8aaba .= '</a>';
            }
            $resd2b5d655698746aa975fd88691d8aaba .= '</li>';
            ...
            if ($pgAd2b5d655698746aa975fd88691d8aaba > 1) {
                $resd2b5d655698746aa975fd88691d8aaba .= '<a href="';
                $resd2b5d655698746aa975fd88691d8aaba .= \URL::to('/').str_replace('{pagesize}', $pgSd2b5d655698746aa975fd88691d8aaba, str_replace('{pagenumber}', ($pgAd2b5d655698746aa975fd88691d8aaba - 1), '/boletasemanal/'.(null == $request->input('p') ? '-' : $request->input('p')).'/'.(null == $request->input('s') ? '-' : $request->input('s')).'/'.(null == $request->input('fi') ? '-' : $request->input('fi')).'/'.(null == $request->input('ff') ? '-' : $request->input('ff')).'/'.(null == $request->input('tl') ? '-' : $request->input('tl')).'/{pagenumber}/{pagesize}/'.(null == $request->input('t') ? '-' : $request->input('t')).''));
                $resd2b5d655698746aa975fd88691d8aaba .= '">';
            }
            $resd2b5d655698746aa975fd88691d8aaba .= str_replace('{Localization}', \Lang::get('resourceff2b12513d1a44948a7e7fbabde0697a.msg9d046e3adb7647fc95991757861b6f28'), '<span aria-hidden="true">&laquo; {Localization}</span>');
            ...
            for ($i = 1; $i <= $pgPd2b5d655698746aa975fd88691d8aaba; ++$i) {
                if ($i > $pgBd2b5d655698746aa975fd88691d8aaba && $i <= $pgTd2b5d655698746aa975fd88691d8aaba) {
                    $resd2b5d655698746aa975fd88691d8aaba .= '<li';
                    if ($i == $pgAd2b5d655698746aa975fd88691d8aaba) {
                        $resd2b5d655698746aa975fd88691d8aaba .= ' class="active" ';
                    } else {
                        $resd2b5d655698746aa975fd88691d8aaba .= '';
                    }
                    $resd2b5d655698746aa975fd88691d8aaba .= '>';
                    $resd2b5d655698746aa975fd88691d8aaba .= '<a href="';
                    $resd2b5d655698746aa975fd88691d8aaba .= \URL::to('/').str_replace('{pagesize}', $pgSd2b5d655698746aa975fd88691d8aaba, str_replace('{pagenumber}', $i, '/boletasemanal/'.(null == $request->input('p') ? '-' : $request->input('p')).'/'.(null == $request->input('s') ? '-' : $request->input('s')).'/'.(null == $request->input('fi') ? '-' : $request->input('fi')).'/'.(null == $request->input('ff') ? '-' : $request->input('ff')).'/'.(null == $request->input('tl') ? '-' : $request->input('tl')).'/{pagenumber}/{pagesize}/'.(null == $request->input('t') ? '-' : $request->input('t')).''));
                    $resd2b5d655698746aa975fd88691d8aaba .= '">';
                    $resd2b5d655698746aa975fd88691d8aaba .= $i;
                    $resd2b5d655698746aa975fd88691d8aaba .= '</a></li>';
                }
            }

            $resd2b5d655698746aa975fd88691d8aaba .= '<li';
            if ($pgAd2b5d655698746aa975fd88691d8aaba < $pgPd2b5d655698746aa975fd88691d8aaba) {
                $resd2b5d655698746aa975fd88691d8aaba .= '';
            } else {
                $resd2b5d655698746aa975fd88691d8aaba .= ' class="disabled" ';
            }
            ...
            $resd2b5d655698746aa975fd88691d8aaba .= str_replace('{Localization}', \Lang::get('resourceff2b12513d1a44948a7e7fbabde0697a.msg6d4792f9962a46f2b37bbf9af604eda9'), '<span aria-hidden="true">{Localization} &raquo;</span>');
            ...
            if ($pgAd2b5d655698746aa975fd88691d8aaba < $pgPd2b5d655698746aa975fd88691d8aaba) {
                $resd2b5d655698746aa975fd88691d8aaba .= '<a href="';
                $resd2b5d655698746aa975fd88691d8aaba .= \URL::to('/').str_replace('{pagesize}', $pgSd2b5d655698746aa975fd88691d8aaba, str_replace('{pagenumber}', $pgPd2b5d655698746aa975fd88691d8aaba, '/boletasemanal/'.(null == $request->input('p') ? '-' : $request->input('p')).'/'.(null == $request->input('s') ? '-' : $request->input('s')).'/'.(null == $request->input('fi') ? '-' : $request->input('fi')).'/'.(null == $request->input('ff') ? '-' : $request->input('ff')).'/'.(null == $request->input('tl') ? '-' : $request->input('tl')).'/{pagenumber}/{pagesize}/'.(null == $request->input('t') ? '-' : $request->input('t')).''));
                $resd2b5d655698746aa975fd88691d8aaba .= '">';
            }
            $resd2b5d655698746aa975fd88691d8aaba .= str_replace('{Localization}', \Lang::get('resourceff2b12513d1a44948a7e7fbabde0697a.msga50b13adc5284e92844239ca59bf38e5'), '<span aria-hidden="true">{Localization} &raquo;</span>');
        ...
        $vd2b5d655698746aa975fd88691d8aaba = $resd2b5d655698746aa975fd88691d8aaba;
        $vd2b5d655698746aa975fd88691d8aabaLink = \URL::to('/').'/boletasemanal/'.(null == $request->input('p') ? '-' : $request->input('p')).'/'.(null == $request->input('s') ? '-' : $request->input('s')).'/'.(null == $request->input('fi') ? '-' : $request->input('fi')).'/'.(null == $request->input('ff') ? '-' : $request->input('ff')).'/'.(null == $request->input('tl') ? '-' : $request->input('tl')).'/{pagenumber}/{pagesize}/'.(null == $request->input('t') ? '-' : $request->input('t')).'';
        $vd2b5d655698746aa975fd88691d8aabaChange = $pgPd2b5d655698746aa975fd88691d8aaba.','.$pgAd2b5d655698746aa975fd88691d8aaba;
        $vd2b5d655698746aa975fd88691d8aabaCurrent = $pgSd2b5d655698746aa975fd88691d8aaba;
        $vd2b5d655698746aa975fd88691d8aabaActual = $pgAd2b5d655698746aa975fd88691d8aaba;
        $vd2b5d655698746aa975fd88691d8aabaTotal = $pgRd2b5d655698746aa975fd88691d8aaba;
        $vd2b5d655698746aa975fd88691d8aabaAjax = (isset($vc244a917560f4ea787be638752b55359Ajax) ? $vc244a917560f4ea787be638752b55359Ajax : '');
        $vd2b5d655698746aa975fd88691d8aabaOrder = $par5551ae677d6b488ebd38625d0f5d9fcec244a917560f4ea787be638752b55359.'|'.$par8fce8a73ac264e4a8f3b56d8b991b8a5c244a917560f4ea787be638752b55359;

        $arrWiths['vc244a917560f4ea787be638752b55359'] = isset($vc244a917560f4ea787be638752b55359) ? $vc244a917560f4ea787be638752b55359 : '';
        $arrWiths['vc244a917560f4ea787be638752b55359Count'] = isset($vc244a917560f4ea787be638752b55359Count) ? $vc244a917560f4ea787be638752b55359Count : '';
        $arrWiths['vc244a917560f4ea787be638752b55359Ajax'] = isset($vc244a917560f4ea787be638752b55359Ajax) ? $vc244a917560f4ea787be638752b55359Ajax : '';
        $arrWiths['v9b4bbccf73b84691bf7d0887a82c7ccc'] = isset($v9b4bbccf73b84691bf7d0887a82c7ccc) ? $v9b4bbccf73b84691bf7d0887a82c7ccc : '';
        $arrWiths['v9b4bbccf73b84691bf7d0887a82c7cccAjax'] = isset($v9b4bbccf73b84691bf7d0887a82c7cccAjax) ? $v9b4bbccf73b84691bf7d0887a82c7cccAjax : '';
        $arrWiths['v3c3bad30715644d3a5cfc609e4bcfe94'] = isset($v3c3bad30715644d3a5cfc609e4bcfe94) ? $v3c3bad30715644d3a5cfc609e4bcfe94 : '';
        $arrWiths['v3c3bad30715644d3a5cfc609e4bcfe94Ajax'] = isset($v3c3bad30715644d3a5cfc609e4bcfe94Ajax) ? $v3c3bad30715644d3a5cfc609e4bcfe94Ajax : '';
        $arrWiths['v58c766cedf5d4096af7a3689be7633fb'] = isset($v58c766cedf5d4096af7a3689be7633fb) ? $v58c766cedf5d4096af7a3689be7633fb : '';
        $arrWiths['v58c766cedf5d4096af7a3689be7633fbAjax'] = isset($v58c766cedf5d4096af7a3689be7633fbAjax) ? $v58c766cedf5d4096af7a3689be7633fbAjax : '';
        $arrWiths['v14389e3dedca4fc7a1751d44fb0fd3cc'] = isset($v14389e3dedca4fc7a1751d44fb0fd3cc) ? $v14389e3dedca4fc7a1751d44fb0fd3cc : '';
        $arrWiths['vcaaf034fd17b4e4495845b17cfee0626'] = isset($vcaaf034fd17b4e4495845b17cfee0626) ? $vcaaf034fd17b4e4495845b17cfee0626 : '';
        $arrWiths['vcaaf034fd17b4e4495845b17cfee0626Ajax'] = isset($vcaaf034fd17b4e4495845b17cfee0626Ajax) ? $vcaaf034fd17b4e4495845b17cfee0626Ajax : '';
        ...
        $arrWiths['vd2b5d655698746aa975fd88691d8aaba'] = isset($vd2b5d655698746aa975fd88691d8aaba) ? $vd2b5d655698746aa975fd88691d8aaba : '';
        $arrWiths['vd2b5d655698746aa975fd88691d8aabaLink'] = isset($vd2b5d655698746aa975fd88691d8aabaLink) ? $vd2b5d655698746aa975fd88691d8aabaLink : '';
        $arrWiths['vd2b5d655698746aa975fd88691d8aabaChange'] = isset($vd2b5d655698746aa975fd88691d8aabaChange) ? $vd2b5d655698746aa975fd88691d8aabaChange : '';
        $arrWiths['vd2b5d655698746aa975fd88691d8aabaCurrent'] = isset($vd2b5d655698746aa975fd88691d8aabaCurrent) ? $vd2b5d655698746aa975fd88691d8aabaCurrent : '';
        $arrWiths['vd2b5d655698746aa975fd88691d8aabaActual'] = isset($vd2b5d655698746aa975fd88691d8aabaActual) ? $vd2b5d655698746aa975fd88691d8aabaActual : '';
        $arrWiths['vd2b5d655698746aa975fd88691d8aabaTotal'] = isset($vd2b5d655698746aa975fd88691d8aabaTotal) ? $vd2b5d655698746aa975fd88691d8aabaTotal : '';
        $arrWiths['vd2b5d655698746aa975fd88691d8aabaAjax'] = isset($vd2b5d655698746aa975fd88691d8aabaAjax) ? $vd2b5d655698746aa975fd88691d8aabaAjax : '';
        $arrWiths['vd2b5d655698746aa975fd88691d8aabaOrder'] = isset($vd2b5d655698746aa975fd88691d8aabaOrder) ? $vd2b5d655698746aa975fd88691d8aabaOrder : '';
        ...
        $response = new \Illuminate\Http\Response(view('006435b4029e439d8aefe2d1254e146b.Index', $arrWiths)->with('title', $arrWiths['title'])->with('vSessionTimeout', \Config::get('session.lifetime') * 60));
