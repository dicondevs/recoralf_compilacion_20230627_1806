...
// Creado               martes, 27 de junio de 2023 17:59:16
 ...
 */
class pgfe448b518ba44e3f85ca60fdcc9e22acController extends Controller
{
    /**
    ...
    public function post(Request $request)
    {
        ...
        // Guardar - Guardar
        if (null != $request->input('ctlf5b82e45c9614075acf7d4651a8e3142_a290d18e691f446c81c4e77c1b896738') && null != $request->input('hida290d18e691f446c81c4e77c1b896738') && 'a290d18e691f446c81c4e77c1b896738' == $request->input('hida290d18e691f446c81c4e77c1b896738')) {
            $key = 0;
            $isNew = false;
            ...
            $tb = \App\tbe0bd2456a7c8443290015bd6353abcdb::where('PK_USUARIOS', $key)->first();
            if (null == $tb) {
                $isNew = true;
                $tb = new \App\tbe0bd2456a7c8443290015bd6353abcdb();
            }

            if (null != $request->input('ctl59d9f671dd2a4f4593b62d681ebc0981_a290d18e691f446c81c4e77c1b896738')) {
                $tb->FK_PERFIL = $request->input('ctl59d9f671dd2a4f4593b62d681ebc0981_a290d18e691f446c81c4e77c1b896738'); //FK_PERFIL
            } elseif (null == $request->input('ctl59d9f671dd2a4f4593b62d681ebc0981_a290d18e691f446c81c4e77c1b896738')) {
                $tb->FK_PERFIL = null;
            }

            if (null != $request->input('ctl29b952a7e8da4b0b8efab56183c6c24e_a290d18e691f446c81c4e77c1b896738')) {
                $tb->FL_APELLIDO_MATERNO = $request->input('ctl29b952a7e8da4b0b8efab56183c6c24e_a290d18e691f446c81c4e77c1b896738'); //FL_APELLIDO_MATERNO
            } elseif (null == $request->input('ctl29b952a7e8da4b0b8efab56183c6c24e_a290d18e691f446c81c4e77c1b896738')) {
                $tb->FL_APELLIDO_MATERNO = null;
            }

            if (null != $request->input('ctlec760426ee1c49d4ab22bb872206cde0_a290d18e691f446c81c4e77c1b896738')) {
                $tb->FL_APELLIDO_PATERNO = $request->input('ctlec760426ee1c49d4ab22bb872206cde0_a290d18e691f446c81c4e77c1b896738'); //FL_APELLIDO_PATERNO
            } elseif (null == $request->input('ctlec760426ee1c49d4ab22bb872206cde0_a290d18e691f446c81c4e77c1b896738')) {
                $tb->FL_APELLIDO_PATERNO = null;
            }

            if (null != $request->input('ctlb847eb04392d433686683daec7887c6f_a290d18e691f446c81c4e77c1b896738')) {
                $tb->FL_NOMBRE = $request->input('ctlb847eb04392d433686683daec7887c6f_a290d18e691f446c81c4e77c1b896738'); //FL_NOMBRE
            } elseif (null == $request->input('ctlb847eb04392d433686683daec7887c6f_a290d18e691f446c81c4e77c1b896738')) {
                $tb->FL_NOMBRE = null;
            }
            if (null != $request->input('ctl54f0c3d44541490eb3d0f0bbdd9f2a4f_a290d18e691f446c81c4e77c1b896738') && '' != $request->input('ctl54f0c3d44541490eb3d0f0bbdd9f2a4f_a290d18e691f446c81c4e77c1b896738')) {
                $tb->FL_CONTRASENA = hash('sha1', $request->input('ctl54f0c3d44541490eb3d0f0bbdd9f2a4f_a290d18e691f446c81c4e77c1b896738')); //FL_CONTRASENA
            }

            if (null != $request->input('ctl884b789ee7a9444eaa8c95c1b2db09a3_a290d18e691f446c81c4e77c1b896738')) {
                $tb->FL_EMAIL = $request->input('ctl884b789ee7a9444eaa8c95c1b2db09a3_a290d18e691f446c81c4e77c1b896738'); //FL_EMAIL
            } elseif (null == $request->input('ctl884b789ee7a9444eaa8c95c1b2db09a3_a290d18e691f446c81c4e77c1b896738')) {
                $tb->FL_EMAIL = null;
            }
            if (null != $request->input('ctl41332b542a734638b2276a180f65af00_a290d18e691f446c81c4e77c1b896738')) {
                $tb->FL_ACTIVO_INACTIVO = true; //FL_ACTIVO_INACTIVO
            } else {
                $tb->FL_ACTIVO_INACTIVO = false; //FL_ACTIVO_INACTIVO
            }

            if (null != $request->input('ctl629e95fec82f4ce79c9746e8fb1e7f6d_a290d18e691f446c81c4e77c1b896738')) {
                $tb->FK_CENTROS_TRABAJO = $request->input('ctl629e95fec82f4ce79c9746e8fb1e7f6d_a290d18e691f446c81c4e77c1b896738'); //FK_CENTROS_TRABAJO
            } elseif (null == $request->input('ctl629e95fec82f4ce79c9746e8fb1e7f6d_a290d18e691f446c81c4e77c1b896738')) {
                $tb->FK_CENTROS_TRABAJO = null;
            }

            $tb->save();

            //FK_USUARIOS
            \App\tb62998425b7114a85a63e84519fe2708a::where('FK_USUARIOS', $tb->PK_USUARIOS)->delete();
            $rele95614a9f8764bfba30910361b7957df = $request->input('ctl6f56cd5c4b024458b3da2da4d1f08d26_a290d18e691f446c81c4e77c1b896738');
            if (null != $rele95614a9f8764bfba30910361b7957df && !is_array($rele95614a9f8764bfba30910361b7957df)) {
                $rele95614a9f8764bfba30910361b7957df = explode(',', $request->input('ctl6f56cd5c4b024458b3da2da4d1f08d26_a290d18e691f446c81c4e77c1b896738'));
            }
            if (null != $rele95614a9f8764bfba30910361b7957df && is_array($rele95614a9f8764bfba30910361b7957df)) {
                foreach ($rele95614a9f8764bfba30910361b7957df as $re95614a9f8764bfba30910361b7957df => $value) {
                    $tbRel = new \App\tb62998425b7114a85a63e84519fe2708a();
                    $tbRel->FK_USUARIOS = $tb->PK_USUARIOS;
                    $tbRel->FK_CENTROS_ACOPIO = $value;
                    $tbRel->save();
                }
            }
    ...
    public function index(Request $request)
    {
        ...
        // Lista Centro de Acopio Users - Lista Centro de Acopio Users

        $par6185a7056560433494dba94e9ae59107278f3495859f48e5b23b7f21fa289f38 = 0;

        if (null == $par6185a7056560433494dba94e9ae59107278f3495859f48e5b23b7f21fa289f38) {
            $par6185a7056560433494dba94e9ae59107278f3495859f48e5b23b7f21fa289f38 = '0';
        }

        $par0a0ce2af85ab462a808e0270326fb860278f3495859f48e5b23b7f21fa289f38 = 0;

        if (null == $par0a0ce2af85ab462a808e0270326fb860278f3495859f48e5b23b7f21fa289f38) {
            $par0a0ce2af85ab462a808e0270326fb860278f3495859f48e5b23b7f21fa289f38 = '0';
        }

        $par5551ae677d6b488ebd38625d0f5d9fce278f3495859f48e5b23b7f21fa289f38 = '';

        if ('-' == $par5551ae677d6b488ebd38625d0f5d9fce278f3495859f48e5b23b7f21fa289f38) {
            $par5551ae677d6b488ebd38625d0f5d9fce278f3495859f48e5b23b7f21fa289f38 = null;
        }

        if (null == $par5551ae677d6b488ebd38625d0f5d9fce278f3495859f48e5b23b7f21fa289f38) {
            $par5551ae677d6b488ebd38625d0f5d9fce278f3495859f48e5b23b7f21fa289f38 = '';
        }

        $par8fce8a73ac264e4a8f3b56d8b991b8a5278f3495859f48e5b23b7f21fa289f38 = '';

        if ('-' == $par8fce8a73ac264e4a8f3b56d8b991b8a5278f3495859f48e5b23b7f21fa289f38) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a5278f3495859f48e5b23b7f21fa289f38 = null;
        }

        if (null == $par8fce8a73ac264e4a8f3b56d8b991b8a5278f3495859f48e5b23b7f21fa289f38) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a5278f3495859f48e5b23b7f21fa289f38 = '';
        }

        $v278f3495859f48e5b23b7f21fa289f38 = \App\repf782f923fd0247bd9f4010b717e52999::mt0ad408e6cdba422d8190d00390c930d3($par6185a7056560433494dba94e9ae59107278f3495859f48e5b23b7f21fa289f38, $par0a0ce2af85ab462a808e0270326fb860278f3495859f48e5b23b7f21fa289f38, $par5551ae677d6b488ebd38625d0f5d9fce278f3495859f48e5b23b7f21fa289f38, $par8fce8a73ac264e4a8f3b56d8b991b8a5278f3495859f48e5b23b7f21fa289f38);

        $v278f3495859f48e5b23b7f21fa289f38Ajax = \URL::to('/').'/api/0ad408e6cdba422d8190d00390c930d3/{page}/{pagesize}/{orderColumn}/{orderType}';

        // Lista Centro de Trabajo - Lista Centro de Trabajo

        $par6185a7056560433494dba94e9ae59107864b48bdb884468aa5925ed5ed29ea1d = 0;

        if (null == $par6185a7056560433494dba94e9ae59107864b48bdb884468aa5925ed5ed29ea1d) {
            $par6185a7056560433494dba94e9ae59107864b48bdb884468aa5925ed5ed29ea1d = '0';
        }

        $par0a0ce2af85ab462a808e0270326fb860864b48bdb884468aa5925ed5ed29ea1d = 0;

        if (null == $par0a0ce2af85ab462a808e0270326fb860864b48bdb884468aa5925ed5ed29ea1d) {
            $par0a0ce2af85ab462a808e0270326fb860864b48bdb884468aa5925ed5ed29ea1d = '0';
        }

        $par5551ae677d6b488ebd38625d0f5d9fce864b48bdb884468aa5925ed5ed29ea1d = '';

        if ('-' == $par5551ae677d6b488ebd38625d0f5d9fce864b48bdb884468aa5925ed5ed29ea1d) {
            $par5551ae677d6b488ebd38625d0f5d9fce864b48bdb884468aa5925ed5ed29ea1d = null;
        }

        if (null == $par5551ae677d6b488ebd38625d0f5d9fce864b48bdb884468aa5925ed5ed29ea1d) {
            $par5551ae677d6b488ebd38625d0f5d9fce864b48bdb884468aa5925ed5ed29ea1d = '';
        }

        $par8fce8a73ac264e4a8f3b56d8b991b8a5864b48bdb884468aa5925ed5ed29ea1d = '';

        if ('-' == $par8fce8a73ac264e4a8f3b56d8b991b8a5864b48bdb884468aa5925ed5ed29ea1d) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a5864b48bdb884468aa5925ed5ed29ea1d = null;
        }

        if (null == $par8fce8a73ac264e4a8f3b56d8b991b8a5864b48bdb884468aa5925ed5ed29ea1d) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a5864b48bdb884468aa5925ed5ed29ea1d = '';
        }

        $v864b48bdb884468aa5925ed5ed29ea1d = \App\repf782f923fd0247bd9f4010b717e52999::mt85df7a461c854558b85b8e2466ff1014($par6185a7056560433494dba94e9ae59107864b48bdb884468aa5925ed5ed29ea1d, $par0a0ce2af85ab462a808e0270326fb860864b48bdb884468aa5925ed5ed29ea1d, $par5551ae677d6b488ebd38625d0f5d9fce864b48bdb884468aa5925ed5ed29ea1d, $par8fce8a73ac264e4a8f3b56d8b991b8a5864b48bdb884468aa5925ed5ed29ea1d);

        $v864b48bdb884468aa5925ed5ed29ea1dAjax = \URL::to('/').'/api/85df7a461c854558b85b8e2466ff1014/{page}/{pagesize}/{orderColumn}/{orderType}';

        // Lista de Centro Acopio - Lista de Centro Acopio

        $pardd3780b5691843b4b7e62ed23891ccc6 = $request->input('ct');

        if (null == $pardd3780b5691843b4b7e62ed23891ccc6) {
            $pardd3780b5691843b4b7e62ed23891ccc6 = '0';
        }

        $par6185a7056560433494dba94e9ae59107e8ebade1b5404309a904a2c2ca436959 = 0;

        if (null == $par6185a7056560433494dba94e9ae59107e8ebade1b5404309a904a2c2ca436959) {
            $par6185a7056560433494dba94e9ae59107e8ebade1b5404309a904a2c2ca436959 = '0';
        }

        $par0a0ce2af85ab462a808e0270326fb860e8ebade1b5404309a904a2c2ca436959 = 0;

        if (null == $par0a0ce2af85ab462a808e0270326fb860e8ebade1b5404309a904a2c2ca436959) {
            $par0a0ce2af85ab462a808e0270326fb860e8ebade1b5404309a904a2c2ca436959 = '0';
        }

        $par5551ae677d6b488ebd38625d0f5d9fcee8ebade1b5404309a904a2c2ca436959 = '';

        if ('-' == $par5551ae677d6b488ebd38625d0f5d9fcee8ebade1b5404309a904a2c2ca436959) {
            $par5551ae677d6b488ebd38625d0f5d9fcee8ebade1b5404309a904a2c2ca436959 = null;
        }

        if (null == $par5551ae677d6b488ebd38625d0f5d9fcee8ebade1b5404309a904a2c2ca436959) {
            $par5551ae677d6b488ebd38625d0f5d9fcee8ebade1b5404309a904a2c2ca436959 = '';
        }

        $par8fce8a73ac264e4a8f3b56d8b991b8a5e8ebade1b5404309a904a2c2ca436959 = '';

        if ('-' == $par8fce8a73ac264e4a8f3b56d8b991b8a5e8ebade1b5404309a904a2c2ca436959) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a5e8ebade1b5404309a904a2c2ca436959 = null;
        }

        if (null == $par8fce8a73ac264e4a8f3b56d8b991b8a5e8ebade1b5404309a904a2c2ca436959) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a5e8ebade1b5404309a904a2c2ca436959 = '';
        }

        $ve8ebade1b5404309a904a2c2ca436959 = \App\repf782f923fd0247bd9f4010b717e52999::mtae8e9cfbd4174125aa0ae9597c5ded2f($pardd3780b5691843b4b7e62ed23891ccc6, $par6185a7056560433494dba94e9ae59107e8ebade1b5404309a904a2c2ca436959, $par0a0ce2af85ab462a808e0270326fb860e8ebade1b5404309a904a2c2ca436959, $par5551ae677d6b488ebd38625d0f5d9fcee8ebade1b5404309a904a2c2ca436959, $par8fce8a73ac264e4a8f3b56d8b991b8a5e8ebade1b5404309a904a2c2ca436959);

        $ve8ebade1b5404309a904a2c2ca436959Ajax = \URL::to('/').'/api/ae8e9cfbd4174125aa0ae9597c5ded2f/'.(null == $pardd3780b5691843b4b7e62ed23891ccc6 ? '-' : ('' == $pardd3780b5691843b4b7e62ed23891ccc6 ? '-' : $pardd3780b5691843b4b7e62ed23891ccc6)).'/{page}/{pagesize}/{orderColumn}/{orderType}';

        // Lista de perfil - Lista de perfil

        $par6185a7056560433494dba94e9ae591073c10bd297f034331963df38fe85c55a0 = 0;

        if (null == $par6185a7056560433494dba94e9ae591073c10bd297f034331963df38fe85c55a0) {
            $par6185a7056560433494dba94e9ae591073c10bd297f034331963df38fe85c55a0 = '0';
        }

        $par0a0ce2af85ab462a808e0270326fb8603c10bd297f034331963df38fe85c55a0 = 0;

        if (null == $par0a0ce2af85ab462a808e0270326fb8603c10bd297f034331963df38fe85c55a0) {
            $par0a0ce2af85ab462a808e0270326fb8603c10bd297f034331963df38fe85c55a0 = '0';
        }

        $par5551ae677d6b488ebd38625d0f5d9fce3c10bd297f034331963df38fe85c55a0 = '';

        if ('-' == $par5551ae677d6b488ebd38625d0f5d9fce3c10bd297f034331963df38fe85c55a0) {
            $par5551ae677d6b488ebd38625d0f5d9fce3c10bd297f034331963df38fe85c55a0 = null;
        }

        if (null == $par5551ae677d6b488ebd38625d0f5d9fce3c10bd297f034331963df38fe85c55a0) {
            $par5551ae677d6b488ebd38625d0f5d9fce3c10bd297f034331963df38fe85c55a0 = '';
        }

        $par8fce8a73ac264e4a8f3b56d8b991b8a53c10bd297f034331963df38fe85c55a0 = '';

        if ('-' == $par8fce8a73ac264e4a8f3b56d8b991b8a53c10bd297f034331963df38fe85c55a0) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a53c10bd297f034331963df38fe85c55a0 = null;
        }

        if (null == $par8fce8a73ac264e4a8f3b56d8b991b8a53c10bd297f034331963df38fe85c55a0) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a53c10bd297f034331963df38fe85c55a0 = '';
        }

        $v3c10bd297f034331963df38fe85c55a0 = \App\repf782f923fd0247bd9f4010b717e52999::mt43cb5f4c6f0143c5a135334d93bebb71($par6185a7056560433494dba94e9ae591073c10bd297f034331963df38fe85c55a0, $par0a0ce2af85ab462a808e0270326fb8603c10bd297f034331963df38fe85c55a0, $par5551ae677d6b488ebd38625d0f5d9fce3c10bd297f034331963df38fe85c55a0, $par8fce8a73ac264e4a8f3b56d8b991b8a53c10bd297f034331963df38fe85c55a0);

        $v3c10bd297f034331963df38fe85c55a0Ajax = \URL::to('/').'/api/43cb5f4c6f0143c5a135334d93bebb71/{page}/{pagesize}/{orderColumn}/{orderType}';

        // Recuperar usuarios - Recuperar usuarios

        $par18d0628ff9114afabc54c2f4ed0d6e4b = $request->input('u');

        if (null == $par18d0628ff9114afabc54c2f4ed0d6e4b) {
            $par18d0628ff9114afabc54c2f4ed0d6e4b = '0';
        }

        $par6185a7056560433494dba94e9ae59107ff15b25ba05144f7b7ebf5dff8221830 = 0;

        if (null == $par6185a7056560433494dba94e9ae59107ff15b25ba05144f7b7ebf5dff8221830) {
            $par6185a7056560433494dba94e9ae59107ff15b25ba05144f7b7ebf5dff8221830 = '0';
        }

        $par0a0ce2af85ab462a808e0270326fb860ff15b25ba05144f7b7ebf5dff8221830 = 0;

        if (null == $par0a0ce2af85ab462a808e0270326fb860ff15b25ba05144f7b7ebf5dff8221830) {
            $par0a0ce2af85ab462a808e0270326fb860ff15b25ba05144f7b7ebf5dff8221830 = '0';
        }

        $par5551ae677d6b488ebd38625d0f5d9fceff15b25ba05144f7b7ebf5dff8221830 = '';

        if ('-' == $par5551ae677d6b488ebd38625d0f5d9fceff15b25ba05144f7b7ebf5dff8221830) {
            $par5551ae677d6b488ebd38625d0f5d9fceff15b25ba05144f7b7ebf5dff8221830 = null;
        }

        if (null == $par5551ae677d6b488ebd38625d0f5d9fceff15b25ba05144f7b7ebf5dff8221830) {
            $par5551ae677d6b488ebd38625d0f5d9fceff15b25ba05144f7b7ebf5dff8221830 = '';
        }

        $par8fce8a73ac264e4a8f3b56d8b991b8a5ff15b25ba05144f7b7ebf5dff8221830 = '';

        if ('-' == $par8fce8a73ac264e4a8f3b56d8b991b8a5ff15b25ba05144f7b7ebf5dff8221830) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a5ff15b25ba05144f7b7ebf5dff8221830 = null;
        }

        if (null == $par8fce8a73ac264e4a8f3b56d8b991b8a5ff15b25ba05144f7b7ebf5dff8221830) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a5ff15b25ba05144f7b7ebf5dff8221830 = '';
        }

        $vff15b25ba05144f7b7ebf5dff8221830 = \App\repf782f923fd0247bd9f4010b717e52999::mt7f8b55907bfd48d7b91d6640c223b0e9($par18d0628ff9114afabc54c2f4ed0d6e4b, $par6185a7056560433494dba94e9ae59107ff15b25ba05144f7b7ebf5dff8221830, $par0a0ce2af85ab462a808e0270326fb860ff15b25ba05144f7b7ebf5dff8221830, $par5551ae677d6b488ebd38625d0f5d9fceff15b25ba05144f7b7ebf5dff8221830, $par8fce8a73ac264e4a8f3b56d8b991b8a5ff15b25ba05144f7b7ebf5dff8221830);

        $vff15b25ba05144f7b7ebf5dff8221830Ajax = \URL::to('/').'/api/7f8b55907bfd48d7b91d6640c223b0e9/'.(null == $par18d0628ff9114afabc54c2f4ed0d6e4b ? '-' : ('' == $par18d0628ff9114afabc54c2f4ed0d6e4b ? '-' : $par18d0628ff9114afabc54c2f4ed0d6e4b)).'/{page}/{pagesize}/{orderColumn}/{orderType}';

        // sp_edit_ct_ca_users - sp_edit_ct_ca_users

        $par9b6900dab5de4694acfab6b3b8717dd41 = $request->session()->get('ses5e122755c3a24f5d8789755168e9de27');

        if (null == $par9b6900dab5de4694acfab6b3b8717dd41) {
            $par9b6900dab5de4694acfab6b3b8717dd41 = '0';
        }

        $par448e6f6786c645329dba568597524dea1 = $request->input('u');

        if (null == $par448e6f6786c645329dba568597524dea1) {
            $par448e6f6786c645329dba568597524dea1 = '0';
        }

        $pard0946669660245b19a26fe94b6fe1b8a1 = $request->input('ct');

        if (null == $pard0946669660245b19a26fe94b6fe1b8a1) {
            $pard0946669660245b19a26fe94b6fe1b8a1 = '0';
        }

        $v38f7cb5222274af89b4b045f6c4427e9 = \App\repf782f923fd0247bd9f4010b717e52999::mtcd58c2d719244584b22b7eca5d30f60a($par9b6900dab5de4694acfab6b3b8717dd41, $par448e6f6786c645329dba568597524dea1, $pard0946669660245b19a26fe94b6fe1b8a1);

        $v38f7cb5222274af89b4b045f6c4427e9Ajax = \URL::to('/').'/api/cd58c2d719244584b22b7eca5d30f60a/'.(null == $par9b6900dab5de4694acfab6b3b8717dd41 ? '-' : ('' == $par9b6900dab5de4694acfab6b3b8717dd41 ? '-' : $par9b6900dab5de4694acfab6b3b8717dd41)).'/'.(null == $par448e6f6786c645329dba568597524dea1 ? '-' : ('' == $par448e6f6786c645329dba568597524dea1 ? '-' : $par448e6f6786c645329dba568597524dea1)).'/'.(null == $pard0946669660245b19a26fe94b6fe1b8a1 ? '-' : ('' == $pard0946669660245b19a26fe94b6fe1b8a1 ? '-' : $pard0946669660245b19a26fe94b6fe1b8a1)).'/{page}/{pagesize}/{orderColumn}/{orderType}';
        ...
        $arrWiths['v278f3495859f48e5b23b7f21fa289f38'] = isset($v278f3495859f48e5b23b7f21fa289f38) ? $v278f3495859f48e5b23b7f21fa289f38 : '';
        $arrWiths['v278f3495859f48e5b23b7f21fa289f38Ajax'] = isset($v278f3495859f48e5b23b7f21fa289f38Ajax) ? $v278f3495859f48e5b23b7f21fa289f38Ajax : '';
        $arrWiths['v864b48bdb884468aa5925ed5ed29ea1d'] = isset($v864b48bdb884468aa5925ed5ed29ea1d) ? $v864b48bdb884468aa5925ed5ed29ea1d : '';
        $arrWiths['v864b48bdb884468aa5925ed5ed29ea1dAjax'] = isset($v864b48bdb884468aa5925ed5ed29ea1dAjax) ? $v864b48bdb884468aa5925ed5ed29ea1dAjax : '';
        $arrWiths['ve8ebade1b5404309a904a2c2ca436959'] = isset($ve8ebade1b5404309a904a2c2ca436959) ? $ve8ebade1b5404309a904a2c2ca436959 : '';
        $arrWiths['ve8ebade1b5404309a904a2c2ca436959Ajax'] = isset($ve8ebade1b5404309a904a2c2ca436959Ajax) ? $ve8ebade1b5404309a904a2c2ca436959Ajax : '';
        $arrWiths['v3c10bd297f034331963df38fe85c55a0'] = isset($v3c10bd297f034331963df38fe85c55a0) ? $v3c10bd297f034331963df38fe85c55a0 : '';
        $arrWiths['v3c10bd297f034331963df38fe85c55a0Ajax'] = isset($v3c10bd297f034331963df38fe85c55a0Ajax) ? $v3c10bd297f034331963df38fe85c55a0Ajax : '';
        $arrWiths['vff15b25ba05144f7b7ebf5dff8221830'] = isset($vff15b25ba05144f7b7ebf5dff8221830) ? $vff15b25ba05144f7b7ebf5dff8221830 : '';
        $arrWiths['vff15b25ba05144f7b7ebf5dff8221830Ajax'] = isset($vff15b25ba05144f7b7ebf5dff8221830Ajax) ? $vff15b25ba05144f7b7ebf5dff8221830Ajax : '';
        $arrWiths['v38f7cb5222274af89b4b045f6c4427e9'] = isset($v38f7cb5222274af89b4b045f6c4427e9) ? $v38f7cb5222274af89b4b045f6c4427e9 : '';
        ...
        $response = new \Illuminate\Http\Response(view('fe448b518ba44e3f85ca60fdcc9e22ac.Index', $arrWiths)->with('title', $arrWiths['title'])->with('vSessionTimeout', \Config::get('session.lifetime') * 60));
