...
// Creado               martes, 27 de junio de 2023 17:58:14
...
/**
 * regionalGrid - Tabla de Regiones.
 */
class pg77493ba58b32424b80547cbbe93bd47bController extends Controller
{
    /**
    ...
    public function post(Request $request)
    {
        ...
        // Guardar Regiones - Guardar Regiones
        if (null != $request->input('ctl19b1bedba7d546529c0aa54c7e4d2040_082a725e6ba049bca101c1597328a0c0') && null != $request->input('hid082a725e6ba049bca101c1597328a0c0') && '082a725e6ba049bca101c1597328a0c0' == $request->input('hid082a725e6ba049bca101c1597328a0c0')) {
            $key = 0;
            $isNew = false;
            ...
            $tb = \App\tb780c854ccf53401995b394fa3d882439::where('PK_REGION', $key)->first();
            if (null == $tb) {
                $isNew = true;
                $tb = new \App\tb780c854ccf53401995b394fa3d882439();
            }

            if (null != $request->input('ctl3607329572c440d9b68ef4a6c13f5921_082a725e6ba049bca101c1597328a0c0')) {
                $tb->FL_NOMBRE = $request->input('ctl3607329572c440d9b68ef4a6c13f5921_082a725e6ba049bca101c1597328a0c0'); //FL_NOMBRE
            } elseif (null == $request->input('ctl3607329572c440d9b68ef4a6c13f5921_082a725e6ba049bca101c1597328a0c0')) {
                $tb->FL_NOMBRE = null;
            }

            if (null != $request->input('nacional')) {
                $tb->FK_NACIONAL = $request->input('nacional'); //FK_NACIONAL
            } elseif (null == $request->input('nacional')) {
                $tb->FK_NACIONAL = null;
            }
            if (null != $request->input('ctl41332b542a734638b2276a180f65af00_082a725e6ba049bca101c1597328a0c0')) {
    ...
    public function index(Request $request)
    {
        ...
        $para41b236e627a42338af1b142c4af67cd = $request->input('nacional');

        if (null == $para41b236e627a42338af1b142c4af67cd) {
            $para41b236e627a42338af1b142c4af67cd = '0';
        }

        $par6185a7056560433494dba94e9ae59107cea875ebf26440d9b514d1625d79921f = 0;

        if (null == $par6185a7056560433494dba94e9ae59107cea875ebf26440d9b514d1625d79921f) {
            $par6185a7056560433494dba94e9ae59107cea875ebf26440d9b514d1625d79921f = '0';
        }

        $par0a0ce2af85ab462a808e0270326fb860cea875ebf26440d9b514d1625d79921f = 0;

        if (null == $par0a0ce2af85ab462a808e0270326fb860cea875ebf26440d9b514d1625d79921f) {
            $par0a0ce2af85ab462a808e0270326fb860cea875ebf26440d9b514d1625d79921f = '0';
        }

        $par5551ae677d6b488ebd38625d0f5d9fcecea875ebf26440d9b514d1625d79921f = '';

        if ('-' == $par5551ae677d6b488ebd38625d0f5d9fcecea875ebf26440d9b514d1625d79921f) {
            $par5551ae677d6b488ebd38625d0f5d9fcecea875ebf26440d9b514d1625d79921f = null;
        }

        if (null == $par5551ae677d6b488ebd38625d0f5d9fcecea875ebf26440d9b514d1625d79921f) {
            $par5551ae677d6b488ebd38625d0f5d9fcecea875ebf26440d9b514d1625d79921f = '';
        }

        $par8fce8a73ac264e4a8f3b56d8b991b8a5cea875ebf26440d9b514d1625d79921f = '';

        if ('-' == $par8fce8a73ac264e4a8f3b56d8b991b8a5cea875ebf26440d9b514d1625d79921f) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a5cea875ebf26440d9b514d1625d79921f = null;
        }

        if (null == $par8fce8a73ac264e4a8f3b56d8b991b8a5cea875ebf26440d9b514d1625d79921f) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a5cea875ebf26440d9b514d1625d79921f = '';
        }

        $vcea875ebf26440d9b514d1625d79921fAjax = \URL::to('/').'/api/f12e049b27704a27adda948b2a000735/'.(null == $para41b236e627a42338af1b142c4af67cd ? '-' : ('' == $para41b236e627a42338af1b142c4af67cd ? '-' : $para41b236e627a42338af1b142c4af67cd)).'/{page}/{pagesize}/{orderColumn}/{orderType}';

        // Lista de Regiones - Lista de Regiones

        $vcea875ebf26440d9b514d1625d79921fCount = \App\repf782f923fd0247bd9f4010b717e52999::mtf12e049b27704a27adda948b2a000735Count($para41b236e627a42338af1b142c4af67cd, $par6185a7056560433494dba94e9ae59107cea875ebf26440d9b514d1625d79921f, $par0a0ce2af85ab462a808e0270326fb860cea875ebf26440d9b514d1625d79921f, $par5551ae677d6b488ebd38625d0f5d9fcecea875ebf26440d9b514d1625d79921f, $par8fce8a73ac264e4a8f3b56d8b991b8a5cea875ebf26440d9b514d1625d79921f);

        //$vcea875ebf26440d9b514d1625d79921fCountAjax =  \URL::to('/')."/api/f12e049b27704a27adda948b2a000735Count{ParametersAjax}/{page}/{pagesize}/{orderColumn}/{orderType}";

        // Recuperar Nacional - Recuperar Nacional

        $par6185a7056560433494dba94e9ae591079ffedcebc2324ae2a4ce633c3e525d82 = 0;

        if (null == $par6185a7056560433494dba94e9ae591079ffedcebc2324ae2a4ce633c3e525d82) {
            $par6185a7056560433494dba94e9ae591079ffedcebc2324ae2a4ce633c3e525d82 = '0';
        }

        $par0a0ce2af85ab462a808e0270326fb8609ffedcebc2324ae2a4ce633c3e525d82 = 0;

        if (null == $par0a0ce2af85ab462a808e0270326fb8609ffedcebc2324ae2a4ce633c3e525d82) {
            $par0a0ce2af85ab462a808e0270326fb8609ffedcebc2324ae2a4ce633c3e525d82 = '0';
        }

        $par5551ae677d6b488ebd38625d0f5d9fce9ffedcebc2324ae2a4ce633c3e525d82 = '';

        if ('-' == $par5551ae677d6b488ebd38625d0f5d9fce9ffedcebc2324ae2a4ce633c3e525d82) {
            $par5551ae677d6b488ebd38625d0f5d9fce9ffedcebc2324ae2a4ce633c3e525d82 = null;
        }

        if (null == $par5551ae677d6b488ebd38625d0f5d9fce9ffedcebc2324ae2a4ce633c3e525d82) {
            $par5551ae677d6b488ebd38625d0f5d9fce9ffedcebc2324ae2a4ce633c3e525d82 = '';
        }

        $par8fce8a73ac264e4a8f3b56d8b991b8a59ffedcebc2324ae2a4ce633c3e525d82 = '';

        if ('-' == $par8fce8a73ac264e4a8f3b56d8b991b8a59ffedcebc2324ae2a4ce633c3e525d82) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a59ffedcebc2324ae2a4ce633c3e525d82 = null;
        }

        if (null == $par8fce8a73ac264e4a8f3b56d8b991b8a59ffedcebc2324ae2a4ce633c3e525d82) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a59ffedcebc2324ae2a4ce633c3e525d82 = '';
        }

        $v9ffedcebc2324ae2a4ce633c3e525d82 = \App\repf782f923fd0247bd9f4010b717e52999::mtad06971b3da64ec9b20e4320a907ba0c($par6185a7056560433494dba94e9ae591079ffedcebc2324ae2a4ce633c3e525d82, $par0a0ce2af85ab462a808e0270326fb8609ffedcebc2324ae2a4ce633c3e525d82, $par5551ae677d6b488ebd38625d0f5d9fce9ffedcebc2324ae2a4ce633c3e525d82, $par8fce8a73ac264e4a8f3b56d8b991b8a59ffedcebc2324ae2a4ce633c3e525d82);

        $v9ffedcebc2324ae2a4ce633c3e525d82Ajax = \URL::to('/').'/api/ad06971b3da64ec9b20e4320a907ba0c/{page}/{pagesize}/{orderColumn}/{orderType}';

        // Recuperar Region - Recuperar Region

        $parb638ec701c4a476286f3c2ad493e9ce9 = $request->input('u');

        if (null == $parb638ec701c4a476286f3c2ad493e9ce9) {
            $parb638ec701c4a476286f3c2ad493e9ce9 = '0';
        }

        $par6185a7056560433494dba94e9ae5910717c35e8692da4c49a6bf00cc172ec412 = 0;

        if (null == $par6185a7056560433494dba94e9ae5910717c35e8692da4c49a6bf00cc172ec412) {
            $par6185a7056560433494dba94e9ae5910717c35e8692da4c49a6bf00cc172ec412 = '0';
        }

        $par0a0ce2af85ab462a808e0270326fb86017c35e8692da4c49a6bf00cc172ec412 = 0;

        if (null == $par0a0ce2af85ab462a808e0270326fb86017c35e8692da4c49a6bf00cc172ec412) {
            $par0a0ce2af85ab462a808e0270326fb86017c35e8692da4c49a6bf00cc172ec412 = '0';
        }

        $par5551ae677d6b488ebd38625d0f5d9fce17c35e8692da4c49a6bf00cc172ec412 = '';

        if ('-' == $par5551ae677d6b488ebd38625d0f5d9fce17c35e8692da4c49a6bf00cc172ec412) {
            $par5551ae677d6b488ebd38625d0f5d9fce17c35e8692da4c49a6bf00cc172ec412 = null;
        }

        if (null == $par5551ae677d6b488ebd38625d0f5d9fce17c35e8692da4c49a6bf00cc172ec412) {
            $par5551ae677d6b488ebd38625d0f5d9fce17c35e8692da4c49a6bf00cc172ec412 = '';
        }

        $par8fce8a73ac264e4a8f3b56d8b991b8a517c35e8692da4c49a6bf00cc172ec412 = '';

        if ('-' == $par8fce8a73ac264e4a8f3b56d8b991b8a517c35e8692da4c49a6bf00cc172ec412) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a517c35e8692da4c49a6bf00cc172ec412 = null;
        }

        if (null == $par8fce8a73ac264e4a8f3b56d8b991b8a517c35e8692da4c49a6bf00cc172ec412) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a517c35e8692da4c49a6bf00cc172ec412 = '';
        }

        $v17c35e8692da4c49a6bf00cc172ec412 = \App\repf782f923fd0247bd9f4010b717e52999::mtc55363199cd64a5888f4f137f1d94426($parb638ec701c4a476286f3c2ad493e9ce9, $par6185a7056560433494dba94e9ae5910717c35e8692da4c49a6bf00cc172ec412, $par0a0ce2af85ab462a808e0270326fb86017c35e8692da4c49a6bf00cc172ec412, $par5551ae677d6b488ebd38625d0f5d9fce17c35e8692da4c49a6bf00cc172ec412, $par8fce8a73ac264e4a8f3b56d8b991b8a517c35e8692da4c49a6bf00cc172ec412);

        $v17c35e8692da4c49a6bf00cc172ec412Ajax = \URL::to('/').'/api/c55363199cd64a5888f4f137f1d94426/'.(null == $parb638ec701c4a476286f3c2ad493e9ce9 ? '-' : ('' == $parb638ec701c4a476286f3c2ad493e9ce9 ? '-' : $parb638ec701c4a476286f3c2ad493e9ce9)).'/{page}/{pagesize}/{orderColumn}/{orderType}';
        ...
        // Tabla de Regiones - Tabla de Regiones
        $v9c7270e170374ca082c27654d123d123 = '';
        $v9c7270e170374ca082c27654d123d123Total = (isset($vcea875ebf26440d9b514d1625d79921fCount) ? $vcea875ebf26440d9b514d1625d79921fCount : 0);
        $v9c7270e170374ca082c27654d123d123Ajax = (isset($vcea875ebf26440d9b514d1625d79921fAjax) ? $vcea875ebf26440d9b514d1625d79921fAjax : '');

        $arrWiths['vcea875ebf26440d9b514d1625d79921fCount'] = isset($vcea875ebf26440d9b514d1625d79921fCount) ? $vcea875ebf26440d9b514d1625d79921fCount : '';
        $arrWiths['vcea875ebf26440d9b514d1625d79921fAjax'] = isset($vcea875ebf26440d9b514d1625d79921fAjax) ? $vcea875ebf26440d9b514d1625d79921fAjax : '';
        $arrWiths['v9ffedcebc2324ae2a4ce633c3e525d82'] = isset($v9ffedcebc2324ae2a4ce633c3e525d82) ? $v9ffedcebc2324ae2a4ce633c3e525d82 : '';
        $arrWiths['v9ffedcebc2324ae2a4ce633c3e525d82Ajax'] = isset($v9ffedcebc2324ae2a4ce633c3e525d82Ajax) ? $v9ffedcebc2324ae2a4ce633c3e525d82Ajax : '';
        $arrWiths['v17c35e8692da4c49a6bf00cc172ec412'] = isset($v17c35e8692da4c49a6bf00cc172ec412) ? $v17c35e8692da4c49a6bf00cc172ec412 : '';
        $arrWiths['v17c35e8692da4c49a6bf00cc172ec412Ajax'] = isset($v17c35e8692da4c49a6bf00cc172ec412Ajax) ? $v17c35e8692da4c49a6bf00cc172ec412Ajax : '';
        ...
        $arrWiths['v9c7270e170374ca082c27654d123d123'] = isset($v9c7270e170374ca082c27654d123d123) ? $v9c7270e170374ca082c27654d123d123 : '';
        $arrWiths['v9c7270e170374ca082c27654d123d123Total'] = isset($v9c7270e170374ca082c27654d123d123Total) ? $v9c7270e170374ca082c27654d123d123Total : '';
        $arrWiths['v9c7270e170374ca082c27654d123d123Ajax'] = isset($v9c7270e170374ca082c27654d123d123Ajax) ? $v9c7270e170374ca082c27654d123d123Ajax : '';
        ...
        $response = new \Illuminate\Http\Response(view('77493ba58b32424b80547cbbe93bd47b.Index', $arrWiths)->with('title', $arrWiths['title'])->with('vSessionTimeout', \Config::get('session.lifetime') * 60));
