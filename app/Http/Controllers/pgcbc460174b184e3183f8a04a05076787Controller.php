...
// Creado               martes, 27 de junio de 2023 17:57:28
...
/**
 * productoresGrid - productoresGrid.
 */
class pgcbc460174b184e3183f8a04a05076787Controller extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        // Lista Centros de Acopio - Lista Centros de Acopio

        $parfad7deac61604736b328699438b22b411 = $request->session()->get('ses5e122755c3a24f5d8789755168e9de27');

        if (null == $parfad7deac61604736b328699438b22b411) {
            $parfad7deac61604736b328699438b22b411 = '0';
        }

        $par97819618a0fe4dd085806b132b9faf371 = $request->input('centrotrabajo');

        if (null == $par97819618a0fe4dd085806b132b9faf371) {
            $par97819618a0fe4dd085806b132b9faf371 = '0';
        }

        $par6185a7056560433494dba94e9ae591070fd03293293f41f280a549c232cecb45 = 0;

        if (null == $par6185a7056560433494dba94e9ae591070fd03293293f41f280a549c232cecb45) {
            $par6185a7056560433494dba94e9ae591070fd03293293f41f280a549c232cecb45 = '0';
        }

        $par0a0ce2af85ab462a808e0270326fb8600fd03293293f41f280a549c232cecb45 = 0;

        if (null == $par0a0ce2af85ab462a808e0270326fb8600fd03293293f41f280a549c232cecb45) {
            $par0a0ce2af85ab462a808e0270326fb8600fd03293293f41f280a549c232cecb45 = '0';
        }

        $par5551ae677d6b488ebd38625d0f5d9fce0fd03293293f41f280a549c232cecb45 = '';

        if ('-' == $par5551ae677d6b488ebd38625d0f5d9fce0fd03293293f41f280a549c232cecb45) {
            $par5551ae677d6b488ebd38625d0f5d9fce0fd03293293f41f280a549c232cecb45 = null;
        }

        if (null == $par5551ae677d6b488ebd38625d0f5d9fce0fd03293293f41f280a549c232cecb45) {
            $par5551ae677d6b488ebd38625d0f5d9fce0fd03293293f41f280a549c232cecb45 = '';
        }

        $par8fce8a73ac264e4a8f3b56d8b991b8a50fd03293293f41f280a549c232cecb45 = '';

        if ('-' == $par8fce8a73ac264e4a8f3b56d8b991b8a50fd03293293f41f280a549c232cecb45) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a50fd03293293f41f280a549c232cecb45 = null;
        }

        if (null == $par8fce8a73ac264e4a8f3b56d8b991b8a50fd03293293f41f280a549c232cecb45) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a50fd03293293f41f280a549c232cecb45 = '';
        }

        $v0fd03293293f41f280a549c232cecb45Ajax = \URL::to('/').'/api/02a574fe1ace4e7fa4d3dbd3827bea60/'.(null == $parfad7deac61604736b328699438b22b411 ? '-' : ('' == $parfad7deac61604736b328699438b22b411 ? '-' : $parfad7deac61604736b328699438b22b411))."/'+encodeURIComponent((($('#ctlee2eba3f950143ab833007d599a1665c_ff3fdec3cccb42c2b1899c5cf35c1e33{Extra}').val() == '' ? '-' : $('#ctlee2eba3f950143ab833007d599a1665c_ff3fdec3cccb42c2b1899c5cf35c1e33{Extra}').val()) != undefined && ($('#ctlee2eba3f950143ab833007d599a1665c_ff3fdec3cccb42c2b1899c5cf35c1e33{Extra}').val() == '' ? '-' : $('#ctlee2eba3f950143ab833007d599a1665c_ff3fdec3cccb42c2b1899c5cf35c1e33{Extra}').val()).length > 0 ? ($('#ctlee2eba3f950143ab833007d599a1665c_ff3fdec3cccb42c2b1899c5cf35c1e33{Extra}').val() == '' ? '-' : $('#ctlee2eba3f950143ab833007d599a1665c_ff3fdec3cccb42c2b1899c5cf35c1e33{Extra}').val()).replace(/\\./g,'---').replace(/\\//g,'___') : ($('#ctlee2eba3f950143ab833007d599a1665c_ff3fdec3cccb42c2b1899c5cf35c1e33{Extra}').val() == '' ? '-' : $('#ctlee2eba3f950143ab833007d599a1665c_ff3fdec3cccb42c2b1899c5cf35c1e33{Extra}').val())))+'/{page}/{pagesize}/{orderColumn}/{orderType}";

        // Lista Centros de Trabajo - Lista Centros de Trabajo

        $par34a7a0fc1a0b49c0acbc3183500b9dc31 = $request->session()->get('ses5e122755c3a24f5d8789755168e9de27');

        if (null == $par34a7a0fc1a0b49c0acbc3183500b9dc31) {
            $par34a7a0fc1a0b49c0acbc3183500b9dc31 = '0';
        }

        $par6185a7056560433494dba94e9ae591079f0cd5a341744b939041e0484375719a = 0;

        if (null == $par6185a7056560433494dba94e9ae591079f0cd5a341744b939041e0484375719a) {
            $par6185a7056560433494dba94e9ae591079f0cd5a341744b939041e0484375719a = '0';
        }

        $par0a0ce2af85ab462a808e0270326fb8609f0cd5a341744b939041e0484375719a = 0;

        if (null == $par0a0ce2af85ab462a808e0270326fb8609f0cd5a341744b939041e0484375719a) {
            $par0a0ce2af85ab462a808e0270326fb8609f0cd5a341744b939041e0484375719a = '0';
        }

        $par5551ae677d6b488ebd38625d0f5d9fce9f0cd5a341744b939041e0484375719a = '';

        if ('-' == $par5551ae677d6b488ebd38625d0f5d9fce9f0cd5a341744b939041e0484375719a) {
            $par5551ae677d6b488ebd38625d0f5d9fce9f0cd5a341744b939041e0484375719a = null;
        }

        if (null == $par5551ae677d6b488ebd38625d0f5d9fce9f0cd5a341744b939041e0484375719a) {
            $par5551ae677d6b488ebd38625d0f5d9fce9f0cd5a341744b939041e0484375719a = '';
        }

        $par8fce8a73ac264e4a8f3b56d8b991b8a59f0cd5a341744b939041e0484375719a = '';

        if ('-' == $par8fce8a73ac264e4a8f3b56d8b991b8a59f0cd5a341744b939041e0484375719a) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a59f0cd5a341744b939041e0484375719a = null;
        }

        if (null == $par8fce8a73ac264e4a8f3b56d8b991b8a59f0cd5a341744b939041e0484375719a) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a59f0cd5a341744b939041e0484375719a = '';
        }

        $v9f0cd5a341744b939041e0484375719a = \App\repf782f923fd0247bd9f4010b717e52999::mt45f7488302534acfb9bf854d9871af60($par34a7a0fc1a0b49c0acbc3183500b9dc31, $par6185a7056560433494dba94e9ae591079f0cd5a341744b939041e0484375719a, $par0a0ce2af85ab462a808e0270326fb8609f0cd5a341744b939041e0484375719a, $par5551ae677d6b488ebd38625d0f5d9fce9f0cd5a341744b939041e0484375719a, $par8fce8a73ac264e4a8f3b56d8b991b8a59f0cd5a341744b939041e0484375719a);

        $v9f0cd5a341744b939041e0484375719aAjax = \URL::to('/').'/api/45f7488302534acfb9bf854d9871af60/'.(null == $par34a7a0fc1a0b49c0acbc3183500b9dc31 ? '-' : ('' == $par34a7a0fc1a0b49c0acbc3183500b9dc31 ? '-' : $par34a7a0fc1a0b49c0acbc3183500b9dc31)).'/{page}/{pagesize}/{orderColumn}/{orderType}';

        // Lista de Estatus - Lista de Estatus

        $par6185a7056560433494dba94e9ae59107e366d029182d4a45ae4f172b427cbe1a = 0;

        if (null == $par6185a7056560433494dba94e9ae59107e366d029182d4a45ae4f172b427cbe1a) {
            $par6185a7056560433494dba94e9ae59107e366d029182d4a45ae4f172b427cbe1a = '0';
        }

        $par0a0ce2af85ab462a808e0270326fb860e366d029182d4a45ae4f172b427cbe1a = 0;

        if (null == $par0a0ce2af85ab462a808e0270326fb860e366d029182d4a45ae4f172b427cbe1a) {
            $par0a0ce2af85ab462a808e0270326fb860e366d029182d4a45ae4f172b427cbe1a = '0';
        }

        $par5551ae677d6b488ebd38625d0f5d9fcee366d029182d4a45ae4f172b427cbe1a = '';

        if ('-' == $par5551ae677d6b488ebd38625d0f5d9fcee366d029182d4a45ae4f172b427cbe1a) {
            $par5551ae677d6b488ebd38625d0f5d9fcee366d029182d4a45ae4f172b427cbe1a = null;
        }

        if (null == $par5551ae677d6b488ebd38625d0f5d9fcee366d029182d4a45ae4f172b427cbe1a) {
            $par5551ae677d6b488ebd38625d0f5d9fcee366d029182d4a45ae4f172b427cbe1a = '';
        }

        $par8fce8a73ac264e4a8f3b56d8b991b8a5e366d029182d4a45ae4f172b427cbe1a = '';

        if ('-' == $par8fce8a73ac264e4a8f3b56d8b991b8a5e366d029182d4a45ae4f172b427cbe1a) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a5e366d029182d4a45ae4f172b427cbe1a = null;
        }

        if (null == $par8fce8a73ac264e4a8f3b56d8b991b8a5e366d029182d4a45ae4f172b427cbe1a) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a5e366d029182d4a45ae4f172b427cbe1a = '';
        }

        $ve366d029182d4a45ae4f172b427cbe1a = \App\repf782f923fd0247bd9f4010b717e52999::mtf71637318de04de6aaa679753a07499b($par6185a7056560433494dba94e9ae59107e366d029182d4a45ae4f172b427cbe1a, $par0a0ce2af85ab462a808e0270326fb860e366d029182d4a45ae4f172b427cbe1a, $par5551ae677d6b488ebd38625d0f5d9fcee366d029182d4a45ae4f172b427cbe1a, $par8fce8a73ac264e4a8f3b56d8b991b8a5e366d029182d4a45ae4f172b427cbe1a);

        $ve366d029182d4a45ae4f172b427cbe1aAjax = \URL::to('/').'/api/f71637318de04de6aaa679753a07499b/{page}/{pagesize}/{orderColumn}/{orderType}';

        // Lista de Lugar - Lista de Lugar

        $par6185a7056560433494dba94e9ae5910742352e014d924324bfb12c11378a6569 = 0;

        if (null == $par6185a7056560433494dba94e9ae5910742352e014d924324bfb12c11378a6569) {
            $par6185a7056560433494dba94e9ae5910742352e014d924324bfb12c11378a6569 = '0';
        }

        $par0a0ce2af85ab462a808e0270326fb86042352e014d924324bfb12c11378a6569 = 0;

        if (null == $par0a0ce2af85ab462a808e0270326fb86042352e014d924324bfb12c11378a6569) {
            $par0a0ce2af85ab462a808e0270326fb86042352e014d924324bfb12c11378a6569 = '0';
        }

        $par5551ae677d6b488ebd38625d0f5d9fce42352e014d924324bfb12c11378a6569 = '';

        if ('-' == $par5551ae677d6b488ebd38625d0f5d9fce42352e014d924324bfb12c11378a6569) {
            $par5551ae677d6b488ebd38625d0f5d9fce42352e014d924324bfb12c11378a6569 = null;
        }

        if (null == $par5551ae677d6b488ebd38625d0f5d9fce42352e014d924324bfb12c11378a6569) {
            $par5551ae677d6b488ebd38625d0f5d9fce42352e014d924324bfb12c11378a6569 = '';
        }

        $par8fce8a73ac264e4a8f3b56d8b991b8a542352e014d924324bfb12c11378a6569 = '';

        if ('-' == $par8fce8a73ac264e4a8f3b56d8b991b8a542352e014d924324bfb12c11378a6569) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a542352e014d924324bfb12c11378a6569 = null;
        }

        if (null == $par8fce8a73ac264e4a8f3b56d8b991b8a542352e014d924324bfb12c11378a6569) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a542352e014d924324bfb12c11378a6569 = '';
        }

        $v42352e014d924324bfb12c11378a6569 = \App\repf782f923fd0247bd9f4010b717e52999::mta64061d55b1c4e4883871fdf7ed1dfea($par6185a7056560433494dba94e9ae5910742352e014d924324bfb12c11378a6569, $par0a0ce2af85ab462a808e0270326fb86042352e014d924324bfb12c11378a6569, $par5551ae677d6b488ebd38625d0f5d9fce42352e014d924324bfb12c11378a6569, $par8fce8a73ac264e4a8f3b56d8b991b8a542352e014d924324bfb12c11378a6569);

        $v42352e014d924324bfb12c11378a6569Ajax = \URL::to('/').'/api/a64061d55b1c4e4883871fdf7ed1dfea/{page}/{pagesize}/{orderColumn}/{orderType}';

        // Lista tipo de leche - Lista tipo de leche

        $par6185a7056560433494dba94e9ae591070808b7023c1b4f72825d5771c7e80a88 = 0;

        if (null == $par6185a7056560433494dba94e9ae591070808b7023c1b4f72825d5771c7e80a88) {
            $par6185a7056560433494dba94e9ae591070808b7023c1b4f72825d5771c7e80a88 = '0';
        }

        $par0a0ce2af85ab462a808e0270326fb8600808b7023c1b4f72825d5771c7e80a88 = 0;

        if (null == $par0a0ce2af85ab462a808e0270326fb8600808b7023c1b4f72825d5771c7e80a88) {
            $par0a0ce2af85ab462a808e0270326fb8600808b7023c1b4f72825d5771c7e80a88 = '0';
        }

        $par5551ae677d6b488ebd38625d0f5d9fce0808b7023c1b4f72825d5771c7e80a88 = '';

        if ('-' == $par5551ae677d6b488ebd38625d0f5d9fce0808b7023c1b4f72825d5771c7e80a88) {
            $par5551ae677d6b488ebd38625d0f5d9fce0808b7023c1b4f72825d5771c7e80a88 = null;
        }

        if (null == $par5551ae677d6b488ebd38625d0f5d9fce0808b7023c1b4f72825d5771c7e80a88) {
            $par5551ae677d6b488ebd38625d0f5d9fce0808b7023c1b4f72825d5771c7e80a88 = '';
        }

        $par8fce8a73ac264e4a8f3b56d8b991b8a50808b7023c1b4f72825d5771c7e80a88 = '';

        if ('-' == $par8fce8a73ac264e4a8f3b56d8b991b8a50808b7023c1b4f72825d5771c7e80a88) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a50808b7023c1b4f72825d5771c7e80a88 = null;
        }

        if (null == $par8fce8a73ac264e4a8f3b56d8b991b8a50808b7023c1b4f72825d5771c7e80a88) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a50808b7023c1b4f72825d5771c7e80a88 = '';
        }

        $v0808b7023c1b4f72825d5771c7e80a88 = \App\repf782f923fd0247bd9f4010b717e52999::mt48e61ec9722046979c8bb305a6922ac3($par6185a7056560433494dba94e9ae591070808b7023c1b4f72825d5771c7e80a88, $par0a0ce2af85ab462a808e0270326fb8600808b7023c1b4f72825d5771c7e80a88, $par5551ae677d6b488ebd38625d0f5d9fce0808b7023c1b4f72825d5771c7e80a88, $par8fce8a73ac264e4a8f3b56d8b991b8a50808b7023c1b4f72825d5771c7e80a88);

        $v0808b7023c1b4f72825d5771c7e80a88Ajax = \URL::to('/').'/api/48e61ec9722046979c8bb305a6922ac3/{page}/{pagesize}/{orderColumn}/{orderType}';

        // Listado de tamaño de productor - Listado de tamaño de productor

        $par6185a7056560433494dba94e9ae591075f0909f6994b4717b4644c1d7679447e = 0;

        if (null == $par6185a7056560433494dba94e9ae591075f0909f6994b4717b4644c1d7679447e) {
            $par6185a7056560433494dba94e9ae591075f0909f6994b4717b4644c1d7679447e = '0';
        }

        $par0a0ce2af85ab462a808e0270326fb8605f0909f6994b4717b4644c1d7679447e = 0;

        if (null == $par0a0ce2af85ab462a808e0270326fb8605f0909f6994b4717b4644c1d7679447e) {
            $par0a0ce2af85ab462a808e0270326fb8605f0909f6994b4717b4644c1d7679447e = '0';
        }

        $par5551ae677d6b488ebd38625d0f5d9fce5f0909f6994b4717b4644c1d7679447e = '';

        if ('-' == $par5551ae677d6b488ebd38625d0f5d9fce5f0909f6994b4717b4644c1d7679447e) {
            $par5551ae677d6b488ebd38625d0f5d9fce5f0909f6994b4717b4644c1d7679447e = null;
        }

        if (null == $par5551ae677d6b488ebd38625d0f5d9fce5f0909f6994b4717b4644c1d7679447e) {
            $par5551ae677d6b488ebd38625d0f5d9fce5f0909f6994b4717b4644c1d7679447e = '';
        }

        $par8fce8a73ac264e4a8f3b56d8b991b8a55f0909f6994b4717b4644c1d7679447e = '';

        if ('-' == $par8fce8a73ac264e4a8f3b56d8b991b8a55f0909f6994b4717b4644c1d7679447e) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a55f0909f6994b4717b4644c1d7679447e = null;
        }

        if (null == $par8fce8a73ac264e4a8f3b56d8b991b8a55f0909f6994b4717b4644c1d7679447e) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a55f0909f6994b4717b4644c1d7679447e = '';
        }

        $v5f0909f6994b4717b4644c1d7679447e = \App\repf782f923fd0247bd9f4010b717e52999::mt61a556104c174df3831a01053dfb6ead($par6185a7056560433494dba94e9ae591075f0909f6994b4717b4644c1d7679447e, $par0a0ce2af85ab462a808e0270326fb8605f0909f6994b4717b4644c1d7679447e, $par5551ae677d6b488ebd38625d0f5d9fce5f0909f6994b4717b4644c1d7679447e, $par8fce8a73ac264e4a8f3b56d8b991b8a55f0909f6994b4717b4644c1d7679447e);

        $v5f0909f6994b4717b4644c1d7679447eAjax = \URL::to('/').'/api/61a556104c174df3831a01053dfb6ead/{page}/{pagesize}/{orderColumn}/{orderType}';

        // sp_productores - sp_productores

        $parb85fd30e43cb4714bf8dcab37bb9ac121 = $request->session()->get('ses5e122755c3a24f5d8789755168e9de27');

        if (null == $parb85fd30e43cb4714bf8dcab37bb9ac121) {
            $parb85fd30e43cb4714bf8dcab37bb9ac121 = '0';
        }

        $par46f7c6b566664092858c80372204bb001 = $request->input('productor');

        if ('-' == $par46f7c6b566664092858c80372204bb001) {
            $par46f7c6b566664092858c80372204bb001 = null;
        }

        if (null == $par46f7c6b566664092858c80372204bb001) {
            $par46f7c6b566664092858c80372204bb001 = '0';
        }

        $pard3a06ed3dda04cfa9bb599eb2379ad2a1 = $request->input('centrotrabajo');

        if ('-' == $pard3a06ed3dda04cfa9bb599eb2379ad2a1) {
            $pard3a06ed3dda04cfa9bb599eb2379ad2a1 = null;
        }

        if (null == $pard3a06ed3dda04cfa9bb599eb2379ad2a1) {
            $pard3a06ed3dda04cfa9bb599eb2379ad2a1 = '0';
        }

        $par5d8de31606df4d2f81817e597467e9161 = $request->input('centroacopio');

        if ('-' == $par5d8de31606df4d2f81817e597467e9161) {
            $par5d8de31606df4d2f81817e597467e9161 = null;
        }

        if (null == $par5d8de31606df4d2f81817e597467e9161) {
            $par5d8de31606df4d2f81817e597467e9161 = '0';
        }

        $par5efb42a4d5d44af1bb329c9cc23b5b831 = $request->input('tamanoproductor');

        if ('-' == $par5efb42a4d5d44af1bb329c9cc23b5b831) {
            $par5efb42a4d5d44af1bb329c9cc23b5b831 = null;
        }

        if (null == $par5efb42a4d5d44af1bb329c9cc23b5b831) {
            $par5efb42a4d5d44af1bb329c9cc23b5b831 = '0';
        }

        $par2f1027332d3749e4a0e59774040bd8561 = $request->input('tipoleche');

        if ('-' == $par2f1027332d3749e4a0e59774040bd8561) {
            $par2f1027332d3749e4a0e59774040bd8561 = null;
        }

        if (null == $par2f1027332d3749e4a0e59774040bd8561) {
            $par2f1027332d3749e4a0e59774040bd8561 = '0';
        }

        $pardcc137c809c241e2b40639cfa0c37c0b1 = $request->input('estatus');

        if ('-' == $pardcc137c809c241e2b40639cfa0c37c0b1) {
            $pardcc137c809c241e2b40639cfa0c37c0b1 = null;
        }

        if (null == $pardcc137c809c241e2b40639cfa0c37c0b1) {
            $pardcc137c809c241e2b40639cfa0c37c0b1 = '0';
        }

        $pare53dc1e09d504d95816f73d2028b8e9c1 = $request->input('codigo');

        if ('-' == $pare53dc1e09d504d95816f73d2028b8e9c1) {
            $pare53dc1e09d504d95816f73d2028b8e9c1 = null;
        }

        if (null == $pare53dc1e09d504d95816f73d2028b8e9c1) {
            $pare53dc1e09d504d95816f73d2028b8e9c1 = '0';
        }

        $par6185a7056560433494dba94e9ae591072457b7f084a54553b567410f3d6ad7b2 = $request->input('pag');

        if (null == $par6185a7056560433494dba94e9ae591072457b7f084a54553b567410f3d6ad7b2) {
            $par6185a7056560433494dba94e9ae591072457b7f084a54553b567410f3d6ad7b2 = '1';
        }

        $par0a0ce2af85ab462a808e0270326fb8602457b7f084a54553b567410f3d6ad7b2 = $request->input('count');

        if (null == $par0a0ce2af85ab462a808e0270326fb8602457b7f084a54553b567410f3d6ad7b2) {
            $par0a0ce2af85ab462a808e0270326fb8602457b7f084a54553b567410f3d6ad7b2 = '10';
        }

        $par5551ae677d6b488ebd38625d0f5d9fce2457b7f084a54553b567410f3d6ad7b2 = '';

        if ('-' == $par5551ae677d6b488ebd38625d0f5d9fce2457b7f084a54553b567410f3d6ad7b2) {
            $par5551ae677d6b488ebd38625d0f5d9fce2457b7f084a54553b567410f3d6ad7b2 = null;
        }

        if (null == $par5551ae677d6b488ebd38625d0f5d9fce2457b7f084a54553b567410f3d6ad7b2) {
            $par5551ae677d6b488ebd38625d0f5d9fce2457b7f084a54553b567410f3d6ad7b2 = '';
        }

        $par8fce8a73ac264e4a8f3b56d8b991b8a52457b7f084a54553b567410f3d6ad7b2 = '';

        if ('-' == $par8fce8a73ac264e4a8f3b56d8b991b8a52457b7f084a54553b567410f3d6ad7b2) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a52457b7f084a54553b567410f3d6ad7b2 = null;
        }

        if (null == $par8fce8a73ac264e4a8f3b56d8b991b8a52457b7f084a54553b567410f3d6ad7b2) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a52457b7f084a54553b567410f3d6ad7b2 = '';
        }

        $v2457b7f084a54553b567410f3d6ad7b2 = \App\repf782f923fd0247bd9f4010b717e52999::mtd2d5f1c690e34c0ebeda831ee2d93002($parb85fd30e43cb4714bf8dcab37bb9ac121, $par46f7c6b566664092858c80372204bb001, $pard3a06ed3dda04cfa9bb599eb2379ad2a1, $par5d8de31606df4d2f81817e597467e9161, $par5efb42a4d5d44af1bb329c9cc23b5b831, $par2f1027332d3749e4a0e59774040bd8561, $pardcc137c809c241e2b40639cfa0c37c0b1, $pare53dc1e09d504d95816f73d2028b8e9c1, $par6185a7056560433494dba94e9ae591072457b7f084a54553b567410f3d6ad7b2, $par0a0ce2af85ab462a808e0270326fb8602457b7f084a54553b567410f3d6ad7b2, $par5551ae677d6b488ebd38625d0f5d9fce2457b7f084a54553b567410f3d6ad7b2, $par8fce8a73ac264e4a8f3b56d8b991b8a52457b7f084a54553b567410f3d6ad7b2);

        $v2457b7f084a54553b567410f3d6ad7b2Ajax = \URL::to('/').'/api/d2d5f1c690e34c0ebeda831ee2d93002/'.(null == $parb85fd30e43cb4714bf8dcab37bb9ac121 ? '-' : ('' == $parb85fd30e43cb4714bf8dcab37bb9ac121 ? '-' : $parb85fd30e43cb4714bf8dcab37bb9ac121)).'/'.(null == $par46f7c6b566664092858c80372204bb001 ? '-' : ('' == $par46f7c6b566664092858c80372204bb001 ? '-' : $par46f7c6b566664092858c80372204bb001)).'/'.(null == $pard3a06ed3dda04cfa9bb599eb2379ad2a1 ? '-' : ('' == $pard3a06ed3dda04cfa9bb599eb2379ad2a1 ? '-' : $pard3a06ed3dda04cfa9bb599eb2379ad2a1)).'/'.(null == $par5d8de31606df4d2f81817e597467e9161 ? '-' : ('' == $par5d8de31606df4d2f81817e597467e9161 ? '-' : $par5d8de31606df4d2f81817e597467e9161)).'/'.(null == $par5efb42a4d5d44af1bb329c9cc23b5b831 ? '-' : ('' == $par5efb42a4d5d44af1bb329c9cc23b5b831 ? '-' : $par5efb42a4d5d44af1bb329c9cc23b5b831)).'/'.(null == $par2f1027332d3749e4a0e59774040bd8561 ? '-' : ('' == $par2f1027332d3749e4a0e59774040bd8561 ? '-' : $par2f1027332d3749e4a0e59774040bd8561)).'/'.(null == $pardcc137c809c241e2b40639cfa0c37c0b1 ? '-' : ('' == $pardcc137c809c241e2b40639cfa0c37c0b1 ? '-' : $pardcc137c809c241e2b40639cfa0c37c0b1)).'/'.(null == $pare53dc1e09d504d95816f73d2028b8e9c1 ? '-' : ('' == $pare53dc1e09d504d95816f73d2028b8e9c1 ? '-' : $pare53dc1e09d504d95816f73d2028b8e9c1)).'/{page}/{pagesize}/{orderColumn}/{orderType}';

        // sp_productores - sp_productores

        $v2457b7f084a54553b567410f3d6ad7b2Count = \App\repf782f923fd0247bd9f4010b717e52999::mtd2d5f1c690e34c0ebeda831ee2d93002Count($parb85fd30e43cb4714bf8dcab37bb9ac121, $par46f7c6b566664092858c80372204bb001, $pard3a06ed3dda04cfa9bb599eb2379ad2a1, $par5d8de31606df4d2f81817e597467e9161, $par5efb42a4d5d44af1bb329c9cc23b5b831, $par2f1027332d3749e4a0e59774040bd8561, $pardcc137c809c241e2b40639cfa0c37c0b1, $pare53dc1e09d504d95816f73d2028b8e9c1, $par6185a7056560433494dba94e9ae591072457b7f084a54553b567410f3d6ad7b2, $par0a0ce2af85ab462a808e0270326fb8602457b7f084a54553b567410f3d6ad7b2, $par5551ae677d6b488ebd38625d0f5d9fce2457b7f084a54553b567410f3d6ad7b2, $par8fce8a73ac264e4a8f3b56d8b991b8a52457b7f084a54553b567410f3d6ad7b2);

        //$v2457b7f084a54553b567410f3d6ad7b2CountAjax =  \URL::to('/')."/api/d2d5f1c690e34c0ebeda831ee2d93002Count{ParametersAjax}/{page}/{pagesize}/{orderColumn}/{orderType}";

        // sp_productores_title - sp_productores_title

        $parda155728f36748dba71fe5e81fbb77be1 = $request->session()->get('ses5e122755c3a24f5d8789755168e9de27');

        if (null == $parda155728f36748dba71fe5e81fbb77be1) {
            $parda155728f36748dba71fe5e81fbb77be1 = '0';
        }

        $para183bed0492b4bc29be1b8c39d156cc21 = null;

        if ('-' == $para183bed0492b4bc29be1b8c39d156cc21) {
            $para183bed0492b4bc29be1b8c39d156cc21 = null;
        }

        if (null == $para183bed0492b4bc29be1b8c39d156cc21) {
            $para183bed0492b4bc29be1b8c39d156cc21 = '';
        }

        $par16debc37a7c040be8372756e3e0dedde1 = null;

        if ('-' == $par16debc37a7c040be8372756e3e0dedde1) {
            $par16debc37a7c040be8372756e3e0dedde1 = null;
        }

        if (null == $par16debc37a7c040be8372756e3e0dedde1) {
            $par16debc37a7c040be8372756e3e0dedde1 = '';
        }

        $par3c3befdcd1524723a0b81975461ffad11 = null;

        if ('-' == $par3c3befdcd1524723a0b81975461ffad11) {
            $par3c3befdcd1524723a0b81975461ffad11 = null;
        }

        if (null == $par3c3befdcd1524723a0b81975461ffad11) {
            $par3c3befdcd1524723a0b81975461ffad11 = '';
        }

        $pard8d80ef0471a4381b2324550fc63218c1 = null;

        if ('-' == $pard8d80ef0471a4381b2324550fc63218c1) {
            $pard8d80ef0471a4381b2324550fc63218c1 = null;
        }

        if (null == $pard8d80ef0471a4381b2324550fc63218c1) {
            $pard8d80ef0471a4381b2324550fc63218c1 = '';
        }

        $par2848dfff9dea4f4191de27cb41106a711 = null;

        if ('-' == $par2848dfff9dea4f4191de27cb41106a711) {
            $par2848dfff9dea4f4191de27cb41106a711 = null;
        }

        if (null == $par2848dfff9dea4f4191de27cb41106a711) {
            $par2848dfff9dea4f4191de27cb41106a711 = '';
        }

        $parfee3929ee94d41ac80caa5e7cf60f8831 = null;

        if ('-' == $parfee3929ee94d41ac80caa5e7cf60f8831) {
            $parfee3929ee94d41ac80caa5e7cf60f8831 = null;
        }

        if (null == $parfee3929ee94d41ac80caa5e7cf60f8831) {
            $parfee3929ee94d41ac80caa5e7cf60f8831 = '';
        }

        $par3fe33f8cdee14917aff0e0bb215619851 = null;

        if ('-' == $par3fe33f8cdee14917aff0e0bb215619851) {
            $par3fe33f8cdee14917aff0e0bb215619851 = null;
        }

        if (null == $par3fe33f8cdee14917aff0e0bb215619851) {
            $par3fe33f8cdee14917aff0e0bb215619851 = '';
        }

        $par62c60baf1da3437f834709b0b4143c991 = null;

        if ('-' == $par62c60baf1da3437f834709b0b4143c991) {
            $par62c60baf1da3437f834709b0b4143c991 = null;
        }

        if (null == $par62c60baf1da3437f834709b0b4143c991) {
            $par62c60baf1da3437f834709b0b4143c991 = '';
        }

        $v520d233cb92b46fd882feac1efc1eb30 = \App\repf782f923fd0247bd9f4010b717e52999::mtdd1b4bd3d5164c59b612acc53b00fd2c($parda155728f36748dba71fe5e81fbb77be1, $para183bed0492b4bc29be1b8c39d156cc21, $par16debc37a7c040be8372756e3e0dedde1, $par3c3befdcd1524723a0b81975461ffad11, $pard8d80ef0471a4381b2324550fc63218c1, $par2848dfff9dea4f4191de27cb41106a711, $parfee3929ee94d41ac80caa5e7cf60f8831, $par3fe33f8cdee14917aff0e0bb215619851, $par62c60baf1da3437f834709b0b4143c991);

        $v520d233cb92b46fd882feac1efc1eb30Ajax = \URL::to('/').'/api/dd1b4bd3d5164c59b612acc53b00fd2c/'.(null == $parda155728f36748dba71fe5e81fbb77be1 ? '-' : ('' == $parda155728f36748dba71fe5e81fbb77be1 ? '-' : $parda155728f36748dba71fe5e81fbb77be1)).'/'.(null == $para183bed0492b4bc29be1b8c39d156cc21 ? '-' : ('' == $para183bed0492b4bc29be1b8c39d156cc21 ? '-' : $para183bed0492b4bc29be1b8c39d156cc21)).'/'.(null == $par16debc37a7c040be8372756e3e0dedde1 ? '-' : ('' == $par16debc37a7c040be8372756e3e0dedde1 ? '-' : $par16debc37a7c040be8372756e3e0dedde1)).'/'.(null == $par3c3befdcd1524723a0b81975461ffad11 ? '-' : ('' == $par3c3befdcd1524723a0b81975461ffad11 ? '-' : $par3c3befdcd1524723a0b81975461ffad11)).'/'.(null == $pard8d80ef0471a4381b2324550fc63218c1 ? '-' : ('' == $pard8d80ef0471a4381b2324550fc63218c1 ? '-' : $pard8d80ef0471a4381b2324550fc63218c1)).'/'.(null == $par2848dfff9dea4f4191de27cb41106a711 ? '-' : ('' == $par2848dfff9dea4f4191de27cb41106a711 ? '-' : $par2848dfff9dea4f4191de27cb41106a711)).'/'.(null == $parfee3929ee94d41ac80caa5e7cf60f8831 ? '-' : ('' == $parfee3929ee94d41ac80caa5e7cf60f8831 ? '-' : $parfee3929ee94d41ac80caa5e7cf60f8831)).'/'.(null == $par3fe33f8cdee14917aff0e0bb215619851 ? '-' : ('' == $par3fe33f8cdee14917aff0e0bb215619851 ? '-' : $par3fe33f8cdee14917aff0e0bb215619851)).'/'.(null == $par62c60baf1da3437f834709b0b4143c991 ? '-' : ('' == $par62c60baf1da3437f834709b0b4143c991 ? '-' : $par62c60baf1da3437f834709b0b4143c991)).'/{page}/{pagesize}/{orderColumn}/{orderType}';

        // Titulo Paginas - Titulo Paginas

        $par8e9cfc8933a449af80f5fd2fdaf0c7461 = $request->session()->get('ses5e122755c3a24f5d8789755168e9de27');

        if (null == $par8e9cfc8933a449af80f5fd2fdaf0c7461) {
            $par8e9cfc8933a449af80f5fd2fdaf0c7461 = '0';
        }

        $par949ac6762f824f589aa55df91c654a401 = $request->input('titulo');

        if ('-' == $par949ac6762f824f589aa55df91c654a401) {
            $par949ac6762f824f589aa55df91c654a401 = null;
        }

        if (null == $par949ac6762f824f589aa55df91c654a401) {
            $par949ac6762f824f589aa55df91c654a401 = '0';
        }

        $par6185a7056560433494dba94e9ae59107e8925e1dc3fc4fa69ab38afdadac35d8 = 0;

        if (null == $par6185a7056560433494dba94e9ae59107e8925e1dc3fc4fa69ab38afdadac35d8) {
            $par6185a7056560433494dba94e9ae59107e8925e1dc3fc4fa69ab38afdadac35d8 = '0';
        }

        $par0a0ce2af85ab462a808e0270326fb860e8925e1dc3fc4fa69ab38afdadac35d8 = 0;

        if (null == $par0a0ce2af85ab462a808e0270326fb860e8925e1dc3fc4fa69ab38afdadac35d8) {
            $par0a0ce2af85ab462a808e0270326fb860e8925e1dc3fc4fa69ab38afdadac35d8 = '0';
        }

        $par5551ae677d6b488ebd38625d0f5d9fcee8925e1dc3fc4fa69ab38afdadac35d8 = '';

        if ('-' == $par5551ae677d6b488ebd38625d0f5d9fcee8925e1dc3fc4fa69ab38afdadac35d8) {
            $par5551ae677d6b488ebd38625d0f5d9fcee8925e1dc3fc4fa69ab38afdadac35d8 = null;
        }

        if (null == $par5551ae677d6b488ebd38625d0f5d9fcee8925e1dc3fc4fa69ab38afdadac35d8) {
            $par5551ae677d6b488ebd38625d0f5d9fcee8925e1dc3fc4fa69ab38afdadac35d8 = '';
        }

        $par8fce8a73ac264e4a8f3b56d8b991b8a5e8925e1dc3fc4fa69ab38afdadac35d8 = '';

        if ('-' == $par8fce8a73ac264e4a8f3b56d8b991b8a5e8925e1dc3fc4fa69ab38afdadac35d8) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a5e8925e1dc3fc4fa69ab38afdadac35d8 = null;
        }

        if (null == $par8fce8a73ac264e4a8f3b56d8b991b8a5e8925e1dc3fc4fa69ab38afdadac35d8) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a5e8925e1dc3fc4fa69ab38afdadac35d8 = '';
        }

        $ve8925e1dc3fc4fa69ab38afdadac35d8 = \App\repf782f923fd0247bd9f4010b717e52999::mtd1203cac9e0a4d2b8d8d3ac5e285d428($par8e9cfc8933a449af80f5fd2fdaf0c7461, $par949ac6762f824f589aa55df91c654a401, $par6185a7056560433494dba94e9ae59107e8925e1dc3fc4fa69ab38afdadac35d8, $par0a0ce2af85ab462a808e0270326fb860e8925e1dc3fc4fa69ab38afdadac35d8, $par5551ae677d6b488ebd38625d0f5d9fcee8925e1dc3fc4fa69ab38afdadac35d8, $par8fce8a73ac264e4a8f3b56d8b991b8a5e8925e1dc3fc4fa69ab38afdadac35d8);

        $ve8925e1dc3fc4fa69ab38afdadac35d8Ajax = \URL::to('/').'/api/d1203cac9e0a4d2b8d8d3ac5e285d428/'.(null == $par8e9cfc8933a449af80f5fd2fdaf0c7461 ? '-' : ('' == $par8e9cfc8933a449af80f5fd2fdaf0c7461 ? '-' : $par8e9cfc8933a449af80f5fd2fdaf0c7461)).'/'.(null == $par949ac6762f824f589aa55df91c654a401 ? '-' : ('' == $par949ac6762f824f589aa55df91c654a401 ? '-' : $par949ac6762f824f589aa55df91c654a401)).'/{page}/{pagesize}/{orderColumn}/{orderType}';
        ...
        // Paginador Productores - Paginador Productores
      $pgB07035f51936848fcbf4bffa3cc70eac2 = 0; // Page bottom
      $pgT07035f51936848fcbf4bffa3cc70eac2 = 0; // Page top
      $pgR07035f51936848fcbf4bffa3cc70eac2 = (isset($v2457b7f084a54553b567410f3d6ad7b2Count) ? $v2457b7f084a54553b567410f3d6ad7b2Count : 0); // Total rows
      $pgA07035f51936848fcbf4bffa3cc70eac2 = $par6185a7056560433494dba94e9ae591072457b7f084a54553b567410f3d6ad7b2; // Current page
      $pgS07035f51936848fcbf4bffa3cc70eac2 = $par0a0ce2af85ab462a808e0270326fb8602457b7f084a54553b567410f3d6ad7b2; // Page size
      $pgH07035f51936848fcbf4bffa3cc70eac2 = 5; // Pages to show
      $pgP07035f51936848fcbf4bffa3cc70eac2 = ceil((isset($v2457b7f084a54553b567410f3d6ad7b2Count) ? $v2457b7f084a54553b567410f3d6ad7b2Count : 0) / $pgS07035f51936848fcbf4bffa3cc70eac2); // Total pages
      $res07035f51936848fcbf4bffa3cc70eac2 = '';

        if ($pgP07035f51936848fcbf4bffa3cc70eac2 > 0 && $pgP07035f51936848fcbf4bffa3cc70eac2 >= $pgA07035f51936848fcbf4bffa3cc70eac2) {
            $pgB07035f51936848fcbf4bffa3cc70eac2 = $pgA07035f51936848fcbf4bffa3cc70eac2 - (int) ($pgH07035f51936848fcbf4bffa3cc70eac2 / 2);

            if ($pgB07035f51936848fcbf4bffa3cc70eac2 <= 1) {
                $pgB07035f51936848fcbf4bffa3cc70eac2 = 0;
            }

            $pgT07035f51936848fcbf4bffa3cc70eac2 = $pgB07035f51936848fcbf4bffa3cc70eac2 + $pgH07035f51936848fcbf4bffa3cc70eac2;

            if ($pgT07035f51936848fcbf4bffa3cc70eac2 >= $pgP07035f51936848fcbf4bffa3cc70eac2) {
                $pgT07035f51936848fcbf4bffa3cc70eac2 = $pgP07035f51936848fcbf4bffa3cc70eac2;
                $pgB07035f51936848fcbf4bffa3cc70eac2 = $pgP07035f51936848fcbf4bffa3cc70eac2 - $pgH07035f51936848fcbf4bffa3cc70eac2;
            }

            $res07035f51936848fcbf4bffa3cc70eac2 .= '<li';
            if ($pgA07035f51936848fcbf4bffa3cc70eac2 > 1) {
                $res07035f51936848fcbf4bffa3cc70eac2 .= '';
            } else {
                $res07035f51936848fcbf4bffa3cc70eac2 .= ' class="disabled" ';
            }
            $res07035f51936848fcbf4bffa3cc70eac2 .= '>';
            if ($pgA07035f51936848fcbf4bffa3cc70eac2 > 1) {
                $res07035f51936848fcbf4bffa3cc70eac2 .= '<a href="';
                $res07035f51936848fcbf4bffa3cc70eac2 .= \URL::to('/').str_replace('{pagesize}', $pgS07035f51936848fcbf4bffa3cc70eac2, str_replace('{pagenumber}', '1', '/productoresGrid/'.(null == $request->input('codigo') ? '-' : $request->input('codigo')).'/'.(null == $request->input('productor') ? '-' : $request->input('productor')).'/'.(null == $request->input('centrotrabajo') ? '-' : $request->input('centrotrabajo')).'/'.(null == $request->input('centroacopio') ? '-' : $request->input('centroacopio')).'/'.(null == $request->input('tamanoproductor') ? '-' : $request->input('tamanoproductor')).'/'.(null == $request->input('tipoleche') ? '-' : $request->input('tipoleche')).'/'.(null == $request->input('estatus') ? '-' : $request->input('estatus')).'/{pagenumber}/{pagesize}/'.(null == $request->input('titulo') ? '-' : $request->input('titulo')).''));
                $res07035f51936848fcbf4bffa3cc70eac2 .= '">';
            }
            $res07035f51936848fcbf4bffa3cc70eac2 .= str_replace('{Localization}', \Lang::get('resourceff2b12513d1a44948a7e7fbabde0697a.msg673755107d9e4f5cb0eef6837c91b302'), '<span aria-hidden="true">&laquo; {Localization}</span>');

            if ($pgA07035f51936848fcbf4bffa3cc70eac2 > 1) {
                $res07035f51936848fcbf4bffa3cc70eac2 .= '</a>';
            }
            $res07035f51936848fcbf4bffa3cc70eac2 .= '</li>';
            ...
            if ($pgA07035f51936848fcbf4bffa3cc70eac2 > 1) {
                $res07035f51936848fcbf4bffa3cc70eac2 .= '<a href="';
                $res07035f51936848fcbf4bffa3cc70eac2 .= \URL::to('/').str_replace('{pagesize}', $pgS07035f51936848fcbf4bffa3cc70eac2, str_replace('{pagenumber}', ($pgA07035f51936848fcbf4bffa3cc70eac2 - 1), '/productoresGrid/'.(null == $request->input('codigo') ? '-' : $request->input('codigo')).'/'.(null == $request->input('productor') ? '-' : $request->input('productor')).'/'.(null == $request->input('centrotrabajo') ? '-' : $request->input('centrotrabajo')).'/'.(null == $request->input('centroacopio') ? '-' : $request->input('centroacopio')).'/'.(null == $request->input('tamanoproductor') ? '-' : $request->input('tamanoproductor')).'/'.(null == $request->input('tipoleche') ? '-' : $request->input('tipoleche')).'/'.(null == $request->input('estatus') ? '-' : $request->input('estatus')).'/{pagenumber}/{pagesize}/'.(null == $request->input('titulo') ? '-' : $request->input('titulo')).''));
                $res07035f51936848fcbf4bffa3cc70eac2 .= '">';
            }
            $res07035f51936848fcbf4bffa3cc70eac2 .= str_replace('{Localization}', \Lang::get('resourceff2b12513d1a44948a7e7fbabde0697a.msg9d046e3adb7647fc95991757861b6f28'), '<span aria-hidden="true">&laquo; {Localization}</span>');
            ...
            for ($i = 1; $i <= $pgP07035f51936848fcbf4bffa3cc70eac2; ++$i) {
                if ($i > $pgB07035f51936848fcbf4bffa3cc70eac2 && $i <= $pgT07035f51936848fcbf4bffa3cc70eac2) {
                    $res07035f51936848fcbf4bffa3cc70eac2 .= '<li';
                    if ($i == $pgA07035f51936848fcbf4bffa3cc70eac2) {
                        $res07035f51936848fcbf4bffa3cc70eac2 .= ' class="active" ';
                    } else {
                        $res07035f51936848fcbf4bffa3cc70eac2 .= '';
                    }
                    $res07035f51936848fcbf4bffa3cc70eac2 .= '>';
                    $res07035f51936848fcbf4bffa3cc70eac2 .= '<a href="';
                    $res07035f51936848fcbf4bffa3cc70eac2 .= \URL::to('/').str_replace('{pagesize}', $pgS07035f51936848fcbf4bffa3cc70eac2, str_replace('{pagenumber}', $i, '/productoresGrid/'.(null == $request->input('codigo') ? '-' : $request->input('codigo')).'/'.(null == $request->input('productor') ? '-' : $request->input('productor')).'/'.(null == $request->input('centrotrabajo') ? '-' : $request->input('centrotrabajo')).'/'.(null == $request->input('centroacopio') ? '-' : $request->input('centroacopio')).'/'.(null == $request->input('tamanoproductor') ? '-' : $request->input('tamanoproductor')).'/'.(null == $request->input('tipoleche') ? '-' : $request->input('tipoleche')).'/'.(null == $request->input('estatus') ? '-' : $request->input('estatus')).'/{pagenumber}/{pagesize}/'.(null == $request->input('titulo') ? '-' : $request->input('titulo')).''));
                    $res07035f51936848fcbf4bffa3cc70eac2 .= '">';
                    $res07035f51936848fcbf4bffa3cc70eac2 .= $i;
                    $res07035f51936848fcbf4bffa3cc70eac2 .= '</a></li>';
                }
            }

            $res07035f51936848fcbf4bffa3cc70eac2 .= '<li';
            if ($pgA07035f51936848fcbf4bffa3cc70eac2 < $pgP07035f51936848fcbf4bffa3cc70eac2) {
                $res07035f51936848fcbf4bffa3cc70eac2 .= '';
            } else {
                $res07035f51936848fcbf4bffa3cc70eac2 .= ' class="disabled" ';
            }
            ...
            $res07035f51936848fcbf4bffa3cc70eac2 .= str_replace('{Localization}', \Lang::get('resourceff2b12513d1a44948a7e7fbabde0697a.msg6d4792f9962a46f2b37bbf9af604eda9'), '<span aria-hidden="true">{Localization} &raquo;</span>');
            ...
            if ($pgA07035f51936848fcbf4bffa3cc70eac2 < $pgP07035f51936848fcbf4bffa3cc70eac2) {
                $res07035f51936848fcbf4bffa3cc70eac2 .= '<a href="';
                $res07035f51936848fcbf4bffa3cc70eac2 .= \URL::to('/').str_replace('{pagesize}', $pgS07035f51936848fcbf4bffa3cc70eac2, str_replace('{pagenumber}', $pgP07035f51936848fcbf4bffa3cc70eac2, '/productoresGrid/'.(null == $request->input('codigo') ? '-' : $request->input('codigo')).'/'.(null == $request->input('productor') ? '-' : $request->input('productor')).'/'.(null == $request->input('centrotrabajo') ? '-' : $request->input('centrotrabajo')).'/'.(null == $request->input('centroacopio') ? '-' : $request->input('centroacopio')).'/'.(null == $request->input('tamanoproductor') ? '-' : $request->input('tamanoproductor')).'/'.(null == $request->input('tipoleche') ? '-' : $request->input('tipoleche')).'/'.(null == $request->input('estatus') ? '-' : $request->input('estatus')).'/{pagenumber}/{pagesize}/'.(null == $request->input('titulo') ? '-' : $request->input('titulo')).''));
                $res07035f51936848fcbf4bffa3cc70eac2 .= '">';
            }
            $res07035f51936848fcbf4bffa3cc70eac2 .= str_replace('{Localization}', \Lang::get('resourceff2b12513d1a44948a7e7fbabde0697a.msga50b13adc5284e92844239ca59bf38e5'), '<span aria-hidden="true">{Localization} &raquo;</span>');
        ...
        $v07035f51936848fcbf4bffa3cc70eac2 = $res07035f51936848fcbf4bffa3cc70eac2;
        $v07035f51936848fcbf4bffa3cc70eac2Link = \URL::to('/').'/productoresGrid/'.(null == $request->input('codigo') ? '-' : $request->input('codigo')).'/'.(null == $request->input('productor') ? '-' : $request->input('productor')).'/'.(null == $request->input('centrotrabajo') ? '-' : $request->input('centrotrabajo')).'/'.(null == $request->input('centroacopio') ? '-' : $request->input('centroacopio')).'/'.(null == $request->input('tamanoproductor') ? '-' : $request->input('tamanoproductor')).'/'.(null == $request->input('tipoleche') ? '-' : $request->input('tipoleche')).'/'.(null == $request->input('estatus') ? '-' : $request->input('estatus')).'/{pagenumber}/{pagesize}/'.(null == $request->input('titulo') ? '-' : $request->input('titulo')).'';
        $v07035f51936848fcbf4bffa3cc70eac2Change = $pgP07035f51936848fcbf4bffa3cc70eac2.','.$pgA07035f51936848fcbf4bffa3cc70eac2;
        $v07035f51936848fcbf4bffa3cc70eac2Current = $pgS07035f51936848fcbf4bffa3cc70eac2;
        $v07035f51936848fcbf4bffa3cc70eac2Actual = $pgA07035f51936848fcbf4bffa3cc70eac2;
        $v07035f51936848fcbf4bffa3cc70eac2Total = $pgR07035f51936848fcbf4bffa3cc70eac2;
        $v07035f51936848fcbf4bffa3cc70eac2Ajax = (isset($v2457b7f084a54553b567410f3d6ad7b2Ajax) ? $v2457b7f084a54553b567410f3d6ad7b2Ajax : '');
        $v07035f51936848fcbf4bffa3cc70eac2Order = $par5551ae677d6b488ebd38625d0f5d9fce2457b7f084a54553b567410f3d6ad7b2.'|'.$par8fce8a73ac264e4a8f3b56d8b991b8a52457b7f084a54553b567410f3d6ad7b2;

        $arrWiths['v0fd03293293f41f280a549c232cecb45Ajax'] = isset($v0fd03293293f41f280a549c232cecb45Ajax) ? $v0fd03293293f41f280a549c232cecb45Ajax : '';
        $arrWiths['v9f0cd5a341744b939041e0484375719a'] = isset($v9f0cd5a341744b939041e0484375719a) ? $v9f0cd5a341744b939041e0484375719a : '';
        $arrWiths['v9f0cd5a341744b939041e0484375719aAjax'] = isset($v9f0cd5a341744b939041e0484375719aAjax) ? $v9f0cd5a341744b939041e0484375719aAjax : '';
        $arrWiths['ve366d029182d4a45ae4f172b427cbe1a'] = isset($ve366d029182d4a45ae4f172b427cbe1a) ? $ve366d029182d4a45ae4f172b427cbe1a : '';
        $arrWiths['ve366d029182d4a45ae4f172b427cbe1aAjax'] = isset($ve366d029182d4a45ae4f172b427cbe1aAjax) ? $ve366d029182d4a45ae4f172b427cbe1aAjax : '';
        $arrWiths['v42352e014d924324bfb12c11378a6569'] = isset($v42352e014d924324bfb12c11378a6569) ? $v42352e014d924324bfb12c11378a6569 : '';
        $arrWiths['v42352e014d924324bfb12c11378a6569Ajax'] = isset($v42352e014d924324bfb12c11378a6569Ajax) ? $v42352e014d924324bfb12c11378a6569Ajax : '';
        $arrWiths['v0808b7023c1b4f72825d5771c7e80a88'] = isset($v0808b7023c1b4f72825d5771c7e80a88) ? $v0808b7023c1b4f72825d5771c7e80a88 : '';
        $arrWiths['v0808b7023c1b4f72825d5771c7e80a88Ajax'] = isset($v0808b7023c1b4f72825d5771c7e80a88Ajax) ? $v0808b7023c1b4f72825d5771c7e80a88Ajax : '';
        $arrWiths['v5f0909f6994b4717b4644c1d7679447e'] = isset($v5f0909f6994b4717b4644c1d7679447e) ? $v5f0909f6994b4717b4644c1d7679447e : '';
        $arrWiths['v5f0909f6994b4717b4644c1d7679447eAjax'] = isset($v5f0909f6994b4717b4644c1d7679447eAjax) ? $v5f0909f6994b4717b4644c1d7679447eAjax : '';
        $arrWiths['v2457b7f084a54553b567410f3d6ad7b2'] = isset($v2457b7f084a54553b567410f3d6ad7b2) ? $v2457b7f084a54553b567410f3d6ad7b2 : '';
        $arrWiths['v2457b7f084a54553b567410f3d6ad7b2Count'] = isset($v2457b7f084a54553b567410f3d6ad7b2Count) ? $v2457b7f084a54553b567410f3d6ad7b2Count : '';
        $arrWiths['v2457b7f084a54553b567410f3d6ad7b2Ajax'] = isset($v2457b7f084a54553b567410f3d6ad7b2Ajax) ? $v2457b7f084a54553b567410f3d6ad7b2Ajax : '';
        $arrWiths['v520d233cb92b46fd882feac1efc1eb30'] = isset($v520d233cb92b46fd882feac1efc1eb30) ? $v520d233cb92b46fd882feac1efc1eb30 : '';
        $arrWiths['ve8925e1dc3fc4fa69ab38afdadac35d8'] = isset($ve8925e1dc3fc4fa69ab38afdadac35d8) ? $ve8925e1dc3fc4fa69ab38afdadac35d8 : '';
        $arrWiths['ve8925e1dc3fc4fa69ab38afdadac35d8Ajax'] = isset($ve8925e1dc3fc4fa69ab38afdadac35d8Ajax) ? $ve8925e1dc3fc4fa69ab38afdadac35d8Ajax : '';
        ...
        $arrWiths['v07035f51936848fcbf4bffa3cc70eac2'] = isset($v07035f51936848fcbf4bffa3cc70eac2) ? $v07035f51936848fcbf4bffa3cc70eac2 : '';
        $arrWiths['v07035f51936848fcbf4bffa3cc70eac2Link'] = isset($v07035f51936848fcbf4bffa3cc70eac2Link) ? $v07035f51936848fcbf4bffa3cc70eac2Link : '';
        $arrWiths['v07035f51936848fcbf4bffa3cc70eac2Change'] = isset($v07035f51936848fcbf4bffa3cc70eac2Change) ? $v07035f51936848fcbf4bffa3cc70eac2Change : '';
        $arrWiths['v07035f51936848fcbf4bffa3cc70eac2Current'] = isset($v07035f51936848fcbf4bffa3cc70eac2Current) ? $v07035f51936848fcbf4bffa3cc70eac2Current : '';
        $arrWiths['v07035f51936848fcbf4bffa3cc70eac2Actual'] = isset($v07035f51936848fcbf4bffa3cc70eac2Actual) ? $v07035f51936848fcbf4bffa3cc70eac2Actual : '';
        $arrWiths['v07035f51936848fcbf4bffa3cc70eac2Total'] = isset($v07035f51936848fcbf4bffa3cc70eac2Total) ? $v07035f51936848fcbf4bffa3cc70eac2Total : '';
        $arrWiths['v07035f51936848fcbf4bffa3cc70eac2Ajax'] = isset($v07035f51936848fcbf4bffa3cc70eac2Ajax) ? $v07035f51936848fcbf4bffa3cc70eac2Ajax : '';
        $arrWiths['v07035f51936848fcbf4bffa3cc70eac2Order'] = isset($v07035f51936848fcbf4bffa3cc70eac2Order) ? $v07035f51936848fcbf4bffa3cc70eac2Order : '';
        ...
        $response = new \Illuminate\Http\Response(view('cbc460174b184e3183f8a04a05076787.Index', $arrWiths)->with('title', $arrWiths['title'])->with('vSessionTimeout', \Config::get('session.lifetime') * 60));
