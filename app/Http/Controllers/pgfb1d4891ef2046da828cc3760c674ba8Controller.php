 ...
 * login - login.
 */
class pgfb1d4891ef2046da828cc3760c674ba8Controller extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        $arrWiths = [];
        if (isset($_GET['token'])) {
            $request->session()->put('ses5e122755c3a24f5d8789755168e9de27', $_GET['token']);

            return redirect('/redirigir/0/3');
        } else {
            return redirect('https://sistemacentral.segalmex.gob.mx');
        }
        ...
        $response = new \Illuminate\Http\Response(view('fb1d4891ef2046da828cc3760c674ba8.Index', $arrWiths)->with('title', $arrWiths['title'])->with('vSessionTimeout', \Config::get('session.lifetime') * 60));
