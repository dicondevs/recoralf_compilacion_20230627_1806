 ...
 */
class pg21826ae9af2b4a5ea39bbcabd2d8c280Controller extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        $par417861170944496888b9473406bc1aec1 = $request->session()->get('ses5e122755c3a24f5d8789755168e9de27');

        if (null == $par417861170944496888b9473406bc1aec1) {
            $par417861170944496888b9473406bc1aec1 = '0';
        }

        $parb79ec9414ba949f789300f9dfd85d84f1 = $request->input('precios');

        if (null == $parb79ec9414ba949f789300f9dfd85d84f1) {
            $parb79ec9414ba949f789300f9dfd85d84f1 = '0';
        }

        $par633aef5a118c4402801fca5a3dc4c8bf1 = $request->input('tipo');

        if (null == $par633aef5a118c4402801fca5a3dc4c8bf1) {
            $par633aef5a118c4402801fca5a3dc4c8bf1 = '0';
        }

        $v590c3355f8b9420296f7efbe3cae57bb = \App\repf782f923fd0247bd9f4010b717e52999::mtc215731e5c4a479d93836e917a97b4d1($par417861170944496888b9473406bc1aec1, $parb79ec9414ba949f789300f9dfd85d84f1, $par633aef5a118c4402801fca5a3dc4c8bf1);

        $v590c3355f8b9420296f7efbe3cae57bbAjax = \URL::to('/').'/api/c215731e5c4a479d93836e917a97b4d1/'.(null == $par417861170944496888b9473406bc1aec1 ? '-' : ('' == $par417861170944496888b9473406bc1aec1 ? '-' : $par417861170944496888b9473406bc1aec1)).'/'.(null == $parb79ec9414ba949f789300f9dfd85d84f1 ? '-' : ('' == $parb79ec9414ba949f789300f9dfd85d84f1 ? '-' : $parb79ec9414ba949f789300f9dfd85d84f1)).'/'.(null == $par633aef5a118c4402801fca5a3dc4c8bf1 ? '-' : ('' == $par633aef5a118c4402801fca5a3dc4c8bf1 ? '-' : $par633aef5a118c4402801fca5a3dc4c8bf1)).'/{page}/{pagesize}/{orderColumn}/{orderType}';
        ...
        $arrWiths['v590c3355f8b9420296f7efbe3cae57bb'] = isset($v590c3355f8b9420296f7efbe3cae57bb) ? $v590c3355f8b9420296f7efbe3cae57bb : '';
        ...
        $response = new \Illuminate\Http\Response(view('21826ae9af2b4a5ea39bbcabd2d8c280.Index', $arrWiths)->with('title', $arrWiths['title'])->with('vSessionTimeout', \Config::get('session.lifetime') * 60));
