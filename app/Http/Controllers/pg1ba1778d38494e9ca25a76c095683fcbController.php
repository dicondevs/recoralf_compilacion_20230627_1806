...
/**
 * productorDetalle - productorDetalle.
 */
class pg1ba1778d38494e9ca25a76c095683fcbController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        $par95e3503650604d209d84abeedea2e04a1 = $request->input('a');

        if (null == $par95e3503650604d209d84abeedea2e04a1) {
            $par95e3503650604d209d84abeedea2e04a1 = '0';
        }

        $par9e8707669f824b83bee0a7c24cd43ef01 = $request->input('b');

        if (null == $par9e8707669f824b83bee0a7c24cd43ef01) {
            $par9e8707669f824b83bee0a7c24cd43ef01 = '0';
        }

        $par34ae96188d4a46079115205f10f197c31 = $request->session()->get('ses5e122755c3a24f5d8789755168e9de27');

        if (null == $par34ae96188d4a46079115205f10f197c31) {
            $par34ae96188d4a46079115205f10f197c31 = '0';
        }

        $v414c7ea2afa545dab0565e3fc633654f = \App\repf782f923fd0247bd9f4010b717e52999::mtfd3fb9893d9c4da6b0dca782dc587b28($par95e3503650604d209d84abeedea2e04a1, $par9e8707669f824b83bee0a7c24cd43ef01, $par34ae96188d4a46079115205f10f197c31);

        $v414c7ea2afa545dab0565e3fc633654fAjax = \URL::to('/').'/api/fd3fb9893d9c4da6b0dca782dc587b28/'.(null == $par95e3503650604d209d84abeedea2e04a1 ? '-' : ('' == $par95e3503650604d209d84abeedea2e04a1 ? '-' : $par95e3503650604d209d84abeedea2e04a1)).'/'.(null == $par9e8707669f824b83bee0a7c24cd43ef01 ? '-' : ('' == $par9e8707669f824b83bee0a7c24cd43ef01 ? '-' : $par9e8707669f824b83bee0a7c24cd43ef01)).'/'.(null == $par34ae96188d4a46079115205f10f197c31 ? '-' : ('' == $par34ae96188d4a46079115205f10f197c31 ? '-' : $par34ae96188d4a46079115205f10f197c31)).'/{page}/{pagesize}/{orderColumn}/{orderType}';

        // sp_titulos_generales - sp_titulos_generales

        $par915f2ce45e324305adf910faaabe6120 = $request->input('b');

        if (null == $par915f2ce45e324305adf910faaabe6120) {
            $par915f2ce45e324305adf910faaabe6120 = '0';
        }

        $par6185a7056560433494dba94e9ae59107678c8cb8eeec4d0aab6bee672de9ae9c = 0;

        if (null == $par6185a7056560433494dba94e9ae59107678c8cb8eeec4d0aab6bee672de9ae9c) {
            $par6185a7056560433494dba94e9ae59107678c8cb8eeec4d0aab6bee672de9ae9c = '0';
        }

        $par0a0ce2af85ab462a808e0270326fb860678c8cb8eeec4d0aab6bee672de9ae9c = 0;

        if (null == $par0a0ce2af85ab462a808e0270326fb860678c8cb8eeec4d0aab6bee672de9ae9c) {
            $par0a0ce2af85ab462a808e0270326fb860678c8cb8eeec4d0aab6bee672de9ae9c = '0';
        }

        $par5551ae677d6b488ebd38625d0f5d9fce678c8cb8eeec4d0aab6bee672de9ae9c = '';

        if ('-' == $par5551ae677d6b488ebd38625d0f5d9fce678c8cb8eeec4d0aab6bee672de9ae9c) {
            $par5551ae677d6b488ebd38625d0f5d9fce678c8cb8eeec4d0aab6bee672de9ae9c = null;
        }

        if (null == $par5551ae677d6b488ebd38625d0f5d9fce678c8cb8eeec4d0aab6bee672de9ae9c) {
            $par5551ae677d6b488ebd38625d0f5d9fce678c8cb8eeec4d0aab6bee672de9ae9c = '';
        }

        $par8fce8a73ac264e4a8f3b56d8b991b8a5678c8cb8eeec4d0aab6bee672de9ae9c = '';

        if ('-' == $par8fce8a73ac264e4a8f3b56d8b991b8a5678c8cb8eeec4d0aab6bee672de9ae9c) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a5678c8cb8eeec4d0aab6bee672de9ae9c = null;
        }

        if (null == $par8fce8a73ac264e4a8f3b56d8b991b8a5678c8cb8eeec4d0aab6bee672de9ae9c) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a5678c8cb8eeec4d0aab6bee672de9ae9c = '';
        }

        $v678c8cb8eeec4d0aab6bee672de9ae9c = \App\repf782f923fd0247bd9f4010b717e52999::mt1f2e4a280a3c490cb91d2b2e03e8c897($par915f2ce45e324305adf910faaabe6120, $par6185a7056560433494dba94e9ae59107678c8cb8eeec4d0aab6bee672de9ae9c, $par0a0ce2af85ab462a808e0270326fb860678c8cb8eeec4d0aab6bee672de9ae9c, $par5551ae677d6b488ebd38625d0f5d9fce678c8cb8eeec4d0aab6bee672de9ae9c, $par8fce8a73ac264e4a8f3b56d8b991b8a5678c8cb8eeec4d0aab6bee672de9ae9c);

        $v678c8cb8eeec4d0aab6bee672de9ae9cAjax = \URL::to('/').'/api/1f2e4a280a3c490cb91d2b2e03e8c897/'.(null == $par915f2ce45e324305adf910faaabe6120 ? '-' : ('' == $par915f2ce45e324305adf910faaabe6120 ? '-' : $par915f2ce45e324305adf910faaabe6120)).'/{page}/{pagesize}/{orderColumn}/{orderType}';
        ...
        $arrWiths['v414c7ea2afa545dab0565e3fc633654f'] = isset($v414c7ea2afa545dab0565e3fc633654f) ? $v414c7ea2afa545dab0565e3fc633654f : '';
        $arrWiths['v678c8cb8eeec4d0aab6bee672de9ae9c'] = isset($v678c8cb8eeec4d0aab6bee672de9ae9c) ? $v678c8cb8eeec4d0aab6bee672de9ae9c : '';
        $arrWiths['v678c8cb8eeec4d0aab6bee672de9ae9cAjax'] = isset($v678c8cb8eeec4d0aab6bee672de9ae9cAjax) ? $v678c8cb8eeec4d0aab6bee672de9ae9cAjax : '';
        ...
        $response = new \Illuminate\Http\Response(view('1ba1778d38494e9ca25a76c095683fcb.Index', $arrWiths)->with('title', $arrWiths['title'])->with('vSessionTimeout', \Config::get('session.lifetime') * 60));
