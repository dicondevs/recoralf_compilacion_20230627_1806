...
/**
 * +traspasosForm - pagina despues de agregar el traspaso principal.
 */
class pgb27bcd49cc2a4d989613cc477aaf2046Controller extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        $response = new \Illuminate\Http\Response(view('b27bcd49cc2a4d989613cc477aaf2046.Index', $arrWiths)->with('title', $arrWiths['title'])->with('vSessionTimeout', \Config::get('session.lifetime') * 60));
