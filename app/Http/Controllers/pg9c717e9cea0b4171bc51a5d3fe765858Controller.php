...
/**
 * Formatos pdf - Formatos pdf.
 */
class pg9c717e9cea0b4171bc51a5d3fe765858Controller extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        $par232e1cf075744d60adcbf43b59fdc1c31 = $request->input('a');

        if (null == $par232e1cf075744d60adcbf43b59fdc1c31) {
            $par232e1cf075744d60adcbf43b59fdc1c31 = '0';
        }

        $parf17cf0047b3d4ae79ebb1ab725cd563f1 = $request->input('b');

        if (null == $parf17cf0047b3d4ae79ebb1ab725cd563f1) {
            $parf17cf0047b3d4ae79ebb1ab725cd563f1 = '0';
        }

        $para3a24efc42b94cb6b807be853afb44ea1 = $request->session()->get('ses5e122755c3a24f5d8789755168e9de27');

        if (null == $para3a24efc42b94cb6b807be853afb44ea1) {
            $para3a24efc42b94cb6b807be853afb44ea1 = '0';
        }

        $va89349921a114c19b946346691764587 = \App\repf782f923fd0247bd9f4010b717e52999::mtb6a79e262e8345c8a5e89909394b8122($par232e1cf075744d60adcbf43b59fdc1c31, $parf17cf0047b3d4ae79ebb1ab725cd563f1, $para3a24efc42b94cb6b807be853afb44ea1);

        $va89349921a114c19b946346691764587Ajax = \URL::to('/').'/api/b6a79e262e8345c8a5e89909394b8122/'.(null == $par232e1cf075744d60adcbf43b59fdc1c31 ? '-' : ('' == $par232e1cf075744d60adcbf43b59fdc1c31 ? '-' : $par232e1cf075744d60adcbf43b59fdc1c31)).'/'.(null == $parf17cf0047b3d4ae79ebb1ab725cd563f1 ? '-' : ('' == $parf17cf0047b3d4ae79ebb1ab725cd563f1 ? '-' : $parf17cf0047b3d4ae79ebb1ab725cd563f1)).'/'.(null == $para3a24efc42b94cb6b807be853afb44ea1 ? '-' : ('' == $para3a24efc42b94cb6b807be853afb44ea1 ? '-' : $para3a24efc42b94cb6b807be853afb44ea1)).'/{page}/{pagesize}/{orderColumn}/{orderType}';
        ...
        if ('1' == $request->input('Excel')) {
            $content = '<html><head></head><body>'.$va89349921a114c19b946346691764587.'</body></html>';
            $headers = [
                  'Content-type' => 'application/vnd.ms-excel;charset=utf-8',
                  'Content-Disposition' => 'attachment; filename="'.\Lang::get('resourceff2b12513d1a44948a7e7fbabde0697a.msgdc54a07da69f4d7fa5c22fd75d4aa09d').'.xls"',
              ];

            return \Response::make($content, 200, $headers);
        } else {
            $imgConv5e914ef83d2d419aa2e04d6a297537ed = new \Mpdf\Mpdf([
            'format' => 'a4',
            'orientation' => 'P',
          ]);
            $imgConv5e914ef83d2d419aa2e04d6a297537ed->SetDisplayMode('fullpage');
            $imgConv5e914ef83d2d419aa2e04d6a297537ed->keep_table_proportions = true;
            $imgConv5e914ef83d2d419aa2e04d6a297537ed->SetTitle(\Lang::get('resourceff2b12513d1a44948a7e7fbabde0697a.msgdc54a07da69f4d7fa5c22fd75d4aa09d'));
            $imgConv5e914ef83d2d419aa2e04d6a297537ed->SetSubject(\Lang::get('resourceff2b12513d1a44948a7e7fbabde0697a.msgdc54a07da69f4d7fa5c22fd75d4aa09d'));
            $imgConv5e914ef83d2d419aa2e04d6a297537ed->SetAuthor('Codium 1.1.8333.17559');
            $imgConv5e914ef83d2d419aa2e04d6a297537ed->SetCreator('Codium 1.1.8333.17559');
            $imgConv5e914ef83d2d419aa2e04d6a297537ed->SetHTMLHeader('');
            $imgConv5e914ef83d2d419aa2e04d6a297537ed->SetHTMLFooter('');
            $imgConv5e914ef83d2d419aa2e04d6a297537ed->WriteHTML('<html><head></head><body>'.$va89349921a114c19b946346691764587.'</body></html>');
            $imgConv5e914ef83d2d419aa2e04d6a297537ed->Output(\Lang::get('resourceff2b12513d1a44948a7e7fbabde0697a.msgdc54a07da69f4d7fa5c22fd75d4aa09d').'.pdf', 'I');
        }

        $arrWiths['va89349921a114c19b946346691764587'] = isset($va89349921a114c19b946346691764587) ? $va89349921a114c19b946346691764587 : '';
        $arrWiths['v4a021de58a344c32960a08292f88ce1f'] = isset($v4a021de58a344c32960a08292f88ce1f) ? $v4a021de58a344c32960a08292f88ce1f : '';
        $arrWiths['v5e914ef83d2d419aa2e04d6a297537ed'] = isset($v5e914ef83d2d419aa2e04d6a297537ed) ? $v5e914ef83d2d419aa2e04d6a297537ed : '';
        ...
        $response = new \Illuminate\Http\Response(view('9c717e9cea0b4171bc51a5d3fe765858.Index', $arrWiths)->with('title', $arrWiths['title'])->with('vSessionTimeout', \Config::get('session.lifetime') * 60));
