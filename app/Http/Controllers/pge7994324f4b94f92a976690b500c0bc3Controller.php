...
/**
 * centrostrabajoForm - centrostrabajoForm.
 */
class pge7994324f4b94f92a976690b500c0bc3Controller extends Controller
{
    /**
    ...
    public function post(Request $request)
    {
        ...
        if (null != $request->input('ctl19b1bedba7d546529c0aa54c7e4d2040_4b281998028445f2ba90c07e9df70ffa') && null != $request->input('hid4b281998028445f2ba90c07e9df70ffa') && '4b281998028445f2ba90c07e9df70ffa' == $request->input('hid4b281998028445f2ba90c07e9df70ffa')) {
            $key = 0;
            $isNew = false;
            if (null != $request->input('centrotrabajo')) {
                $key = $request->input('centrotrabajo');
            }

            $tb = \App\tb44e4f4d9d8324792aa7571d8772a0830::where('PK_CENTROS_TRABAJO', $key)->first();
            if (null == $tb) {
                $isNew = true;
                $tb = new \App\tb44e4f4d9d8324792aa7571d8772a0830();
            }

            if (null != $request->input('ctl3607329572c440d9b68ef4a6c13f5921_4b281998028445f2ba90c07e9df70ffa')) {
                $tb->FL_NOMBRE = $request->input('ctl3607329572c440d9b68ef4a6c13f5921_4b281998028445f2ba90c07e9df70ffa'); //FL_NOMBRE
            } elseif (null == $request->input('ctl3607329572c440d9b68ef4a6c13f5921_4b281998028445f2ba90c07e9df70ffa')) {
                $tb->FL_NOMBRE = null;
            }

            if (null != $request->input('ctl18f96041624e4a08aa4c1ab266c5a933_4b281998028445f2ba90c07e9df70ffa')) {
                $tb->FL_ABREV = $request->input('ctl18f96041624e4a08aa4c1ab266c5a933_4b281998028445f2ba90c07e9df70ffa'); //FL_ABREV
            } elseif (null == $request->input('ctl18f96041624e4a08aa4c1ab266c5a933_4b281998028445f2ba90c07e9df70ffa')) {
                $tb->FL_ABREV = null;
            }

            if (null != $request->input('estado')) {
                $tb->FK_ESTADO = $request->input('estado'); //FK_ESTADO
            } elseif (null == $request->input('estado')) {
                $tb->FK_ESTADO = null;
            }

            if (null != $request->input('ctl3a6b40f3f7d340e6a3b804e2eca643dc_4b281998028445f2ba90c07e9df70ffa')) {
                $tb->FK_USUARIO = $request->input('ctl3a6b40f3f7d340e6a3b804e2eca643dc_4b281998028445f2ba90c07e9df70ffa'); //FK_USUARIO
            } elseif (null == $request->input('ctl3a6b40f3f7d340e6a3b804e2eca643dc_4b281998028445f2ba90c07e9df70ffa')) {
                $tb->FK_USUARIO = null;
            }
            if (null != $request->input('ctl41332b542a734638b2276a180f65af00_4b281998028445f2ba90c07e9df70ffa')) {
                $tb->FL_ACTIVO_INACTIVO = true; //FL_ACTIVO_INACTIVO
            } else {
                $tb->FL_ACTIVO_INACTIVO = false; //FL_ACTIVO_INACTIVO
            }

            if (null != $request->input('ctl47e0d7688af14f70b686a4714843ee9b_4b281998028445f2ba90c07e9df70ffa')) {
                $tb->FL_CENTROS_COSTO_CT = $request->input('ctl47e0d7688af14f70b686a4714843ee9b_4b281998028445f2ba90c07e9df70ffa'); //FL_CENTROS_COSTO_CT
            } elseif (null == $request->input('ctl47e0d7688af14f70b686a4714843ee9b_4b281998028445f2ba90c07e9df70ffa')) {
                $tb->FL_CENTROS_COSTO_CT = null;
            }
    ...
    public function index(Request $request)
    {
        ...
        $parf40be115e4c04dedadee447ccad1bf8f = $request->input('centrotrabajo');

        if (null == $parf40be115e4c04dedadee447ccad1bf8f) {
            $parf40be115e4c04dedadee447ccad1bf8f = '0';
        }

        $par6185a7056560433494dba94e9ae591078e7535a758024eefaa18e9574df1eee4 = 0;

        if (null == $par6185a7056560433494dba94e9ae591078e7535a758024eefaa18e9574df1eee4) {
            $par6185a7056560433494dba94e9ae591078e7535a758024eefaa18e9574df1eee4 = '0';
        }

        $par0a0ce2af85ab462a808e0270326fb8608e7535a758024eefaa18e9574df1eee4 = 0;

        if (null == $par0a0ce2af85ab462a808e0270326fb8608e7535a758024eefaa18e9574df1eee4) {
            $par0a0ce2af85ab462a808e0270326fb8608e7535a758024eefaa18e9574df1eee4 = '0';
        }

        $par5551ae677d6b488ebd38625d0f5d9fce8e7535a758024eefaa18e9574df1eee4 = '';

        if ('-' == $par5551ae677d6b488ebd38625d0f5d9fce8e7535a758024eefaa18e9574df1eee4) {
            $par5551ae677d6b488ebd38625d0f5d9fce8e7535a758024eefaa18e9574df1eee4 = null;
        }

        if (null == $par5551ae677d6b488ebd38625d0f5d9fce8e7535a758024eefaa18e9574df1eee4) {
            $par5551ae677d6b488ebd38625d0f5d9fce8e7535a758024eefaa18e9574df1eee4 = '';
        }

        $par8fce8a73ac264e4a8f3b56d8b991b8a58e7535a758024eefaa18e9574df1eee4 = '';

        if ('-' == $par8fce8a73ac264e4a8f3b56d8b991b8a58e7535a758024eefaa18e9574df1eee4) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a58e7535a758024eefaa18e9574df1eee4 = null;
        }

        if (null == $par8fce8a73ac264e4a8f3b56d8b991b8a58e7535a758024eefaa18e9574df1eee4) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a58e7535a758024eefaa18e9574df1eee4 = '';
        }

        $v8e7535a758024eefaa18e9574df1eee4 = \App\repf782f923fd0247bd9f4010b717e52999::mt5375e2c238d840eab1d71e94438ae827($parf40be115e4c04dedadee447ccad1bf8f, $par6185a7056560433494dba94e9ae591078e7535a758024eefaa18e9574df1eee4, $par0a0ce2af85ab462a808e0270326fb8608e7535a758024eefaa18e9574df1eee4, $par5551ae677d6b488ebd38625d0f5d9fce8e7535a758024eefaa18e9574df1eee4, $par8fce8a73ac264e4a8f3b56d8b991b8a58e7535a758024eefaa18e9574df1eee4);

        $v8e7535a758024eefaa18e9574df1eee4Ajax = \URL::to('/').'/api/5375e2c238d840eab1d71e94438ae827/'.(null == $parf40be115e4c04dedadee447ccad1bf8f ? '-' : ('' == $parf40be115e4c04dedadee447ccad1bf8f ? '-' : $parf40be115e4c04dedadee447ccad1bf8f)).'/{page}/{pagesize}/{orderColumn}/{orderType}';

        // Recuperar Centros de trabajo - Recuperar Centros de trabajo

        $par85fc7ca8ecdf4de989af499d61eb9878 = $request->input('centrotrabajo');

        if (null == $par85fc7ca8ecdf4de989af499d61eb9878) {
            $par85fc7ca8ecdf4de989af499d61eb9878 = '0';
        }

        $par6185a7056560433494dba94e9ae591074ccf2dc8145b4e729372de12877759f8 = 0;

        if (null == $par6185a7056560433494dba94e9ae591074ccf2dc8145b4e729372de12877759f8) {
            $par6185a7056560433494dba94e9ae591074ccf2dc8145b4e729372de12877759f8 = '0';
        }

        $par0a0ce2af85ab462a808e0270326fb8604ccf2dc8145b4e729372de12877759f8 = 0;

        if (null == $par0a0ce2af85ab462a808e0270326fb8604ccf2dc8145b4e729372de12877759f8) {
            $par0a0ce2af85ab462a808e0270326fb8604ccf2dc8145b4e729372de12877759f8 = '0';
        }

        $par5551ae677d6b488ebd38625d0f5d9fce4ccf2dc8145b4e729372de12877759f8 = '';

        if ('-' == $par5551ae677d6b488ebd38625d0f5d9fce4ccf2dc8145b4e729372de12877759f8) {
            $par5551ae677d6b488ebd38625d0f5d9fce4ccf2dc8145b4e729372de12877759f8 = null;
        }

        if (null == $par5551ae677d6b488ebd38625d0f5d9fce4ccf2dc8145b4e729372de12877759f8) {
            $par5551ae677d6b488ebd38625d0f5d9fce4ccf2dc8145b4e729372de12877759f8 = '';
        }

        $par8fce8a73ac264e4a8f3b56d8b991b8a54ccf2dc8145b4e729372de12877759f8 = '';

        if ('-' == $par8fce8a73ac264e4a8f3b56d8b991b8a54ccf2dc8145b4e729372de12877759f8) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a54ccf2dc8145b4e729372de12877759f8 = null;
        }

        if (null == $par8fce8a73ac264e4a8f3b56d8b991b8a54ccf2dc8145b4e729372de12877759f8) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a54ccf2dc8145b4e729372de12877759f8 = '';
        }

        $v4ccf2dc8145b4e729372de12877759f8 = \App\repf782f923fd0247bd9f4010b717e52999::mt3f56423cf125496ead92782f861022be($par85fc7ca8ecdf4de989af499d61eb9878, $par6185a7056560433494dba94e9ae591074ccf2dc8145b4e729372de12877759f8, $par0a0ce2af85ab462a808e0270326fb8604ccf2dc8145b4e729372de12877759f8, $par5551ae677d6b488ebd38625d0f5d9fce4ccf2dc8145b4e729372de12877759f8, $par8fce8a73ac264e4a8f3b56d8b991b8a54ccf2dc8145b4e729372de12877759f8);

        $v4ccf2dc8145b4e729372de12877759f8Ajax = \URL::to('/').'/api/3f56423cf125496ead92782f861022be/'.(null == $par85fc7ca8ecdf4de989af499d61eb9878 ? '-' : ('' == $par85fc7ca8ecdf4de989af499d61eb9878 ? '-' : $par85fc7ca8ecdf4de989af499d61eb9878)).'/{page}/{pagesize}/{orderColumn}/{orderType}';
        ...
        $arrWiths['v8e7535a758024eefaa18e9574df1eee4'] = isset($v8e7535a758024eefaa18e9574df1eee4) ? $v8e7535a758024eefaa18e9574df1eee4 : '';
        $arrWiths['v8e7535a758024eefaa18e9574df1eee4Ajax'] = isset($v8e7535a758024eefaa18e9574df1eee4Ajax) ? $v8e7535a758024eefaa18e9574df1eee4Ajax : '';
        $arrWiths['v4ccf2dc8145b4e729372de12877759f8'] = isset($v4ccf2dc8145b4e729372de12877759f8) ? $v4ccf2dc8145b4e729372de12877759f8 : '';
        $arrWiths['v4ccf2dc8145b4e729372de12877759f8Ajax'] = isset($v4ccf2dc8145b4e729372de12877759f8Ajax) ? $v4ccf2dc8145b4e729372de12877759f8Ajax : '';
        ...
        $response = new \Illuminate\Http\Response(view('e7994324f4b94f92a976690b500c0bc3.Index', $arrWiths)->with('title', $arrWiths['title'])->with('vSessionTimeout', \Config::get('session.lifetime') * 60));
