...
// Creado               martes, 27 de junio de 2023 17:56:44
...
/**
 * Centros Acopio form - Centros Acopio form.
 */
class pga380b9c6a42e44da8791bf1fa351101aController extends Controller
{
    /**
    ...
    public function post(Request $request)
    {
        ...
        // Guardar centros acopio - Guardar centros acopio
        if (null != $request->input('ctl19b1bedba7d546529c0aa54c7e4d2040_7b516d780e2a42b0af255d50e352613b') && null != $request->input('hid7b516d780e2a42b0af255d50e352613b') && '7b516d780e2a42b0af255d50e352613b' == $request->input('hid7b516d780e2a42b0af255d50e352613b')) {
            $key = 0;
            $isNew = false;
            if (null != $request->input('b')) {
                $key = $request->input('b');
            }

            $tb = \App\tbcae1c2cfbfd74b5fbdd2f84317339030::where('PK_CENTRO_ACOPIO', $key)->first();
            if (null == $tb) {
                $isNew = true;
                $tb = new \App\tbcae1c2cfbfd74b5fbdd2f84317339030();
            }

            if (null != $request->input('ctlc3ddcec421964d0a9d813f1de97f380c_7b516d780e2a42b0af255d50e352613b')) {
                $tb->FK_ESTADO = $request->input('ctlc3ddcec421964d0a9d813f1de97f380c_7b516d780e2a42b0af255d50e352613b'); //FK_ESTADO
            } elseif (null == $request->input('ctlc3ddcec421964d0a9d813f1de97f380c_7b516d780e2a42b0af255d50e352613b')) {
                $tb->FK_ESTADO = null;
            }

            if (null != $request->input('ctlf0d94ffc1a4c4d6687883a7c60fee2af_7b516d780e2a42b0af255d50e352613b')) {
                $tb->FK_LOCALIDAD = $request->input('ctlf0d94ffc1a4c4d6687883a7c60fee2af_7b516d780e2a42b0af255d50e352613b'); //FK_LOCALIDAD
            } elseif (null == $request->input('ctlf0d94ffc1a4c4d6687883a7c60fee2af_7b516d780e2a42b0af255d50e352613b')) {
                $tb->FK_LOCALIDAD = null;
            }

            if (null != $request->input('ctl0d895d2753924104a240a0b833a0b778_7b516d780e2a42b0af255d50e352613b')) {
                $tb->FK_MUNICIPIO = $request->input('ctl0d895d2753924104a240a0b833a0b778_7b516d780e2a42b0af255d50e352613b'); //FK_MUNICIPIO
            } elseif (null == $request->input('ctl0d895d2753924104a240a0b833a0b778_7b516d780e2a42b0af255d50e352613b')) {
                $tb->FK_MUNICIPIO = null;
            }

            if (null != $request->input('ctl35478b091bd64361ba406bfc1fd35892_7b516d780e2a42b0af255d50e352613b')) {
                $tb->FL_CLAVE = $request->input('ctl35478b091bd64361ba406bfc1fd35892_7b516d780e2a42b0af255d50e352613b'); //FL_CLAVE
            } elseif (null == $request->input('ctl35478b091bd64361ba406bfc1fd35892_7b516d780e2a42b0af255d50e352613b')) {
                $tb->FL_CLAVE = null;
            }

            if (null != $request->input('ctl56898ab7935347ecb1eadac39f0e6b88_7b516d780e2a42b0af255d50e352613b')) {
                $tb->FL_DIRECCION = $request->input('ctl56898ab7935347ecb1eadac39f0e6b88_7b516d780e2a42b0af255d50e352613b'); //FL_DIRECCION
            } elseif (null == $request->input('ctl56898ab7935347ecb1eadac39f0e6b88_7b516d780e2a42b0af255d50e352613b')) {
                $tb->FL_DIRECCION = null;
            }

            if (null != $request->input('ctl21ba4531a57749f8b6292d4978e35f0f_7b516d780e2a42b0af255d50e352613b')) {
                $tb->FL_LATITUD = $request->input('ctl21ba4531a57749f8b6292d4978e35f0f_7b516d780e2a42b0af255d50e352613b'); //FL_LATITUD
            } elseif (null == $request->input('ctl21ba4531a57749f8b6292d4978e35f0f_7b516d780e2a42b0af255d50e352613b')) {
                $tb->FL_LATITUD = null;
            }

            if (null != $request->input('ctl7ba3dfabab314324a98079332a684437_7b516d780e2a42b0af255d50e352613b')) {
                $tb->FL_LONGITUD = $request->input('ctl7ba3dfabab314324a98079332a684437_7b516d780e2a42b0af255d50e352613b'); //FL_LONGITUD
            } elseif (null == $request->input('ctl7ba3dfabab314324a98079332a684437_7b516d780e2a42b0af255d50e352613b')) {
                $tb->FL_LONGITUD = null;
            }

            if (null != $request->input('ctl3607329572c440d9b68ef4a6c13f5921_7b516d780e2a42b0af255d50e352613b')) {
                $tb->FL_NOMBRE = $request->input('ctl3607329572c440d9b68ef4a6c13f5921_7b516d780e2a42b0af255d50e352613b'); //FL_NOMBRE
            } elseif (null == $request->input('ctl3607329572c440d9b68ef4a6c13f5921_7b516d780e2a42b0af255d50e352613b')) {
                $tb->FL_NOMBRE = null;
            }

            if (null != $request->input('a')) {
                $tb->FK_CENTROS_TRABAJO = $request->input('a'); //FK_CENTROS_TRABAJO
            } elseif (null == $request->input('a')) {
                $tb->FK_CENTROS_TRABAJO = null;
            }
            if (null != $request->input('ctl41332b542a734638b2276a180f65af00_7b516d780e2a42b0af255d50e352613b')) {
                $tb->FL_ACTIVO_INACTIVO = true; //FL_ACTIVO_INACTIVO
            } else {
                $tb->FL_ACTIVO_INACTIVO = false; //FL_ACTIVO_INACTIVO
            }

            if (null != $request->input('ctl1234084c054c46aba96c84a478676b87_7b516d780e2a42b0af255d50e352613b')) {
                $tb->FL_CAPACIDAD_INSTALADA = $request->input('ctl1234084c054c46aba96c84a478676b87_7b516d780e2a42b0af255d50e352613b'); //FL_CAPACIDAD_INSTALADA
            } elseif (null == $request->input('ctl1234084c054c46aba96c84a478676b87_7b516d780e2a42b0af255d50e352613b')) {
                $tb->FL_CAPACIDAD_INSTALADA = null;
            }

            if (null != $request->input('ctl6ca1287b4ded4d6ba6837537371e5b4a_7b516d780e2a42b0af255d50e352613b')) {
                $tb->FL_CENTRO_COSTOS_CA = $request->input('ctl6ca1287b4ded4d6ba6837537371e5b4a_7b516d780e2a42b0af255d50e352613b'); //FL_CENTRO_COSTOS_CA
            } elseif (null == $request->input('ctl6ca1287b4ded4d6ba6837537371e5b4a_7b516d780e2a42b0af255d50e352613b')) {
                $tb->FL_CENTRO_COSTOS_CA = null;
            }
            if (null != $request->input('ctl3a3d19b3870b498d97c8700a32539f5d_7b516d780e2a42b0af255d50e352613b')) {
                $tb->FL_PLANTA = true; //FL_PLANTA
            } else {
                $tb->FL_PLANTA = false; //FL_PLANTA
            }

            if (null != $request->input('ctl404c14191f2847c185e938e233077d44_7b516d780e2a42b0af255d50e352613b')) {
                $tb->FL_TIPO_PROCESO = $request->input('ctl404c14191f2847c185e938e233077d44_7b516d780e2a42b0af255d50e352613b'); //FL_TIPO_PROCESO
            } elseif (null == $request->input('ctl404c14191f2847c185e938e233077d44_7b516d780e2a42b0af255d50e352613b')) {
                $tb->FL_TIPO_PROCESO = null;
            }

            if (null != $request->input('ctl9c73034797154d8985fc37f0000ae6ed_7b516d780e2a42b0af255d50e352613b')) {
                $tb->FL_CAPACIDAD_INSTALADA_DIARIA = $request->input('ctl9c73034797154d8985fc37f0000ae6ed_7b516d780e2a42b0af255d50e352613b'); //FL_CAPACIDAD_INSTALADA_DIARIA
            } elseif (null == $request->input('ctl9c73034797154d8985fc37f0000ae6ed_7b516d780e2a42b0af255d50e352613b')) {
                $tb->FL_CAPACIDAD_INSTALADA_DIARIA = null;
            }
    ...
    public function index(Request $request)
    {
        ...
        $par6185a7056560433494dba94e9ae591074bc882070ff446a6b973c0f30691b869 = 0;

        if (null == $par6185a7056560433494dba94e9ae591074bc882070ff446a6b973c0f30691b869) {
            $par6185a7056560433494dba94e9ae591074bc882070ff446a6b973c0f30691b869 = '0';
        }

        $par0a0ce2af85ab462a808e0270326fb8604bc882070ff446a6b973c0f30691b869 = 0;

        if (null == $par0a0ce2af85ab462a808e0270326fb8604bc882070ff446a6b973c0f30691b869) {
            $par0a0ce2af85ab462a808e0270326fb8604bc882070ff446a6b973c0f30691b869 = '0';
        }

        $par5551ae677d6b488ebd38625d0f5d9fce4bc882070ff446a6b973c0f30691b869 = '';

        if ('-' == $par5551ae677d6b488ebd38625d0f5d9fce4bc882070ff446a6b973c0f30691b869) {
            $par5551ae677d6b488ebd38625d0f5d9fce4bc882070ff446a6b973c0f30691b869 = null;
        }

        if (null == $par5551ae677d6b488ebd38625d0f5d9fce4bc882070ff446a6b973c0f30691b869) {
            $par5551ae677d6b488ebd38625d0f5d9fce4bc882070ff446a6b973c0f30691b869 = '';
        }

        $par8fce8a73ac264e4a8f3b56d8b991b8a54bc882070ff446a6b973c0f30691b869 = '';

        if ('-' == $par8fce8a73ac264e4a8f3b56d8b991b8a54bc882070ff446a6b973c0f30691b869) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a54bc882070ff446a6b973c0f30691b869 = null;
        }

        if (null == $par8fce8a73ac264e4a8f3b56d8b991b8a54bc882070ff446a6b973c0f30691b869) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a54bc882070ff446a6b973c0f30691b869 = '';
        }

        $v4bc882070ff446a6b973c0f30691b869 = \App\repf782f923fd0247bd9f4010b717e52999::mtabea1b31ebd541018e0ac1aeeb09858a($par6185a7056560433494dba94e9ae591074bc882070ff446a6b973c0f30691b869, $par0a0ce2af85ab462a808e0270326fb8604bc882070ff446a6b973c0f30691b869, $par5551ae677d6b488ebd38625d0f5d9fce4bc882070ff446a6b973c0f30691b869, $par8fce8a73ac264e4a8f3b56d8b991b8a54bc882070ff446a6b973c0f30691b869);

        $v4bc882070ff446a6b973c0f30691b869Ajax = \URL::to('/').'/api/abea1b31ebd541018e0ac1aeeb09858a/{page}/{pagesize}/{orderColumn}/{orderType}';

        // Lista de municipios - Lista de municipios

        $parcc42f42ce11443a889eba7ceaeec5dd7 = $request->input('a');

        if (null == $parcc42f42ce11443a889eba7ceaeec5dd7) {
            $parcc42f42ce11443a889eba7ceaeec5dd7 = '0';
        }

        $par6185a7056560433494dba94e9ae591071fc6372e61a7484f88667ca92312dfc5 = 0;

        if (null == $par6185a7056560433494dba94e9ae591071fc6372e61a7484f88667ca92312dfc5) {
            $par6185a7056560433494dba94e9ae591071fc6372e61a7484f88667ca92312dfc5 = '0';
        }

        $par0a0ce2af85ab462a808e0270326fb8601fc6372e61a7484f88667ca92312dfc5 = 0;

        if (null == $par0a0ce2af85ab462a808e0270326fb8601fc6372e61a7484f88667ca92312dfc5) {
            $par0a0ce2af85ab462a808e0270326fb8601fc6372e61a7484f88667ca92312dfc5 = '0';
        }

        $par5551ae677d6b488ebd38625d0f5d9fce1fc6372e61a7484f88667ca92312dfc5 = '';

        if ('-' == $par5551ae677d6b488ebd38625d0f5d9fce1fc6372e61a7484f88667ca92312dfc5) {
            $par5551ae677d6b488ebd38625d0f5d9fce1fc6372e61a7484f88667ca92312dfc5 = null;
        }

        if (null == $par5551ae677d6b488ebd38625d0f5d9fce1fc6372e61a7484f88667ca92312dfc5) {
            $par5551ae677d6b488ebd38625d0f5d9fce1fc6372e61a7484f88667ca92312dfc5 = '';
        }

        $par8fce8a73ac264e4a8f3b56d8b991b8a51fc6372e61a7484f88667ca92312dfc5 = '';

        if ('-' == $par8fce8a73ac264e4a8f3b56d8b991b8a51fc6372e61a7484f88667ca92312dfc5) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a51fc6372e61a7484f88667ca92312dfc5 = null;
        }

        if (null == $par8fce8a73ac264e4a8f3b56d8b991b8a51fc6372e61a7484f88667ca92312dfc5) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a51fc6372e61a7484f88667ca92312dfc5 = '';
        }

        $v1fc6372e61a7484f88667ca92312dfc5Ajax = \URL::to('/')."/api/9866c32545064a31a6b35587ee0c898e/'+encodeURIComponent((($('#ctlc3ddcec421964d0a9d813f1de97f380c_7b516d780e2a42b0af255d50e352613b{Extra}').val() == '' ? '-' : $('#ctlc3ddcec421964d0a9d813f1de97f380c_7b516d780e2a42b0af255d50e352613b{Extra}').val()) != undefined && ($('#ctlc3ddcec421964d0a9d813f1de97f380c_7b516d780e2a42b0af255d50e352613b{Extra}').val() == '' ? '-' : $('#ctlc3ddcec421964d0a9d813f1de97f380c_7b516d780e2a42b0af255d50e352613b{Extra}').val()).length > 0 ? ($('#ctlc3ddcec421964d0a9d813f1de97f380c_7b516d780e2a42b0af255d50e352613b{Extra}').val() == '' ? '-' : $('#ctlc3ddcec421964d0a9d813f1de97f380c_7b516d780e2a42b0af255d50e352613b{Extra}').val()).replace(/\\./g,'---').replace(/\\//g,'___') : ($('#ctlc3ddcec421964d0a9d813f1de97f380c_7b516d780e2a42b0af255d50e352613b{Extra}').val() == '' ? '-' : $('#ctlc3ddcec421964d0a9d813f1de97f380c_7b516d780e2a42b0af255d50e352613b{Extra}').val())))+'/{page}/{pagesize}/{orderColumn}/{orderType}";

        // Lista Localidad - Lista Localidad

        $par8e53624dfd1a4b888828e844e94e4e57 = $request->input('a');

        if (null == $par8e53624dfd1a4b888828e844e94e4e57) {
            $par8e53624dfd1a4b888828e844e94e4e57 = '0';
        }

        $par6185a7056560433494dba94e9ae59107df987785e5694bc1b76bb271723938c4 = 0;

        if (null == $par6185a7056560433494dba94e9ae59107df987785e5694bc1b76bb271723938c4) {
            $par6185a7056560433494dba94e9ae59107df987785e5694bc1b76bb271723938c4 = '0';
        }

        $par0a0ce2af85ab462a808e0270326fb860df987785e5694bc1b76bb271723938c4 = 0;

        if (null == $par0a0ce2af85ab462a808e0270326fb860df987785e5694bc1b76bb271723938c4) {
            $par0a0ce2af85ab462a808e0270326fb860df987785e5694bc1b76bb271723938c4 = '0';
        }

        $par5551ae677d6b488ebd38625d0f5d9fcedf987785e5694bc1b76bb271723938c4 = '';

        if ('-' == $par5551ae677d6b488ebd38625d0f5d9fcedf987785e5694bc1b76bb271723938c4) {
            $par5551ae677d6b488ebd38625d0f5d9fcedf987785e5694bc1b76bb271723938c4 = null;
        }

        if (null == $par5551ae677d6b488ebd38625d0f5d9fcedf987785e5694bc1b76bb271723938c4) {
            $par5551ae677d6b488ebd38625d0f5d9fcedf987785e5694bc1b76bb271723938c4 = '';
        }

        $par8fce8a73ac264e4a8f3b56d8b991b8a5df987785e5694bc1b76bb271723938c4 = '';

        if ('-' == $par8fce8a73ac264e4a8f3b56d8b991b8a5df987785e5694bc1b76bb271723938c4) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a5df987785e5694bc1b76bb271723938c4 = null;
        }

        if (null == $par8fce8a73ac264e4a8f3b56d8b991b8a5df987785e5694bc1b76bb271723938c4) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a5df987785e5694bc1b76bb271723938c4 = '';
        }

        $vdf987785e5694bc1b76bb271723938c4Ajax = \URL::to('/')."/api/2d133b9efb4445e182266241e4b38e05/'+encodeURIComponent((($('#ctl0d895d2753924104a240a0b833a0b778_7b516d780e2a42b0af255d50e352613b{Extra}').val() == '' ? '-' : $('#ctl0d895d2753924104a240a0b833a0b778_7b516d780e2a42b0af255d50e352613b{Extra}').val()) != undefined && ($('#ctl0d895d2753924104a240a0b833a0b778_7b516d780e2a42b0af255d50e352613b{Extra}').val() == '' ? '-' : $('#ctl0d895d2753924104a240a0b833a0b778_7b516d780e2a42b0af255d50e352613b{Extra}').val()).length > 0 ? ($('#ctl0d895d2753924104a240a0b833a0b778_7b516d780e2a42b0af255d50e352613b{Extra}').val() == '' ? '-' : $('#ctl0d895d2753924104a240a0b833a0b778_7b516d780e2a42b0af255d50e352613b{Extra}').val()).replace(/\\./g,'---').replace(/\\//g,'___') : ($('#ctl0d895d2753924104a240a0b833a0b778_7b516d780e2a42b0af255d50e352613b{Extra}').val() == '' ? '-' : $('#ctl0d895d2753924104a240a0b833a0b778_7b516d780e2a42b0af255d50e352613b{Extra}').val())))+'/{page}/{pagesize}/{orderColumn}/{orderType}";

        // Recuperar Centros acopio - Recuperar Centros acopio

        $pard2482aa827a94b30a75837c93a1b1071 = $request->input('b');

        if (null == $pard2482aa827a94b30a75837c93a1b1071) {
            $pard2482aa827a94b30a75837c93a1b1071 = '0';
        }

        $par6185a7056560433494dba94e9ae591075552289db8944da78fa204033349646f = 0;

        if (null == $par6185a7056560433494dba94e9ae591075552289db8944da78fa204033349646f) {
            $par6185a7056560433494dba94e9ae591075552289db8944da78fa204033349646f = '0';
        }

        $par0a0ce2af85ab462a808e0270326fb8605552289db8944da78fa204033349646f = 0;

        if (null == $par0a0ce2af85ab462a808e0270326fb8605552289db8944da78fa204033349646f) {
            $par0a0ce2af85ab462a808e0270326fb8605552289db8944da78fa204033349646f = '0';
        }

        $par5551ae677d6b488ebd38625d0f5d9fce5552289db8944da78fa204033349646f = '';

        if ('-' == $par5551ae677d6b488ebd38625d0f5d9fce5552289db8944da78fa204033349646f) {
            $par5551ae677d6b488ebd38625d0f5d9fce5552289db8944da78fa204033349646f = null;
        }

        if (null == $par5551ae677d6b488ebd38625d0f5d9fce5552289db8944da78fa204033349646f) {
            $par5551ae677d6b488ebd38625d0f5d9fce5552289db8944da78fa204033349646f = '';
        }

        $par8fce8a73ac264e4a8f3b56d8b991b8a55552289db8944da78fa204033349646f = '';

        if ('-' == $par8fce8a73ac264e4a8f3b56d8b991b8a55552289db8944da78fa204033349646f) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a55552289db8944da78fa204033349646f = null;
        }

        if (null == $par8fce8a73ac264e4a8f3b56d8b991b8a55552289db8944da78fa204033349646f) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a55552289db8944da78fa204033349646f = '';
        }

        $v5552289db8944da78fa204033349646f = \App\repf782f923fd0247bd9f4010b717e52999::mtf6804dd3d98a484494e46bbd26c56df1($pard2482aa827a94b30a75837c93a1b1071, $par6185a7056560433494dba94e9ae591075552289db8944da78fa204033349646f, $par0a0ce2af85ab462a808e0270326fb8605552289db8944da78fa204033349646f, $par5551ae677d6b488ebd38625d0f5d9fce5552289db8944da78fa204033349646f, $par8fce8a73ac264e4a8f3b56d8b991b8a55552289db8944da78fa204033349646f);

        $v5552289db8944da78fa204033349646fAjax = \URL::to('/').'/api/f6804dd3d98a484494e46bbd26c56df1/'.(null == $pard2482aa827a94b30a75837c93a1b1071 ? '-' : ('' == $pard2482aa827a94b30a75837c93a1b1071 ? '-' : $pard2482aa827a94b30a75837c93a1b1071)).'/{page}/{pagesize}/{orderColumn}/{orderType}';
        ...
        $arrWiths['v4bc882070ff446a6b973c0f30691b869'] = isset($v4bc882070ff446a6b973c0f30691b869) ? $v4bc882070ff446a6b973c0f30691b869 : '';
        $arrWiths['v4bc882070ff446a6b973c0f30691b869Ajax'] = isset($v4bc882070ff446a6b973c0f30691b869Ajax) ? $v4bc882070ff446a6b973c0f30691b869Ajax : '';
        $arrWiths['v1fc6372e61a7484f88667ca92312dfc5Ajax'] = isset($v1fc6372e61a7484f88667ca92312dfc5Ajax) ? $v1fc6372e61a7484f88667ca92312dfc5Ajax : '';
        $arrWiths['vdf987785e5694bc1b76bb271723938c4Ajax'] = isset($vdf987785e5694bc1b76bb271723938c4Ajax) ? $vdf987785e5694bc1b76bb271723938c4Ajax : '';
        $arrWiths['v5552289db8944da78fa204033349646f'] = isset($v5552289db8944da78fa204033349646f) ? $v5552289db8944da78fa204033349646f : '';
        $arrWiths['v5552289db8944da78fa204033349646fAjax'] = isset($v5552289db8944da78fa204033349646fAjax) ? $v5552289db8944da78fa204033349646fAjax : '';
        ...
        $response = new \Illuminate\Http\Response(view('a380b9c6a42e44da8791bf1fa351101a.Index', $arrWiths)->with('title', $arrWiths['title'])->with('vSessionTimeout', \Config::get('session.lifetime') * 60));
