...
/**
 * perfilGrid - perfilGrid.
 */
class pg9e064ade72cc46caafb9eeee046d28c1Controller extends Controller
{
    /**
    ...
    public function post(Request $request)
    {
        ...
        // Guardar Menu - Guardar Menu
        if (null != $request->input('ctl3f4c37c6271849e1afdcbaa396e78f3f_1495db41b4c84fbf8dbf012ab9de7e4d') && null != $request->input('hid1495db41b4c84fbf8dbf012ab9de7e4d') && '1495db41b4c84fbf8dbf012ab9de7e4d' == $request->input('hid1495db41b4c84fbf8dbf012ab9de7e4d')) {
            $key = 0;
            $isNew = false;
            if (0 != null) {
                $key = 0;
            ...
            $tb = \App\tb8a5867a15a584cf1b0cc1c6dad6c612b::where('PK_PERFIL_MENU', $key)->first();
            if (null == $tb) {
                $isNew = true;
                $tb = new \App\tb8a5867a15a584cf1b0cc1c6dad6c612b();
            }

            if (null != $request->input('ctlf7b8aa4429fe4ad382494802a7fbd287_1495db41b4c84fbf8dbf012ab9de7e4d')) {
                $tb->FK_MENU = $request->input('ctlf7b8aa4429fe4ad382494802a7fbd287_1495db41b4c84fbf8dbf012ab9de7e4d'); //FK_MENU
            } elseif (null == $request->input('ctlf7b8aa4429fe4ad382494802a7fbd287_1495db41b4c84fbf8dbf012ab9de7e4d')) {
                $tb->FK_MENU = null;
            }

            if (null != $request->input('ctl59d9f671dd2a4f4593b62d681ebc0981_1495db41b4c84fbf8dbf012ab9de7e4d')) {
                $tb->FK_PERFIL = $request->input('ctl59d9f671dd2a4f4593b62d681ebc0981_1495db41b4c84fbf8dbf012ab9de7e4d'); //FK_PERFIL
            } elseif (null == $request->input('ctl59d9f671dd2a4f4593b62d681ebc0981_1495db41b4c84fbf8dbf012ab9de7e4d')) {
                $tb->FK_PERFIL = null;
            }
    ...
    public function index(Request $request)
    {
        ...
        $par6185a7056560433494dba94e9ae59107d180d5810a054e659544d398d79cdcab = 0;

        if (null == $par6185a7056560433494dba94e9ae59107d180d5810a054e659544d398d79cdcab) {
            $par6185a7056560433494dba94e9ae59107d180d5810a054e659544d398d79cdcab = '0';
        }

        $par0a0ce2af85ab462a808e0270326fb860d180d5810a054e659544d398d79cdcab = 0;

        if (null == $par0a0ce2af85ab462a808e0270326fb860d180d5810a054e659544d398d79cdcab) {
            $par0a0ce2af85ab462a808e0270326fb860d180d5810a054e659544d398d79cdcab = '0';
        }

        $par5551ae677d6b488ebd38625d0f5d9fced180d5810a054e659544d398d79cdcab = '';

        if ('-' == $par5551ae677d6b488ebd38625d0f5d9fced180d5810a054e659544d398d79cdcab) {
            $par5551ae677d6b488ebd38625d0f5d9fced180d5810a054e659544d398d79cdcab = null;
        }

        if (null == $par5551ae677d6b488ebd38625d0f5d9fced180d5810a054e659544d398d79cdcab) {
            $par5551ae677d6b488ebd38625d0f5d9fced180d5810a054e659544d398d79cdcab = '';
        }

        $par8fce8a73ac264e4a8f3b56d8b991b8a5d180d5810a054e659544d398d79cdcab = '';

        if ('-' == $par8fce8a73ac264e4a8f3b56d8b991b8a5d180d5810a054e659544d398d79cdcab) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a5d180d5810a054e659544d398d79cdcab = null;
        }

        if (null == $par8fce8a73ac264e4a8f3b56d8b991b8a5d180d5810a054e659544d398d79cdcab) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a5d180d5810a054e659544d398d79cdcab = '';
        }

        $vd180d5810a054e659544d398d79cdcab = \App\repf782f923fd0247bd9f4010b717e52999::mt0c6c6f77495247fa889579c85be10e7e($par6185a7056560433494dba94e9ae59107d180d5810a054e659544d398d79cdcab, $par0a0ce2af85ab462a808e0270326fb860d180d5810a054e659544d398d79cdcab, $par5551ae677d6b488ebd38625d0f5d9fced180d5810a054e659544d398d79cdcab, $par8fce8a73ac264e4a8f3b56d8b991b8a5d180d5810a054e659544d398d79cdcab);

        $vd180d5810a054e659544d398d79cdcabAjax = \URL::to('/').'/api/0c6c6f77495247fa889579c85be10e7e/{page}/{pagesize}/{orderColumn}/{orderType}';

        // Lista de Perfiles - Lista de Perfiles

        $par6185a7056560433494dba94e9ae59107724de5746c4344579bcc65a0c1f13188 = 0;

        if (null == $par6185a7056560433494dba94e9ae59107724de5746c4344579bcc65a0c1f13188) {
            $par6185a7056560433494dba94e9ae59107724de5746c4344579bcc65a0c1f13188 = '0';
        }

        $par0a0ce2af85ab462a808e0270326fb860724de5746c4344579bcc65a0c1f13188 = 0;

        if (null == $par0a0ce2af85ab462a808e0270326fb860724de5746c4344579bcc65a0c1f13188) {
            $par0a0ce2af85ab462a808e0270326fb860724de5746c4344579bcc65a0c1f13188 = '0';
        }

        $par5551ae677d6b488ebd38625d0f5d9fce724de5746c4344579bcc65a0c1f13188 = '';

        if ('-' == $par5551ae677d6b488ebd38625d0f5d9fce724de5746c4344579bcc65a0c1f13188) {
            $par5551ae677d6b488ebd38625d0f5d9fce724de5746c4344579bcc65a0c1f13188 = null;
        }

        if (null == $par5551ae677d6b488ebd38625d0f5d9fce724de5746c4344579bcc65a0c1f13188) {
            $par5551ae677d6b488ebd38625d0f5d9fce724de5746c4344579bcc65a0c1f13188 = '';
        }

        $par8fce8a73ac264e4a8f3b56d8b991b8a5724de5746c4344579bcc65a0c1f13188 = '';

        if ('-' == $par8fce8a73ac264e4a8f3b56d8b991b8a5724de5746c4344579bcc65a0c1f13188) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a5724de5746c4344579bcc65a0c1f13188 = null;
        }

        if (null == $par8fce8a73ac264e4a8f3b56d8b991b8a5724de5746c4344579bcc65a0c1f13188) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a5724de5746c4344579bcc65a0c1f13188 = '';
        }

        $v724de5746c4344579bcc65a0c1f13188 = \App\repf782f923fd0247bd9f4010b717e52999::mt43cb5f4c6f0143c5a135334d93bebb71($par6185a7056560433494dba94e9ae59107724de5746c4344579bcc65a0c1f13188, $par0a0ce2af85ab462a808e0270326fb860724de5746c4344579bcc65a0c1f13188, $par5551ae677d6b488ebd38625d0f5d9fce724de5746c4344579bcc65a0c1f13188, $par8fce8a73ac264e4a8f3b56d8b991b8a5724de5746c4344579bcc65a0c1f13188);

        $v724de5746c4344579bcc65a0c1f13188Ajax = \URL::to('/').'/api/43cb5f4c6f0143c5a135334d93bebb71/{page}/{pagesize}/{orderColumn}/{orderType}';

        // Modelador Perfiles Menu - Modelador Perfiles Menu

        $par6185a7056560433494dba94e9ae59107170a087040d24845ac5e9094291bb832 = 0;

        if (null == $par6185a7056560433494dba94e9ae59107170a087040d24845ac5e9094291bb832) {
            $par6185a7056560433494dba94e9ae59107170a087040d24845ac5e9094291bb832 = '0';
        }

        $par0a0ce2af85ab462a808e0270326fb860170a087040d24845ac5e9094291bb832 = 0;

        if (null == $par0a0ce2af85ab462a808e0270326fb860170a087040d24845ac5e9094291bb832) {
            $par0a0ce2af85ab462a808e0270326fb860170a087040d24845ac5e9094291bb832 = '0';
        }

        $par5551ae677d6b488ebd38625d0f5d9fce170a087040d24845ac5e9094291bb832 = '';

        if ('-' == $par5551ae677d6b488ebd38625d0f5d9fce170a087040d24845ac5e9094291bb832) {
            $par5551ae677d6b488ebd38625d0f5d9fce170a087040d24845ac5e9094291bb832 = null;
        }

        if (null == $par5551ae677d6b488ebd38625d0f5d9fce170a087040d24845ac5e9094291bb832) {
            $par5551ae677d6b488ebd38625d0f5d9fce170a087040d24845ac5e9094291bb832 = '';
        }

        $par8fce8a73ac264e4a8f3b56d8b991b8a5170a087040d24845ac5e9094291bb832 = '';

        if ('-' == $par8fce8a73ac264e4a8f3b56d8b991b8a5170a087040d24845ac5e9094291bb832) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a5170a087040d24845ac5e9094291bb832 = null;
        }

        if (null == $par8fce8a73ac264e4a8f3b56d8b991b8a5170a087040d24845ac5e9094291bb832) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a5170a087040d24845ac5e9094291bb832 = '';
        }

        $v170a087040d24845ac5e9094291bb832Ajax = \URL::to('/').'/api/d1f2d9029cda4a078d86938214048578/{page}/{pagesize}/{orderColumn}/{orderType}';

        // Modelador Perfiles Menu - Modelador Perfiles Menu

        $v170a087040d24845ac5e9094291bb832Count = \App\repf782f923fd0247bd9f4010b717e52999::mtd1f2d9029cda4a078d86938214048578Count($par6185a7056560433494dba94e9ae59107170a087040d24845ac5e9094291bb832, $par0a0ce2af85ab462a808e0270326fb860170a087040d24845ac5e9094291bb832, $par5551ae677d6b488ebd38625d0f5d9fce170a087040d24845ac5e9094291bb832, $par8fce8a73ac264e4a8f3b56d8b991b8a5170a087040d24845ac5e9094291bb832);

        //$v170a087040d24845ac5e9094291bb832CountAjax =  \URL::to('/')."/api/d1f2d9029cda4a078d86938214048578Count{ParametersAjax}/{page}/{pagesize}/{orderColumn}/{orderType}";

        // Titulo Perfil - Titulo Perfil
        ...
        $par6185a7056560433494dba94e9ae59107231c4b0e7a764083a0c9141939304f29 = 0;

        if (null == $par6185a7056560433494dba94e9ae59107231c4b0e7a764083a0c9141939304f29) {
            $par6185a7056560433494dba94e9ae59107231c4b0e7a764083a0c9141939304f29 = '0';
        }

        $par0a0ce2af85ab462a808e0270326fb860231c4b0e7a764083a0c9141939304f29 = 0;

        if (null == $par0a0ce2af85ab462a808e0270326fb860231c4b0e7a764083a0c9141939304f29) {
            $par0a0ce2af85ab462a808e0270326fb860231c4b0e7a764083a0c9141939304f29 = '0';
        }

        $par5551ae677d6b488ebd38625d0f5d9fce231c4b0e7a764083a0c9141939304f29 = '';

        if ('-' == $par5551ae677d6b488ebd38625d0f5d9fce231c4b0e7a764083a0c9141939304f29) {
            $par5551ae677d6b488ebd38625d0f5d9fce231c4b0e7a764083a0c9141939304f29 = null;
        }

        if (null == $par5551ae677d6b488ebd38625d0f5d9fce231c4b0e7a764083a0c9141939304f29) {
            $par5551ae677d6b488ebd38625d0f5d9fce231c4b0e7a764083a0c9141939304f29 = '';
        }

        $par8fce8a73ac264e4a8f3b56d8b991b8a5231c4b0e7a764083a0c9141939304f29 = '';

        if ('-' == $par8fce8a73ac264e4a8f3b56d8b991b8a5231c4b0e7a764083a0c9141939304f29) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a5231c4b0e7a764083a0c9141939304f29 = null;
        }

        if (null == $par8fce8a73ac264e4a8f3b56d8b991b8a5231c4b0e7a764083a0c9141939304f29) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a5231c4b0e7a764083a0c9141939304f29 = '';
        }

        $v231c4b0e7a764083a0c9141939304f29 = \App\repf782f923fd0247bd9f4010b717e52999::mtd1203cac9e0a4d2b8d8d3ac5e285d428($par8e9cfc8933a449af80f5fd2fdaf0c7461, $par949ac6762f824f589aa55df91c654a401, $par6185a7056560433494dba94e9ae59107231c4b0e7a764083a0c9141939304f29, $par0a0ce2af85ab462a808e0270326fb860231c4b0e7a764083a0c9141939304f29, $par5551ae677d6b488ebd38625d0f5d9fce231c4b0e7a764083a0c9141939304f29, $par8fce8a73ac264e4a8f3b56d8b991b8a5231c4b0e7a764083a0c9141939304f29);

        $v231c4b0e7a764083a0c9141939304f29Ajax = \URL::to('/').'/api/d1203cac9e0a4d2b8d8d3ac5e285d428/'.(null == $par8e9cfc8933a449af80f5fd2fdaf0c7461 ? '-' : ('' == $par8e9cfc8933a449af80f5fd2fdaf0c7461 ? '-' : $par8e9cfc8933a449af80f5fd2fdaf0c7461)).'/'.(null == $par949ac6762f824f589aa55df91c654a401 ? '-' : ('' == $par949ac6762f824f589aa55df91c654a401 ? '-' : $par949ac6762f824f589aa55df91c654a401)).'/{page}/{pagesize}/{orderColumn}/{orderType}';
        ...
        // Grid Perfiles Menu - Grid Perfiles Menu
        $vea54df4ad16745bda417718574be30a2 = '';
        $vea54df4ad16745bda417718574be30a2Total = (isset($v170a087040d24845ac5e9094291bb832Count) ? $v170a087040d24845ac5e9094291bb832Count : 0);
        $vea54df4ad16745bda417718574be30a2Ajax = (isset($v170a087040d24845ac5e9094291bb832Ajax) ? $v170a087040d24845ac5e9094291bb832Ajax : '');

        $arrWiths['vd180d5810a054e659544d398d79cdcab'] = isset($vd180d5810a054e659544d398d79cdcab) ? $vd180d5810a054e659544d398d79cdcab : '';
        $arrWiths['vd180d5810a054e659544d398d79cdcabAjax'] = isset($vd180d5810a054e659544d398d79cdcabAjax) ? $vd180d5810a054e659544d398d79cdcabAjax : '';
        $arrWiths['v724de5746c4344579bcc65a0c1f13188'] = isset($v724de5746c4344579bcc65a0c1f13188) ? $v724de5746c4344579bcc65a0c1f13188 : '';
        $arrWiths['v724de5746c4344579bcc65a0c1f13188Ajax'] = isset($v724de5746c4344579bcc65a0c1f13188Ajax) ? $v724de5746c4344579bcc65a0c1f13188Ajax : '';
        $arrWiths['v170a087040d24845ac5e9094291bb832Count'] = isset($v170a087040d24845ac5e9094291bb832Count) ? $v170a087040d24845ac5e9094291bb832Count : '';
        $arrWiths['v170a087040d24845ac5e9094291bb832Ajax'] = isset($v170a087040d24845ac5e9094291bb832Ajax) ? $v170a087040d24845ac5e9094291bb832Ajax : '';
        $arrWiths['v231c4b0e7a764083a0c9141939304f29'] = isset($v231c4b0e7a764083a0c9141939304f29) ? $v231c4b0e7a764083a0c9141939304f29 : '';
        $arrWiths['v231c4b0e7a764083a0c9141939304f29Ajax'] = isset($v231c4b0e7a764083a0c9141939304f29Ajax) ? $v231c4b0e7a764083a0c9141939304f29Ajax : '';
        ...
        $arrWiths['vea54df4ad16745bda417718574be30a2'] = isset($vea54df4ad16745bda417718574be30a2) ? $vea54df4ad16745bda417718574be30a2 : '';
        $arrWiths['vea54df4ad16745bda417718574be30a2Total'] = isset($vea54df4ad16745bda417718574be30a2Total) ? $vea54df4ad16745bda417718574be30a2Total : '';
        $arrWiths['vea54df4ad16745bda417718574be30a2Ajax'] = isset($vea54df4ad16745bda417718574be30a2Ajax) ? $vea54df4ad16745bda417718574be30a2Ajax : '';
        ...
        $response = new \Illuminate\Http\Response(view('9e064ade72cc46caafb9eeee046d28c1.Index', $arrWiths)->with('title', $arrWiths['title'])->with('vSessionTimeout', \Config::get('session.lifetime') * 60));
