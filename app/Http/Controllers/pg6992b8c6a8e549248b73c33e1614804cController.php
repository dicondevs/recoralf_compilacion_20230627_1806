...
// Creado               martes, 27 de junio de 2023 17:57:20
...
/**
 * productorDBform - productorDBform.
 */
class pg6992b8c6a8e549248b73c33e1614804cController extends Controller
{
    /**
    ...
    public function post(Request $request)
    {
        ...
        // Guardar Datos Bancarios Productor - Guardar Datos Bancarios Productor
        if (null != $request->input('ctl3f4c37c6271849e1afdcbaa396e78f3f_0b8ac399bbd34d5aac25b31879a8f59c') && null != $request->input('hid0b8ac399bbd34d5aac25b31879a8f59c') && '0b8ac399bbd34d5aac25b31879a8f59c' == $request->input('hid0b8ac399bbd34d5aac25b31879a8f59c')) {
            $key = 0;
            $isNew = false;
            ...
            if (null != $request->input('ctla50078a3588d48e9b63d6d5ee1291712_0b8ac399bbd34d5aac25b31879a8f59c')) {
                $tb->FL_CLABE_TRANSFERENCIA = $request->input('ctla50078a3588d48e9b63d6d5ee1291712_0b8ac399bbd34d5aac25b31879a8f59c'); //FL_CLABE_TRANSFERENCIA
            } elseif (null == $request->input('ctla50078a3588d48e9b63d6d5ee1291712_0b8ac399bbd34d5aac25b31879a8f59c')) {
                $tb->FL_CLABE_TRANSFERENCIA = null;
            }

            if (null != $request->input('ctlf47039d15a0341c8a17c96bb5a77f71d_0b8ac399bbd34d5aac25b31879a8f59c')) {
                $tb->FL_CUENTA_BANCARIA = $request->input('ctlf47039d15a0341c8a17c96bb5a77f71d_0b8ac399bbd34d5aac25b31879a8f59c'); //FL_CUENTA_BANCARIA
            } elseif (null == $request->input('ctlf47039d15a0341c8a17c96bb5a77f71d_0b8ac399bbd34d5aac25b31879a8f59c')) {
                $tb->FL_CUENTA_BANCARIA = null;
            }

            if (null != $request->input('ctl8a78ba6baecc4e5b8ab65e933913d1f1_0b8ac399bbd34d5aac25b31879a8f59c')) {
                $tb->FK_BANCO = $request->input('ctl8a78ba6baecc4e5b8ab65e933913d1f1_0b8ac399bbd34d5aac25b31879a8f59c'); //FK_BANCO
            } elseif (null == $request->input('ctl8a78ba6baecc4e5b8ab65e933913d1f1_0b8ac399bbd34d5aac25b31879a8f59c')) {
                $tb->FK_BANCO = null;
            }

            if (null != $request->input('ctlaa79d58556614f9f8558cc3017b8fd89_0b8ac399bbd34d5aac25b31879a8f59c')) {
                $tb->FK_FORMA_PAGO = $request->input('ctlaa79d58556614f9f8558cc3017b8fd89_0b8ac399bbd34d5aac25b31879a8f59c'); //FK_FORMA_PAGO
            } elseif (null == $request->input('ctlaa79d58556614f9f8558cc3017b8fd89_0b8ac399bbd34d5aac25b31879a8f59c')) {
                $tb->FK_FORMA_PAGO = null;
            }
    ...
    public function index(Request $request)
    {
        ...
        $par6185a7056560433494dba94e9ae591072a3df81f4e364997b21c76f4c114e72f = 0;

        if (null == $par6185a7056560433494dba94e9ae591072a3df81f4e364997b21c76f4c114e72f) {
            $par6185a7056560433494dba94e9ae591072a3df81f4e364997b21c76f4c114e72f = '0';
        }

        $par0a0ce2af85ab462a808e0270326fb8602a3df81f4e364997b21c76f4c114e72f = 0;

        if (null == $par0a0ce2af85ab462a808e0270326fb8602a3df81f4e364997b21c76f4c114e72f) {
            $par0a0ce2af85ab462a808e0270326fb8602a3df81f4e364997b21c76f4c114e72f = '0';
        }

        $par5551ae677d6b488ebd38625d0f5d9fce2a3df81f4e364997b21c76f4c114e72f = '';

        if ('-' == $par5551ae677d6b488ebd38625d0f5d9fce2a3df81f4e364997b21c76f4c114e72f) {
            $par5551ae677d6b488ebd38625d0f5d9fce2a3df81f4e364997b21c76f4c114e72f = null;
        }

        if (null == $par5551ae677d6b488ebd38625d0f5d9fce2a3df81f4e364997b21c76f4c114e72f) {
            $par5551ae677d6b488ebd38625d0f5d9fce2a3df81f4e364997b21c76f4c114e72f = '';
        }

        $par8fce8a73ac264e4a8f3b56d8b991b8a52a3df81f4e364997b21c76f4c114e72f = '';

        if ('-' == $par8fce8a73ac264e4a8f3b56d8b991b8a52a3df81f4e364997b21c76f4c114e72f) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a52a3df81f4e364997b21c76f4c114e72f = null;
        }

        if (null == $par8fce8a73ac264e4a8f3b56d8b991b8a52a3df81f4e364997b21c76f4c114e72f) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a52a3df81f4e364997b21c76f4c114e72f = '';
        }

        $v2a3df81f4e364997b21c76f4c114e72f = \App\repf782f923fd0247bd9f4010b717e52999::mt2060f98099844820b4d7c107cdea42c5($par6185a7056560433494dba94e9ae591072a3df81f4e364997b21c76f4c114e72f, $par0a0ce2af85ab462a808e0270326fb8602a3df81f4e364997b21c76f4c114e72f, $par5551ae677d6b488ebd38625d0f5d9fce2a3df81f4e364997b21c76f4c114e72f, $par8fce8a73ac264e4a8f3b56d8b991b8a52a3df81f4e364997b21c76f4c114e72f);

        $v2a3df81f4e364997b21c76f4c114e72fAjax = \URL::to('/').'/api/2060f98099844820b4d7c107cdea42c5/{page}/{pagesize}/{orderColumn}/{orderType}';

        // Lista Forma de Pago - Lista Forma de Pago

        $par6185a7056560433494dba94e9ae5910746a9fdaca2e9423988d4cd4062818e82 = 0;

        if (null == $par6185a7056560433494dba94e9ae5910746a9fdaca2e9423988d4cd4062818e82) {
            $par6185a7056560433494dba94e9ae5910746a9fdaca2e9423988d4cd4062818e82 = '0';
        }

        $par0a0ce2af85ab462a808e0270326fb86046a9fdaca2e9423988d4cd4062818e82 = 0;

        if (null == $par0a0ce2af85ab462a808e0270326fb86046a9fdaca2e9423988d4cd4062818e82) {
            $par0a0ce2af85ab462a808e0270326fb86046a9fdaca2e9423988d4cd4062818e82 = '0';
        }

        $par5551ae677d6b488ebd38625d0f5d9fce46a9fdaca2e9423988d4cd4062818e82 = '';

        if ('-' == $par5551ae677d6b488ebd38625d0f5d9fce46a9fdaca2e9423988d4cd4062818e82) {
            $par5551ae677d6b488ebd38625d0f5d9fce46a9fdaca2e9423988d4cd4062818e82 = null;
        }

        if (null == $par5551ae677d6b488ebd38625d0f5d9fce46a9fdaca2e9423988d4cd4062818e82) {
            $par5551ae677d6b488ebd38625d0f5d9fce46a9fdaca2e9423988d4cd4062818e82 = '';
        }

        $par8fce8a73ac264e4a8f3b56d8b991b8a546a9fdaca2e9423988d4cd4062818e82 = '';

        if ('-' == $par8fce8a73ac264e4a8f3b56d8b991b8a546a9fdaca2e9423988d4cd4062818e82) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a546a9fdaca2e9423988d4cd4062818e82 = null;
        }

        if (null == $par8fce8a73ac264e4a8f3b56d8b991b8a546a9fdaca2e9423988d4cd4062818e82) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a546a9fdaca2e9423988d4cd4062818e82 = '';
        }

        $v46a9fdaca2e9423988d4cd4062818e82 = \App\repf782f923fd0247bd9f4010b717e52999::mtd0c4777555334065bbc2eb29c13aba00($par6185a7056560433494dba94e9ae5910746a9fdaca2e9423988d4cd4062818e82, $par0a0ce2af85ab462a808e0270326fb86046a9fdaca2e9423988d4cd4062818e82, $par5551ae677d6b488ebd38625d0f5d9fce46a9fdaca2e9423988d4cd4062818e82, $par8fce8a73ac264e4a8f3b56d8b991b8a546a9fdaca2e9423988d4cd4062818e82);

        $v46a9fdaca2e9423988d4cd4062818e82Ajax = \URL::to('/').'/api/d0c4777555334065bbc2eb29c13aba00/{page}/{pagesize}/{orderColumn}/{orderType}';
        ...
        $par6185a7056560433494dba94e9ae591070df81e23cd644a118c884e7ff070b025 = 0;

        if (null == $par6185a7056560433494dba94e9ae591070df81e23cd644a118c884e7ff070b025) {
            $par6185a7056560433494dba94e9ae591070df81e23cd644a118c884e7ff070b025 = '0';
        }

        $par0a0ce2af85ab462a808e0270326fb8600df81e23cd644a118c884e7ff070b025 = 0;

        if (null == $par0a0ce2af85ab462a808e0270326fb8600df81e23cd644a118c884e7ff070b025) {
            $par0a0ce2af85ab462a808e0270326fb8600df81e23cd644a118c884e7ff070b025 = '0';
        }

        $par5551ae677d6b488ebd38625d0f5d9fce0df81e23cd644a118c884e7ff070b025 = '';

        if ('-' == $par5551ae677d6b488ebd38625d0f5d9fce0df81e23cd644a118c884e7ff070b025) {
            $par5551ae677d6b488ebd38625d0f5d9fce0df81e23cd644a118c884e7ff070b025 = null;
        }

        if (null == $par5551ae677d6b488ebd38625d0f5d9fce0df81e23cd644a118c884e7ff070b025) {
            $par5551ae677d6b488ebd38625d0f5d9fce0df81e23cd644a118c884e7ff070b025 = '';
        }

        $par8fce8a73ac264e4a8f3b56d8b991b8a50df81e23cd644a118c884e7ff070b025 = '';

        if ('-' == $par8fce8a73ac264e4a8f3b56d8b991b8a50df81e23cd644a118c884e7ff070b025) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a50df81e23cd644a118c884e7ff070b025 = null;
        }

        if (null == $par8fce8a73ac264e4a8f3b56d8b991b8a50df81e23cd644a118c884e7ff070b025) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a50df81e23cd644a118c884e7ff070b025 = '';
        }

        $v0df81e23cd644a118c884e7ff070b025 = \App\repf782f923fd0247bd9f4010b717e52999::mt87f3ff2a9cc344c58921f820b898209f($par81d62592acd84ddb8e7915b8e90881d2, $par6185a7056560433494dba94e9ae591070df81e23cd644a118c884e7ff070b025, $par0a0ce2af85ab462a808e0270326fb8600df81e23cd644a118c884e7ff070b025, $par5551ae677d6b488ebd38625d0f5d9fce0df81e23cd644a118c884e7ff070b025, $par8fce8a73ac264e4a8f3b56d8b991b8a50df81e23cd644a118c884e7ff070b025);

        $v0df81e23cd644a118c884e7ff070b025Ajax = \URL::to('/').'/api/87f3ff2a9cc344c58921f820b898209f/'.(null == $par81d62592acd84ddb8e7915b8e90881d2 ? '-' : ('' == $par81d62592acd84ddb8e7915b8e90881d2 ? '-' : $par81d62592acd84ddb8e7915b8e90881d2)).'/{page}/{pagesize}/{orderColumn}/{orderType}';
        ...
        $arrWiths['v2a3df81f4e364997b21c76f4c114e72f'] = isset($v2a3df81f4e364997b21c76f4c114e72f) ? $v2a3df81f4e364997b21c76f4c114e72f : '';
        $arrWiths['v2a3df81f4e364997b21c76f4c114e72fAjax'] = isset($v2a3df81f4e364997b21c76f4c114e72fAjax) ? $v2a3df81f4e364997b21c76f4c114e72fAjax : '';
        $arrWiths['v46a9fdaca2e9423988d4cd4062818e82'] = isset($v46a9fdaca2e9423988d4cd4062818e82) ? $v46a9fdaca2e9423988d4cd4062818e82 : '';
        $arrWiths['v46a9fdaca2e9423988d4cd4062818e82Ajax'] = isset($v46a9fdaca2e9423988d4cd4062818e82Ajax) ? $v46a9fdaca2e9423988d4cd4062818e82Ajax : '';
        $arrWiths['v0df81e23cd644a118c884e7ff070b025'] = isset($v0df81e23cd644a118c884e7ff070b025) ? $v0df81e23cd644a118c884e7ff070b025 : '';
        $arrWiths['v0df81e23cd644a118c884e7ff070b025Ajax'] = isset($v0df81e23cd644a118c884e7ff070b025Ajax) ? $v0df81e23cd644a118c884e7ff070b025Ajax : '';
        ...
        $response = new \Illuminate\Http\Response(view('6992b8c6a8e549248b73c33e1614804c.Index', $arrWiths)->with('title', $arrWiths['title'])->with('vSessionTimeout', \Config::get('session.lifetime') * 60));
