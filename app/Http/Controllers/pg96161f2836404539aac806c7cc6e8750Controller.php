...
// Creado               martes, 27 de junio de 2023 17:56:46
...
/**
 * estadosGrid - Tabla de datos Estados.
 */
class pg96161f2836404539aac806c7cc6e8750Controller extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        $par6185a7056560433494dba94e9ae59107f3de06921c9d40178330af927eecde42 = 0;

        if (null == $par6185a7056560433494dba94e9ae59107f3de06921c9d40178330af927eecde42) {
            $par6185a7056560433494dba94e9ae59107f3de06921c9d40178330af927eecde42 = '0';
        }

        $par0a0ce2af85ab462a808e0270326fb860f3de06921c9d40178330af927eecde42 = 0;

        if (null == $par0a0ce2af85ab462a808e0270326fb860f3de06921c9d40178330af927eecde42) {
            $par0a0ce2af85ab462a808e0270326fb860f3de06921c9d40178330af927eecde42 = '0';
        }

        $par5551ae677d6b488ebd38625d0f5d9fcef3de06921c9d40178330af927eecde42 = '';

        if ('-' == $par5551ae677d6b488ebd38625d0f5d9fcef3de06921c9d40178330af927eecde42) {
            $par5551ae677d6b488ebd38625d0f5d9fcef3de06921c9d40178330af927eecde42 = null;
        }

        if (null == $par5551ae677d6b488ebd38625d0f5d9fcef3de06921c9d40178330af927eecde42) {
            $par5551ae677d6b488ebd38625d0f5d9fcef3de06921c9d40178330af927eecde42 = '';
        }

        $par8fce8a73ac264e4a8f3b56d8b991b8a5f3de06921c9d40178330af927eecde42 = '';

        if ('-' == $par8fce8a73ac264e4a8f3b56d8b991b8a5f3de06921c9d40178330af927eecde42) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a5f3de06921c9d40178330af927eecde42 = null;
        }

        if (null == $par8fce8a73ac264e4a8f3b56d8b991b8a5f3de06921c9d40178330af927eecde42) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a5f3de06921c9d40178330af927eecde42 = '';
        }

        $vf3de06921c9d40178330af927eecde42 = \App\repf782f923fd0247bd9f4010b717e52999::mtabea1b31ebd541018e0ac1aeeb09858a($par6185a7056560433494dba94e9ae59107f3de06921c9d40178330af927eecde42, $par0a0ce2af85ab462a808e0270326fb860f3de06921c9d40178330af927eecde42, $par5551ae677d6b488ebd38625d0f5d9fcef3de06921c9d40178330af927eecde42, $par8fce8a73ac264e4a8f3b56d8b991b8a5f3de06921c9d40178330af927eecde42);

        $vf3de06921c9d40178330af927eecde42Ajax = \URL::to('/').'/api/abea1b31ebd541018e0ac1aeeb09858a/{page}/{pagesize}/{orderColumn}/{orderType}';

        // Modelador Estados - Modelador Estados

        $par228a80b706e845d8a2d22a860d88c01e = $request->input('regiones');

        if (null == $par228a80b706e845d8a2d22a860d88c01e) {
            $par228a80b706e845d8a2d22a860d88c01e = '0';
        }

        $par6185a7056560433494dba94e9ae5910729d5fb99d0d64e46a79e97e10d486258 = 0;

        if (null == $par6185a7056560433494dba94e9ae5910729d5fb99d0d64e46a79e97e10d486258) {
            $par6185a7056560433494dba94e9ae5910729d5fb99d0d64e46a79e97e10d486258 = '0';
        }

        $par0a0ce2af85ab462a808e0270326fb86029d5fb99d0d64e46a79e97e10d486258 = 0;

        if (null == $par0a0ce2af85ab462a808e0270326fb86029d5fb99d0d64e46a79e97e10d486258) {
            $par0a0ce2af85ab462a808e0270326fb86029d5fb99d0d64e46a79e97e10d486258 = '0';
        }

        $par5551ae677d6b488ebd38625d0f5d9fce29d5fb99d0d64e46a79e97e10d486258 = '';

        if ('-' == $par5551ae677d6b488ebd38625d0f5d9fce29d5fb99d0d64e46a79e97e10d486258) {
            $par5551ae677d6b488ebd38625d0f5d9fce29d5fb99d0d64e46a79e97e10d486258 = null;
        }

        if (null == $par5551ae677d6b488ebd38625d0f5d9fce29d5fb99d0d64e46a79e97e10d486258) {
            $par5551ae677d6b488ebd38625d0f5d9fce29d5fb99d0d64e46a79e97e10d486258 = '';
        }

        $par8fce8a73ac264e4a8f3b56d8b991b8a529d5fb99d0d64e46a79e97e10d486258 = '';

        if ('-' == $par8fce8a73ac264e4a8f3b56d8b991b8a529d5fb99d0d64e46a79e97e10d486258) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a529d5fb99d0d64e46a79e97e10d486258 = null;
        }

        if (null == $par8fce8a73ac264e4a8f3b56d8b991b8a529d5fb99d0d64e46a79e97e10d486258) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a529d5fb99d0d64e46a79e97e10d486258 = '';
        }

        $v29d5fb99d0d64e46a79e97e10d486258Ajax = \URL::to('/').'/api/9610894d477640eeb7d8beb0b86f7a72/'.(null == $par228a80b706e845d8a2d22a860d88c01e ? '-' : ('' == $par228a80b706e845d8a2d22a860d88c01e ? '-' : $par228a80b706e845d8a2d22a860d88c01e)).'/{page}/{pagesize}/{orderColumn}/{orderType}';

        // Modelador Estados - Modelador Estados

        $v29d5fb99d0d64e46a79e97e10d486258Count = \App\repf782f923fd0247bd9f4010b717e52999::mt9610894d477640eeb7d8beb0b86f7a72Count($par228a80b706e845d8a2d22a860d88c01e, $par6185a7056560433494dba94e9ae5910729d5fb99d0d64e46a79e97e10d486258, $par0a0ce2af85ab462a808e0270326fb86029d5fb99d0d64e46a79e97e10d486258, $par5551ae677d6b488ebd38625d0f5d9fce29d5fb99d0d64e46a79e97e10d486258, $par8fce8a73ac264e4a8f3b56d8b991b8a529d5fb99d0d64e46a79e97e10d486258);

        //$v29d5fb99d0d64e46a79e97e10d486258CountAjax =  \URL::to('/')."/api/9610894d477640eeb7d8beb0b86f7a72Count{ParametersAjax}/{page}/{pagesize}/{orderColumn}/{orderType}";

        // Recuperar Region - Recuperar Region

        $parb638ec701c4a476286f3c2ad493e9ce9 = $request->input('regiones');

        if (null == $parb638ec701c4a476286f3c2ad493e9ce9) {
            $parb638ec701c4a476286f3c2ad493e9ce9 = '0';
        }

        $par6185a7056560433494dba94e9ae59107b53e650e4e254c1382963a3f411d2797 = 0;

        if (null == $par6185a7056560433494dba94e9ae59107b53e650e4e254c1382963a3f411d2797) {
            $par6185a7056560433494dba94e9ae59107b53e650e4e254c1382963a3f411d2797 = '0';
        }

        $par0a0ce2af85ab462a808e0270326fb860b53e650e4e254c1382963a3f411d2797 = 0;

        if (null == $par0a0ce2af85ab462a808e0270326fb860b53e650e4e254c1382963a3f411d2797) {
            $par0a0ce2af85ab462a808e0270326fb860b53e650e4e254c1382963a3f411d2797 = '0';
        }

        $par5551ae677d6b488ebd38625d0f5d9fceb53e650e4e254c1382963a3f411d2797 = '';

        if ('-' == $par5551ae677d6b488ebd38625d0f5d9fceb53e650e4e254c1382963a3f411d2797) {
            $par5551ae677d6b488ebd38625d0f5d9fceb53e650e4e254c1382963a3f411d2797 = null;
        }

        if (null == $par5551ae677d6b488ebd38625d0f5d9fceb53e650e4e254c1382963a3f411d2797) {
            $par5551ae677d6b488ebd38625d0f5d9fceb53e650e4e254c1382963a3f411d2797 = '';
        }

        $par8fce8a73ac264e4a8f3b56d8b991b8a5b53e650e4e254c1382963a3f411d2797 = '';

        if ('-' == $par8fce8a73ac264e4a8f3b56d8b991b8a5b53e650e4e254c1382963a3f411d2797) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a5b53e650e4e254c1382963a3f411d2797 = null;
        }

        if (null == $par8fce8a73ac264e4a8f3b56d8b991b8a5b53e650e4e254c1382963a3f411d2797) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a5b53e650e4e254c1382963a3f411d2797 = '';
        }

        $vb53e650e4e254c1382963a3f411d2797 = \App\repf782f923fd0247bd9f4010b717e52999::mtc55363199cd64a5888f4f137f1d94426($parb638ec701c4a476286f3c2ad493e9ce9, $par6185a7056560433494dba94e9ae59107b53e650e4e254c1382963a3f411d2797, $par0a0ce2af85ab462a808e0270326fb860b53e650e4e254c1382963a3f411d2797, $par5551ae677d6b488ebd38625d0f5d9fceb53e650e4e254c1382963a3f411d2797, $par8fce8a73ac264e4a8f3b56d8b991b8a5b53e650e4e254c1382963a3f411d2797);

        $vb53e650e4e254c1382963a3f411d2797Ajax = \URL::to('/').'/api/c55363199cd64a5888f4f137f1d94426/'.(null == $parb638ec701c4a476286f3c2ad493e9ce9 ? '-' : ('' == $parb638ec701c4a476286f3c2ad493e9ce9 ? '-' : $parb638ec701c4a476286f3c2ad493e9ce9)).'/{page}/{pagesize}/{orderColumn}/{orderType}';
        ...
        $v93bc922499564b12b8d9ee66aef570b3 = '';
        $v93bc922499564b12b8d9ee66aef570b3Total = (isset($v29d5fb99d0d64e46a79e97e10d486258Count) ? $v29d5fb99d0d64e46a79e97e10d486258Count : 0);
        $v93bc922499564b12b8d9ee66aef570b3Ajax = (isset($v29d5fb99d0d64e46a79e97e10d486258Ajax) ? $v29d5fb99d0d64e46a79e97e10d486258Ajax : '');

        $arrWiths['vf3de06921c9d40178330af927eecde42'] = isset($vf3de06921c9d40178330af927eecde42) ? $vf3de06921c9d40178330af927eecde42 : '';
        $arrWiths['vf3de06921c9d40178330af927eecde42Ajax'] = isset($vf3de06921c9d40178330af927eecde42Ajax) ? $vf3de06921c9d40178330af927eecde42Ajax : '';
        $arrWiths['v29d5fb99d0d64e46a79e97e10d486258Count'] = isset($v29d5fb99d0d64e46a79e97e10d486258Count) ? $v29d5fb99d0d64e46a79e97e10d486258Count : '';
        $arrWiths['v29d5fb99d0d64e46a79e97e10d486258Ajax'] = isset($v29d5fb99d0d64e46a79e97e10d486258Ajax) ? $v29d5fb99d0d64e46a79e97e10d486258Ajax : '';
        $arrWiths['vb53e650e4e254c1382963a3f411d2797'] = isset($vb53e650e4e254c1382963a3f411d2797) ? $vb53e650e4e254c1382963a3f411d2797 : '';
        $arrWiths['vb53e650e4e254c1382963a3f411d2797Ajax'] = isset($vb53e650e4e254c1382963a3f411d2797Ajax) ? $vb53e650e4e254c1382963a3f411d2797Ajax : '';
        ...
        $arrWiths['v93bc922499564b12b8d9ee66aef570b3'] = isset($v93bc922499564b12b8d9ee66aef570b3) ? $v93bc922499564b12b8d9ee66aef570b3 : '';
        $arrWiths['v93bc922499564b12b8d9ee66aef570b3Total'] = isset($v93bc922499564b12b8d9ee66aef570b3Total) ? $v93bc922499564b12b8d9ee66aef570b3Total : '';
        $arrWiths['v93bc922499564b12b8d9ee66aef570b3Ajax'] = isset($v93bc922499564b12b8d9ee66aef570b3Ajax) ? $v93bc922499564b12b8d9ee66aef570b3Ajax : '';
        ...
        $response = new \Illuminate\Http\Response(view('96161f2836404539aac806c7cc6e8750.Index', $arrWiths)->with('title', $arrWiths['title'])->with('vSessionTimeout', \Config::get('session.lifetime') * 60));
