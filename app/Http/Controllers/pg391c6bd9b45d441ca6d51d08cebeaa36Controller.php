...
/**
 * detallecataogos - detallecataogos.
 */
class pg391c6bd9b45d441ca6d51d08cebeaa36Controller extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        $parc5047ec7ff5741edbe7275120eade79d1 = $request->session()->get('ses5e122755c3a24f5d8789755168e9de27');

        if (null == $parc5047ec7ff5741edbe7275120eade79d1) {
            $parc5047ec7ff5741edbe7275120eade79d1 = '0';
        }

        $vb8c91d3ac2f74246a103795e5e4bc0da = \App\repf782f923fd0247bd9f4010b717e52999::mt7d2563f12d3a4875b0f20bbd03ae0718($parc5047ec7ff5741edbe7275120eade79d1);

        $vb8c91d3ac2f74246a103795e5e4bc0daAjax = \URL::to('/').'/api/7d2563f12d3a4875b0f20bbd03ae0718/'.(null == $parc5047ec7ff5741edbe7275120eade79d1 ? '-' : ('' == $parc5047ec7ff5741edbe7275120eade79d1 ? '-' : $parc5047ec7ff5741edbe7275120eade79d1)).'/{page}/{pagesize}/{orderColumn}/{orderType}';
        ...
        $arrWiths['vb8c91d3ac2f74246a103795e5e4bc0da'] = isset($vb8c91d3ac2f74246a103795e5e4bc0da) ? $vb8c91d3ac2f74246a103795e5e4bc0da : '';
        ...
        $response = new \Illuminate\Http\Response(view('391c6bd9b45d441ca6d51d08cebeaa36.Index', $arrWiths)->with('title', $arrWiths['title'])->with('vSessionTimeout', \Config::get('session.lifetime') * 60));
