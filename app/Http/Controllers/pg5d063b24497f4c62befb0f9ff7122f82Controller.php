...
// Creado               martes, 27 de junio de 2023 17:57:18
 ...
 */
class pg5d063b24497f4c62befb0f9ff7122f82Controller extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        // Lista centros de acopio precios - Lista centros de acopio precios

        $pardd3780b5691843b4b7e62ed23891ccc6 = $request->input('estimulo');

        if (null == $pardd3780b5691843b4b7e62ed23891ccc6) {
            $pardd3780b5691843b4b7e62ed23891ccc6 = '0';
        }

        $par6185a7056560433494dba94e9ae59107eaa1ac184ff44d2f9734591e2dd4ceee = 0;

        if (null == $par6185a7056560433494dba94e9ae59107eaa1ac184ff44d2f9734591e2dd4ceee) {
            $par6185a7056560433494dba94e9ae59107eaa1ac184ff44d2f9734591e2dd4ceee = '0';
        }

        $par0a0ce2af85ab462a808e0270326fb860eaa1ac184ff44d2f9734591e2dd4ceee = 0;

        if (null == $par0a0ce2af85ab462a808e0270326fb860eaa1ac184ff44d2f9734591e2dd4ceee) {
            $par0a0ce2af85ab462a808e0270326fb860eaa1ac184ff44d2f9734591e2dd4ceee = '0';
        }

        $par5551ae677d6b488ebd38625d0f5d9fceeaa1ac184ff44d2f9734591e2dd4ceee = '';

        if ('-' == $par5551ae677d6b488ebd38625d0f5d9fceeaa1ac184ff44d2f9734591e2dd4ceee) {
            $par5551ae677d6b488ebd38625d0f5d9fceeaa1ac184ff44d2f9734591e2dd4ceee = null;
        }

        if (null == $par5551ae677d6b488ebd38625d0f5d9fceeaa1ac184ff44d2f9734591e2dd4ceee) {
            $par5551ae677d6b488ebd38625d0f5d9fceeaa1ac184ff44d2f9734591e2dd4ceee = '';
        }

        $par8fce8a73ac264e4a8f3b56d8b991b8a5eaa1ac184ff44d2f9734591e2dd4ceee = '';

        if ('-' == $par8fce8a73ac264e4a8f3b56d8b991b8a5eaa1ac184ff44d2f9734591e2dd4ceee) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a5eaa1ac184ff44d2f9734591e2dd4ceee = null;
        }

        if (null == $par8fce8a73ac264e4a8f3b56d8b991b8a5eaa1ac184ff44d2f9734591e2dd4ceee) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a5eaa1ac184ff44d2f9734591e2dd4ceee = '';
        }

        $veaa1ac184ff44d2f9734591e2dd4ceeeAjax = \URL::to('/')."/api/ae8e9cfbd4174125aa0ae9597c5ded2f/'+encodeURIComponent((($('#ctlf629596e10c040759fdb8c929935e636_4e9ca835c3a54396a53138a63f5f6549{Extra}').val() == '' ? '-' : $('#ctlf629596e10c040759fdb8c929935e636_4e9ca835c3a54396a53138a63f5f6549{Extra}').val()) != undefined && ($('#ctlf629596e10c040759fdb8c929935e636_4e9ca835c3a54396a53138a63f5f6549{Extra}').val() == '' ? '-' : $('#ctlf629596e10c040759fdb8c929935e636_4e9ca835c3a54396a53138a63f5f6549{Extra}').val()).length > 0 ? ($('#ctlf629596e10c040759fdb8c929935e636_4e9ca835c3a54396a53138a63f5f6549{Extra}').val() == '' ? '-' : $('#ctlf629596e10c040759fdb8c929935e636_4e9ca835c3a54396a53138a63f5f6549{Extra}').val()).replace(/\\./g,'---').replace(/\\//g,'___') : ($('#ctlf629596e10c040759fdb8c929935e636_4e9ca835c3a54396a53138a63f5f6549{Extra}').val() == '' ? '-' : $('#ctlf629596e10c040759fdb8c929935e636_4e9ca835c3a54396a53138a63f5f6549{Extra}').val())))+'/{page}/{pagesize}/{orderColumn}/{orderType}";

        // Lista centros de trabajo precios - Lista centros de trabajo precios

        $par4bf6a056ccbc4668908ee1961f073ffb = $request->input('estimulo');

        if (null == $par4bf6a056ccbc4668908ee1961f073ffb) {
            $par4bf6a056ccbc4668908ee1961f073ffb = '0';
        }

        $par6185a7056560433494dba94e9ae5910738a6f9eb4c9a454da52fc403a54de2c8 = 0;

        if (null == $par6185a7056560433494dba94e9ae5910738a6f9eb4c9a454da52fc403a54de2c8) {
            $par6185a7056560433494dba94e9ae5910738a6f9eb4c9a454da52fc403a54de2c8 = '0';
        }

        $par0a0ce2af85ab462a808e0270326fb86038a6f9eb4c9a454da52fc403a54de2c8 = 0;

        if (null == $par0a0ce2af85ab462a808e0270326fb86038a6f9eb4c9a454da52fc403a54de2c8) {
            $par0a0ce2af85ab462a808e0270326fb86038a6f9eb4c9a454da52fc403a54de2c8 = '0';
        }

        $par5551ae677d6b488ebd38625d0f5d9fce38a6f9eb4c9a454da52fc403a54de2c8 = '';

        if ('-' == $par5551ae677d6b488ebd38625d0f5d9fce38a6f9eb4c9a454da52fc403a54de2c8) {
            $par5551ae677d6b488ebd38625d0f5d9fce38a6f9eb4c9a454da52fc403a54de2c8 = null;
        }

        if (null == $par5551ae677d6b488ebd38625d0f5d9fce38a6f9eb4c9a454da52fc403a54de2c8) {
            $par5551ae677d6b488ebd38625d0f5d9fce38a6f9eb4c9a454da52fc403a54de2c8 = '';
        }

        $par8fce8a73ac264e4a8f3b56d8b991b8a538a6f9eb4c9a454da52fc403a54de2c8 = '';

        if ('-' == $par8fce8a73ac264e4a8f3b56d8b991b8a538a6f9eb4c9a454da52fc403a54de2c8) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a538a6f9eb4c9a454da52fc403a54de2c8 = null;
        }

        if (null == $par8fce8a73ac264e4a8f3b56d8b991b8a538a6f9eb4c9a454da52fc403a54de2c8) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a538a6f9eb4c9a454da52fc403a54de2c8 = '';
        }

        $v38a6f9eb4c9a454da52fc403a54de2c8Ajax = \URL::to('/')."/api/5a1d9d566ef8489daca48684bc6e3ba1/'+encodeURIComponent((($('#ctl75a6e0797cc54d8d828a39dfda3307fe_4e9ca835c3a54396a53138a63f5f6549{Extra}').val() == '' ? '-' : $('#ctl75a6e0797cc54d8d828a39dfda3307fe_4e9ca835c3a54396a53138a63f5f6549{Extra}').val()) != undefined && ($('#ctl75a6e0797cc54d8d828a39dfda3307fe_4e9ca835c3a54396a53138a63f5f6549{Extra}').val() == '' ? '-' : $('#ctl75a6e0797cc54d8d828a39dfda3307fe_4e9ca835c3a54396a53138a63f5f6549{Extra}').val()).length > 0 ? ($('#ctl75a6e0797cc54d8d828a39dfda3307fe_4e9ca835c3a54396a53138a63f5f6549{Extra}').val() == '' ? '-' : $('#ctl75a6e0797cc54d8d828a39dfda3307fe_4e9ca835c3a54396a53138a63f5f6549{Extra}').val()).replace(/\\./g,'---').replace(/\\//g,'___') : ($('#ctl75a6e0797cc54d8d828a39dfda3307fe_4e9ca835c3a54396a53138a63f5f6549{Extra}').val() == '' ? '-' : $('#ctl75a6e0797cc54d8d828a39dfda3307fe_4e9ca835c3a54396a53138a63f5f6549{Extra}').val())))+'/{page}/{pagesize}/{orderColumn}/{orderType}";

        // Lista de Activo Inactive - Lista de Activo Inactive

        $par6185a7056560433494dba94e9ae5910711e6ea5f82be4ec5b492494e701d82cc = 0;

        if (null == $par6185a7056560433494dba94e9ae5910711e6ea5f82be4ec5b492494e701d82cc) {
            $par6185a7056560433494dba94e9ae5910711e6ea5f82be4ec5b492494e701d82cc = '0';
        }

        $par0a0ce2af85ab462a808e0270326fb86011e6ea5f82be4ec5b492494e701d82cc = 0;

        if (null == $par0a0ce2af85ab462a808e0270326fb86011e6ea5f82be4ec5b492494e701d82cc) {
            $par0a0ce2af85ab462a808e0270326fb86011e6ea5f82be4ec5b492494e701d82cc = '0';
        }

        $par5551ae677d6b488ebd38625d0f5d9fce11e6ea5f82be4ec5b492494e701d82cc = '';

        if ('-' == $par5551ae677d6b488ebd38625d0f5d9fce11e6ea5f82be4ec5b492494e701d82cc) {
            $par5551ae677d6b488ebd38625d0f5d9fce11e6ea5f82be4ec5b492494e701d82cc = null;
        }

        if (null == $par5551ae677d6b488ebd38625d0f5d9fce11e6ea5f82be4ec5b492494e701d82cc) {
            $par5551ae677d6b488ebd38625d0f5d9fce11e6ea5f82be4ec5b492494e701d82cc = '';
        }

        $par8fce8a73ac264e4a8f3b56d8b991b8a511e6ea5f82be4ec5b492494e701d82cc = '';

        if ('-' == $par8fce8a73ac264e4a8f3b56d8b991b8a511e6ea5f82be4ec5b492494e701d82cc) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a511e6ea5f82be4ec5b492494e701d82cc = null;
        }

        if (null == $par8fce8a73ac264e4a8f3b56d8b991b8a511e6ea5f82be4ec5b492494e701d82cc) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a511e6ea5f82be4ec5b492494e701d82cc = '';
        }

        $v11e6ea5f82be4ec5b492494e701d82cc = \App\repf782f923fd0247bd9f4010b717e52999::mt30537a680d42439baf88e670eb555322($par6185a7056560433494dba94e9ae5910711e6ea5f82be4ec5b492494e701d82cc, $par0a0ce2af85ab462a808e0270326fb86011e6ea5f82be4ec5b492494e701d82cc, $par5551ae677d6b488ebd38625d0f5d9fce11e6ea5f82be4ec5b492494e701d82cc, $par8fce8a73ac264e4a8f3b56d8b991b8a511e6ea5f82be4ec5b492494e701d82cc);

        $v11e6ea5f82be4ec5b492494e701d82ccAjax = \URL::to('/').'/api/30537a680d42439baf88e670eb555322/{page}/{pagesize}/{orderColumn}/{orderType}';

        // Lista de estados precios - Lista de estados precios

        $par228a80b706e845d8a2d22a860d88c01e = $request->input('estimulo');

        if (null == $par228a80b706e845d8a2d22a860d88c01e) {
            $par228a80b706e845d8a2d22a860d88c01e = '0';
        }

        $par6185a7056560433494dba94e9ae59107eb612457addf4a309bc294bd4dad0613 = 0;

        if (null == $par6185a7056560433494dba94e9ae59107eb612457addf4a309bc294bd4dad0613) {
            $par6185a7056560433494dba94e9ae59107eb612457addf4a309bc294bd4dad0613 = '0';
        }

        $par0a0ce2af85ab462a808e0270326fb860eb612457addf4a309bc294bd4dad0613 = 0;

        if (null == $par0a0ce2af85ab462a808e0270326fb860eb612457addf4a309bc294bd4dad0613) {
            $par0a0ce2af85ab462a808e0270326fb860eb612457addf4a309bc294bd4dad0613 = '0';
        }

        $par5551ae677d6b488ebd38625d0f5d9fceeb612457addf4a309bc294bd4dad0613 = '';

        if ('-' == $par5551ae677d6b488ebd38625d0f5d9fceeb612457addf4a309bc294bd4dad0613) {
            $par5551ae677d6b488ebd38625d0f5d9fceeb612457addf4a309bc294bd4dad0613 = null;
        }

        if (null == $par5551ae677d6b488ebd38625d0f5d9fceeb612457addf4a309bc294bd4dad0613) {
            $par5551ae677d6b488ebd38625d0f5d9fceeb612457addf4a309bc294bd4dad0613 = '';
        }

        $par8fce8a73ac264e4a8f3b56d8b991b8a5eb612457addf4a309bc294bd4dad0613 = '';

        if ('-' == $par8fce8a73ac264e4a8f3b56d8b991b8a5eb612457addf4a309bc294bd4dad0613) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a5eb612457addf4a309bc294bd4dad0613 = null;
        }

        if (null == $par8fce8a73ac264e4a8f3b56d8b991b8a5eb612457addf4a309bc294bd4dad0613) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a5eb612457addf4a309bc294bd4dad0613 = '';
        }

        $veb612457addf4a309bc294bd4dad0613Ajax = \URL::to('/')."/api/9610894d477640eeb7d8beb0b86f7a72/'+encodeURIComponent((($('#ctlaf0a4f5c93304cf2a7d17a57a85dd15b_4e9ca835c3a54396a53138a63f5f6549{Extra}').val() == '' ? '-' : $('#ctlaf0a4f5c93304cf2a7d17a57a85dd15b_4e9ca835c3a54396a53138a63f5f6549{Extra}').val()) != undefined && ($('#ctlaf0a4f5c93304cf2a7d17a57a85dd15b_4e9ca835c3a54396a53138a63f5f6549{Extra}').val() == '' ? '-' : $('#ctlaf0a4f5c93304cf2a7d17a57a85dd15b_4e9ca835c3a54396a53138a63f5f6549{Extra}').val()).length > 0 ? ($('#ctlaf0a4f5c93304cf2a7d17a57a85dd15b_4e9ca835c3a54396a53138a63f5f6549{Extra}').val() == '' ? '-' : $('#ctlaf0a4f5c93304cf2a7d17a57a85dd15b_4e9ca835c3a54396a53138a63f5f6549{Extra}').val()).replace(/\\./g,'---').replace(/\\//g,'___') : ($('#ctlaf0a4f5c93304cf2a7d17a57a85dd15b_4e9ca835c3a54396a53138a63f5f6549{Extra}').val() == '' ? '-' : $('#ctlaf0a4f5c93304cf2a7d17a57a85dd15b_4e9ca835c3a54396a53138a63f5f6549{Extra}').val())))+'/{page}/{pagesize}/{orderColumn}/{orderType}";

        // Lista de Regiones - Lista de Regiones

        $para41b236e627a42338af1b142c4af67cd = 1;

        if (null == $para41b236e627a42338af1b142c4af67cd) {
            $para41b236e627a42338af1b142c4af67cd = '1';
        }

        $par6185a7056560433494dba94e9ae591070e1a8a0605b24adb9a54f45af3349d70 = 0;

        if (null == $par6185a7056560433494dba94e9ae591070e1a8a0605b24adb9a54f45af3349d70) {
            $par6185a7056560433494dba94e9ae591070e1a8a0605b24adb9a54f45af3349d70 = '0';
        }

        $par0a0ce2af85ab462a808e0270326fb8600e1a8a0605b24adb9a54f45af3349d70 = 0;

        if (null == $par0a0ce2af85ab462a808e0270326fb8600e1a8a0605b24adb9a54f45af3349d70) {
            $par0a0ce2af85ab462a808e0270326fb8600e1a8a0605b24adb9a54f45af3349d70 = '0';
        }

        $par5551ae677d6b488ebd38625d0f5d9fce0e1a8a0605b24adb9a54f45af3349d70 = '';

        if ('-' == $par5551ae677d6b488ebd38625d0f5d9fce0e1a8a0605b24adb9a54f45af3349d70) {
            $par5551ae677d6b488ebd38625d0f5d9fce0e1a8a0605b24adb9a54f45af3349d70 = null;
        }

        if (null == $par5551ae677d6b488ebd38625d0f5d9fce0e1a8a0605b24adb9a54f45af3349d70) {
            $par5551ae677d6b488ebd38625d0f5d9fce0e1a8a0605b24adb9a54f45af3349d70 = '';
        }

        $par8fce8a73ac264e4a8f3b56d8b991b8a50e1a8a0605b24adb9a54f45af3349d70 = '';

        if ('-' == $par8fce8a73ac264e4a8f3b56d8b991b8a50e1a8a0605b24adb9a54f45af3349d70) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a50e1a8a0605b24adb9a54f45af3349d70 = null;
        }

        if (null == $par8fce8a73ac264e4a8f3b56d8b991b8a50e1a8a0605b24adb9a54f45af3349d70) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a50e1a8a0605b24adb9a54f45af3349d70 = '';
        }

        $v0e1a8a0605b24adb9a54f45af3349d70 = \App\repf782f923fd0247bd9f4010b717e52999::mtf12e049b27704a27adda948b2a000735($para41b236e627a42338af1b142c4af67cd, $par6185a7056560433494dba94e9ae591070e1a8a0605b24adb9a54f45af3349d70, $par0a0ce2af85ab462a808e0270326fb8600e1a8a0605b24adb9a54f45af3349d70, $par5551ae677d6b488ebd38625d0f5d9fce0e1a8a0605b24adb9a54f45af3349d70, $par8fce8a73ac264e4a8f3b56d8b991b8a50e1a8a0605b24adb9a54f45af3349d70);

        $v0e1a8a0605b24adb9a54f45af3349d70Ajax = \URL::to('/').'/api/f12e049b27704a27adda948b2a000735/'.(null == $para41b236e627a42338af1b142c4af67cd ? '-' : ('' == $para41b236e627a42338af1b142c4af67cd ? '-' : $para41b236e627a42338af1b142c4af67cd)).'/{page}/{pagesize}/{orderColumn}/{orderType}';

        // Lista tipo de estimulos - Lista tipo de estimulos

        $par6185a7056560433494dba94e9ae591074652535b500e4e4da76e94cb2de7cda7 = 0;

        if (null == $par6185a7056560433494dba94e9ae591074652535b500e4e4da76e94cb2de7cda7) {
            $par6185a7056560433494dba94e9ae591074652535b500e4e4da76e94cb2de7cda7 = '0';
        }

        $par0a0ce2af85ab462a808e0270326fb8604652535b500e4e4da76e94cb2de7cda7 = 0;

        if (null == $par0a0ce2af85ab462a808e0270326fb8604652535b500e4e4da76e94cb2de7cda7) {
            $par0a0ce2af85ab462a808e0270326fb8604652535b500e4e4da76e94cb2de7cda7 = '0';
        }

        $par5551ae677d6b488ebd38625d0f5d9fce4652535b500e4e4da76e94cb2de7cda7 = '';

        if ('-' == $par5551ae677d6b488ebd38625d0f5d9fce4652535b500e4e4da76e94cb2de7cda7) {
            $par5551ae677d6b488ebd38625d0f5d9fce4652535b500e4e4da76e94cb2de7cda7 = null;
        }

        if (null == $par5551ae677d6b488ebd38625d0f5d9fce4652535b500e4e4da76e94cb2de7cda7) {
            $par5551ae677d6b488ebd38625d0f5d9fce4652535b500e4e4da76e94cb2de7cda7 = '';
        }

        $par8fce8a73ac264e4a8f3b56d8b991b8a54652535b500e4e4da76e94cb2de7cda7 = '';

        if ('-' == $par8fce8a73ac264e4a8f3b56d8b991b8a54652535b500e4e4da76e94cb2de7cda7) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a54652535b500e4e4da76e94cb2de7cda7 = null;
        }

        if (null == $par8fce8a73ac264e4a8f3b56d8b991b8a54652535b500e4e4da76e94cb2de7cda7) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a54652535b500e4e4da76e94cb2de7cda7 = '';
        }

        $v4652535b500e4e4da76e94cb2de7cda7 = \App\repf782f923fd0247bd9f4010b717e52999::mtff0d208e1b5f4df0b5c17a6a88cefa73($par6185a7056560433494dba94e9ae591074652535b500e4e4da76e94cb2de7cda7, $par0a0ce2af85ab462a808e0270326fb8604652535b500e4e4da76e94cb2de7cda7, $par5551ae677d6b488ebd38625d0f5d9fce4652535b500e4e4da76e94cb2de7cda7, $par8fce8a73ac264e4a8f3b56d8b991b8a54652535b500e4e4da76e94cb2de7cda7);

        $v4652535b500e4e4da76e94cb2de7cda7Ajax = \URL::to('/').'/api/ff0d208e1b5f4df0b5c17a6a88cefa73/{page}/{pagesize}/{orderColumn}/{orderType}';

        // Modelador Precios - Modelador Precios

        $par64460d6003f9470cbac9ad05c7b7ac99 = $request->input('estimulo');

        if (null == $par64460d6003f9470cbac9ad05c7b7ac99) {
            $par64460d6003f9470cbac9ad05c7b7ac99 = '-';
        }

        $par2a57f56f85564d88b8850464dd421a81 = $request->input('regiones');

        if (null == $par2a57f56f85564d88b8850464dd421a81) {
            $par2a57f56f85564d88b8850464dd421a81 = '-';
        }

        $parb09fcc153e3541b0971c156dfd21badb = $request->input('estado');

        if (null == $parb09fcc153e3541b0971c156dfd21badb) {
            $parb09fcc153e3541b0971c156dfd21badb = '-';
        }

        $paracaafe2db6cd4020aea7c4dba013c573 = $request->input('centrostrabajo');

        if (null == $paracaafe2db6cd4020aea7c4dba013c573) {
            $paracaafe2db6cd4020aea7c4dba013c573 = '-';
        }

        $parb2ea07fb09904160b3da3964658945dd = $request->input('centroacopio');

        if (null == $parb2ea07fb09904160b3da3964658945dd) {
            $parb2ea07fb09904160b3da3964658945dd = '-';
        }

        $par6185a7056560433494dba94e9ae591072686ed7a542a4eb984f2e14137f25b9c = 0;

        if (null == $par6185a7056560433494dba94e9ae591072686ed7a542a4eb984f2e14137f25b9c) {
            $par6185a7056560433494dba94e9ae591072686ed7a542a4eb984f2e14137f25b9c = '0';
        }

        $par0a0ce2af85ab462a808e0270326fb8602686ed7a542a4eb984f2e14137f25b9c = 0;

        if (null == $par0a0ce2af85ab462a808e0270326fb8602686ed7a542a4eb984f2e14137f25b9c) {
            $par0a0ce2af85ab462a808e0270326fb8602686ed7a542a4eb984f2e14137f25b9c = '0';
        }

        $par5551ae677d6b488ebd38625d0f5d9fce2686ed7a542a4eb984f2e14137f25b9c = '';

        if ('-' == $par5551ae677d6b488ebd38625d0f5d9fce2686ed7a542a4eb984f2e14137f25b9c) {
            $par5551ae677d6b488ebd38625d0f5d9fce2686ed7a542a4eb984f2e14137f25b9c = null;
        }

        if (null == $par5551ae677d6b488ebd38625d0f5d9fce2686ed7a542a4eb984f2e14137f25b9c) {
            $par5551ae677d6b488ebd38625d0f5d9fce2686ed7a542a4eb984f2e14137f25b9c = '';
        }

        $par8fce8a73ac264e4a8f3b56d8b991b8a52686ed7a542a4eb984f2e14137f25b9c = '';

        if ('-' == $par8fce8a73ac264e4a8f3b56d8b991b8a52686ed7a542a4eb984f2e14137f25b9c) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a52686ed7a542a4eb984f2e14137f25b9c = null;
        }

        if (null == $par8fce8a73ac264e4a8f3b56d8b991b8a52686ed7a542a4eb984f2e14137f25b9c) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a52686ed7a542a4eb984f2e14137f25b9c = '';
        }

        $v2686ed7a542a4eb984f2e14137f25b9cAjax = \URL::to('/').'/api/20344f2640684f459ec9bc0d181d95c5/'.(null == $par64460d6003f9470cbac9ad05c7b7ac99 ? '-' : ('' == $par64460d6003f9470cbac9ad05c7b7ac99 ? '-' : $par64460d6003f9470cbac9ad05c7b7ac99)).'/'.(null == $par2a57f56f85564d88b8850464dd421a81 ? '-' : ('' == $par2a57f56f85564d88b8850464dd421a81 ? '-' : $par2a57f56f85564d88b8850464dd421a81)).'/'.(null == $parb09fcc153e3541b0971c156dfd21badb ? '-' : ('' == $parb09fcc153e3541b0971c156dfd21badb ? '-' : $parb09fcc153e3541b0971c156dfd21badb)).'/'.(null == $paracaafe2db6cd4020aea7c4dba013c573 ? '-' : ('' == $paracaafe2db6cd4020aea7c4dba013c573 ? '-' : $paracaafe2db6cd4020aea7c4dba013c573)).'/'.(null == $parb2ea07fb09904160b3da3964658945dd ? '-' : ('' == $parb2ea07fb09904160b3da3964658945dd ? '-' : $parb2ea07fb09904160b3da3964658945dd)).'/{page}/{pagesize}/{orderColumn}/{orderType}';

        // Modelador Precios - Modelador Precios

        $v2686ed7a542a4eb984f2e14137f25b9cCount = \App\repf782f923fd0247bd9f4010b717e52999::mt20344f2640684f459ec9bc0d181d95c5Count($par64460d6003f9470cbac9ad05c7b7ac99, $par2a57f56f85564d88b8850464dd421a81, $parb09fcc153e3541b0971c156dfd21badb, $paracaafe2db6cd4020aea7c4dba013c573, $parb2ea07fb09904160b3da3964658945dd, $par6185a7056560433494dba94e9ae591072686ed7a542a4eb984f2e14137f25b9c, $par0a0ce2af85ab462a808e0270326fb8602686ed7a542a4eb984f2e14137f25b9c, $par5551ae677d6b488ebd38625d0f5d9fce2686ed7a542a4eb984f2e14137f25b9c, $par8fce8a73ac264e4a8f3b56d8b991b8a52686ed7a542a4eb984f2e14137f25b9c);

        //$v2686ed7a542a4eb984f2e14137f25b9cCountAjax =  \URL::to('/')."/api/20344f2640684f459ec9bc0d181d95c5Count{ParametersAjax}/{page}/{pagesize}/{orderColumn}/{orderType}";

        // Titulos Pagina - Titulos Pagina
        ...
        $par6185a7056560433494dba94e9ae59107a7ffcea23b3e4dd5b232057cad157172 = 0;

        if (null == $par6185a7056560433494dba94e9ae59107a7ffcea23b3e4dd5b232057cad157172) {
            $par6185a7056560433494dba94e9ae59107a7ffcea23b3e4dd5b232057cad157172 = '0';
        }

        $par0a0ce2af85ab462a808e0270326fb860a7ffcea23b3e4dd5b232057cad157172 = 0;

        if (null == $par0a0ce2af85ab462a808e0270326fb860a7ffcea23b3e4dd5b232057cad157172) {
            $par0a0ce2af85ab462a808e0270326fb860a7ffcea23b3e4dd5b232057cad157172 = '0';
        }

        $par5551ae677d6b488ebd38625d0f5d9fcea7ffcea23b3e4dd5b232057cad157172 = '';

        if ('-' == $par5551ae677d6b488ebd38625d0f5d9fcea7ffcea23b3e4dd5b232057cad157172) {
            $par5551ae677d6b488ebd38625d0f5d9fcea7ffcea23b3e4dd5b232057cad157172 = null;
        }

        if (null == $par5551ae677d6b488ebd38625d0f5d9fcea7ffcea23b3e4dd5b232057cad157172) {
            $par5551ae677d6b488ebd38625d0f5d9fcea7ffcea23b3e4dd5b232057cad157172 = '';
        }

        $par8fce8a73ac264e4a8f3b56d8b991b8a5a7ffcea23b3e4dd5b232057cad157172 = '';

        if ('-' == $par8fce8a73ac264e4a8f3b56d8b991b8a5a7ffcea23b3e4dd5b232057cad157172) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a5a7ffcea23b3e4dd5b232057cad157172 = null;
        }

        if (null == $par8fce8a73ac264e4a8f3b56d8b991b8a5a7ffcea23b3e4dd5b232057cad157172) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a5a7ffcea23b3e4dd5b232057cad157172 = '';
        }

        $va7ffcea23b3e4dd5b232057cad157172 = \App\repf782f923fd0247bd9f4010b717e52999::mtd1203cac9e0a4d2b8d8d3ac5e285d428($par8e9cfc8933a449af80f5fd2fdaf0c7461, $par949ac6762f824f589aa55df91c654a401, $par6185a7056560433494dba94e9ae59107a7ffcea23b3e4dd5b232057cad157172, $par0a0ce2af85ab462a808e0270326fb860a7ffcea23b3e4dd5b232057cad157172, $par5551ae677d6b488ebd38625d0f5d9fcea7ffcea23b3e4dd5b232057cad157172, $par8fce8a73ac264e4a8f3b56d8b991b8a5a7ffcea23b3e4dd5b232057cad157172);

        $va7ffcea23b3e4dd5b232057cad157172Ajax = \URL::to('/').'/api/d1203cac9e0a4d2b8d8d3ac5e285d428/'.(null == $par8e9cfc8933a449af80f5fd2fdaf0c7461 ? '-' : ('' == $par8e9cfc8933a449af80f5fd2fdaf0c7461 ? '-' : $par8e9cfc8933a449af80f5fd2fdaf0c7461)).'/'.(null == $par949ac6762f824f589aa55df91c654a401 ? '-' : ('' == $par949ac6762f824f589aa55df91c654a401 ? '-' : $par949ac6762f824f589aa55df91c654a401)).'/{page}/{pagesize}/{orderColumn}/{orderType}';
        ...
        $vfd27bbc94c704630a5abbf64cb7cb93a = '';
        $vfd27bbc94c704630a5abbf64cb7cb93aTotal = (isset($v2686ed7a542a4eb984f2e14137f25b9cCount) ? $v2686ed7a542a4eb984f2e14137f25b9cCount : 0);
        $vfd27bbc94c704630a5abbf64cb7cb93aAjax = (isset($v2686ed7a542a4eb984f2e14137f25b9cAjax) ? $v2686ed7a542a4eb984f2e14137f25b9cAjax : '');

        $arrWiths['veaa1ac184ff44d2f9734591e2dd4ceeeAjax'] = isset($veaa1ac184ff44d2f9734591e2dd4ceeeAjax) ? $veaa1ac184ff44d2f9734591e2dd4ceeeAjax : '';
        $arrWiths['v38a6f9eb4c9a454da52fc403a54de2c8Ajax'] = isset($v38a6f9eb4c9a454da52fc403a54de2c8Ajax) ? $v38a6f9eb4c9a454da52fc403a54de2c8Ajax : '';
        $arrWiths['v11e6ea5f82be4ec5b492494e701d82cc'] = isset($v11e6ea5f82be4ec5b492494e701d82cc) ? $v11e6ea5f82be4ec5b492494e701d82cc : '';
        $arrWiths['v11e6ea5f82be4ec5b492494e701d82ccAjax'] = isset($v11e6ea5f82be4ec5b492494e701d82ccAjax) ? $v11e6ea5f82be4ec5b492494e701d82ccAjax : '';
        $arrWiths['veb612457addf4a309bc294bd4dad0613Ajax'] = isset($veb612457addf4a309bc294bd4dad0613Ajax) ? $veb612457addf4a309bc294bd4dad0613Ajax : '';
        $arrWiths['v0e1a8a0605b24adb9a54f45af3349d70'] = isset($v0e1a8a0605b24adb9a54f45af3349d70) ? $v0e1a8a0605b24adb9a54f45af3349d70 : '';
        $arrWiths['v0e1a8a0605b24adb9a54f45af3349d70Ajax'] = isset($v0e1a8a0605b24adb9a54f45af3349d70Ajax) ? $v0e1a8a0605b24adb9a54f45af3349d70Ajax : '';
        $arrWiths['v4652535b500e4e4da76e94cb2de7cda7'] = isset($v4652535b500e4e4da76e94cb2de7cda7) ? $v4652535b500e4e4da76e94cb2de7cda7 : '';
        $arrWiths['v4652535b500e4e4da76e94cb2de7cda7Ajax'] = isset($v4652535b500e4e4da76e94cb2de7cda7Ajax) ? $v4652535b500e4e4da76e94cb2de7cda7Ajax : '';
        $arrWiths['v2686ed7a542a4eb984f2e14137f25b9cCount'] = isset($v2686ed7a542a4eb984f2e14137f25b9cCount) ? $v2686ed7a542a4eb984f2e14137f25b9cCount : '';
        $arrWiths['v2686ed7a542a4eb984f2e14137f25b9cAjax'] = isset($v2686ed7a542a4eb984f2e14137f25b9cAjax) ? $v2686ed7a542a4eb984f2e14137f25b9cAjax : '';
        $arrWiths['va7ffcea23b3e4dd5b232057cad157172'] = isset($va7ffcea23b3e4dd5b232057cad157172) ? $va7ffcea23b3e4dd5b232057cad157172 : '';
        $arrWiths['va7ffcea23b3e4dd5b232057cad157172Ajax'] = isset($va7ffcea23b3e4dd5b232057cad157172Ajax) ? $va7ffcea23b3e4dd5b232057cad157172Ajax : '';
        ...
        $arrWiths['vfd27bbc94c704630a5abbf64cb7cb93a'] = isset($vfd27bbc94c704630a5abbf64cb7cb93a) ? $vfd27bbc94c704630a5abbf64cb7cb93a : '';
        $arrWiths['vfd27bbc94c704630a5abbf64cb7cb93aTotal'] = isset($vfd27bbc94c704630a5abbf64cb7cb93aTotal) ? $vfd27bbc94c704630a5abbf64cb7cb93aTotal : '';
        $arrWiths['vfd27bbc94c704630a5abbf64cb7cb93aAjax'] = isset($vfd27bbc94c704630a5abbf64cb7cb93aAjax) ? $vfd27bbc94c704630a5abbf64cb7cb93aAjax : '';
        ...
        $response = new \Illuminate\Http\Response(view('5d063b24497f4c62befb0f9ff7122f82.Index', $arrWiths)->with('title', $arrWiths['title'])->with('vSessionTimeout', \Config::get('session.lifetime') * 60));
