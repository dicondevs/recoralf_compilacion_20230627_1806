...
/**
 * productorcentroacopio - productorcentroacopio.
 */
class pg702f9adb4c98495f8bb2e77a0a72d063Controller extends Controller
{
    /**
    ...
    public function post(Request $request)
    {
        ...
        // Guardar Prod CenAcop - Guardar Prod CenAcop
        if (null != $request->input('ctl19b1bedba7d546529c0aa54c7e4d2040_91dba27c31054515b172fa618eedeba0') && null != $request->input('hid91dba27c31054515b172fa618eedeba0') && '91dba27c31054515b172fa618eedeba0' == $request->input('hid91dba27c31054515b172fa618eedeba0')) {
            $key = 0;
            $isNew = false;
            ...
            //FK_PRODUCTOR
            $tot6234015fe8ee4df3a01c9bb34197365c = (int) $request->input('hd91dba27c31054515b172fa618eedeba0_1');
            $for6234015fe8ee4df3a01c9bb34197365c = false;
            for ($i = 1; $i <= $tot6234015fe8ee4df3a01c9bb34197365c; ++$i) {
                $val = $request->input('hd91dba27c31054515b172fa618eedeba0_1_'.$i);
                if ('1' == $request->input('del91dba27c31054515b172fa618eedeba0_1_'.$i) && !$for6234015fe8ee4df3a01c9bb34197365c) {
                    if ('' != $request->input('hd91dba27c31054515b172fa618eedeba0_1_'.$i)) {
                        \App\tb63eddac8503e48ef8ba7965cd5d64334::where('PK_PRODUCTOR_CENTRO_ACOPIO', $val)->delete();
                    }
                } else {
                    if ('' == $request->input('hd91dba27c31054515b172fa618eedeba0_1_'.$i) || $for6234015fe8ee4df3a01c9bb34197365c) {
                        $tbRel = new \App\tb63eddac8503e48ef8ba7965cd5d64334();

                        if (null != $request->input('ctlef2a507ee7f04a99852194aff80e93dc_91dba27c31054515b172fa618eedeba0_'.$i.'')) {
                            $tbRel->FK_CENTRO_ACOPIO = $request->input('ctlef2a507ee7f04a99852194aff80e93dc_91dba27c31054515b172fa618eedeba0_'.$i.''); //FK_CENTRO_ACOPIO
                        } elseif (null == $request->input('ctlef2a507ee7f04a99852194aff80e93dc_91dba27c31054515b172fa618eedeba0_'.$i.'')) {
                            $tbRel->FK_CENTRO_ACOPIO = null;
                        }

                        if (null != $request->input('ctl5c3ee84e12f34e6fa626b03563038001_91dba27c31054515b172fa618eedeba0_'.$i.'')) {
                            $tbRel->FK_CENTRO_TRABAJO = $request->input('ctl5c3ee84e12f34e6fa626b03563038001_91dba27c31054515b172fa618eedeba0_'.$i.''); //FK_CENTRO_TRABAJO
                        } elseif (null == $request->input('ctl5c3ee84e12f34e6fa626b03563038001_91dba27c31054515b172fa618eedeba0_'.$i.'')) {
                            $tbRel->FK_CENTRO_TRABAJO = null;
                        }
                        if (null != $request->input('ctl46523daaddac4c0eb2ba34bf9aa8c9a5_91dba27c31054515b172fa618eedeba0_'.$i.'')) {
                            $tbRel->FL_ACTIVO_INACTIVO = true; //FL_ACTIVO_INACTIVO
                        } else {
                            $tbRel->FL_ACTIVO_INACTIVO = false; //FL_ACTIVO_INACTIVO
                        }

                        if (null != $request->input('ctl86051a86148b4072be3c787ce0b9d857_91dba27c31054515b172fa618eedeba0_'.$i.'')) {
                            $tbRel->FK_ESTADO = $request->input('ctl86051a86148b4072be3c787ce0b9d857_91dba27c31054515b172fa618eedeba0_'.$i.''); //FK_ESTADO
                        } elseif (null == $request->input('ctl86051a86148b4072be3c787ce0b9d857_91dba27c31054515b172fa618eedeba0_'.$i.'')) {
                        ...
                        if (null != $request->session()->get('ses5e122755c3a24f5d8789755168e9de27')) {
                            $tbRel->FK_USUARIO = $request->session()->get('ses5e122755c3a24f5d8789755168e9de27'); //FK_USUARIO
                        } elseif (null == $request->session()->get('ses5e122755c3a24f5d8789755168e9de27')) {
                            $tbRel->FK_USUARIO = null;
                        }
    ...
    public function index(Request $request)
    {
        ...
        $par6185a7056560433494dba94e9ae59107e3dc6a90ecb44b429a4c1585de6acd1d = 0;

        if (null == $par6185a7056560433494dba94e9ae59107e3dc6a90ecb44b429a4c1585de6acd1d) {
            $par6185a7056560433494dba94e9ae59107e3dc6a90ecb44b429a4c1585de6acd1d = '0';
        }

        $par0a0ce2af85ab462a808e0270326fb860e3dc6a90ecb44b429a4c1585de6acd1d = 0;

        if (null == $par0a0ce2af85ab462a808e0270326fb860e3dc6a90ecb44b429a4c1585de6acd1d) {
            $par0a0ce2af85ab462a808e0270326fb860e3dc6a90ecb44b429a4c1585de6acd1d = '0';
        }

        $par5551ae677d6b488ebd38625d0f5d9fcee3dc6a90ecb44b429a4c1585de6acd1d = '';

        if ('-' == $par5551ae677d6b488ebd38625d0f5d9fcee3dc6a90ecb44b429a4c1585de6acd1d) {
            $par5551ae677d6b488ebd38625d0f5d9fcee3dc6a90ecb44b429a4c1585de6acd1d = null;
        }

        if (null == $par5551ae677d6b488ebd38625d0f5d9fcee3dc6a90ecb44b429a4c1585de6acd1d) {
            $par5551ae677d6b488ebd38625d0f5d9fcee3dc6a90ecb44b429a4c1585de6acd1d = '';
        }

        $par8fce8a73ac264e4a8f3b56d8b991b8a5e3dc6a90ecb44b429a4c1585de6acd1d = '';

        if ('-' == $par8fce8a73ac264e4a8f3b56d8b991b8a5e3dc6a90ecb44b429a4c1585de6acd1d) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a5e3dc6a90ecb44b429a4c1585de6acd1d = null;
        }

        if (null == $par8fce8a73ac264e4a8f3b56d8b991b8a5e3dc6a90ecb44b429a4c1585de6acd1d) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a5e3dc6a90ecb44b429a4c1585de6acd1d = '';
        }

        $ve3dc6a90ecb44b429a4c1585de6acd1dAjax = \URL::to('/')."/api/ae8e9cfbd4174125aa0ae9597c5ded2f/'+encodeURIComponent((($('#ctl5c3ee84e12f34e6fa626b03563038001_91dba27c31054515b172fa618eedeba0{Extra}').val() == '' ? '-' : $('#ctl5c3ee84e12f34e6fa626b03563038001_91dba27c31054515b172fa618eedeba0{Extra}').val()) != undefined && ($('#ctl5c3ee84e12f34e6fa626b03563038001_91dba27c31054515b172fa618eedeba0{Extra}').val() == '' ? '-' : $('#ctl5c3ee84e12f34e6fa626b03563038001_91dba27c31054515b172fa618eedeba0{Extra}').val()).length > 0 ? ($('#ctl5c3ee84e12f34e6fa626b03563038001_91dba27c31054515b172fa618eedeba0{Extra}').val() == '' ? '-' : $('#ctl5c3ee84e12f34e6fa626b03563038001_91dba27c31054515b172fa618eedeba0{Extra}').val()).replace(/\\./g,'---').replace(/\\//g,'___') : ($('#ctl5c3ee84e12f34e6fa626b03563038001_91dba27c31054515b172fa618eedeba0{Extra}').val() == '' ? '-' : $('#ctl5c3ee84e12f34e6fa626b03563038001_91dba27c31054515b172fa618eedeba0{Extra}').val())))+'/{page}/{pagesize}/{orderColumn}/{orderType}";
        ...
        $par6185a7056560433494dba94e9ae59107b48d2702032044f1a1c04bc36afd2804 = 0;

        if (null == $par6185a7056560433494dba94e9ae59107b48d2702032044f1a1c04bc36afd2804) {
            $par6185a7056560433494dba94e9ae59107b48d2702032044f1a1c04bc36afd2804 = '0';
        }

        $par0a0ce2af85ab462a808e0270326fb860b48d2702032044f1a1c04bc36afd2804 = 0;

        if (null == $par0a0ce2af85ab462a808e0270326fb860b48d2702032044f1a1c04bc36afd2804) {
            $par0a0ce2af85ab462a808e0270326fb860b48d2702032044f1a1c04bc36afd2804 = '0';
        }

        $par5551ae677d6b488ebd38625d0f5d9fceb48d2702032044f1a1c04bc36afd2804 = '';

        if ('-' == $par5551ae677d6b488ebd38625d0f5d9fceb48d2702032044f1a1c04bc36afd2804) {
            $par5551ae677d6b488ebd38625d0f5d9fceb48d2702032044f1a1c04bc36afd2804 = null;
        }

        if (null == $par5551ae677d6b488ebd38625d0f5d9fceb48d2702032044f1a1c04bc36afd2804) {
            $par5551ae677d6b488ebd38625d0f5d9fceb48d2702032044f1a1c04bc36afd2804 = '';
        }

        $par8fce8a73ac264e4a8f3b56d8b991b8a5b48d2702032044f1a1c04bc36afd2804 = '';

        if ('-' == $par8fce8a73ac264e4a8f3b56d8b991b8a5b48d2702032044f1a1c04bc36afd2804) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a5b48d2702032044f1a1c04bc36afd2804 = null;
        }

        if (null == $par8fce8a73ac264e4a8f3b56d8b991b8a5b48d2702032044f1a1c04bc36afd2804) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a5b48d2702032044f1a1c04bc36afd2804 = '';
        }

        $vb48d2702032044f1a1c04bc36afd2804Ajax = \URL::to('/')."/api/5a1d9d566ef8489daca48684bc6e3ba1/'+encodeURIComponent((($('#ctl86051a86148b4072be3c787ce0b9d857_91dba27c31054515b172fa618eedeba0{Extra}').val() == '' ? '-' : $('#ctl86051a86148b4072be3c787ce0b9d857_91dba27c31054515b172fa618eedeba0{Extra}').val()) != undefined && ($('#ctl86051a86148b4072be3c787ce0b9d857_91dba27c31054515b172fa618eedeba0{Extra}').val() == '' ? '-' : $('#ctl86051a86148b4072be3c787ce0b9d857_91dba27c31054515b172fa618eedeba0{Extra}').val()).length > 0 ? ($('#ctl86051a86148b4072be3c787ce0b9d857_91dba27c31054515b172fa618eedeba0{Extra}').val() == '' ? '-' : $('#ctl86051a86148b4072be3c787ce0b9d857_91dba27c31054515b172fa618eedeba0{Extra}').val()).replace(/\\./g,'---').replace(/\\//g,'___') : ($('#ctl86051a86148b4072be3c787ce0b9d857_91dba27c31054515b172fa618eedeba0{Extra}').val() == '' ? '-' : $('#ctl86051a86148b4072be3c787ce0b9d857_91dba27c31054515b172fa618eedeba0{Extra}').val())))+'/{page}/{pagesize}/{orderColumn}/{orderType}";

        // Lista de Lugar - Lista de Lugar

        $par6185a7056560433494dba94e9ae591076ce986e3ee344efdbaf139af7a874bd1 = 0;

        if (null == $par6185a7056560433494dba94e9ae591076ce986e3ee344efdbaf139af7a874bd1) {
            $par6185a7056560433494dba94e9ae591076ce986e3ee344efdbaf139af7a874bd1 = '0';
        }

        $par0a0ce2af85ab462a808e0270326fb8606ce986e3ee344efdbaf139af7a874bd1 = 0;

        if (null == $par0a0ce2af85ab462a808e0270326fb8606ce986e3ee344efdbaf139af7a874bd1) {
            $par0a0ce2af85ab462a808e0270326fb8606ce986e3ee344efdbaf139af7a874bd1 = '0';
        }

        $par5551ae677d6b488ebd38625d0f5d9fce6ce986e3ee344efdbaf139af7a874bd1 = '';

        if ('-' == $par5551ae677d6b488ebd38625d0f5d9fce6ce986e3ee344efdbaf139af7a874bd1) {
            $par5551ae677d6b488ebd38625d0f5d9fce6ce986e3ee344efdbaf139af7a874bd1 = null;
        }

        if (null == $par5551ae677d6b488ebd38625d0f5d9fce6ce986e3ee344efdbaf139af7a874bd1) {
            $par5551ae677d6b488ebd38625d0f5d9fce6ce986e3ee344efdbaf139af7a874bd1 = '';
        }

        $par8fce8a73ac264e4a8f3b56d8b991b8a56ce986e3ee344efdbaf139af7a874bd1 = '';

        if ('-' == $par8fce8a73ac264e4a8f3b56d8b991b8a56ce986e3ee344efdbaf139af7a874bd1) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a56ce986e3ee344efdbaf139af7a874bd1 = null;
        }

        if (null == $par8fce8a73ac264e4a8f3b56d8b991b8a56ce986e3ee344efdbaf139af7a874bd1) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a56ce986e3ee344efdbaf139af7a874bd1 = '';
        }

        $v6ce986e3ee344efdbaf139af7a874bd1 = \App\repf782f923fd0247bd9f4010b717e52999::mta64061d55b1c4e4883871fdf7ed1dfea($par6185a7056560433494dba94e9ae591076ce986e3ee344efdbaf139af7a874bd1, $par0a0ce2af85ab462a808e0270326fb8606ce986e3ee344efdbaf139af7a874bd1, $par5551ae677d6b488ebd38625d0f5d9fce6ce986e3ee344efdbaf139af7a874bd1, $par8fce8a73ac264e4a8f3b56d8b991b8a56ce986e3ee344efdbaf139af7a874bd1);

        $v6ce986e3ee344efdbaf139af7a874bd1Ajax = \URL::to('/').'/api/a64061d55b1c4e4883871fdf7ed1dfea/{page}/{pagesize}/{orderColumn}/{orderType}';

        // Recuperar Prod CentAco - Recuperar Prod CentAco
        ...
        $par6185a7056560433494dba94e9ae591079bdc836b21ea4eccbac34b5187ec38d8 = 0;

        if (null == $par6185a7056560433494dba94e9ae591079bdc836b21ea4eccbac34b5187ec38d8) {
            $par6185a7056560433494dba94e9ae591079bdc836b21ea4eccbac34b5187ec38d8 = '0';
        }

        $par0a0ce2af85ab462a808e0270326fb8609bdc836b21ea4eccbac34b5187ec38d8 = 0;

        if (null == $par0a0ce2af85ab462a808e0270326fb8609bdc836b21ea4eccbac34b5187ec38d8) {
            $par0a0ce2af85ab462a808e0270326fb8609bdc836b21ea4eccbac34b5187ec38d8 = '0';
        }

        $par5551ae677d6b488ebd38625d0f5d9fce9bdc836b21ea4eccbac34b5187ec38d8 = '';

        if ('-' == $par5551ae677d6b488ebd38625d0f5d9fce9bdc836b21ea4eccbac34b5187ec38d8) {
            $par5551ae677d6b488ebd38625d0f5d9fce9bdc836b21ea4eccbac34b5187ec38d8 = null;
        }

        if (null == $par5551ae677d6b488ebd38625d0f5d9fce9bdc836b21ea4eccbac34b5187ec38d8) {
            $par5551ae677d6b488ebd38625d0f5d9fce9bdc836b21ea4eccbac34b5187ec38d8 = '';
        }

        $par8fce8a73ac264e4a8f3b56d8b991b8a59bdc836b21ea4eccbac34b5187ec38d8 = '';

        if ('-' == $par8fce8a73ac264e4a8f3b56d8b991b8a59bdc836b21ea4eccbac34b5187ec38d8) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a59bdc836b21ea4eccbac34b5187ec38d8 = null;
        }

        if (null == $par8fce8a73ac264e4a8f3b56d8b991b8a59bdc836b21ea4eccbac34b5187ec38d8) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a59bdc836b21ea4eccbac34b5187ec38d8 = '';
        }

        $v9bdc836b21ea4eccbac34b5187ec38d8 = \App\repf782f923fd0247bd9f4010b717e52999::mt87f3ff2a9cc344c58921f820b898209f($par81d62592acd84ddb8e7915b8e90881d2, $par6185a7056560433494dba94e9ae591079bdc836b21ea4eccbac34b5187ec38d8, $par0a0ce2af85ab462a808e0270326fb8609bdc836b21ea4eccbac34b5187ec38d8, $par5551ae677d6b488ebd38625d0f5d9fce9bdc836b21ea4eccbac34b5187ec38d8, $par8fce8a73ac264e4a8f3b56d8b991b8a59bdc836b21ea4eccbac34b5187ec38d8);

        $v9bdc836b21ea4eccbac34b5187ec38d8Ajax = \URL::to('/').'/api/87f3ff2a9cc344c58921f820b898209f/'.(null == $par81d62592acd84ddb8e7915b8e90881d2 ? '-' : ('' == $par81d62592acd84ddb8e7915b8e90881d2 ? '-' : $par81d62592acd84ddb8e7915b8e90881d2)).'/{page}/{pagesize}/{orderColumn}/{orderType}';
        ...
        $arrWiths['ve3dc6a90ecb44b429a4c1585de6acd1dAjax'] = isset($ve3dc6a90ecb44b429a4c1585de6acd1dAjax) ? $ve3dc6a90ecb44b429a4c1585de6acd1dAjax : '';
        $arrWiths['vb48d2702032044f1a1c04bc36afd2804Ajax'] = isset($vb48d2702032044f1a1c04bc36afd2804Ajax) ? $vb48d2702032044f1a1c04bc36afd2804Ajax : '';
        $arrWiths['v6ce986e3ee344efdbaf139af7a874bd1'] = isset($v6ce986e3ee344efdbaf139af7a874bd1) ? $v6ce986e3ee344efdbaf139af7a874bd1 : '';
        $arrWiths['v6ce986e3ee344efdbaf139af7a874bd1Ajax'] = isset($v6ce986e3ee344efdbaf139af7a874bd1Ajax) ? $v6ce986e3ee344efdbaf139af7a874bd1Ajax : '';
        $arrWiths['v9bdc836b21ea4eccbac34b5187ec38d8'] = isset($v9bdc836b21ea4eccbac34b5187ec38d8) ? $v9bdc836b21ea4eccbac34b5187ec38d8 : '';
        $arrWiths['v9bdc836b21ea4eccbac34b5187ec38d8Ajax'] = isset($v9bdc836b21ea4eccbac34b5187ec38d8Ajax) ? $v9bdc836b21ea4eccbac34b5187ec38d8Ajax : '';
        ...
        $response = new \Illuminate\Http\Response(view('702f9adb4c98495f8bb2e77a0a72d063.Index', $arrWiths)->with('title', $arrWiths['title'])->with('vSessionTimeout', \Config::get('session.lifetime') * 60));
