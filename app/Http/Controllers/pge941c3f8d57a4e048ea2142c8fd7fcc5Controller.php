...
// Creado               martes, 27 de junio de 2023 17:56:24
...
/**
 * asignarCentroAcopioUser - asignarCentroAcopioUser.
 */
class pge941c3f8d57a4e048ea2142c8fd7fcc5Controller extends Controller
{
    /**
    ...
    public function post(Request $request)
    {
        ...
        // Guardar asigna CT CA - Guardar asigna CT CA
        if (null != $request->input('ctl19b1bedba7d546529c0aa54c7e4d2040_34c914f6774c40d1902ef3ef63ad2e17') && null != $request->input('hid34c914f6774c40d1902ef3ef63ad2e17') && '34c914f6774c40d1902ef3ef63ad2e17' == $request->input('hid34c914f6774c40d1902ef3ef63ad2e17')) {
            $key = 0;
            $isNew = false;
            if (null != $request->input('pk_usuario')) {
                $key = $request->input('pk_usuario');
            }
            ...
            if (null != $request->input('ctlf629596e10c040759fdb8c929935e636_34c914f6774c40d1902ef3ef63ad2e17')) {
                $tb->FK_CENTROS_TRABAJO = $request->input('ctlf629596e10c040759fdb8c929935e636_34c914f6774c40d1902ef3ef63ad2e17'); //FK_CENTROS_TRABAJO
            } elseif (null == $request->input('ctlf629596e10c040759fdb8c929935e636_34c914f6774c40d1902ef3ef63ad2e17')) {
            ...
            $rele95614a9f8764bfba30910361b7957df = $request->input('ctl5dcb3f4063c64a3c96a68fdaeca26bb0_34c914f6774c40d1902ef3ef63ad2e17');
            if (null != $rele95614a9f8764bfba30910361b7957df && !is_array($rele95614a9f8764bfba30910361b7957df)) {
                $rele95614a9f8764bfba30910361b7957df = explode(',', $request->input('ctl5dcb3f4063c64a3c96a68fdaeca26bb0_34c914f6774c40d1902ef3ef63ad2e17'));
            }
            if (null != $rele95614a9f8764bfba30910361b7957df && is_array($rele95614a9f8764bfba30910361b7957df)) {
    ...
    public function index(Request $request)
    {
        ...
        // Lista de Centro de Trabajo - Lista de Centro de Trabajo

        $par6185a7056560433494dba94e9ae591079000ea4814e34e6ea661d5990ef40fe6 = 0;

        if (null == $par6185a7056560433494dba94e9ae591079000ea4814e34e6ea661d5990ef40fe6) {
            $par6185a7056560433494dba94e9ae591079000ea4814e34e6ea661d5990ef40fe6 = '0';
        }

        $par0a0ce2af85ab462a808e0270326fb8609000ea4814e34e6ea661d5990ef40fe6 = 0;

        if (null == $par0a0ce2af85ab462a808e0270326fb8609000ea4814e34e6ea661d5990ef40fe6) {
            $par0a0ce2af85ab462a808e0270326fb8609000ea4814e34e6ea661d5990ef40fe6 = '0';
        }

        $par5551ae677d6b488ebd38625d0f5d9fce9000ea4814e34e6ea661d5990ef40fe6 = '';

        if ('-' == $par5551ae677d6b488ebd38625d0f5d9fce9000ea4814e34e6ea661d5990ef40fe6) {
            $par5551ae677d6b488ebd38625d0f5d9fce9000ea4814e34e6ea661d5990ef40fe6 = null;
        }

        if (null == $par5551ae677d6b488ebd38625d0f5d9fce9000ea4814e34e6ea661d5990ef40fe6) {
            $par5551ae677d6b488ebd38625d0f5d9fce9000ea4814e34e6ea661d5990ef40fe6 = '';
        }

        $par8fce8a73ac264e4a8f3b56d8b991b8a59000ea4814e34e6ea661d5990ef40fe6 = '';

        if ('-' == $par8fce8a73ac264e4a8f3b56d8b991b8a59000ea4814e34e6ea661d5990ef40fe6) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a59000ea4814e34e6ea661d5990ef40fe6 = null;
        }

        if (null == $par8fce8a73ac264e4a8f3b56d8b991b8a59000ea4814e34e6ea661d5990ef40fe6) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a59000ea4814e34e6ea661d5990ef40fe6 = '';
        }

        $v9000ea4814e34e6ea661d5990ef40fe6 = \App\repf782f923fd0247bd9f4010b717e52999::mt85df7a461c854558b85b8e2466ff1014($par6185a7056560433494dba94e9ae591079000ea4814e34e6ea661d5990ef40fe6, $par0a0ce2af85ab462a808e0270326fb8609000ea4814e34e6ea661d5990ef40fe6, $par5551ae677d6b488ebd38625d0f5d9fce9000ea4814e34e6ea661d5990ef40fe6, $par8fce8a73ac264e4a8f3b56d8b991b8a59000ea4814e34e6ea661d5990ef40fe6);

        $v9000ea4814e34e6ea661d5990ef40fe6Ajax = \URL::to('/').'/api/85df7a461c854558b85b8e2466ff1014/{page}/{pagesize}/{orderColumn}/{orderType}';

        // Lista de Centros de Acopio - Lista de Centros de Acopio

        $pardd3780b5691843b4b7e62ed23891ccc6 = $request->input('centrotrabajo');

        if (null == $pardd3780b5691843b4b7e62ed23891ccc6) {
            $pardd3780b5691843b4b7e62ed23891ccc6 = '0';
        }

        $par6185a7056560433494dba94e9ae591071cb81a917d724f1da9716dc4f68c0121 = 0;

        if (null == $par6185a7056560433494dba94e9ae591071cb81a917d724f1da9716dc4f68c0121) {
            $par6185a7056560433494dba94e9ae591071cb81a917d724f1da9716dc4f68c0121 = '0';
        }

        $par0a0ce2af85ab462a808e0270326fb8601cb81a917d724f1da9716dc4f68c0121 = 0;

        if (null == $par0a0ce2af85ab462a808e0270326fb8601cb81a917d724f1da9716dc4f68c0121) {
            $par0a0ce2af85ab462a808e0270326fb8601cb81a917d724f1da9716dc4f68c0121 = '0';
        }

        $par5551ae677d6b488ebd38625d0f5d9fce1cb81a917d724f1da9716dc4f68c0121 = '';

        if ('-' == $par5551ae677d6b488ebd38625d0f5d9fce1cb81a917d724f1da9716dc4f68c0121) {
            $par5551ae677d6b488ebd38625d0f5d9fce1cb81a917d724f1da9716dc4f68c0121 = null;
        }

        if (null == $par5551ae677d6b488ebd38625d0f5d9fce1cb81a917d724f1da9716dc4f68c0121) {
            $par5551ae677d6b488ebd38625d0f5d9fce1cb81a917d724f1da9716dc4f68c0121 = '';
        }

        $par8fce8a73ac264e4a8f3b56d8b991b8a51cb81a917d724f1da9716dc4f68c0121 = '';

        if ('-' == $par8fce8a73ac264e4a8f3b56d8b991b8a51cb81a917d724f1da9716dc4f68c0121) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a51cb81a917d724f1da9716dc4f68c0121 = null;
        }

        if (null == $par8fce8a73ac264e4a8f3b56d8b991b8a51cb81a917d724f1da9716dc4f68c0121) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a51cb81a917d724f1da9716dc4f68c0121 = '';
        }

        $v1cb81a917d724f1da9716dc4f68c0121 = \App\repf782f923fd0247bd9f4010b717e52999::mtae8e9cfbd4174125aa0ae9597c5ded2f($pardd3780b5691843b4b7e62ed23891ccc6, $par6185a7056560433494dba94e9ae591071cb81a917d724f1da9716dc4f68c0121, $par0a0ce2af85ab462a808e0270326fb8601cb81a917d724f1da9716dc4f68c0121, $par5551ae677d6b488ebd38625d0f5d9fce1cb81a917d724f1da9716dc4f68c0121, $par8fce8a73ac264e4a8f3b56d8b991b8a51cb81a917d724f1da9716dc4f68c0121);

        $v1cb81a917d724f1da9716dc4f68c0121Ajax = \URL::to('/').'/api/ae8e9cfbd4174125aa0ae9597c5ded2f/'.(null == $pardd3780b5691843b4b7e62ed23891ccc6 ? '-' : ('' == $pardd3780b5691843b4b7e62ed23891ccc6 ? '-' : $pardd3780b5691843b4b7e62ed23891ccc6)).'/{page}/{pagesize}/{orderColumn}/{orderType}';

        // Recueprar Usuarios - Recueprar Usuarios

        $par18d0628ff9114afabc54c2f4ed0d6e4b = $request->input('pk_usuario');

        if (null == $par18d0628ff9114afabc54c2f4ed0d6e4b) {
            $par18d0628ff9114afabc54c2f4ed0d6e4b = '0';
        }

        $par6185a7056560433494dba94e9ae5910732af4de345d344d6ad0030ad036d707d = 0;

        if (null == $par6185a7056560433494dba94e9ae5910732af4de345d344d6ad0030ad036d707d) {
            $par6185a7056560433494dba94e9ae5910732af4de345d344d6ad0030ad036d707d = '0';
        }

        $par0a0ce2af85ab462a808e0270326fb86032af4de345d344d6ad0030ad036d707d = 0;

        if (null == $par0a0ce2af85ab462a808e0270326fb86032af4de345d344d6ad0030ad036d707d) {
            $par0a0ce2af85ab462a808e0270326fb86032af4de345d344d6ad0030ad036d707d = '0';
        }

        $par5551ae677d6b488ebd38625d0f5d9fce32af4de345d344d6ad0030ad036d707d = '';

        if ('-' == $par5551ae677d6b488ebd38625d0f5d9fce32af4de345d344d6ad0030ad036d707d) {
            $par5551ae677d6b488ebd38625d0f5d9fce32af4de345d344d6ad0030ad036d707d = null;
        }

        if (null == $par5551ae677d6b488ebd38625d0f5d9fce32af4de345d344d6ad0030ad036d707d) {
            $par5551ae677d6b488ebd38625d0f5d9fce32af4de345d344d6ad0030ad036d707d = '';
        }

        $par8fce8a73ac264e4a8f3b56d8b991b8a532af4de345d344d6ad0030ad036d707d = '';

        if ('-' == $par8fce8a73ac264e4a8f3b56d8b991b8a532af4de345d344d6ad0030ad036d707d) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a532af4de345d344d6ad0030ad036d707d = null;
        }

        if (null == $par8fce8a73ac264e4a8f3b56d8b991b8a532af4de345d344d6ad0030ad036d707d) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a532af4de345d344d6ad0030ad036d707d = '';
        }

        $v32af4de345d344d6ad0030ad036d707d = \App\repf782f923fd0247bd9f4010b717e52999::mt7f8b55907bfd48d7b91d6640c223b0e9($par18d0628ff9114afabc54c2f4ed0d6e4b, $par6185a7056560433494dba94e9ae5910732af4de345d344d6ad0030ad036d707d, $par0a0ce2af85ab462a808e0270326fb86032af4de345d344d6ad0030ad036d707d, $par5551ae677d6b488ebd38625d0f5d9fce32af4de345d344d6ad0030ad036d707d, $par8fce8a73ac264e4a8f3b56d8b991b8a532af4de345d344d6ad0030ad036d707d);

        $v32af4de345d344d6ad0030ad036d707dAjax = \URL::to('/').'/api/7f8b55907bfd48d7b91d6640c223b0e9/'.(null == $par18d0628ff9114afabc54c2f4ed0d6e4b ? '-' : ('' == $par18d0628ff9114afabc54c2f4ed0d6e4b ? '-' : $par18d0628ff9114afabc54c2f4ed0d6e4b)).'/{page}/{pagesize}/{orderColumn}/{orderType}';

        // Recuperar Centros Trabajo por users - Recuperar Centros Trabajo por users

        $par8680722284074ed2bc9383a1b02ced50 = $request->input('pk_usuario');

        if (null == $par8680722284074ed2bc9383a1b02ced50) {
            $par8680722284074ed2bc9383a1b02ced50 = '0';
        }

        $par6185a7056560433494dba94e9ae591075fa771bcc3264e90a4ca2321bb523aab = 0;

        if (null == $par6185a7056560433494dba94e9ae591075fa771bcc3264e90a4ca2321bb523aab) {
            $par6185a7056560433494dba94e9ae591075fa771bcc3264e90a4ca2321bb523aab = '0';
        }

        $par0a0ce2af85ab462a808e0270326fb8605fa771bcc3264e90a4ca2321bb523aab = 0;

        if (null == $par0a0ce2af85ab462a808e0270326fb8605fa771bcc3264e90a4ca2321bb523aab) {
            $par0a0ce2af85ab462a808e0270326fb8605fa771bcc3264e90a4ca2321bb523aab = '0';
        }

        $par5551ae677d6b488ebd38625d0f5d9fce5fa771bcc3264e90a4ca2321bb523aab = '';

        if ('-' == $par5551ae677d6b488ebd38625d0f5d9fce5fa771bcc3264e90a4ca2321bb523aab) {
            $par5551ae677d6b488ebd38625d0f5d9fce5fa771bcc3264e90a4ca2321bb523aab = null;
        }

        if (null == $par5551ae677d6b488ebd38625d0f5d9fce5fa771bcc3264e90a4ca2321bb523aab) {
            $par5551ae677d6b488ebd38625d0f5d9fce5fa771bcc3264e90a4ca2321bb523aab = '';
        }

        $par8fce8a73ac264e4a8f3b56d8b991b8a55fa771bcc3264e90a4ca2321bb523aab = '';

        if ('-' == $par8fce8a73ac264e4a8f3b56d8b991b8a55fa771bcc3264e90a4ca2321bb523aab) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a55fa771bcc3264e90a4ca2321bb523aab = null;
        }

        if (null == $par8fce8a73ac264e4a8f3b56d8b991b8a55fa771bcc3264e90a4ca2321bb523aab) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a55fa771bcc3264e90a4ca2321bb523aab = '';
        }

        $v5fa771bcc3264e90a4ca2321bb523aab = \App\repf782f923fd0247bd9f4010b717e52999::mt4b38c8745c3c4a5cb4519b394881fe82($par8680722284074ed2bc9383a1b02ced50, $par6185a7056560433494dba94e9ae591075fa771bcc3264e90a4ca2321bb523aab, $par0a0ce2af85ab462a808e0270326fb8605fa771bcc3264e90a4ca2321bb523aab, $par5551ae677d6b488ebd38625d0f5d9fce5fa771bcc3264e90a4ca2321bb523aab, $par8fce8a73ac264e4a8f3b56d8b991b8a55fa771bcc3264e90a4ca2321bb523aab);

        $v5fa771bcc3264e90a4ca2321bb523aabAjax = \URL::to('/').'/api/4b38c8745c3c4a5cb4519b394881fe82/'.(null == $par8680722284074ed2bc9383a1b02ced50 ? '-' : ('' == $par8680722284074ed2bc9383a1b02ced50 ? '-' : $par8680722284074ed2bc9383a1b02ced50)).'/{page}/{pagesize}/{orderColumn}/{orderType}';
        ...
        $arrWiths['v9000ea4814e34e6ea661d5990ef40fe6'] = isset($v9000ea4814e34e6ea661d5990ef40fe6) ? $v9000ea4814e34e6ea661d5990ef40fe6 : '';
        $arrWiths['v9000ea4814e34e6ea661d5990ef40fe6Ajax'] = isset($v9000ea4814e34e6ea661d5990ef40fe6Ajax) ? $v9000ea4814e34e6ea661d5990ef40fe6Ajax : '';
        $arrWiths['v1cb81a917d724f1da9716dc4f68c0121'] = isset($v1cb81a917d724f1da9716dc4f68c0121) ? $v1cb81a917d724f1da9716dc4f68c0121 : '';
        $arrWiths['v1cb81a917d724f1da9716dc4f68c0121Ajax'] = isset($v1cb81a917d724f1da9716dc4f68c0121Ajax) ? $v1cb81a917d724f1da9716dc4f68c0121Ajax : '';
        $arrWiths['v32af4de345d344d6ad0030ad036d707d'] = isset($v32af4de345d344d6ad0030ad036d707d) ? $v32af4de345d344d6ad0030ad036d707d : '';
        $arrWiths['v32af4de345d344d6ad0030ad036d707dAjax'] = isset($v32af4de345d344d6ad0030ad036d707dAjax) ? $v32af4de345d344d6ad0030ad036d707dAjax : '';
        $arrWiths['v5fa771bcc3264e90a4ca2321bb523aab'] = isset($v5fa771bcc3264e90a4ca2321bb523aab) ? $v5fa771bcc3264e90a4ca2321bb523aab : '';
        $arrWiths['v5fa771bcc3264e90a4ca2321bb523aabAjax'] = isset($v5fa771bcc3264e90a4ca2321bb523aabAjax) ? $v5fa771bcc3264e90a4ca2321bb523aabAjax : '';
        $arrWiths['v9cf71462dc3c4ab5bd937588c60a28da'] = isset($v9cf71462dc3c4ab5bd937588c60a28da) ? $v9cf71462dc3c4ab5bd937588c60a28da : '';
        ...
        $response = new \Illuminate\Http\Response(view('e941c3f8d57a4e048ea2142c8fd7fcc5.Index', $arrWiths)->with('title', $arrWiths['title'])->with('vSessionTimeout', \Config::get('session.lifetime') * 60));
