...
/**
 * productorGeoForm - productorGeoForm.
 */
class pg6dc2ca17a8fb4e2bbb8e5246eb866afeController extends Controller
{
    /**
    ...
    public function post(Request $request)
    {
        ...
        // Guardar productor Geolocalizacion - Guardar productor Geolocalizacion
        if (null != $request->input('ctl3f4c37c6271849e1afdcbaa396e78f3f_36653926384f4810bd5a1e74701c50b0') && null != $request->input('hid36653926384f4810bd5a1e74701c50b0') && '36653926384f4810bd5a1e74701c50b0' == $request->input('hid36653926384f4810bd5a1e74701c50b0')) {
            $key = 0;
            $isNew = false;
            ...
            if (null != $request->input('ctl21ba4531a57749f8b6292d4978e35f0f_36653926384f4810bd5a1e74701c50b0')) {
                $tb->FL_LATITUD = $request->input('ctl21ba4531a57749f8b6292d4978e35f0f_36653926384f4810bd5a1e74701c50b0'); //FL_LATITUD
            } elseif (null == $request->input('ctl21ba4531a57749f8b6292d4978e35f0f_36653926384f4810bd5a1e74701c50b0')) {
                $tb->FL_LATITUD = null;
            }

            if (null != $request->input('ctl7ba3dfabab314324a98079332a684437_36653926384f4810bd5a1e74701c50b0')) {
                $tb->FL_LONGITUD = $request->input('ctl7ba3dfabab314324a98079332a684437_36653926384f4810bd5a1e74701c50b0'); //FL_LONGITUD
            } elseif (null == $request->input('ctl7ba3dfabab314324a98079332a684437_36653926384f4810bd5a1e74701c50b0')) {
                $tb->FL_LONGITUD = null;
            }
    ...
    public function index(Request $request)
    {
        ...
        // Recueperar Geolocalizacion Productor - Recueperar Geolocalizacion Productor
        ...
        $par6185a7056560433494dba94e9ae59107b9c49719c06b4487808a3cc881eba551 = 0;

        if (null == $par6185a7056560433494dba94e9ae59107b9c49719c06b4487808a3cc881eba551) {
            $par6185a7056560433494dba94e9ae59107b9c49719c06b4487808a3cc881eba551 = '0';
        }

        $par0a0ce2af85ab462a808e0270326fb860b9c49719c06b4487808a3cc881eba551 = 0;

        if (null == $par0a0ce2af85ab462a808e0270326fb860b9c49719c06b4487808a3cc881eba551) {
            $par0a0ce2af85ab462a808e0270326fb860b9c49719c06b4487808a3cc881eba551 = '0';
        }

        $par5551ae677d6b488ebd38625d0f5d9fceb9c49719c06b4487808a3cc881eba551 = '';

        if ('-' == $par5551ae677d6b488ebd38625d0f5d9fceb9c49719c06b4487808a3cc881eba551) {
            $par5551ae677d6b488ebd38625d0f5d9fceb9c49719c06b4487808a3cc881eba551 = null;
        }

        if (null == $par5551ae677d6b488ebd38625d0f5d9fceb9c49719c06b4487808a3cc881eba551) {
            $par5551ae677d6b488ebd38625d0f5d9fceb9c49719c06b4487808a3cc881eba551 = '';
        }

        $par8fce8a73ac264e4a8f3b56d8b991b8a5b9c49719c06b4487808a3cc881eba551 = '';

        if ('-' == $par8fce8a73ac264e4a8f3b56d8b991b8a5b9c49719c06b4487808a3cc881eba551) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a5b9c49719c06b4487808a3cc881eba551 = null;
        }

        if (null == $par8fce8a73ac264e4a8f3b56d8b991b8a5b9c49719c06b4487808a3cc881eba551) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a5b9c49719c06b4487808a3cc881eba551 = '';
        }

        $vb9c49719c06b4487808a3cc881eba551 = \App\repf782f923fd0247bd9f4010b717e52999::mt87f3ff2a9cc344c58921f820b898209f($par81d62592acd84ddb8e7915b8e90881d2, $par6185a7056560433494dba94e9ae59107b9c49719c06b4487808a3cc881eba551, $par0a0ce2af85ab462a808e0270326fb860b9c49719c06b4487808a3cc881eba551, $par5551ae677d6b488ebd38625d0f5d9fceb9c49719c06b4487808a3cc881eba551, $par8fce8a73ac264e4a8f3b56d8b991b8a5b9c49719c06b4487808a3cc881eba551);

        $vb9c49719c06b4487808a3cc881eba551Ajax = \URL::to('/').'/api/87f3ff2a9cc344c58921f820b898209f/'.(null == $par81d62592acd84ddb8e7915b8e90881d2 ? '-' : ('' == $par81d62592acd84ddb8e7915b8e90881d2 ? '-' : $par81d62592acd84ddb8e7915b8e90881d2)).'/{page}/{pagesize}/{orderColumn}/{orderType}';
        ...
        $arrWiths['vb9c49719c06b4487808a3cc881eba551'] = isset($vb9c49719c06b4487808a3cc881eba551) ? $vb9c49719c06b4487808a3cc881eba551 : '';
        $arrWiths['vb9c49719c06b4487808a3cc881eba551Ajax'] = isset($vb9c49719c06b4487808a3cc881eba551Ajax) ? $vb9c49719c06b4487808a3cc881eba551Ajax : '';
        ...
        $response = new \Illuminate\Http\Response(view('6dc2ca17a8fb4e2bbb8e5246eb866afe.Index', $arrWiths)->with('title', $arrWiths['title'])->with('vSessionTimeout', \Config::get('session.lifetime') * 60));
