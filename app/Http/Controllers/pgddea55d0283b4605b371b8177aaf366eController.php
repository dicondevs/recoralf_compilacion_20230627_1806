...
/**
 * boletasGrid - boletasGrid.
 */
class pgddea55d0283b4605b371b8177aaf366eController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        // Boletas Semanas - Boletas Semanas

        $par39bedec193a54615beb54d9b6484be8a = $request->input('productor');

        if (null == $par39bedec193a54615beb54d9b6484be8a) {
            $par39bedec193a54615beb54d9b6484be8a = '-';
        }

        $par708c184650d94901b621b577d4577e2f = $request->input('semana');

        if (null == $par708c184650d94901b621b577d4577e2f) {
            $par708c184650d94901b621b577d4577e2f = '-';
        }

        $par6185a7056560433494dba94e9ae5910709968a12097848159bcc84c7e0e954f1 = 0;

        if (null == $par6185a7056560433494dba94e9ae5910709968a12097848159bcc84c7e0e954f1) {
            $par6185a7056560433494dba94e9ae5910709968a12097848159bcc84c7e0e954f1 = '0';
        }

        $par0a0ce2af85ab462a808e0270326fb86009968a12097848159bcc84c7e0e954f1 = 0;

        if (null == $par0a0ce2af85ab462a808e0270326fb86009968a12097848159bcc84c7e0e954f1) {
            $par0a0ce2af85ab462a808e0270326fb86009968a12097848159bcc84c7e0e954f1 = '0';
        }

        $par5551ae677d6b488ebd38625d0f5d9fce09968a12097848159bcc84c7e0e954f1 = '';

        if ('-' == $par5551ae677d6b488ebd38625d0f5d9fce09968a12097848159bcc84c7e0e954f1) {
            $par5551ae677d6b488ebd38625d0f5d9fce09968a12097848159bcc84c7e0e954f1 = null;
        }

        if (null == $par5551ae677d6b488ebd38625d0f5d9fce09968a12097848159bcc84c7e0e954f1) {
            $par5551ae677d6b488ebd38625d0f5d9fce09968a12097848159bcc84c7e0e954f1 = '';
        }

        $par8fce8a73ac264e4a8f3b56d8b991b8a509968a12097848159bcc84c7e0e954f1 = '';

        if ('-' == $par8fce8a73ac264e4a8f3b56d8b991b8a509968a12097848159bcc84c7e0e954f1) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a509968a12097848159bcc84c7e0e954f1 = null;
        }

        if (null == $par8fce8a73ac264e4a8f3b56d8b991b8a509968a12097848159bcc84c7e0e954f1) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a509968a12097848159bcc84c7e0e954f1 = '';
        }

        $v09968a12097848159bcc84c7e0e954f1Ajax = \URL::to('/').'/api/203dcfc17e354b038afdb62d24b2e913/'.(null == $par39bedec193a54615beb54d9b6484be8a ? '-' : ('' == $par39bedec193a54615beb54d9b6484be8a ? '-' : $par39bedec193a54615beb54d9b6484be8a)).'/'.(null == $par708c184650d94901b621b577d4577e2f ? '-' : ('' == $par708c184650d94901b621b577d4577e2f ? '-' : $par708c184650d94901b621b577d4577e2f)).'/{page}/{pagesize}/{orderColumn}/{orderType}';

        // Boletas Semanas - Boletas Semanas

        $v09968a12097848159bcc84c7e0e954f1Count = \App\repf782f923fd0247bd9f4010b717e52999::mt203dcfc17e354b038afdb62d24b2e913Count($par39bedec193a54615beb54d9b6484be8a, $par708c184650d94901b621b577d4577e2f, $par6185a7056560433494dba94e9ae5910709968a12097848159bcc84c7e0e954f1, $par0a0ce2af85ab462a808e0270326fb86009968a12097848159bcc84c7e0e954f1, $par5551ae677d6b488ebd38625d0f5d9fce09968a12097848159bcc84c7e0e954f1, $par8fce8a73ac264e4a8f3b56d8b991b8a509968a12097848159bcc84c7e0e954f1);

        //$v09968a12097848159bcc84c7e0e954f1CountAjax =  \URL::to('/')."/api/203dcfc17e354b038afdb62d24b2e913Count{ParametersAjax}/{page}/{pagesize}/{orderColumn}/{orderType}";

        // Lista de codigo productor - Lista de codigo productor
        ...
        $par6185a7056560433494dba94e9ae59107994087834a6b4363bff5a63b400835b4 = 0;

        if (null == $par6185a7056560433494dba94e9ae59107994087834a6b4363bff5a63b400835b4) {
            $par6185a7056560433494dba94e9ae59107994087834a6b4363bff5a63b400835b4 = '0';
        }

        $par0a0ce2af85ab462a808e0270326fb860994087834a6b4363bff5a63b400835b4 = 0;

        if (null == $par0a0ce2af85ab462a808e0270326fb860994087834a6b4363bff5a63b400835b4) {
            $par0a0ce2af85ab462a808e0270326fb860994087834a6b4363bff5a63b400835b4 = '0';
        }

        $par5551ae677d6b488ebd38625d0f5d9fce994087834a6b4363bff5a63b400835b4 = '';

        if ('-' == $par5551ae677d6b488ebd38625d0f5d9fce994087834a6b4363bff5a63b400835b4) {
            $par5551ae677d6b488ebd38625d0f5d9fce994087834a6b4363bff5a63b400835b4 = null;
        }

        if (null == $par5551ae677d6b488ebd38625d0f5d9fce994087834a6b4363bff5a63b400835b4) {
            $par5551ae677d6b488ebd38625d0f5d9fce994087834a6b4363bff5a63b400835b4 = '';
        }

        $par8fce8a73ac264e4a8f3b56d8b991b8a5994087834a6b4363bff5a63b400835b4 = '';

        if ('-' == $par8fce8a73ac264e4a8f3b56d8b991b8a5994087834a6b4363bff5a63b400835b4) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a5994087834a6b4363bff5a63b400835b4 = null;
        }

        if (null == $par8fce8a73ac264e4a8f3b56d8b991b8a5994087834a6b4363bff5a63b400835b4) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a5994087834a6b4363bff5a63b400835b4 = '';
        }

        $v994087834a6b4363bff5a63b400835b4 = \App\repf782f923fd0247bd9f4010b717e52999::mt78425363b8964e69b078a6c87a0bf345($par4a3af8ffced0440a861dfc0a64a7df881, $par00626c2ae46a478aa2100971433ea90d1, $par6185a7056560433494dba94e9ae59107994087834a6b4363bff5a63b400835b4, $par0a0ce2af85ab462a808e0270326fb860994087834a6b4363bff5a63b400835b4, $par5551ae677d6b488ebd38625d0f5d9fce994087834a6b4363bff5a63b400835b4, $par8fce8a73ac264e4a8f3b56d8b991b8a5994087834a6b4363bff5a63b400835b4);

        $v994087834a6b4363bff5a63b400835b4Ajax = \URL::to('/').'/api/78425363b8964e69b078a6c87a0bf345/'.(null == $par4a3af8ffced0440a861dfc0a64a7df881 ? '-' : ('' == $par4a3af8ffced0440a861dfc0a64a7df881 ? '-' : $par4a3af8ffced0440a861dfc0a64a7df881)).'/'.(null == $par00626c2ae46a478aa2100971433ea90d1 ? '-' : ('' == $par00626c2ae46a478aa2100971433ea90d1 ? '-' : $par00626c2ae46a478aa2100971433ea90d1)).'/{page}/{pagesize}/{orderColumn}/{orderType}';

        // Lista de Semanas - Lista de Semanas

        $par6185a7056560433494dba94e9ae59107b35ecfd669ed439680f1a0aa8c8c6df0 = 0;

        if (null == $par6185a7056560433494dba94e9ae59107b35ecfd669ed439680f1a0aa8c8c6df0) {
            $par6185a7056560433494dba94e9ae59107b35ecfd669ed439680f1a0aa8c8c6df0 = '0';
        }

        $par0a0ce2af85ab462a808e0270326fb860b35ecfd669ed439680f1a0aa8c8c6df0 = 0;

        if (null == $par0a0ce2af85ab462a808e0270326fb860b35ecfd669ed439680f1a0aa8c8c6df0) {
            $par0a0ce2af85ab462a808e0270326fb860b35ecfd669ed439680f1a0aa8c8c6df0 = '0';
        }

        $par5551ae677d6b488ebd38625d0f5d9fceb35ecfd669ed439680f1a0aa8c8c6df0 = '';

        if ('-' == $par5551ae677d6b488ebd38625d0f5d9fceb35ecfd669ed439680f1a0aa8c8c6df0) {
            $par5551ae677d6b488ebd38625d0f5d9fceb35ecfd669ed439680f1a0aa8c8c6df0 = null;
        }

        if (null == $par5551ae677d6b488ebd38625d0f5d9fceb35ecfd669ed439680f1a0aa8c8c6df0) {
            $par5551ae677d6b488ebd38625d0f5d9fceb35ecfd669ed439680f1a0aa8c8c6df0 = '';
        }

        $par8fce8a73ac264e4a8f3b56d8b991b8a5b35ecfd669ed439680f1a0aa8c8c6df0 = '';

        if ('-' == $par8fce8a73ac264e4a8f3b56d8b991b8a5b35ecfd669ed439680f1a0aa8c8c6df0) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a5b35ecfd669ed439680f1a0aa8c8c6df0 = null;
        }

        if (null == $par8fce8a73ac264e4a8f3b56d8b991b8a5b35ecfd669ed439680f1a0aa8c8c6df0) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a5b35ecfd669ed439680f1a0aa8c8c6df0 = '';
        }

        $vb35ecfd669ed439680f1a0aa8c8c6df0 = \App\repf782f923fd0247bd9f4010b717e52999::mtf3b6d1a392b14ca986fa6ded0a35c490($par6185a7056560433494dba94e9ae59107b35ecfd669ed439680f1a0aa8c8c6df0, $par0a0ce2af85ab462a808e0270326fb860b35ecfd669ed439680f1a0aa8c8c6df0, $par5551ae677d6b488ebd38625d0f5d9fceb35ecfd669ed439680f1a0aa8c8c6df0, $par8fce8a73ac264e4a8f3b56d8b991b8a5b35ecfd669ed439680f1a0aa8c8c6df0);

        $vb35ecfd669ed439680f1a0aa8c8c6df0Ajax = \URL::to('/').'/api/f3b6d1a392b14ca986fa6ded0a35c490/{page}/{pagesize}/{orderColumn}/{orderType}';
        ...
        $par6185a7056560433494dba94e9ae59107c15071b57337400998941bee03d9f5d7 = 0;

        if (null == $par6185a7056560433494dba94e9ae59107c15071b57337400998941bee03d9f5d7) {
            $par6185a7056560433494dba94e9ae59107c15071b57337400998941bee03d9f5d7 = '0';
        }

        $par0a0ce2af85ab462a808e0270326fb860c15071b57337400998941bee03d9f5d7 = 0;

        if (null == $par0a0ce2af85ab462a808e0270326fb860c15071b57337400998941bee03d9f5d7) {
            $par0a0ce2af85ab462a808e0270326fb860c15071b57337400998941bee03d9f5d7 = '0';
        }

        $par5551ae677d6b488ebd38625d0f5d9fcec15071b57337400998941bee03d9f5d7 = '';

        if ('-' == $par5551ae677d6b488ebd38625d0f5d9fcec15071b57337400998941bee03d9f5d7) {
            $par5551ae677d6b488ebd38625d0f5d9fcec15071b57337400998941bee03d9f5d7 = null;
        }

        if (null == $par5551ae677d6b488ebd38625d0f5d9fcec15071b57337400998941bee03d9f5d7) {
            $par5551ae677d6b488ebd38625d0f5d9fcec15071b57337400998941bee03d9f5d7 = '';
        }

        $par8fce8a73ac264e4a8f3b56d8b991b8a5c15071b57337400998941bee03d9f5d7 = '';

        if ('-' == $par8fce8a73ac264e4a8f3b56d8b991b8a5c15071b57337400998941bee03d9f5d7) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a5c15071b57337400998941bee03d9f5d7 = null;
        }

        if (null == $par8fce8a73ac264e4a8f3b56d8b991b8a5c15071b57337400998941bee03d9f5d7) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a5c15071b57337400998941bee03d9f5d7 = '';
        }

        $vc15071b57337400998941bee03d9f5d7 = \App\repf782f923fd0247bd9f4010b717e52999::mt1f2e4a280a3c490cb91d2b2e03e8c897($par915f2ce45e324305adf910faaabe6120, $par6185a7056560433494dba94e9ae59107c15071b57337400998941bee03d9f5d7, $par0a0ce2af85ab462a808e0270326fb860c15071b57337400998941bee03d9f5d7, $par5551ae677d6b488ebd38625d0f5d9fcec15071b57337400998941bee03d9f5d7, $par8fce8a73ac264e4a8f3b56d8b991b8a5c15071b57337400998941bee03d9f5d7);

        $vc15071b57337400998941bee03d9f5d7Ajax = \URL::to('/').'/api/1f2e4a280a3c490cb91d2b2e03e8c897/'.(null == $par915f2ce45e324305adf910faaabe6120 ? '-' : ('' == $par915f2ce45e324305adf910faaabe6120 ? '-' : $par915f2ce45e324305adf910faaabe6120)).'/{page}/{pagesize}/{orderColumn}/{orderType}';
        ...
        // Tabla de Datos Boletas - Tabla de Datos Boletas
        $v1dab9c7878f04e4bb5fdf1fb40a81e9e = '';
        $v1dab9c7878f04e4bb5fdf1fb40a81e9eTotal = (isset($v09968a12097848159bcc84c7e0e954f1Count) ? $v09968a12097848159bcc84c7e0e954f1Count : 0);
        $v1dab9c7878f04e4bb5fdf1fb40a81e9eAjax = (isset($v09968a12097848159bcc84c7e0e954f1Ajax) ? $v09968a12097848159bcc84c7e0e954f1Ajax : '');

        $arrWiths['v09968a12097848159bcc84c7e0e954f1Count'] = isset($v09968a12097848159bcc84c7e0e954f1Count) ? $v09968a12097848159bcc84c7e0e954f1Count : '';
        $arrWiths['v09968a12097848159bcc84c7e0e954f1Ajax'] = isset($v09968a12097848159bcc84c7e0e954f1Ajax) ? $v09968a12097848159bcc84c7e0e954f1Ajax : '';
        $arrWiths['v994087834a6b4363bff5a63b400835b4'] = isset($v994087834a6b4363bff5a63b400835b4) ? $v994087834a6b4363bff5a63b400835b4 : '';
        $arrWiths['v994087834a6b4363bff5a63b400835b4Ajax'] = isset($v994087834a6b4363bff5a63b400835b4Ajax) ? $v994087834a6b4363bff5a63b400835b4Ajax : '';
        $arrWiths['vb35ecfd669ed439680f1a0aa8c8c6df0'] = isset($vb35ecfd669ed439680f1a0aa8c8c6df0) ? $vb35ecfd669ed439680f1a0aa8c8c6df0 : '';
        $arrWiths['vb35ecfd669ed439680f1a0aa8c8c6df0Ajax'] = isset($vb35ecfd669ed439680f1a0aa8c8c6df0Ajax) ? $vb35ecfd669ed439680f1a0aa8c8c6df0Ajax : '';
        $arrWiths['vc15071b57337400998941bee03d9f5d7'] = isset($vc15071b57337400998941bee03d9f5d7) ? $vc15071b57337400998941bee03d9f5d7 : '';
        $arrWiths['vc15071b57337400998941bee03d9f5d7Ajax'] = isset($vc15071b57337400998941bee03d9f5d7Ajax) ? $vc15071b57337400998941bee03d9f5d7Ajax : '';
        ...
        $arrWiths['v1dab9c7878f04e4bb5fdf1fb40a81e9e'] = isset($v1dab9c7878f04e4bb5fdf1fb40a81e9e) ? $v1dab9c7878f04e4bb5fdf1fb40a81e9e : '';
        $arrWiths['v1dab9c7878f04e4bb5fdf1fb40a81e9eTotal'] = isset($v1dab9c7878f04e4bb5fdf1fb40a81e9eTotal) ? $v1dab9c7878f04e4bb5fdf1fb40a81e9eTotal : '';
        $arrWiths['v1dab9c7878f04e4bb5fdf1fb40a81e9eAjax'] = isset($v1dab9c7878f04e4bb5fdf1fb40a81e9eAjax) ? $v1dab9c7878f04e4bb5fdf1fb40a81e9eAjax : '';
        ...
        $response = new \Illuminate\Http\Response(view('ddea55d0283b4605b371b8177aaf366e.Index', $arrWiths)->with('title', $arrWiths['title'])->with('vSessionTimeout', \Config::get('session.lifetime') * 60));
