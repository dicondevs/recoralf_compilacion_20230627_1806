...
// Creado               martes, 27 de junio de 2023 17:57:01
...
/**
 * estimulosGrid - estimulosGrid.
 */
class pg3885b7c9a46b452eaad0a68345de9572Controller extends Controller
{
    /**
    ...
    public function post(Request $request)
    {
        ...
        if (null != $request->input('ctlf7270deb27574fd089e1c6db5aad39d6_b0687122d01d48068a2f11551500e94c') && null != $request->input('hidb0687122d01d48068a2f11551500e94c') && 'b0687122d01d48068a2f11551500e94c' == $request->input('hidb0687122d01d48068a2f11551500e94c')) {
            $key = 0;
            $isNew = false;
            if (null != $request->input('g')) {
                $key = $request->input('g');
            }

            $tb = \App\tb40ccdb05a4444e9ea4f733c5026e8296::where('PK_TIPO_ESTIMULOS', $key)->first();
            if (null == $tb) {
                $isNew = true;
                $tb = new \App\tb40ccdb05a4444e9ea4f733c5026e8296();
            }

            if (null != $request->input('ctl2dcc66101cb74ddfb5c0a7c45eda656f_b0687122d01d48068a2f11551500e94c')) {
                $tb->FL_NOMBRE = $request->input('ctl2dcc66101cb74ddfb5c0a7c45eda656f_b0687122d01d48068a2f11551500e94c'); //FL_NOMBRE
            } elseif (null == $request->input('ctl2dcc66101cb74ddfb5c0a7c45eda656f_b0687122d01d48068a2f11551500e94c')) {
                $tb->FL_NOMBRE = null;
            }
            if (null != $request->input('ctl41332b542a734638b2276a180f65af00_b0687122d01d48068a2f11551500e94c')) {
    ...
    public function index(Request $request)
    {
        ...
        // Lista Tipo Estimulo - Lista Tipo Estimulo

        $par6185a7056560433494dba94e9ae5910790b2ee326db84bcdbd7adad7afeefa89 = 0;

        if (null == $par6185a7056560433494dba94e9ae5910790b2ee326db84bcdbd7adad7afeefa89) {
            $par6185a7056560433494dba94e9ae5910790b2ee326db84bcdbd7adad7afeefa89 = '0';
        }

        $par0a0ce2af85ab462a808e0270326fb86090b2ee326db84bcdbd7adad7afeefa89 = 0;

        if (null == $par0a0ce2af85ab462a808e0270326fb86090b2ee326db84bcdbd7adad7afeefa89) {
            $par0a0ce2af85ab462a808e0270326fb86090b2ee326db84bcdbd7adad7afeefa89 = '0';
        }

        $par5551ae677d6b488ebd38625d0f5d9fce90b2ee326db84bcdbd7adad7afeefa89 = '';

        if ('-' == $par5551ae677d6b488ebd38625d0f5d9fce90b2ee326db84bcdbd7adad7afeefa89) {
            $par5551ae677d6b488ebd38625d0f5d9fce90b2ee326db84bcdbd7adad7afeefa89 = null;
        }

        if (null == $par5551ae677d6b488ebd38625d0f5d9fce90b2ee326db84bcdbd7adad7afeefa89) {
            $par5551ae677d6b488ebd38625d0f5d9fce90b2ee326db84bcdbd7adad7afeefa89 = '';
        }

        $par8fce8a73ac264e4a8f3b56d8b991b8a590b2ee326db84bcdbd7adad7afeefa89 = '';

        if ('-' == $par8fce8a73ac264e4a8f3b56d8b991b8a590b2ee326db84bcdbd7adad7afeefa89) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a590b2ee326db84bcdbd7adad7afeefa89 = null;
        }

        if (null == $par8fce8a73ac264e4a8f3b56d8b991b8a590b2ee326db84bcdbd7adad7afeefa89) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a590b2ee326db84bcdbd7adad7afeefa89 = '';
        }

        $v90b2ee326db84bcdbd7adad7afeefa89Ajax = \URL::to('/').'/api/ff0d208e1b5f4df0b5c17a6a88cefa73/{page}/{pagesize}/{orderColumn}/{orderType}';

        // Lista Tipo Estimulo - Lista Tipo Estimulo

        $v90b2ee326db84bcdbd7adad7afeefa89Count = \App\repf782f923fd0247bd9f4010b717e52999::mtff0d208e1b5f4df0b5c17a6a88cefa73Count($par6185a7056560433494dba94e9ae5910790b2ee326db84bcdbd7adad7afeefa89, $par0a0ce2af85ab462a808e0270326fb86090b2ee326db84bcdbd7adad7afeefa89, $par5551ae677d6b488ebd38625d0f5d9fce90b2ee326db84bcdbd7adad7afeefa89, $par8fce8a73ac264e4a8f3b56d8b991b8a590b2ee326db84bcdbd7adad7afeefa89);

        //$v90b2ee326db84bcdbd7adad7afeefa89CountAjax =  \URL::to('/')."/api/ff0d208e1b5f4df0b5c17a6a88cefa73Count{ParametersAjax}/{page}/{pagesize}/{orderColumn}/{orderType}";

        // Recuperar tipo Estimulos - Recuperar tipo Estimulos

        $par95be5e9289b14a9c94b39bec9354679e = $request->input('g');

        if (null == $par95be5e9289b14a9c94b39bec9354679e) {
            $par95be5e9289b14a9c94b39bec9354679e = '0';
        }

        $par6185a7056560433494dba94e9ae591071f75c6514d7e4e0ab67fcda1e054ef28 = 0;

        if (null == $par6185a7056560433494dba94e9ae591071f75c6514d7e4e0ab67fcda1e054ef28) {
            $par6185a7056560433494dba94e9ae591071f75c6514d7e4e0ab67fcda1e054ef28 = '0';
        }

        $par0a0ce2af85ab462a808e0270326fb8601f75c6514d7e4e0ab67fcda1e054ef28 = 0;

        if (null == $par0a0ce2af85ab462a808e0270326fb8601f75c6514d7e4e0ab67fcda1e054ef28) {
            $par0a0ce2af85ab462a808e0270326fb8601f75c6514d7e4e0ab67fcda1e054ef28 = '0';
        }

        $par5551ae677d6b488ebd38625d0f5d9fce1f75c6514d7e4e0ab67fcda1e054ef28 = '';

        if ('-' == $par5551ae677d6b488ebd38625d0f5d9fce1f75c6514d7e4e0ab67fcda1e054ef28) {
            $par5551ae677d6b488ebd38625d0f5d9fce1f75c6514d7e4e0ab67fcda1e054ef28 = null;
        }

        if (null == $par5551ae677d6b488ebd38625d0f5d9fce1f75c6514d7e4e0ab67fcda1e054ef28) {
            $par5551ae677d6b488ebd38625d0f5d9fce1f75c6514d7e4e0ab67fcda1e054ef28 = '';
        }

        $par8fce8a73ac264e4a8f3b56d8b991b8a51f75c6514d7e4e0ab67fcda1e054ef28 = '';

        if ('-' == $par8fce8a73ac264e4a8f3b56d8b991b8a51f75c6514d7e4e0ab67fcda1e054ef28) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a51f75c6514d7e4e0ab67fcda1e054ef28 = null;
        }

        if (null == $par8fce8a73ac264e4a8f3b56d8b991b8a51f75c6514d7e4e0ab67fcda1e054ef28) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a51f75c6514d7e4e0ab67fcda1e054ef28 = '';
        }

        $v1f75c6514d7e4e0ab67fcda1e054ef28 = \App\repf782f923fd0247bd9f4010b717e52999::mtc9fa352996814827b5606b0dd1200c92($par95be5e9289b14a9c94b39bec9354679e, $par6185a7056560433494dba94e9ae591071f75c6514d7e4e0ab67fcda1e054ef28, $par0a0ce2af85ab462a808e0270326fb8601f75c6514d7e4e0ab67fcda1e054ef28, $par5551ae677d6b488ebd38625d0f5d9fce1f75c6514d7e4e0ab67fcda1e054ef28, $par8fce8a73ac264e4a8f3b56d8b991b8a51f75c6514d7e4e0ab67fcda1e054ef28);

        $v1f75c6514d7e4e0ab67fcda1e054ef28Ajax = \URL::to('/').'/api/c9fa352996814827b5606b0dd1200c92/'.(null == $par95be5e9289b14a9c94b39bec9354679e ? '-' : ('' == $par95be5e9289b14a9c94b39bec9354679e ? '-' : $par95be5e9289b14a9c94b39bec9354679e)).'/{page}/{pagesize}/{orderColumn}/{orderType}';
        ...
        $par6185a7056560433494dba94e9ae59107c8066ca779fe40e38067c305ff01e4b5 = 0;

        if (null == $par6185a7056560433494dba94e9ae59107c8066ca779fe40e38067c305ff01e4b5) {
            $par6185a7056560433494dba94e9ae59107c8066ca779fe40e38067c305ff01e4b5 = '0';
        }

        $par0a0ce2af85ab462a808e0270326fb860c8066ca779fe40e38067c305ff01e4b5 = 0;

        if (null == $par0a0ce2af85ab462a808e0270326fb860c8066ca779fe40e38067c305ff01e4b5) {
            $par0a0ce2af85ab462a808e0270326fb860c8066ca779fe40e38067c305ff01e4b5 = '0';
        }

        $par5551ae677d6b488ebd38625d0f5d9fcec8066ca779fe40e38067c305ff01e4b5 = '';

        if ('-' == $par5551ae677d6b488ebd38625d0f5d9fcec8066ca779fe40e38067c305ff01e4b5) {
            $par5551ae677d6b488ebd38625d0f5d9fcec8066ca779fe40e38067c305ff01e4b5 = null;
        }

        if (null == $par5551ae677d6b488ebd38625d0f5d9fcec8066ca779fe40e38067c305ff01e4b5) {
            $par5551ae677d6b488ebd38625d0f5d9fcec8066ca779fe40e38067c305ff01e4b5 = '';
        }

        $par8fce8a73ac264e4a8f3b56d8b991b8a5c8066ca779fe40e38067c305ff01e4b5 = '';

        if ('-' == $par8fce8a73ac264e4a8f3b56d8b991b8a5c8066ca779fe40e38067c305ff01e4b5) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a5c8066ca779fe40e38067c305ff01e4b5 = null;
        }

        if (null == $par8fce8a73ac264e4a8f3b56d8b991b8a5c8066ca779fe40e38067c305ff01e4b5) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a5c8066ca779fe40e38067c305ff01e4b5 = '';
        }

        $vc8066ca779fe40e38067c305ff01e4b5 = \App\repf782f923fd0247bd9f4010b717e52999::mtd1203cac9e0a4d2b8d8d3ac5e285d428($par8e9cfc8933a449af80f5fd2fdaf0c7461, $par949ac6762f824f589aa55df91c654a401, $par6185a7056560433494dba94e9ae59107c8066ca779fe40e38067c305ff01e4b5, $par0a0ce2af85ab462a808e0270326fb860c8066ca779fe40e38067c305ff01e4b5, $par5551ae677d6b488ebd38625d0f5d9fcec8066ca779fe40e38067c305ff01e4b5, $par8fce8a73ac264e4a8f3b56d8b991b8a5c8066ca779fe40e38067c305ff01e4b5);

        $vc8066ca779fe40e38067c305ff01e4b5Ajax = \URL::to('/').'/api/d1203cac9e0a4d2b8d8d3ac5e285d428/'.(null == $par8e9cfc8933a449af80f5fd2fdaf0c7461 ? '-' : ('' == $par8e9cfc8933a449af80f5fd2fdaf0c7461 ? '-' : $par8e9cfc8933a449af80f5fd2fdaf0c7461)).'/'.(null == $par949ac6762f824f589aa55df91c654a401 ? '-' : ('' == $par949ac6762f824f589aa55df91c654a401 ? '-' : $par949ac6762f824f589aa55df91c654a401)).'/{page}/{pagesize}/{orderColumn}/{orderType}';
        ...
        // Tabla Tipo Estimulos - Tabla Tipo Estimulos
        $v70ded6b374b84884b00fec0e4dcbd7c1 = '';
        $v70ded6b374b84884b00fec0e4dcbd7c1Total = (isset($v90b2ee326db84bcdbd7adad7afeefa89Count) ? $v90b2ee326db84bcdbd7adad7afeefa89Count : 0);
        $v70ded6b374b84884b00fec0e4dcbd7c1Ajax = (isset($v90b2ee326db84bcdbd7adad7afeefa89Ajax) ? $v90b2ee326db84bcdbd7adad7afeefa89Ajax : '');

        $arrWiths['v90b2ee326db84bcdbd7adad7afeefa89Count'] = isset($v90b2ee326db84bcdbd7adad7afeefa89Count) ? $v90b2ee326db84bcdbd7adad7afeefa89Count : '';
        $arrWiths['v90b2ee326db84bcdbd7adad7afeefa89Ajax'] = isset($v90b2ee326db84bcdbd7adad7afeefa89Ajax) ? $v90b2ee326db84bcdbd7adad7afeefa89Ajax : '';
        $arrWiths['v1f75c6514d7e4e0ab67fcda1e054ef28'] = isset($v1f75c6514d7e4e0ab67fcda1e054ef28) ? $v1f75c6514d7e4e0ab67fcda1e054ef28 : '';
        $arrWiths['v1f75c6514d7e4e0ab67fcda1e054ef28Ajax'] = isset($v1f75c6514d7e4e0ab67fcda1e054ef28Ajax) ? $v1f75c6514d7e4e0ab67fcda1e054ef28Ajax : '';
        $arrWiths['vc8066ca779fe40e38067c305ff01e4b5'] = isset($vc8066ca779fe40e38067c305ff01e4b5) ? $vc8066ca779fe40e38067c305ff01e4b5 : '';
        $arrWiths['vc8066ca779fe40e38067c305ff01e4b5Ajax'] = isset($vc8066ca779fe40e38067c305ff01e4b5Ajax) ? $vc8066ca779fe40e38067c305ff01e4b5Ajax : '';
        ...
        $arrWiths['v70ded6b374b84884b00fec0e4dcbd7c1'] = isset($v70ded6b374b84884b00fec0e4dcbd7c1) ? $v70ded6b374b84884b00fec0e4dcbd7c1 : '';
        $arrWiths['v70ded6b374b84884b00fec0e4dcbd7c1Total'] = isset($v70ded6b374b84884b00fec0e4dcbd7c1Total) ? $v70ded6b374b84884b00fec0e4dcbd7c1Total : '';
        $arrWiths['v70ded6b374b84884b00fec0e4dcbd7c1Ajax'] = isset($v70ded6b374b84884b00fec0e4dcbd7c1Ajax) ? $v70ded6b374b84884b00fec0e4dcbd7c1Ajax : '';
        ...
        $response = new \Illuminate\Http\Response(view('3885b7c9a46b452eaad0a68345de9572.Index', $arrWiths)->with('title', $arrWiths['title'])->with('vSessionTimeout', \Config::get('session.lifetime') * 60));
