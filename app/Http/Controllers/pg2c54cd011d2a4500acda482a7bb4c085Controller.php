...
// Creado               martes, 27 de junio de 2023 17:58:16
...
/**
 * semanasGrid - semanasGrid.
 */
class pg2c54cd011d2a4500acda482a7bb4c085Controller extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        // Tabla de Datos Semanas - Tabla de Datos Semanas

        $parc2dc6bfe440b4046b3462f6f037e3c02 = $request->input('b');

        if ('-' == $parc2dc6bfe440b4046b3462f6f037e3c02) {
            $parc2dc6bfe440b4046b3462f6f037e3c02 = null;
        }

        if (null == $parc2dc6bfe440b4046b3462f6f037e3c02) {
            $parc2dc6bfe440b4046b3462f6f037e3c02 = '-';
        }

        $par6185a7056560433494dba94e9ae59107e166d33740094af58b6fa6117cee7409 = $request->input('p');

        if (null == $par6185a7056560433494dba94e9ae59107e166d33740094af58b6fa6117cee7409) {
            $par6185a7056560433494dba94e9ae59107e166d33740094af58b6fa6117cee7409 = '1';
        }

        $par0a0ce2af85ab462a808e0270326fb860e166d33740094af58b6fa6117cee7409 = $request->input('c');

        if (null == $par0a0ce2af85ab462a808e0270326fb860e166d33740094af58b6fa6117cee7409) {
            $par0a0ce2af85ab462a808e0270326fb860e166d33740094af58b6fa6117cee7409 = '10';
        }

        $par5551ae677d6b488ebd38625d0f5d9fcee166d33740094af58b6fa6117cee7409 = '';

        if ('-' == $par5551ae677d6b488ebd38625d0f5d9fcee166d33740094af58b6fa6117cee7409) {
            $par5551ae677d6b488ebd38625d0f5d9fcee166d33740094af58b6fa6117cee7409 = null;
        }

        if (null == $par5551ae677d6b488ebd38625d0f5d9fcee166d33740094af58b6fa6117cee7409) {
            $par5551ae677d6b488ebd38625d0f5d9fcee166d33740094af58b6fa6117cee7409 = '';
        }

        $par8fce8a73ac264e4a8f3b56d8b991b8a5e166d33740094af58b6fa6117cee7409 = '';

        if ('-' == $par8fce8a73ac264e4a8f3b56d8b991b8a5e166d33740094af58b6fa6117cee7409) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a5e166d33740094af58b6fa6117cee7409 = null;
        }

        if (null == $par8fce8a73ac264e4a8f3b56d8b991b8a5e166d33740094af58b6fa6117cee7409) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a5e166d33740094af58b6fa6117cee7409 = '';
        }

        $ve166d33740094af58b6fa6117cee7409Ajax = \URL::to('/')."/api/f653797b67a241e98e0a363b26f2b0b4/'+encodeURIComponent((($('#ctl3607329572c440d9b68ef4a6c13f5921_a99f16e2a80242f8ac76b63c4c58ef41{Extra}').val() == '' ? '-' : $('#ctl3607329572c440d9b68ef4a6c13f5921_a99f16e2a80242f8ac76b63c4c58ef41{Extra}').val()) != undefined && ($('#ctl3607329572c440d9b68ef4a6c13f5921_a99f16e2a80242f8ac76b63c4c58ef41{Extra}').val() == '' ? '-' : $('#ctl3607329572c440d9b68ef4a6c13f5921_a99f16e2a80242f8ac76b63c4c58ef41{Extra}').val()).length > 0 ? ($('#ctl3607329572c440d9b68ef4a6c13f5921_a99f16e2a80242f8ac76b63c4c58ef41{Extra}').val() == '' ? '-' : $('#ctl3607329572c440d9b68ef4a6c13f5921_a99f16e2a80242f8ac76b63c4c58ef41{Extra}').val()).replace(/\\./g,'---').replace(/\\//g,'___') : ($('#ctl3607329572c440d9b68ef4a6c13f5921_a99f16e2a80242f8ac76b63c4c58ef41{Extra}').val() == '' ? '-' : $('#ctl3607329572c440d9b68ef4a6c13f5921_a99f16e2a80242f8ac76b63c4c58ef41{Extra}').val())))+'/{page}/{pagesize}/{orderColumn}/{orderType}";

        // Tabla de Datos Semanas - Tabla de Datos Semanas

        $ve166d33740094af58b6fa6117cee7409Count = \App\repf782f923fd0247bd9f4010b717e52999::mtf653797b67a241e98e0a363b26f2b0b4Count($parc2dc6bfe440b4046b3462f6f037e3c02, $par6185a7056560433494dba94e9ae59107e166d33740094af58b6fa6117cee7409, $par0a0ce2af85ab462a808e0270326fb860e166d33740094af58b6fa6117cee7409, $par5551ae677d6b488ebd38625d0f5d9fcee166d33740094af58b6fa6117cee7409, $par8fce8a73ac264e4a8f3b56d8b991b8a5e166d33740094af58b6fa6117cee7409);

        //$ve166d33740094af58b6fa6117cee7409CountAjax =  \URL::to('/')."/api/f653797b67a241e98e0a363b26f2b0b4Count{ParametersAjax}/{page}/{pagesize}/{orderColumn}/{orderType}";
        ...
        $par6185a7056560433494dba94e9ae5910710e10de5df2f4354b2e376fdc6f717c0 = 0;

        if (null == $par6185a7056560433494dba94e9ae5910710e10de5df2f4354b2e376fdc6f717c0) {
            $par6185a7056560433494dba94e9ae5910710e10de5df2f4354b2e376fdc6f717c0 = '0';
        }

        $par0a0ce2af85ab462a808e0270326fb86010e10de5df2f4354b2e376fdc6f717c0 = 0;

        if (null == $par0a0ce2af85ab462a808e0270326fb86010e10de5df2f4354b2e376fdc6f717c0) {
            $par0a0ce2af85ab462a808e0270326fb86010e10de5df2f4354b2e376fdc6f717c0 = '0';
        }

        $par5551ae677d6b488ebd38625d0f5d9fce10e10de5df2f4354b2e376fdc6f717c0 = '';

        if ('-' == $par5551ae677d6b488ebd38625d0f5d9fce10e10de5df2f4354b2e376fdc6f717c0) {
            $par5551ae677d6b488ebd38625d0f5d9fce10e10de5df2f4354b2e376fdc6f717c0 = null;
        }

        if (null == $par5551ae677d6b488ebd38625d0f5d9fce10e10de5df2f4354b2e376fdc6f717c0) {
            $par5551ae677d6b488ebd38625d0f5d9fce10e10de5df2f4354b2e376fdc6f717c0 = '';
        }

        $par8fce8a73ac264e4a8f3b56d8b991b8a510e10de5df2f4354b2e376fdc6f717c0 = '';

        if ('-' == $par8fce8a73ac264e4a8f3b56d8b991b8a510e10de5df2f4354b2e376fdc6f717c0) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a510e10de5df2f4354b2e376fdc6f717c0 = null;
        }

        if (null == $par8fce8a73ac264e4a8f3b56d8b991b8a510e10de5df2f4354b2e376fdc6f717c0) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a510e10de5df2f4354b2e376fdc6f717c0 = '';
        }

        $v10e10de5df2f4354b2e376fdc6f717c0 = \App\repf782f923fd0247bd9f4010b717e52999::mtd1203cac9e0a4d2b8d8d3ac5e285d428($par8e9cfc8933a449af80f5fd2fdaf0c7461, $par949ac6762f824f589aa55df91c654a401, $par6185a7056560433494dba94e9ae5910710e10de5df2f4354b2e376fdc6f717c0, $par0a0ce2af85ab462a808e0270326fb86010e10de5df2f4354b2e376fdc6f717c0, $par5551ae677d6b488ebd38625d0f5d9fce10e10de5df2f4354b2e376fdc6f717c0, $par8fce8a73ac264e4a8f3b56d8b991b8a510e10de5df2f4354b2e376fdc6f717c0);

        $v10e10de5df2f4354b2e376fdc6f717c0Ajax = \URL::to('/').'/api/d1203cac9e0a4d2b8d8d3ac5e285d428/'.(null == $par8e9cfc8933a449af80f5fd2fdaf0c7461 ? '-' : ('' == $par8e9cfc8933a449af80f5fd2fdaf0c7461 ? '-' : $par8e9cfc8933a449af80f5fd2fdaf0c7461)).'/'.(null == $par949ac6762f824f589aa55df91c654a401 ? '-' : ('' == $par949ac6762f824f589aa55df91c654a401 ? '-' : $par949ac6762f824f589aa55df91c654a401)).'/{page}/{pagesize}/{orderColumn}/{orderType}';
        ...
        // Tabla de Datos Semana - Tabla de Datos Semana
        $v505876fc262a4cf4a8c0597cbbd4740e = '';
        $v505876fc262a4cf4a8c0597cbbd4740eTotal = (isset($ve166d33740094af58b6fa6117cee7409Count) ? $ve166d33740094af58b6fa6117cee7409Count : 0);
        $v505876fc262a4cf4a8c0597cbbd4740eAjax = (isset($ve166d33740094af58b6fa6117cee7409Ajax) ? $ve166d33740094af58b6fa6117cee7409Ajax : '');

        $arrWiths['ve166d33740094af58b6fa6117cee7409Count'] = isset($ve166d33740094af58b6fa6117cee7409Count) ? $ve166d33740094af58b6fa6117cee7409Count : '';
        $arrWiths['ve166d33740094af58b6fa6117cee7409Ajax'] = isset($ve166d33740094af58b6fa6117cee7409Ajax) ? $ve166d33740094af58b6fa6117cee7409Ajax : '';
        $arrWiths['v10e10de5df2f4354b2e376fdc6f717c0'] = isset($v10e10de5df2f4354b2e376fdc6f717c0) ? $v10e10de5df2f4354b2e376fdc6f717c0 : '';
        $arrWiths['v10e10de5df2f4354b2e376fdc6f717c0Ajax'] = isset($v10e10de5df2f4354b2e376fdc6f717c0Ajax) ? $v10e10de5df2f4354b2e376fdc6f717c0Ajax : '';
        ...
        $arrWiths['v505876fc262a4cf4a8c0597cbbd4740e'] = isset($v505876fc262a4cf4a8c0597cbbd4740e) ? $v505876fc262a4cf4a8c0597cbbd4740e : '';
        $arrWiths['v505876fc262a4cf4a8c0597cbbd4740eTotal'] = isset($v505876fc262a4cf4a8c0597cbbd4740eTotal) ? $v505876fc262a4cf4a8c0597cbbd4740eTotal : '';
        $arrWiths['v505876fc262a4cf4a8c0597cbbd4740eAjax'] = isset($v505876fc262a4cf4a8c0597cbbd4740eAjax) ? $v505876fc262a4cf4a8c0597cbbd4740eAjax : '';
        ...
        $response = new \Illuminate\Http\Response(view('2c54cd011d2a4500acda482a7bb4c085.Index', $arrWiths)->with('title', $arrWiths['title'])->with('vSessionTimeout', \Config::get('session.lifetime') * 60));
