 ...
 * redirigir - redirigir.
 */
class pg3c85bec1cb1c4aa291222cc9f41f57e2Controller extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        $par354d696c9e684306806c0dacf7397ab81 = $request->input('b');

        if (null == $par354d696c9e684306806c0dacf7397ab81) {
            $par354d696c9e684306806c0dacf7397ab81 = '0';
        }

        $paracef50dec05c4ac6aa039c8d7a306b461 = $request->input('a');

        if (null == $paracef50dec05c4ac6aa039c8d7a306b461) {
            $paracef50dec05c4ac6aa039c8d7a306b461 = '0';
        }

        $para98e3976538d4ee0b20ba7ce2dd579341 = $request->session()->get('ses5e122755c3a24f5d8789755168e9de27');

        if (null == $para98e3976538d4ee0b20ba7ce2dd579341) {
            $para98e3976538d4ee0b20ba7ce2dd579341 = '0';
        }

        $v51a05dc2644c4cc986e7014e6a947d9c = \App\repf782f923fd0247bd9f4010b717e52999::mt4dc154931ab347f0bac9ec78cc721ef5($par354d696c9e684306806c0dacf7397ab81, $paracef50dec05c4ac6aa039c8d7a306b461, $para98e3976538d4ee0b20ba7ce2dd579341);

        $v51a05dc2644c4cc986e7014e6a947d9cAjax = \URL::to('/').'/api/4dc154931ab347f0bac9ec78cc721ef5/'.(null == $par354d696c9e684306806c0dacf7397ab81 ? '-' : ('' == $par354d696c9e684306806c0dacf7397ab81 ? '-' : $par354d696c9e684306806c0dacf7397ab81)).'/'.(null == $paracef50dec05c4ac6aa039c8d7a306b461 ? '-' : ('' == $paracef50dec05c4ac6aa039c8d7a306b461 ? '-' : $paracef50dec05c4ac6aa039c8d7a306b461)).'/'.(null == $para98e3976538d4ee0b20ba7ce2dd579341 ? '-' : ('' == $para98e3976538d4ee0b20ba7ce2dd579341 ? '-' : $para98e3976538d4ee0b20ba7ce2dd579341)).'/{page}/{pagesize}/{orderColumn}/{orderType}';

        $arrWiths['v51a05dc2644c4cc986e7014e6a947d9c'] = isset($v51a05dc2644c4cc986e7014e6a947d9c) ? $v51a05dc2644c4cc986e7014e6a947d9c : '';
        ...
        $response = new \Illuminate\Http\Response(view('3c85bec1cb1c4aa291222cc9f41f57e2.Index', $arrWiths)->with('title', $arrWiths['title'])->with('vSessionTimeout', \Config::get('session.lifetime') * 60));
