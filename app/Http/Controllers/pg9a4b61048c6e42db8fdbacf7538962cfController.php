...
/**
 * formValidMenuPerfil - formValidMenuPerfil.
 */
class pg9a4b61048c6e42db8fdbacf7538962cfController extends Controller
{
    /**
    ...
    public function post(Request $request)
    {
        ...
        if (null != $request->input('ctl19b1bedba7d546529c0aa54c7e4d2040_6decdf4dfbec4ff098fb25c95f4bbb2a') && null != $request->input('hid6decdf4dfbec4ff098fb25c95f4bbb2a') && '6decdf4dfbec4ff098fb25c95f4bbb2a' == $request->input('hid6decdf4dfbec4ff098fb25c95f4bbb2a')) {
            $key = 0;
            $isNew = false;
            ...
            if (null != $request->input('ctl4715d58579164ac2ada1ffe7827b84d5_6decdf4dfbec4ff098fb25c95f4bbb2a')) {
                $tb->FL_ALTA = true; //FL_ALTA
            } else {
                $tb->FL_ALTA = false; //FL_ALTA
            }
            if (null != $request->input('ctl7c284763c5f74e84bcdda869c0a22cd5_6decdf4dfbec4ff098fb25c95f4bbb2a')) {
                $tb->FL_CESTATUS = true; //FL_CESTATUS
            } else {
                $tb->FL_CESTATUS = false; //FL_CESTATUS
            }
            if (null != $request->input('ctlebba58002f06461dace9b7a6c4610965_6decdf4dfbec4ff098fb25c95f4bbb2a')) {
                $tb->FL_DETALLE = true; //FL_DETALLE
            } else {
                $tb->FL_DETALLE = false; //FL_DETALLE
            }
            if (null != $request->input('ctl5fbf587916144ef6a86e8f95fa5bbc21_6decdf4dfbec4ff098fb25c95f4bbb2a')) {
                $tb->FL_EDITAR = true; //FL_EDITAR
            } else {
                $tb->FL_EDITAR = false; //FL_EDITAR
            }
            if (null != $request->input('ctl8cbc3b829edd4e6cacd32d2f4b3bc50b_6decdf4dfbec4ff098fb25c95f4bbb2a')) {
                $tb->FL_ELIMINAR = true; //FL_ELIMINAR
            } else {
                $tb->FL_ELIMINAR = false; //FL_ELIMINAR
            }
            if (null != $request->input('ctl59039a48aa9e420da016df4a5746af49_6decdf4dfbec4ff098fb25c95f4bbb2a')) {
                $tb->FL_VALIDAR = true; //FL_VALIDAR
            } else {
                $tb->FL_VALIDAR = false; //FL_VALIDAR
            }
    ...
    public function index(Request $request)
    {
        ...
        $parbd07f901e7a64d0e980d949d26e42bbd = $request->input('u');

        if (null == $parbd07f901e7a64d0e980d949d26e42bbd) {
            $parbd07f901e7a64d0e980d949d26e42bbd = '0';
        }

        $par6185a7056560433494dba94e9ae591070b1550e9ab6a4ebc9d96c35de78b2e99 = 0;

        if (null == $par6185a7056560433494dba94e9ae591070b1550e9ab6a4ebc9d96c35de78b2e99) {
            $par6185a7056560433494dba94e9ae591070b1550e9ab6a4ebc9d96c35de78b2e99 = '0';
        }

        $par0a0ce2af85ab462a808e0270326fb8600b1550e9ab6a4ebc9d96c35de78b2e99 = 0;

        if (null == $par0a0ce2af85ab462a808e0270326fb8600b1550e9ab6a4ebc9d96c35de78b2e99) {
            $par0a0ce2af85ab462a808e0270326fb8600b1550e9ab6a4ebc9d96c35de78b2e99 = '0';
        }

        $par5551ae677d6b488ebd38625d0f5d9fce0b1550e9ab6a4ebc9d96c35de78b2e99 = '';

        if ('-' == $par5551ae677d6b488ebd38625d0f5d9fce0b1550e9ab6a4ebc9d96c35de78b2e99) {
            $par5551ae677d6b488ebd38625d0f5d9fce0b1550e9ab6a4ebc9d96c35de78b2e99 = null;
        }

        if (null == $par5551ae677d6b488ebd38625d0f5d9fce0b1550e9ab6a4ebc9d96c35de78b2e99) {
            $par5551ae677d6b488ebd38625d0f5d9fce0b1550e9ab6a4ebc9d96c35de78b2e99 = '';
        }

        $par8fce8a73ac264e4a8f3b56d8b991b8a50b1550e9ab6a4ebc9d96c35de78b2e99 = '';

        if ('-' == $par8fce8a73ac264e4a8f3b56d8b991b8a50b1550e9ab6a4ebc9d96c35de78b2e99) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a50b1550e9ab6a4ebc9d96c35de78b2e99 = null;
        }

        if (null == $par8fce8a73ac264e4a8f3b56d8b991b8a50b1550e9ab6a4ebc9d96c35de78b2e99) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a50b1550e9ab6a4ebc9d96c35de78b2e99 = '';
        }

        $v0b1550e9ab6a4ebc9d96c35de78b2e99 = \App\repf782f923fd0247bd9f4010b717e52999::mt7a554656bf474c729d8f6f802a183501($parbd07f901e7a64d0e980d949d26e42bbd, $par6185a7056560433494dba94e9ae591070b1550e9ab6a4ebc9d96c35de78b2e99, $par0a0ce2af85ab462a808e0270326fb8600b1550e9ab6a4ebc9d96c35de78b2e99, $par5551ae677d6b488ebd38625d0f5d9fce0b1550e9ab6a4ebc9d96c35de78b2e99, $par8fce8a73ac264e4a8f3b56d8b991b8a50b1550e9ab6a4ebc9d96c35de78b2e99);

        $v0b1550e9ab6a4ebc9d96c35de78b2e99Ajax = \URL::to('/').'/api/7a554656bf474c729d8f6f802a183501/'.(null == $parbd07f901e7a64d0e980d949d26e42bbd ? '-' : ('' == $parbd07f901e7a64d0e980d949d26e42bbd ? '-' : $parbd07f901e7a64d0e980d949d26e42bbd)).'/{page}/{pagesize}/{orderColumn}/{orderType}';
        ...
        $arrWiths['v0b1550e9ab6a4ebc9d96c35de78b2e99'] = isset($v0b1550e9ab6a4ebc9d96c35de78b2e99) ? $v0b1550e9ab6a4ebc9d96c35de78b2e99 : '';
        $arrWiths['v0b1550e9ab6a4ebc9d96c35de78b2e99Ajax'] = isset($v0b1550e9ab6a4ebc9d96c35de78b2e99Ajax) ? $v0b1550e9ab6a4ebc9d96c35de78b2e99Ajax : '';
        ...
        $response = new \Illuminate\Http\Response(view('9a4b61048c6e42db8fdbacf7538962cf.Index', $arrWiths)->with('title', $arrWiths['title'])->with('vSessionTimeout', \Config::get('session.lifetime') * 60));
