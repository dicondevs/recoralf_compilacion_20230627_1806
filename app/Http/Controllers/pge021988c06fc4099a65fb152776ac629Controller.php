...
// Creado               martes, 27 de junio de 2023 17:56:54
...
/**
 * estatusGrid - Pagina de Estatus.
 */
class pge021988c06fc4099a65fb152776ac629Controller extends Controller
{
    /**
    ...
    public function post(Request $request)
    {
        ...
        // Guardar Estatus - Guardar Estatus
        if (null != $request->input('ctlf7270deb27574fd089e1c6db5aad39d6_b27bf9c7995740a8bfc0a8662494e22a') && null != $request->input('hidb27bf9c7995740a8bfc0a8662494e22a') && 'b27bf9c7995740a8bfc0a8662494e22a' == $request->input('hidb27bf9c7995740a8bfc0a8662494e22a')) {
            $key = 0;
            $isNew = false;
            ...
            $tb = \App\tbfefd6b763aac4a4388a89a4755e5d254::where('PK_ESTATUS', $key)->first();
            if (null == $tb) {
                $isNew = true;
                $tb = new \App\tbfefd6b763aac4a4388a89a4755e5d254();
            }

            if (null != $request->input('ctlbee73da84a7446ff983095ff4d3912c6_b27bf9c7995740a8bfc0a8662494e22a')) {
                $tb->FL_ESTATUS = $request->input('ctlbee73da84a7446ff983095ff4d3912c6_b27bf9c7995740a8bfc0a8662494e22a'); //FL_ESTATUS
            } elseif (null == $request->input('ctlbee73da84a7446ff983095ff4d3912c6_b27bf9c7995740a8bfc0a8662494e22a')) {
                $tb->FL_ESTATUS = null;
            }

            if (null != $request->input('tipoestatus')) {
                $tb->FK_TIPO_ESTATUS = $request->input('tipoestatus'); //FK_TIPO_ESTATUS
            } elseif (null == $request->input('tipoestatus')) {
                $tb->FK_TIPO_ESTATUS = null;
            }

            if (null != $request->input('ctl372f535507f34d2e877091deab85d4e0_b27bf9c7995740a8bfc0a8662494e22a')) {
                $tb->FL_CLASE = $request->input('ctl372f535507f34d2e877091deab85d4e0_b27bf9c7995740a8bfc0a8662494e22a'); //FL_CLASE
            } elseif (null == $request->input('ctl372f535507f34d2e877091deab85d4e0_b27bf9c7995740a8bfc0a8662494e22a')) {
                $tb->FL_CLASE = null;
            }
    ...
    public function index(Request $request)
    {
        ...
        $parb2f4baaac3fc4c6f9e164920b3ed1ebf = $request->input('tipoestatus');

        if (null == $parb2f4baaac3fc4c6f9e164920b3ed1ebf) {
            $parb2f4baaac3fc4c6f9e164920b3ed1ebf = '0';
        }

        $par6185a7056560433494dba94e9ae59107599fc2e8004a46bebf31a06186bdd782 = 0;

        if (null == $par6185a7056560433494dba94e9ae59107599fc2e8004a46bebf31a06186bdd782) {
            $par6185a7056560433494dba94e9ae59107599fc2e8004a46bebf31a06186bdd782 = '0';
        }

        $par0a0ce2af85ab462a808e0270326fb860599fc2e8004a46bebf31a06186bdd782 = 0;

        if (null == $par0a0ce2af85ab462a808e0270326fb860599fc2e8004a46bebf31a06186bdd782) {
            $par0a0ce2af85ab462a808e0270326fb860599fc2e8004a46bebf31a06186bdd782 = '0';
        }

        $par5551ae677d6b488ebd38625d0f5d9fce599fc2e8004a46bebf31a06186bdd782 = '';

        if ('-' == $par5551ae677d6b488ebd38625d0f5d9fce599fc2e8004a46bebf31a06186bdd782) {
            $par5551ae677d6b488ebd38625d0f5d9fce599fc2e8004a46bebf31a06186bdd782 = null;
        }

        if (null == $par5551ae677d6b488ebd38625d0f5d9fce599fc2e8004a46bebf31a06186bdd782) {
            $par5551ae677d6b488ebd38625d0f5d9fce599fc2e8004a46bebf31a06186bdd782 = '';
        }

        $par8fce8a73ac264e4a8f3b56d8b991b8a5599fc2e8004a46bebf31a06186bdd782 = '';

        if ('-' == $par8fce8a73ac264e4a8f3b56d8b991b8a5599fc2e8004a46bebf31a06186bdd782) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a5599fc2e8004a46bebf31a06186bdd782 = null;
        }

        if (null == $par8fce8a73ac264e4a8f3b56d8b991b8a5599fc2e8004a46bebf31a06186bdd782) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a5599fc2e8004a46bebf31a06186bdd782 = '';
        }

        $v599fc2e8004a46bebf31a06186bdd782Ajax = \URL::to('/').'/api/df246c22d0e649e99a67be25e4b15d6e/'.(null == $parb2f4baaac3fc4c6f9e164920b3ed1ebf ? '-' : ('' == $parb2f4baaac3fc4c6f9e164920b3ed1ebf ? '-' : $parb2f4baaac3fc4c6f9e164920b3ed1ebf)).'/{page}/{pagesize}/{orderColumn}/{orderType}';

        // Modelador Estatus - Modelador Estatus

        $v599fc2e8004a46bebf31a06186bdd782Count = \App\repf782f923fd0247bd9f4010b717e52999::mtdf246c22d0e649e99a67be25e4b15d6eCount($parb2f4baaac3fc4c6f9e164920b3ed1ebf, $par6185a7056560433494dba94e9ae59107599fc2e8004a46bebf31a06186bdd782, $par0a0ce2af85ab462a808e0270326fb860599fc2e8004a46bebf31a06186bdd782, $par5551ae677d6b488ebd38625d0f5d9fce599fc2e8004a46bebf31a06186bdd782, $par8fce8a73ac264e4a8f3b56d8b991b8a5599fc2e8004a46bebf31a06186bdd782);

        //$v599fc2e8004a46bebf31a06186bdd782CountAjax =  \URL::to('/')."/api/df246c22d0e649e99a67be25e4b15d6eCount{ParametersAjax}/{page}/{pagesize}/{orderColumn}/{orderType}";

        // Recuperar Estatus - Recuperar Estatus

        $par55fcc07af34943a8a0e6f4eba09bf0e3 = $request->input('u');

        if (null == $par55fcc07af34943a8a0e6f4eba09bf0e3) {
            $par55fcc07af34943a8a0e6f4eba09bf0e3 = '0';
        }

        $par6185a7056560433494dba94e9ae591075139335b61f948cba61cf1fb2295ad72 = 0;

        if (null == $par6185a7056560433494dba94e9ae591075139335b61f948cba61cf1fb2295ad72) {
            $par6185a7056560433494dba94e9ae591075139335b61f948cba61cf1fb2295ad72 = '0';
        }

        $par0a0ce2af85ab462a808e0270326fb8605139335b61f948cba61cf1fb2295ad72 = 0;

        if (null == $par0a0ce2af85ab462a808e0270326fb8605139335b61f948cba61cf1fb2295ad72) {
            $par0a0ce2af85ab462a808e0270326fb8605139335b61f948cba61cf1fb2295ad72 = '0';
        }

        $par5551ae677d6b488ebd38625d0f5d9fce5139335b61f948cba61cf1fb2295ad72 = '';

        if ('-' == $par5551ae677d6b488ebd38625d0f5d9fce5139335b61f948cba61cf1fb2295ad72) {
            $par5551ae677d6b488ebd38625d0f5d9fce5139335b61f948cba61cf1fb2295ad72 = null;
        }

        if (null == $par5551ae677d6b488ebd38625d0f5d9fce5139335b61f948cba61cf1fb2295ad72) {
            $par5551ae677d6b488ebd38625d0f5d9fce5139335b61f948cba61cf1fb2295ad72 = '';
        }

        $par8fce8a73ac264e4a8f3b56d8b991b8a55139335b61f948cba61cf1fb2295ad72 = '';

        if ('-' == $par8fce8a73ac264e4a8f3b56d8b991b8a55139335b61f948cba61cf1fb2295ad72) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a55139335b61f948cba61cf1fb2295ad72 = null;
        }

        if (null == $par8fce8a73ac264e4a8f3b56d8b991b8a55139335b61f948cba61cf1fb2295ad72) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a55139335b61f948cba61cf1fb2295ad72 = '';
        }

        $v5139335b61f948cba61cf1fb2295ad72 = \App\repf782f923fd0247bd9f4010b717e52999::mt7b332aa4000f420a9afc673748ab5b19($par55fcc07af34943a8a0e6f4eba09bf0e3, $par6185a7056560433494dba94e9ae591075139335b61f948cba61cf1fb2295ad72, $par0a0ce2af85ab462a808e0270326fb8605139335b61f948cba61cf1fb2295ad72, $par5551ae677d6b488ebd38625d0f5d9fce5139335b61f948cba61cf1fb2295ad72, $par8fce8a73ac264e4a8f3b56d8b991b8a55139335b61f948cba61cf1fb2295ad72);

        $v5139335b61f948cba61cf1fb2295ad72Ajax = \URL::to('/').'/api/7b332aa4000f420a9afc673748ab5b19/'.(null == $par55fcc07af34943a8a0e6f4eba09bf0e3 ? '-' : ('' == $par55fcc07af34943a8a0e6f4eba09bf0e3 ? '-' : $par55fcc07af34943a8a0e6f4eba09bf0e3)).'/{page}/{pagesize}/{orderColumn}/{orderType}';
        ...
        $par6185a7056560433494dba94e9ae59107b52fc42eae3a4829a79b66a127e65cd4 = 0;

        if (null == $par6185a7056560433494dba94e9ae59107b52fc42eae3a4829a79b66a127e65cd4) {
            $par6185a7056560433494dba94e9ae59107b52fc42eae3a4829a79b66a127e65cd4 = '0';
        }

        $par0a0ce2af85ab462a808e0270326fb860b52fc42eae3a4829a79b66a127e65cd4 = 0;

        if (null == $par0a0ce2af85ab462a808e0270326fb860b52fc42eae3a4829a79b66a127e65cd4) {
            $par0a0ce2af85ab462a808e0270326fb860b52fc42eae3a4829a79b66a127e65cd4 = '0';
        }

        $par5551ae677d6b488ebd38625d0f5d9fceb52fc42eae3a4829a79b66a127e65cd4 = '';

        if ('-' == $par5551ae677d6b488ebd38625d0f5d9fceb52fc42eae3a4829a79b66a127e65cd4) {
            $par5551ae677d6b488ebd38625d0f5d9fceb52fc42eae3a4829a79b66a127e65cd4 = null;
        }

        if (null == $par5551ae677d6b488ebd38625d0f5d9fceb52fc42eae3a4829a79b66a127e65cd4) {
            $par5551ae677d6b488ebd38625d0f5d9fceb52fc42eae3a4829a79b66a127e65cd4 = '';
        }

        $par8fce8a73ac264e4a8f3b56d8b991b8a5b52fc42eae3a4829a79b66a127e65cd4 = '';

        if ('-' == $par8fce8a73ac264e4a8f3b56d8b991b8a5b52fc42eae3a4829a79b66a127e65cd4) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a5b52fc42eae3a4829a79b66a127e65cd4 = null;
        }

        if (null == $par8fce8a73ac264e4a8f3b56d8b991b8a5b52fc42eae3a4829a79b66a127e65cd4) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a5b52fc42eae3a4829a79b66a127e65cd4 = '';
        }

        $vb52fc42eae3a4829a79b66a127e65cd4 = \App\repf782f923fd0247bd9f4010b717e52999::mtd1203cac9e0a4d2b8d8d3ac5e285d428($par8e9cfc8933a449af80f5fd2fdaf0c7461, $par949ac6762f824f589aa55df91c654a401, $par6185a7056560433494dba94e9ae59107b52fc42eae3a4829a79b66a127e65cd4, $par0a0ce2af85ab462a808e0270326fb860b52fc42eae3a4829a79b66a127e65cd4, $par5551ae677d6b488ebd38625d0f5d9fceb52fc42eae3a4829a79b66a127e65cd4, $par8fce8a73ac264e4a8f3b56d8b991b8a5b52fc42eae3a4829a79b66a127e65cd4);

        $vb52fc42eae3a4829a79b66a127e65cd4Ajax = \URL::to('/').'/api/d1203cac9e0a4d2b8d8d3ac5e285d428/'.(null == $par8e9cfc8933a449af80f5fd2fdaf0c7461 ? '-' : ('' == $par8e9cfc8933a449af80f5fd2fdaf0c7461 ? '-' : $par8e9cfc8933a449af80f5fd2fdaf0c7461)).'/'.(null == $par949ac6762f824f589aa55df91c654a401 ? '-' : ('' == $par949ac6762f824f589aa55df91c654a401 ? '-' : $par949ac6762f824f589aa55df91c654a401)).'/{page}/{pagesize}/{orderColumn}/{orderType}';
        ...
        // Tabla de estatus - Tabla de estatus
        $vd4947b4db17440478a84e1d3c8b1481b = '';
        $vd4947b4db17440478a84e1d3c8b1481bTotal = (isset($v599fc2e8004a46bebf31a06186bdd782Count) ? $v599fc2e8004a46bebf31a06186bdd782Count : 0);
        $vd4947b4db17440478a84e1d3c8b1481bAjax = (isset($v599fc2e8004a46bebf31a06186bdd782Ajax) ? $v599fc2e8004a46bebf31a06186bdd782Ajax : '');

        $arrWiths['v599fc2e8004a46bebf31a06186bdd782Count'] = isset($v599fc2e8004a46bebf31a06186bdd782Count) ? $v599fc2e8004a46bebf31a06186bdd782Count : '';
        $arrWiths['v599fc2e8004a46bebf31a06186bdd782Ajax'] = isset($v599fc2e8004a46bebf31a06186bdd782Ajax) ? $v599fc2e8004a46bebf31a06186bdd782Ajax : '';
        $arrWiths['v5139335b61f948cba61cf1fb2295ad72'] = isset($v5139335b61f948cba61cf1fb2295ad72) ? $v5139335b61f948cba61cf1fb2295ad72 : '';
        $arrWiths['v5139335b61f948cba61cf1fb2295ad72Ajax'] = isset($v5139335b61f948cba61cf1fb2295ad72Ajax) ? $v5139335b61f948cba61cf1fb2295ad72Ajax : '';
        $arrWiths['vb52fc42eae3a4829a79b66a127e65cd4'] = isset($vb52fc42eae3a4829a79b66a127e65cd4) ? $vb52fc42eae3a4829a79b66a127e65cd4 : '';
        $arrWiths['vb52fc42eae3a4829a79b66a127e65cd4Ajax'] = isset($vb52fc42eae3a4829a79b66a127e65cd4Ajax) ? $vb52fc42eae3a4829a79b66a127e65cd4Ajax : '';
        ...
        $arrWiths['vd4947b4db17440478a84e1d3c8b1481b'] = isset($vd4947b4db17440478a84e1d3c8b1481b) ? $vd4947b4db17440478a84e1d3c8b1481b : '';
        $arrWiths['vd4947b4db17440478a84e1d3c8b1481bTotal'] = isset($vd4947b4db17440478a84e1d3c8b1481bTotal) ? $vd4947b4db17440478a84e1d3c8b1481bTotal : '';
        $arrWiths['vd4947b4db17440478a84e1d3c8b1481bAjax'] = isset($vd4947b4db17440478a84e1d3c8b1481bAjax) ? $vd4947b4db17440478a84e1d3c8b1481bAjax : '';
        ...
        $response = new \Illuminate\Http\Response(view('e021988c06fc4099a65fb152776ac629.Index', $arrWiths)->with('title', $arrWiths['title'])->with('vSessionTimeout', \Config::get('session.lifetime') * 60));
