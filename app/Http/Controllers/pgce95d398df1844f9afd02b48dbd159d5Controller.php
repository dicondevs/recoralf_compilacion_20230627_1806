...
/**
 * preregistroFormato - Formato de preregistro.
 */
class pgce95d398df1844f9afd02b48dbd159d5Controller extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        $pard1e016be4f234b77b736d7dcdeb428a91 = $request->input('u');

        if (null == $pard1e016be4f234b77b736d7dcdeb428a91) {
            $pard1e016be4f234b77b736d7dcdeb428a91 = '0';
        }

        $v15b9cb4a4a994315b6ccc9a515b13281 = \App\repf782f923fd0247bd9f4010b717e52999::mt0b839269b0264914812909818ffddfd9($pard1e016be4f234b77b736d7dcdeb428a91);

        $v15b9cb4a4a994315b6ccc9a515b13281Ajax = \URL::to('/').'/api/0b839269b0264914812909818ffddfd9/'.(null == $pard1e016be4f234b77b736d7dcdeb428a91 ? '-' : ('' == $pard1e016be4f234b77b736d7dcdeb428a91 ? '-' : $pard1e016be4f234b77b736d7dcdeb428a91)).'/{page}/{pagesize}/{orderColumn}/{orderType}';

        //sp_preregistro_formato - sp_preregistro_formato
        if ('1' == $request->input('Excel')) {
            $content = '<html><head></head><body>'.$v15b9cb4a4a994315b6ccc9a515b13281.'</body></html>';
            $headers = [
                  'Content-type' => 'application/vnd.ms-excel;charset=utf-8',
                  'Content-Disposition' => 'attachment; filename="'.\Lang::get('resourceff2b12513d1a44948a7e7fbabde0697a.msg83e78e0ba46d4b50867d0e520257a885').'.xls"',
              ];

            return \Response::make($content, 200, $headers);
        } else {
            $imgConv652a2b8f4c3b46c0ab235b7df958b899 = new \Mpdf\Mpdf([
            'format' => 'letter',
            'orientation' => 'P',
          ]);
            $imgConv652a2b8f4c3b46c0ab235b7df958b899->SetDisplayMode('fullpage');
            $imgConv652a2b8f4c3b46c0ab235b7df958b899->keep_table_proportions = true;
            $imgConv652a2b8f4c3b46c0ab235b7df958b899->SetTitle(\Lang::get('resourceff2b12513d1a44948a7e7fbabde0697a.msg83e78e0ba46d4b50867d0e520257a885'));
            $imgConv652a2b8f4c3b46c0ab235b7df958b899->SetSubject(\Lang::get('resourceff2b12513d1a44948a7e7fbabde0697a.msg83e78e0ba46d4b50867d0e520257a885'));
            $imgConv652a2b8f4c3b46c0ab235b7df958b899->SetAuthor('Codium 1.1.8333.17559');
            $imgConv652a2b8f4c3b46c0ab235b7df958b899->SetCreator('Codium 1.1.8333.17559');
            $imgConv652a2b8f4c3b46c0ab235b7df958b899->SetHTMLHeader('');
            $imgConv652a2b8f4c3b46c0ab235b7df958b899->SetHTMLFooter('');
            $imgConv652a2b8f4c3b46c0ab235b7df958b899->WriteHTML('<html><head></head><body>'.$v15b9cb4a4a994315b6ccc9a515b13281.'</body></html>');
            $imgConv652a2b8f4c3b46c0ab235b7df958b899->Output(\Lang::get('resourceff2b12513d1a44948a7e7fbabde0697a.msg83e78e0ba46d4b50867d0e520257a885').'.pdf', 'I');
        }

        $arrWiths['v15b9cb4a4a994315b6ccc9a515b13281'] = isset($v15b9cb4a4a994315b6ccc9a515b13281) ? $v15b9cb4a4a994315b6ccc9a515b13281 : '';
        $arrWiths['v652a2b8f4c3b46c0ab235b7df958b899'] = isset($v652a2b8f4c3b46c0ab235b7df958b899) ? $v652a2b8f4c3b46c0ab235b7df958b899 : '';
        ...
        $response = new \Illuminate\Http\Response(view('ce95d398df1844f9afd02b48dbd159d5.Index', $arrWiths)->with('title', $arrWiths['title'])->with('vSessionTimeout', \Config::get('session.lifetime') * 60));
