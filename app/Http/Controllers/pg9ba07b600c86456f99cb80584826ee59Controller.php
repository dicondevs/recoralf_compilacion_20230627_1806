...
/**
 * formtiporecurso - formtiporecurso.
 */
class pg9ba07b600c86456f99cb80584826ee59Controller extends Controller
{
    /**
    ...
    public function post(Request $request)
    {
        ...
        if (null != $request->input('ctl19b1bedba7d546529c0aa54c7e4d2040_8557f443c89f4d73b53feabc8843ace9') && null != $request->input('hid8557f443c89f4d73b53feabc8843ace9') && '8557f443c89f4d73b53feabc8843ace9' == $request->input('hid8557f443c89f4d73b53feabc8843ace9')) {
            $key = 0;
            $isNew = false;
            ...
            $tb = \App\tbdc80cd5b9bdb428ca8df0ca2b682f1bb::where('PK_TIPO_RECURSO', $key)->first();
            if (null == $tb) {
                $isNew = true;
                $tb = new \App\tbdc80cd5b9bdb428ca8df0ca2b682f1bb();
            }

            if (null != $request->input('ctlf9c00724ae7a40bba6fc5f54989f07ea_8557f443c89f4d73b53feabc8843ace9')) {
                $tb->FL_TIPO_RECURSO = $request->input('ctlf9c00724ae7a40bba6fc5f54989f07ea_8557f443c89f4d73b53feabc8843ace9'); //FL_TIPO_RECURSO
            } elseif (null == $request->input('ctlf9c00724ae7a40bba6fc5f54989f07ea_8557f443c89f4d73b53feabc8843ace9')) {
                $tb->FL_TIPO_RECURSO = null;
            }

            if (null != $request->input('ctldae2d43c09424455ab21cdfc870458f0_8557f443c89f4d73b53feabc8843ace9')) {
                $tb->FL_PROGRAMA = $request->input('ctldae2d43c09424455ab21cdfc870458f0_8557f443c89f4d73b53feabc8843ace9'); //FL_PROGRAMA
            } elseif (null == $request->input('ctldae2d43c09424455ab21cdfc870458f0_8557f443c89f4d73b53feabc8843ace9')) {
                $tb->FL_PROGRAMA = null;
            }

            if (null != $request->input('ctlaee6269dc74b4945866152b3ad4bc366_8557f443c89f4d73b53feabc8843ace9')) {
                $tb->FL_NOMENCLATURA = $request->input('ctlaee6269dc74b4945866152b3ad4bc366_8557f443c89f4d73b53feabc8843ace9'); //FL_NOMENCLATURA
            } elseif (null == $request->input('ctlaee6269dc74b4945866152b3ad4bc366_8557f443c89f4d73b53feabc8843ace9')) {
                $tb->FL_NOMENCLATURA = null;
            }
    ...
    public function index(Request $request)
    {
        ...
        $response = new \Illuminate\Http\Response(view('9ba07b600c86456f99cb80584826ee59.Index', $arrWiths)->with('title', $arrWiths['title'])->with('vSessionTimeout', \Config::get('session.lifetime') * 60));
