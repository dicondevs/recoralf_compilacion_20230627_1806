...
/**
 * productorEstatus - productorEstatus.
 */
class pg92afebfee2444180a5251c5989988f14Controller extends Controller
{
    /**
    ...
    public function post(Request $request)
    {
        ...
        // Guardar - Guardar
        if (null != $request->input('ctl3f4c37c6271849e1afdcbaa396e78f3f_38f43dd9b9d44216a645180e6c441087') && null != $request->input('hid38f43dd9b9d44216a645180e6c441087') && '38f43dd9b9d44216a645180e6c441087' == $request->input('hid38f43dd9b9d44216a645180e6c441087')) {
            $key = 0;
            $isNew = false;
            ...
            if (null == $tb) {
                $tbCheck = \App\tb267831275fef4ffaae652b1d4a04b208::where([['FL_CODIGO_CONTABLE', '=', $request->input('ctl48bd46807c70413a9a6ee30efc4ea9fa_38f43dd9b9d44216a645180e6c441087')]])->first();
                if (null != $tbCheck) {
            ...
            if (null != $request->input('ctl48bd46807c70413a9a6ee30efc4ea9fa_38f43dd9b9d44216a645180e6c441087')) {
                $tb->FL_CODIGO_CONTABLE = $request->input('ctl48bd46807c70413a9a6ee30efc4ea9fa_38f43dd9b9d44216a645180e6c441087'); //FL_CODIGO_CONTABLE
            } elseif (null == $request->input('ctl48bd46807c70413a9a6ee30efc4ea9fa_38f43dd9b9d44216a645180e6c441087')) {
                $tb->FL_CODIGO_CONTABLE = null;
            }

            if (null != $request->input('ctl69b2dfe13f10447e88b962545b0cef21_38f43dd9b9d44216a645180e6c441087')) {
                $tb->FK_ESTATUS = $request->input('ctl69b2dfe13f10447e88b962545b0cef21_38f43dd9b9d44216a645180e6c441087'); //FK_ESTATUS
            } elseif (null == $request->input('ctl69b2dfe13f10447e88b962545b0cef21_38f43dd9b9d44216a645180e6c441087')) {
                $tb->FK_ESTATUS = null;
            }
            ...
            if (null != $request->input('u')) {
                $tb->FK_PRODUCTOR = $request->input('u'); //FK_PRODUCTOR
            } elseif (null == $request->input('u')) {
            ...
            if (null != $request->input('ctl42dedb7241dc4827b4c4b8fa13222248_38f43dd9b9d44216a645180e6c441087')) {
                $tb->FL_COMENTARIOS = $request->input('ctl42dedb7241dc4827b4c4b8fa13222248_38f43dd9b9d44216a645180e6c441087'); //FL_COMENTARIOS
            } elseif (null == $request->input('ctl42dedb7241dc4827b4c4b8fa13222248_38f43dd9b9d44216a645180e6c441087')) {
            ...
            if (null != $request->input('hid38f43dd9b9d44216a645180e6c441087') && '38f43dd9b9d44216a645180e6c441087' == $request->input('hid38f43dd9b9d44216a645180e6c441087')) {
                $par9d712dac7967477a853d0d55459b502d1 = $request->input('u');

                if (null == $par9d712dac7967477a853d0d55459b502d1) {
                    $par9d712dac7967477a853d0d55459b502d1 = 'u';
                }

                $para68909de4efd417781a73306db4ed7a91 = $request->input('ctl69b2dfe13f10447e88b962545b0cef21_38f43dd9b9d44216a645180e6c441087');

                if (null == $para68909de4efd417781a73306db4ed7a91) {
                    $para68909de4efd417781a73306db4ed7a91 = '0';
                }

                $par14150a6b46234cb68f37c8d870b32cb31 = 1;
    ...
    public function index(Request $request)
    {
        ...
        // sp_editar_productor - sp_editar_productor
        ...
        $par6185a7056560433494dba94e9ae59107339dc05fb0f1466594f3718ccccc144d = 0;

        if (null == $par6185a7056560433494dba94e9ae59107339dc05fb0f1466594f3718ccccc144d) {
            $par6185a7056560433494dba94e9ae59107339dc05fb0f1466594f3718ccccc144d = '0';
        }

        $par0a0ce2af85ab462a808e0270326fb860339dc05fb0f1466594f3718ccccc144d = 0;

        if (null == $par0a0ce2af85ab462a808e0270326fb860339dc05fb0f1466594f3718ccccc144d) {
            $par0a0ce2af85ab462a808e0270326fb860339dc05fb0f1466594f3718ccccc144d = '0';
        }

        $par5551ae677d6b488ebd38625d0f5d9fce339dc05fb0f1466594f3718ccccc144d = '';

        if ('-' == $par5551ae677d6b488ebd38625d0f5d9fce339dc05fb0f1466594f3718ccccc144d) {
            $par5551ae677d6b488ebd38625d0f5d9fce339dc05fb0f1466594f3718ccccc144d = null;
        }

        if (null == $par5551ae677d6b488ebd38625d0f5d9fce339dc05fb0f1466594f3718ccccc144d) {
            $par5551ae677d6b488ebd38625d0f5d9fce339dc05fb0f1466594f3718ccccc144d = '';
        }

        $par8fce8a73ac264e4a8f3b56d8b991b8a5339dc05fb0f1466594f3718ccccc144d = '';

        if ('-' == $par8fce8a73ac264e4a8f3b56d8b991b8a5339dc05fb0f1466594f3718ccccc144d) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a5339dc05fb0f1466594f3718ccccc144d = null;
        }

        if (null == $par8fce8a73ac264e4a8f3b56d8b991b8a5339dc05fb0f1466594f3718ccccc144d) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a5339dc05fb0f1466594f3718ccccc144d = '';
        }

        $v339dc05fb0f1466594f3718ccccc144d = \App\repf782f923fd0247bd9f4010b717e52999::mt87f3ff2a9cc344c58921f820b898209f($par81d62592acd84ddb8e7915b8e90881d2, $par6185a7056560433494dba94e9ae59107339dc05fb0f1466594f3718ccccc144d, $par0a0ce2af85ab462a808e0270326fb860339dc05fb0f1466594f3718ccccc144d, $par5551ae677d6b488ebd38625d0f5d9fce339dc05fb0f1466594f3718ccccc144d, $par8fce8a73ac264e4a8f3b56d8b991b8a5339dc05fb0f1466594f3718ccccc144d);

        $v339dc05fb0f1466594f3718ccccc144dAjax = \URL::to('/').'/api/87f3ff2a9cc344c58921f820b898209f/'.(null == $par81d62592acd84ddb8e7915b8e90881d2 ? '-' : ('' == $par81d62592acd84ddb8e7915b8e90881d2 ? '-' : $par81d62592acd84ddb8e7915b8e90881d2)).'/{page}/{pagesize}/{orderColumn}/{orderType}';

        // sp_productor_estatus - sp_productor_estatus

        $parff8f5817eb9749f6bf3d666ed6acff721 = $request->session()->get('ses5e122755c3a24f5d8789755168e9de27');

        if (null == $parff8f5817eb9749f6bf3d666ed6acff721) {
            $parff8f5817eb9749f6bf3d666ed6acff721 = '0';
        }

        $para5c63d7712fe407aae4e81f4c8045e701 = $request->input('u');

        if (null == $para5c63d7712fe407aae4e81f4c8045e701) {
            $para5c63d7712fe407aae4e81f4c8045e701 = '0';
        }

        $par6185a7056560433494dba94e9ae591070c482111ab234e05aa6ba9049edd2411 = 0;

        if (null == $par6185a7056560433494dba94e9ae591070c482111ab234e05aa6ba9049edd2411) {
            $par6185a7056560433494dba94e9ae591070c482111ab234e05aa6ba9049edd2411 = '0';
        }

        $par0a0ce2af85ab462a808e0270326fb8600c482111ab234e05aa6ba9049edd2411 = 0;

        if (null == $par0a0ce2af85ab462a808e0270326fb8600c482111ab234e05aa6ba9049edd2411) {
            $par0a0ce2af85ab462a808e0270326fb8600c482111ab234e05aa6ba9049edd2411 = '0';
        }

        $par5551ae677d6b488ebd38625d0f5d9fce0c482111ab234e05aa6ba9049edd2411 = '';

        if ('-' == $par5551ae677d6b488ebd38625d0f5d9fce0c482111ab234e05aa6ba9049edd2411) {
            $par5551ae677d6b488ebd38625d0f5d9fce0c482111ab234e05aa6ba9049edd2411 = null;
        }

        if (null == $par5551ae677d6b488ebd38625d0f5d9fce0c482111ab234e05aa6ba9049edd2411) {
            $par5551ae677d6b488ebd38625d0f5d9fce0c482111ab234e05aa6ba9049edd2411 = '';
        }

        $par8fce8a73ac264e4a8f3b56d8b991b8a50c482111ab234e05aa6ba9049edd2411 = '';

        if ('-' == $par8fce8a73ac264e4a8f3b56d8b991b8a50c482111ab234e05aa6ba9049edd2411) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a50c482111ab234e05aa6ba9049edd2411 = null;
        }

        if (null == $par8fce8a73ac264e4a8f3b56d8b991b8a50c482111ab234e05aa6ba9049edd2411) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a50c482111ab234e05aa6ba9049edd2411 = '';
        }

        $v0c482111ab234e05aa6ba9049edd2411 = \App\repf782f923fd0247bd9f4010b717e52999::mtc27ef752528f45dc99bfc610429aea62($parff8f5817eb9749f6bf3d666ed6acff721, $para5c63d7712fe407aae4e81f4c8045e701, $par6185a7056560433494dba94e9ae591070c482111ab234e05aa6ba9049edd2411, $par0a0ce2af85ab462a808e0270326fb8600c482111ab234e05aa6ba9049edd2411, $par5551ae677d6b488ebd38625d0f5d9fce0c482111ab234e05aa6ba9049edd2411, $par8fce8a73ac264e4a8f3b56d8b991b8a50c482111ab234e05aa6ba9049edd2411);

        $v0c482111ab234e05aa6ba9049edd2411Ajax = \URL::to('/').'/api/c27ef752528f45dc99bfc610429aea62/'.(null == $parff8f5817eb9749f6bf3d666ed6acff721 ? '-' : ('' == $parff8f5817eb9749f6bf3d666ed6acff721 ? '-' : $parff8f5817eb9749f6bf3d666ed6acff721)).'/'.(null == $para5c63d7712fe407aae4e81f4c8045e701 ? '-' : ('' == $para5c63d7712fe407aae4e81f4c8045e701 ? '-' : $para5c63d7712fe407aae4e81f4c8045e701)).'/{page}/{pagesize}/{orderColumn}/{orderType}';
        ...
        $arrWiths['v339dc05fb0f1466594f3718ccccc144d'] = isset($v339dc05fb0f1466594f3718ccccc144d) ? $v339dc05fb0f1466594f3718ccccc144d : '';
        $arrWiths['v339dc05fb0f1466594f3718ccccc144dAjax'] = isset($v339dc05fb0f1466594f3718ccccc144dAjax) ? $v339dc05fb0f1466594f3718ccccc144dAjax : '';
        $arrWiths['v0c482111ab234e05aa6ba9049edd2411'] = isset($v0c482111ab234e05aa6ba9049edd2411) ? $v0c482111ab234e05aa6ba9049edd2411 : '';
        $arrWiths['v0c482111ab234e05aa6ba9049edd2411Ajax'] = isset($v0c482111ab234e05aa6ba9049edd2411Ajax) ? $v0c482111ab234e05aa6ba9049edd2411Ajax : '';
        ...
        $response = new \Illuminate\Http\Response(view('92afebfee2444180a5251c5989988f14.Index', $arrWiths)->with('title', $arrWiths['title'])->with('vSessionTimeout', \Config::get('session.lifetime') * 60));
