 ...
 * menuForm - menuForm.
 */
class pgd56c9c6500d545d2b9d7d108e3a383ddController extends Controller
{
    /**
    ...
    public function post(Request $request)
    {
        ...
        if (null != $request->input('ctl3f4c37c6271849e1afdcbaa396e78f3f_4b1cec8fedd14013b87ab4cd08a34550') && null != $request->input('hid4b1cec8fedd14013b87ab4cd08a34550') && '4b1cec8fedd14013b87ab4cd08a34550' == $request->input('hid4b1cec8fedd14013b87ab4cd08a34550')) {
            $key = 0;
            $isNew = false;
            ...
            $tb = \App\tbde4c71c3ea154a69a1431728c2deb90b::where('PK_MENU', $key)->first();
            if (null == $tb) {
                $isNew = true;
                $tb = new \App\tbde4c71c3ea154a69a1431728c2deb90b();
            }

            if (null != $request->input('ctl9b95cdf91b654f3d9df447b55326fd35_4b1cec8fedd14013b87ab4cd08a34550')) {
                $tb->FL_ICON = $request->input('ctl9b95cdf91b654f3d9df447b55326fd35_4b1cec8fedd14013b87ab4cd08a34550'); //FL_ICON
            } elseif (null == $request->input('ctl9b95cdf91b654f3d9df447b55326fd35_4b1cec8fedd14013b87ab4cd08a34550')) {
                $tb->FL_ICON = null;
            }

            if (null != $request->input('ctlb847eb04392d433686683daec7887c6f_4b1cec8fedd14013b87ab4cd08a34550')) {
                $tb->FL_NOMBRE = $request->input('ctlb847eb04392d433686683daec7887c6f_4b1cec8fedd14013b87ab4cd08a34550'); //FL_NOMBRE
            } elseif (null == $request->input('ctlb847eb04392d433686683daec7887c6f_4b1cec8fedd14013b87ab4cd08a34550')) {
                $tb->FL_NOMBRE = null;
            }

            if (null != $request->input('ctl2d7d65ebd85d4368bb842b6443d24e10_4b1cec8fedd14013b87ab4cd08a34550')) {
                $tb->FL_ORDEN = $request->input('ctl2d7d65ebd85d4368bb842b6443d24e10_4b1cec8fedd14013b87ab4cd08a34550'); //FL_ORDEN
            } elseif (null == $request->input('ctl2d7d65ebd85d4368bb842b6443d24e10_4b1cec8fedd14013b87ab4cd08a34550')) {
                $tb->FL_ORDEN = null;
            }

            if (null != $request->input('ctlde11561626ea42d08158cc33f18d8291_4b1cec8fedd14013b87ab4cd08a34550')) {
                $tb->FL_TITULO_PAGINA = $request->input('ctlde11561626ea42d08158cc33f18d8291_4b1cec8fedd14013b87ab4cd08a34550'); //FL_TITULO_PAGINA
            } elseif (null == $request->input('ctlde11561626ea42d08158cc33f18d8291_4b1cec8fedd14013b87ab4cd08a34550')) {
                $tb->FL_TITULO_PAGINA = null;
            }

            if (null != $request->input('ctlad02c722f0184c1ca70714ef8bf6d2c4_4b1cec8fedd14013b87ab4cd08a34550')) {
                $tb->FL_URL = $request->input('ctlad02c722f0184c1ca70714ef8bf6d2c4_4b1cec8fedd14013b87ab4cd08a34550'); //FL_URL
            } elseif (null == $request->input('ctlad02c722f0184c1ca70714ef8bf6d2c4_4b1cec8fedd14013b87ab4cd08a34550')) {
                $tb->FL_URL = null;
            }
            if (null != $request->input('ctl96e6974f9176491f9ca547fc55efd38b_4b1cec8fedd14013b87ab4cd08a34550')) {
                $tb->FL_VENTANA = true; //FL_VENTANA
            } else {
                $tb->FL_VENTANA = false; //FL_VENTANA
            }
    ...
    public function index(Request $request)
    {
        ...
        $par77350ff06f37420aaf1abe36b6a839d4 = $request->input('u');

        if (null == $par77350ff06f37420aaf1abe36b6a839d4) {
            $par77350ff06f37420aaf1abe36b6a839d4 = '0';
        }

        $par6185a7056560433494dba94e9ae591071ddce8caa6b94e7aaba463b3a10959dd = 0;

        if (null == $par6185a7056560433494dba94e9ae591071ddce8caa6b94e7aaba463b3a10959dd) {
            $par6185a7056560433494dba94e9ae591071ddce8caa6b94e7aaba463b3a10959dd = '0';
        }

        $par0a0ce2af85ab462a808e0270326fb8601ddce8caa6b94e7aaba463b3a10959dd = 0;

        if (null == $par0a0ce2af85ab462a808e0270326fb8601ddce8caa6b94e7aaba463b3a10959dd) {
            $par0a0ce2af85ab462a808e0270326fb8601ddce8caa6b94e7aaba463b3a10959dd = '0';
        }

        $par5551ae677d6b488ebd38625d0f5d9fce1ddce8caa6b94e7aaba463b3a10959dd = '';

        if ('-' == $par5551ae677d6b488ebd38625d0f5d9fce1ddce8caa6b94e7aaba463b3a10959dd) {
            $par5551ae677d6b488ebd38625d0f5d9fce1ddce8caa6b94e7aaba463b3a10959dd = null;
        }

        if (null == $par5551ae677d6b488ebd38625d0f5d9fce1ddce8caa6b94e7aaba463b3a10959dd) {
            $par5551ae677d6b488ebd38625d0f5d9fce1ddce8caa6b94e7aaba463b3a10959dd = '';
        }

        $par8fce8a73ac264e4a8f3b56d8b991b8a51ddce8caa6b94e7aaba463b3a10959dd = '';

        if ('-' == $par8fce8a73ac264e4a8f3b56d8b991b8a51ddce8caa6b94e7aaba463b3a10959dd) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a51ddce8caa6b94e7aaba463b3a10959dd = null;
        }

        if (null == $par8fce8a73ac264e4a8f3b56d8b991b8a51ddce8caa6b94e7aaba463b3a10959dd) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a51ddce8caa6b94e7aaba463b3a10959dd = '';
        }

        $v1ddce8caa6b94e7aaba463b3a10959dd = \App\repf782f923fd0247bd9f4010b717e52999::mtbc0208f881cf422ea0b6c0b9802e9e97($par77350ff06f37420aaf1abe36b6a839d4, $par6185a7056560433494dba94e9ae591071ddce8caa6b94e7aaba463b3a10959dd, $par0a0ce2af85ab462a808e0270326fb8601ddce8caa6b94e7aaba463b3a10959dd, $par5551ae677d6b488ebd38625d0f5d9fce1ddce8caa6b94e7aaba463b3a10959dd, $par8fce8a73ac264e4a8f3b56d8b991b8a51ddce8caa6b94e7aaba463b3a10959dd);

        $v1ddce8caa6b94e7aaba463b3a10959ddAjax = \URL::to('/').'/api/bc0208f881cf422ea0b6c0b9802e9e97/'.(null == $par77350ff06f37420aaf1abe36b6a839d4 ? '-' : ('' == $par77350ff06f37420aaf1abe36b6a839d4 ? '-' : $par77350ff06f37420aaf1abe36b6a839d4)).'/{page}/{pagesize}/{orderColumn}/{orderType}';
        ...
        $arrWiths['v1ddce8caa6b94e7aaba463b3a10959dd'] = isset($v1ddce8caa6b94e7aaba463b3a10959dd) ? $v1ddce8caa6b94e7aaba463b3a10959dd : '';
        $arrWiths['v1ddce8caa6b94e7aaba463b3a10959ddAjax'] = isset($v1ddce8caa6b94e7aaba463b3a10959ddAjax) ? $v1ddce8caa6b94e7aaba463b3a10959ddAjax : '';
        ...
        $response = new \Illuminate\Http\Response(view('d56c9c6500d545d2b9d7d108e3a383dd.Index', $arrWiths)->with('title', $arrWiths['title'])->with('vSessionTimeout', \Config::get('session.lifetime') * 60));
