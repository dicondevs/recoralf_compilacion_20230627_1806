 ...
 */
class pg4cb953ebd62b49debfc400a46578e16cController extends Controller
{
    /**
    ...
    public function post(Request $request)
    {
        ...
        if (null != $request->input('ctl3f4c37c6271849e1afdcbaa396e78f3f_f14c2e3efbc449438ff976d9912c048a') && null != $request->input('hidf14c2e3efbc449438ff976d9912c048a') && 'f14c2e3efbc449438ff976d9912c048a' == $request->input('hidf14c2e3efbc449438ff976d9912c048a')) {
            $key = 0;
            $isNew = false;
            ...
            $tb = \App\tb2e10d438cf3d420b98ad8fadbcb0d857::where('PK_CHOFER', $key)->first();
            if (null == $tb) {
                $isNew = true;
                $tb = new \App\tb2e10d438cf3d420b98ad8fadbcb0d857();
            }

            if (null != $request->input('ctl29b952a7e8da4b0b8efab56183c6c24e_f14c2e3efbc449438ff976d9912c048a')) {
                $tb->FL_APELLIDO_MATERNO = $request->input('ctl29b952a7e8da4b0b8efab56183c6c24e_f14c2e3efbc449438ff976d9912c048a'); //FL_APELLIDO_MATERNO
            } elseif (null == $request->input('ctl29b952a7e8da4b0b8efab56183c6c24e_f14c2e3efbc449438ff976d9912c048a')) {
                $tb->FL_APELLIDO_MATERNO = null;
            }

            if (null != $request->input('ctlec760426ee1c49d4ab22bb872206cde0_f14c2e3efbc449438ff976d9912c048a')) {
                $tb->FL_APELLIDO_PATERNO = $request->input('ctlec760426ee1c49d4ab22bb872206cde0_f14c2e3efbc449438ff976d9912c048a'); //FL_APELLIDO_PATERNO
            } elseif (null == $request->input('ctlec760426ee1c49d4ab22bb872206cde0_f14c2e3efbc449438ff976d9912c048a')) {
                $tb->FL_APELLIDO_PATERNO = null;
            }

            if (null != $request->input('ctlef9197c54d954cff8dcec57939692727_f14c2e3efbc449438ff976d9912c048a')) {
                $tb->FL_CAPACIDAD = $request->input('ctlef9197c54d954cff8dcec57939692727_f14c2e3efbc449438ff976d9912c048a'); //FL_CAPACIDAD
            } elseif (null == $request->input('ctlef9197c54d954cff8dcec57939692727_f14c2e3efbc449438ff976d9912c048a')) {
                $tb->FL_CAPACIDAD = null;
            }

            if (null != $request->input('ctl823f43a7a54f4969af56a56921944633_f14c2e3efbc449438ff976d9912c048a')) {
                $tb->FL_MARCA = $request->input('ctl823f43a7a54f4969af56a56921944633_f14c2e3efbc449438ff976d9912c048a'); //FL_MARCA
            } elseif (null == $request->input('ctl823f43a7a54f4969af56a56921944633_f14c2e3efbc449438ff976d9912c048a')) {
                $tb->FL_MARCA = null;
            }

            if (null != $request->input('ctl15a378ec2537462ba6feaa2eaf5232df_f14c2e3efbc449438ff976d9912c048a')) {
                $tb->FL_MODELO = $request->input('ctl15a378ec2537462ba6feaa2eaf5232df_f14c2e3efbc449438ff976d9912c048a'); //FL_MODELO
            } elseif (null == $request->input('ctl15a378ec2537462ba6feaa2eaf5232df_f14c2e3efbc449438ff976d9912c048a')) {
                $tb->FL_MODELO = null;
            }

            if (null != $request->input('ctle433790a47694acd97446e182863e0cb_f14c2e3efbc449438ff976d9912c048a')) {
                $tb->FL_NO_PIPA = $request->input('ctle433790a47694acd97446e182863e0cb_f14c2e3efbc449438ff976d9912c048a'); //FL_NO_PIPA
            } elseif (null == $request->input('ctle433790a47694acd97446e182863e0cb_f14c2e3efbc449438ff976d9912c048a')) {
                $tb->FL_NO_PIPA = null;
            }

            if (null != $request->input('ctlb847eb04392d433686683daec7887c6f_f14c2e3efbc449438ff976d9912c048a')) {
                $tb->FL_NOMBRE = $request->input('ctlb847eb04392d433686683daec7887c6f_f14c2e3efbc449438ff976d9912c048a'); //FL_NOMBRE
            } elseif (null == $request->input('ctlb847eb04392d433686683daec7887c6f_f14c2e3efbc449438ff976d9912c048a')) {
                $tb->FL_NOMBRE = null;
            }

            if (null != $request->input('ctlf2326c6b274543b89fe07337ceb89346_f14c2e3efbc449438ff976d9912c048a')) {
                $tb->FL_PLACAS = $request->input('ctlf2326c6b274543b89fe07337ceb89346_f14c2e3efbc449438ff976d9912c048a'); //FL_PLACAS
            } elseif (null == $request->input('ctlf2326c6b274543b89fe07337ceb89346_f14c2e3efbc449438ff976d9912c048a')) {
                $tb->FL_PLACAS = null;
            }
    ...
    public function index(Request $request)
    {
        ...
        $par1f47e8db62ec4bf69f943fe3890c6cb4 = $request->input('u');

        if (null == $par1f47e8db62ec4bf69f943fe3890c6cb4) {
            $par1f47e8db62ec4bf69f943fe3890c6cb4 = '0';
        }

        $par6185a7056560433494dba94e9ae5910769fcac75fc584fa2b15ed89ab4dbe9a5 = 0;

        if (null == $par6185a7056560433494dba94e9ae5910769fcac75fc584fa2b15ed89ab4dbe9a5) {
            $par6185a7056560433494dba94e9ae5910769fcac75fc584fa2b15ed89ab4dbe9a5 = '0';
        }

        $par0a0ce2af85ab462a808e0270326fb86069fcac75fc584fa2b15ed89ab4dbe9a5 = 0;

        if (null == $par0a0ce2af85ab462a808e0270326fb86069fcac75fc584fa2b15ed89ab4dbe9a5) {
            $par0a0ce2af85ab462a808e0270326fb86069fcac75fc584fa2b15ed89ab4dbe9a5 = '0';
        }

        $par5551ae677d6b488ebd38625d0f5d9fce69fcac75fc584fa2b15ed89ab4dbe9a5 = '';

        if ('-' == $par5551ae677d6b488ebd38625d0f5d9fce69fcac75fc584fa2b15ed89ab4dbe9a5) {
            $par5551ae677d6b488ebd38625d0f5d9fce69fcac75fc584fa2b15ed89ab4dbe9a5 = null;
        }

        if (null == $par5551ae677d6b488ebd38625d0f5d9fce69fcac75fc584fa2b15ed89ab4dbe9a5) {
            $par5551ae677d6b488ebd38625d0f5d9fce69fcac75fc584fa2b15ed89ab4dbe9a5 = '';
        }

        $par8fce8a73ac264e4a8f3b56d8b991b8a569fcac75fc584fa2b15ed89ab4dbe9a5 = '';

        if ('-' == $par8fce8a73ac264e4a8f3b56d8b991b8a569fcac75fc584fa2b15ed89ab4dbe9a5) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a569fcac75fc584fa2b15ed89ab4dbe9a5 = null;
        }

        if (null == $par8fce8a73ac264e4a8f3b56d8b991b8a569fcac75fc584fa2b15ed89ab4dbe9a5) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a569fcac75fc584fa2b15ed89ab4dbe9a5 = '';
        }

        $v69fcac75fc584fa2b15ed89ab4dbe9a5 = \App\repf782f923fd0247bd9f4010b717e52999::mt6c58a297e6b6426c8bedd55ec084a150($par1f47e8db62ec4bf69f943fe3890c6cb4, $par6185a7056560433494dba94e9ae5910769fcac75fc584fa2b15ed89ab4dbe9a5, $par0a0ce2af85ab462a808e0270326fb86069fcac75fc584fa2b15ed89ab4dbe9a5, $par5551ae677d6b488ebd38625d0f5d9fce69fcac75fc584fa2b15ed89ab4dbe9a5, $par8fce8a73ac264e4a8f3b56d8b991b8a569fcac75fc584fa2b15ed89ab4dbe9a5);

        $v69fcac75fc584fa2b15ed89ab4dbe9a5Ajax = \URL::to('/').'/api/6c58a297e6b6426c8bedd55ec084a150/'.(null == $par1f47e8db62ec4bf69f943fe3890c6cb4 ? '-' : ('' == $par1f47e8db62ec4bf69f943fe3890c6cb4 ? '-' : $par1f47e8db62ec4bf69f943fe3890c6cb4)).'/{page}/{pagesize}/{orderColumn}/{orderType}';
        ...
        $arrWiths['v69fcac75fc584fa2b15ed89ab4dbe9a5'] = isset($v69fcac75fc584fa2b15ed89ab4dbe9a5) ? $v69fcac75fc584fa2b15ed89ab4dbe9a5 : '';
        $arrWiths['v69fcac75fc584fa2b15ed89ab4dbe9a5Ajax'] = isset($v69fcac75fc584fa2b15ed89ab4dbe9a5Ajax) ? $v69fcac75fc584fa2b15ed89ab4dbe9a5Ajax : '';
        ...
        $response = new \Illuminate\Http\Response(view('4cb953ebd62b49debfc400a46578e16c.Index', $arrWiths)->with('title', $arrWiths['title'])->with('vSessionTimeout', \Config::get('session.lifetime') * 60));
