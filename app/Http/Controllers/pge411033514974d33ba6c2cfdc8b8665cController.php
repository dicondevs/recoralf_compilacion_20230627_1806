...
/**
 * Contenidos html - Contenidos html.
 */
class pge411033514974d33ba6c2cfdc8b8665cController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        $par7fea58bc6833435ba5da972a89efb1bb1 = $request->input('a');

        if ('-' == $par7fea58bc6833435ba5da972a89efb1bb1) {
            $par7fea58bc6833435ba5da972a89efb1bb1 = null;
        }

        if (null == $par7fea58bc6833435ba5da972a89efb1bb1) {
            $par7fea58bc6833435ba5da972a89efb1bb1 = '0';
        }

        $parbdf6a36aabc94bf9aaade7d5240b08531 = $request->input('b');

        if ('-' == $parbdf6a36aabc94bf9aaade7d5240b08531) {
            $parbdf6a36aabc94bf9aaade7d5240b08531 = null;
        }

        if (null == $parbdf6a36aabc94bf9aaade7d5240b08531) {
            $parbdf6a36aabc94bf9aaade7d5240b08531 = '0';
        }

        $par973821124f0e4a3bbc23cb464b93b4e51 = $request->input('c');

        if ('-' == $par973821124f0e4a3bbc23cb464b93b4e51) {
            $par973821124f0e4a3bbc23cb464b93b4e51 = null;
        }

        if (null == $par973821124f0e4a3bbc23cb464b93b4e51) {
            $par973821124f0e4a3bbc23cb464b93b4e51 = '0';
        }

        $par8427abea3a704199a259348d15e8c9a51 = $request->input('d');

        if ('-' == $par8427abea3a704199a259348d15e8c9a51) {
            $par8427abea3a704199a259348d15e8c9a51 = null;
        }

        if (null == $par8427abea3a704199a259348d15e8c9a51) {
            $par8427abea3a704199a259348d15e8c9a51 = '0';
        }

        $parc4e8c71f4d394c4889249f37b0e4b9be1 = $request->input('e');

        if ('-' == $parc4e8c71f4d394c4889249f37b0e4b9be1) {
            $parc4e8c71f4d394c4889249f37b0e4b9be1 = null;
        }

        if (null == $parc4e8c71f4d394c4889249f37b0e4b9be1) {
            $parc4e8c71f4d394c4889249f37b0e4b9be1 = '0';
        }

        $pardac4ef7b4c0147f8bec58cc8fbc13a061 = $request->session()->get('ses5e122755c3a24f5d8789755168e9de27');

        if (null == $pardac4ef7b4c0147f8bec58cc8fbc13a061) {
            $pardac4ef7b4c0147f8bec58cc8fbc13a061 = '0';
        }

        $v681a3c9be94449ef8ae494aa57fb1533 = \App\repf782f923fd0247bd9f4010b717e52999::mt8c5bfd6691ca4060b904e60cd3c9e51f($par7fea58bc6833435ba5da972a89efb1bb1, $parbdf6a36aabc94bf9aaade7d5240b08531, $par973821124f0e4a3bbc23cb464b93b4e51, $par8427abea3a704199a259348d15e8c9a51, $parc4e8c71f4d394c4889249f37b0e4b9be1, $pardac4ef7b4c0147f8bec58cc8fbc13a061);

        $v681a3c9be94449ef8ae494aa57fb1533Ajax = \URL::to('/').'/api/8c5bfd6691ca4060b904e60cd3c9e51f/'.(null == $par7fea58bc6833435ba5da972a89efb1bb1 ? '-' : ('' == $par7fea58bc6833435ba5da972a89efb1bb1 ? '-' : $par7fea58bc6833435ba5da972a89efb1bb1)).'/'.(null == $parbdf6a36aabc94bf9aaade7d5240b08531 ? '-' : ('' == $parbdf6a36aabc94bf9aaade7d5240b08531 ? '-' : $parbdf6a36aabc94bf9aaade7d5240b08531)).'/'.(null == $par973821124f0e4a3bbc23cb464b93b4e51 ? '-' : ('' == $par973821124f0e4a3bbc23cb464b93b4e51 ? '-' : $par973821124f0e4a3bbc23cb464b93b4e51)).'/'.(null == $par8427abea3a704199a259348d15e8c9a51 ? '-' : ('' == $par8427abea3a704199a259348d15e8c9a51 ? '-' : $par8427abea3a704199a259348d15e8c9a51)).'/'.(null == $parc4e8c71f4d394c4889249f37b0e4b9be1 ? '-' : ('' == $parc4e8c71f4d394c4889249f37b0e4b9be1 ? '-' : $parc4e8c71f4d394c4889249f37b0e4b9be1)).'/'.(null == $pardac4ef7b4c0147f8bec58cc8fbc13a061 ? '-' : ('' == $pardac4ef7b4c0147f8bec58cc8fbc13a061 ? '-' : $pardac4ef7b4c0147f8bec58cc8fbc13a061)).'/{page}/{pagesize}/{orderColumn}/{orderType}';
        ...
        $arrWiths['v681a3c9be94449ef8ae494aa57fb1533'] = isset($v681a3c9be94449ef8ae494aa57fb1533) ? $v681a3c9be94449ef8ae494aa57fb1533 : '';
        ...
        $response = new \Illuminate\Http\Response(view('e411033514974d33ba6c2cfdc8b8665c.Index', $arrWiths)->with('title', $arrWiths['title'])->with('vSessionTimeout', \Config::get('session.lifetime') * 60));
