...
// Creado               martes, 27 de junio de 2023 17:58:06
...
/**
 * recibasGrid - recibasGrid.
 */
class pged7d3a0faccc4166abe85798e058d44bController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        $par22a10fa2a5f04de8b5e9c184d6b19392 = $request->input('ca');

        if (null == $par22a10fa2a5f04de8b5e9c184d6b19392) {
            $par22a10fa2a5f04de8b5e9c184d6b19392 = '0';
        }

        $par6185a7056560433494dba94e9ae5910734dea539354d479394e3f52e84995097 = 0;

        if (null == $par6185a7056560433494dba94e9ae5910734dea539354d479394e3f52e84995097) {
            $par6185a7056560433494dba94e9ae5910734dea539354d479394e3f52e84995097 = '0';
        }

        $par0a0ce2af85ab462a808e0270326fb86034dea539354d479394e3f52e84995097 = 0;

        if (null == $par0a0ce2af85ab462a808e0270326fb86034dea539354d479394e3f52e84995097) {
            $par0a0ce2af85ab462a808e0270326fb86034dea539354d479394e3f52e84995097 = '0';
        }

        $par5551ae677d6b488ebd38625d0f5d9fce34dea539354d479394e3f52e84995097 = '';

        if ('-' == $par5551ae677d6b488ebd38625d0f5d9fce34dea539354d479394e3f52e84995097) {
            $par5551ae677d6b488ebd38625d0f5d9fce34dea539354d479394e3f52e84995097 = null;
        }

        if (null == $par5551ae677d6b488ebd38625d0f5d9fce34dea539354d479394e3f52e84995097) {
            $par5551ae677d6b488ebd38625d0f5d9fce34dea539354d479394e3f52e84995097 = '';
        }

        $par8fce8a73ac264e4a8f3b56d8b991b8a534dea539354d479394e3f52e84995097 = '';

        if ('-' == $par8fce8a73ac264e4a8f3b56d8b991b8a534dea539354d479394e3f52e84995097) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a534dea539354d479394e3f52e84995097 = null;
        }

        if (null == $par8fce8a73ac264e4a8f3b56d8b991b8a534dea539354d479394e3f52e84995097) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a534dea539354d479394e3f52e84995097 = '';
        }

        $v34dea539354d479394e3f52e84995097Ajax = \URL::to('/')."/api/d69ed607b308439d99ab4ea34275bb97/'+encodeURIComponent((($('#ctlf629596e10c040759fdb8c929935e636_8832ac841f0d43f5bfad042194440bb9{Extra}').val() == '' ? '-' : $('#ctlf629596e10c040759fdb8c929935e636_8832ac841f0d43f5bfad042194440bb9{Extra}').val()) != undefined && ($('#ctlf629596e10c040759fdb8c929935e636_8832ac841f0d43f5bfad042194440bb9{Extra}').val() == '' ? '-' : $('#ctlf629596e10c040759fdb8c929935e636_8832ac841f0d43f5bfad042194440bb9{Extra}').val()).length > 0 ? ($('#ctlf629596e10c040759fdb8c929935e636_8832ac841f0d43f5bfad042194440bb9{Extra}').val() == '' ? '-' : $('#ctlf629596e10c040759fdb8c929935e636_8832ac841f0d43f5bfad042194440bb9{Extra}').val()).replace(/\\./g,'---').replace(/\\//g,'___') : ($('#ctlf629596e10c040759fdb8c929935e636_8832ac841f0d43f5bfad042194440bb9{Extra}').val() == '' ? '-' : $('#ctlf629596e10c040759fdb8c929935e636_8832ac841f0d43f5bfad042194440bb9{Extra}').val())))+'/{page}/{pagesize}/{orderColumn}/{orderType}";

        // Lista Centros de Trabajo - Lista Centros de Trabajo

        $par6185a7056560433494dba94e9ae59107b5103549474841d7b72a049be14b859b = 0;

        if (null == $par6185a7056560433494dba94e9ae59107b5103549474841d7b72a049be14b859b) {
            $par6185a7056560433494dba94e9ae59107b5103549474841d7b72a049be14b859b = '0';
        }

        $par0a0ce2af85ab462a808e0270326fb860b5103549474841d7b72a049be14b859b = 0;

        if (null == $par0a0ce2af85ab462a808e0270326fb860b5103549474841d7b72a049be14b859b) {
            $par0a0ce2af85ab462a808e0270326fb860b5103549474841d7b72a049be14b859b = '0';
        }

        $par5551ae677d6b488ebd38625d0f5d9fceb5103549474841d7b72a049be14b859b = '';

        if ('-' == $par5551ae677d6b488ebd38625d0f5d9fceb5103549474841d7b72a049be14b859b) {
            $par5551ae677d6b488ebd38625d0f5d9fceb5103549474841d7b72a049be14b859b = null;
        }

        if (null == $par5551ae677d6b488ebd38625d0f5d9fceb5103549474841d7b72a049be14b859b) {
            $par5551ae677d6b488ebd38625d0f5d9fceb5103549474841d7b72a049be14b859b = '';
        }

        $par8fce8a73ac264e4a8f3b56d8b991b8a5b5103549474841d7b72a049be14b859b = '';

        if ('-' == $par8fce8a73ac264e4a8f3b56d8b991b8a5b5103549474841d7b72a049be14b859b) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a5b5103549474841d7b72a049be14b859b = null;
        }

        if (null == $par8fce8a73ac264e4a8f3b56d8b991b8a5b5103549474841d7b72a049be14b859b) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a5b5103549474841d7b72a049be14b859b = '';
        }

        $vb5103549474841d7b72a049be14b859b = \App\repf782f923fd0247bd9f4010b717e52999::mt8a72f29cb88a4c25b11f1b5da7be1efe($par6185a7056560433494dba94e9ae59107b5103549474841d7b72a049be14b859b, $par0a0ce2af85ab462a808e0270326fb860b5103549474841d7b72a049be14b859b, $par5551ae677d6b488ebd38625d0f5d9fceb5103549474841d7b72a049be14b859b, $par8fce8a73ac264e4a8f3b56d8b991b8a5b5103549474841d7b72a049be14b859b);

        $vb5103549474841d7b72a049be14b859bAjax = \URL::to('/').'/api/8a72f29cb88a4c25b11f1b5da7be1efe/{page}/{pagesize}/{orderColumn}/{orderType}';

        // Lista Semanas Recibas - Lista de Semanas de Recibas

        $par6185a7056560433494dba94e9ae5910778f67fd204844d7db82b1df3826dcf4d = 0;

        if (null == $par6185a7056560433494dba94e9ae5910778f67fd204844d7db82b1df3826dcf4d) {
            $par6185a7056560433494dba94e9ae5910778f67fd204844d7db82b1df3826dcf4d = '0';
        }

        $par0a0ce2af85ab462a808e0270326fb86078f67fd204844d7db82b1df3826dcf4d = 0;

        if (null == $par0a0ce2af85ab462a808e0270326fb86078f67fd204844d7db82b1df3826dcf4d) {
            $par0a0ce2af85ab462a808e0270326fb86078f67fd204844d7db82b1df3826dcf4d = '0';
        }

        $par5551ae677d6b488ebd38625d0f5d9fce78f67fd204844d7db82b1df3826dcf4d = '';

        if ('-' == $par5551ae677d6b488ebd38625d0f5d9fce78f67fd204844d7db82b1df3826dcf4d) {
            $par5551ae677d6b488ebd38625d0f5d9fce78f67fd204844d7db82b1df3826dcf4d = null;
        }

        if (null == $par5551ae677d6b488ebd38625d0f5d9fce78f67fd204844d7db82b1df3826dcf4d) {
            $par5551ae677d6b488ebd38625d0f5d9fce78f67fd204844d7db82b1df3826dcf4d = '';
        }

        $par8fce8a73ac264e4a8f3b56d8b991b8a578f67fd204844d7db82b1df3826dcf4d = '';

        if ('-' == $par8fce8a73ac264e4a8f3b56d8b991b8a578f67fd204844d7db82b1df3826dcf4d) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a578f67fd204844d7db82b1df3826dcf4d = null;
        }

        if (null == $par8fce8a73ac264e4a8f3b56d8b991b8a578f67fd204844d7db82b1df3826dcf4d) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a578f67fd204844d7db82b1df3826dcf4d = '';
        }

        $v78f67fd204844d7db82b1df3826dcf4d = \App\repf782f923fd0247bd9f4010b717e52999::mtf3b6d1a392b14ca986fa6ded0a35c490($par6185a7056560433494dba94e9ae5910778f67fd204844d7db82b1df3826dcf4d, $par0a0ce2af85ab462a808e0270326fb86078f67fd204844d7db82b1df3826dcf4d, $par5551ae677d6b488ebd38625d0f5d9fce78f67fd204844d7db82b1df3826dcf4d, $par8fce8a73ac264e4a8f3b56d8b991b8a578f67fd204844d7db82b1df3826dcf4d);

        $v78f67fd204844d7db82b1df3826dcf4dAjax = \URL::to('/').'/api/f3b6d1a392b14ca986fa6ded0a35c490/{page}/{pagesize}/{orderColumn}/{orderType}';

        // Lista tipo de leche - Lista tipo de leche

        $par6185a7056560433494dba94e9ae59107e629324b842b4ad8831a9db90413582b = 0;

        if (null == $par6185a7056560433494dba94e9ae59107e629324b842b4ad8831a9db90413582b) {
            $par6185a7056560433494dba94e9ae59107e629324b842b4ad8831a9db90413582b = '0';
        }

        $par0a0ce2af85ab462a808e0270326fb860e629324b842b4ad8831a9db90413582b = 0;

        if (null == $par0a0ce2af85ab462a808e0270326fb860e629324b842b4ad8831a9db90413582b) {
            $par0a0ce2af85ab462a808e0270326fb860e629324b842b4ad8831a9db90413582b = '0';
        }

        $par5551ae677d6b488ebd38625d0f5d9fcee629324b842b4ad8831a9db90413582b = '';

        if ('-' == $par5551ae677d6b488ebd38625d0f5d9fcee629324b842b4ad8831a9db90413582b) {
            $par5551ae677d6b488ebd38625d0f5d9fcee629324b842b4ad8831a9db90413582b = null;
        }

        if (null == $par5551ae677d6b488ebd38625d0f5d9fcee629324b842b4ad8831a9db90413582b) {
            $par5551ae677d6b488ebd38625d0f5d9fcee629324b842b4ad8831a9db90413582b = '';
        }

        $par8fce8a73ac264e4a8f3b56d8b991b8a5e629324b842b4ad8831a9db90413582b = '';

        if ('-' == $par8fce8a73ac264e4a8f3b56d8b991b8a5e629324b842b4ad8831a9db90413582b) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a5e629324b842b4ad8831a9db90413582b = null;
        }

        if (null == $par8fce8a73ac264e4a8f3b56d8b991b8a5e629324b842b4ad8831a9db90413582b) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a5e629324b842b4ad8831a9db90413582b = '';
        }

        $ve629324b842b4ad8831a9db90413582b = \App\repf782f923fd0247bd9f4010b717e52999::mt48e61ec9722046979c8bb305a6922ac3($par6185a7056560433494dba94e9ae59107e629324b842b4ad8831a9db90413582b, $par0a0ce2af85ab462a808e0270326fb860e629324b842b4ad8831a9db90413582b, $par5551ae677d6b488ebd38625d0f5d9fcee629324b842b4ad8831a9db90413582b, $par8fce8a73ac264e4a8f3b56d8b991b8a5e629324b842b4ad8831a9db90413582b);

        $ve629324b842b4ad8831a9db90413582bAjax = \URL::to('/').'/api/48e61ec9722046979c8bb305a6922ac3/{page}/{pagesize}/{orderColumn}/{orderType}';

        // sp_recibas - sp_recibas

        $par8c47d4e616ea43cbb7bb47f514d55c581 = $request->session()->get('ses5e122755c3a24f5d8789755168e9de27');

        if (null == $par8c47d4e616ea43cbb7bb47f514d55c581) {
            $par8c47d4e616ea43cbb7bb47f514d55c581 = '0';
        }

        $par741b7424515e4f09aabf0d882d9054901 = $request->input('pc');

        if ('-' == $par741b7424515e4f09aabf0d882d9054901) {
            $par741b7424515e4f09aabf0d882d9054901 = null;
        }

        if (null == $par741b7424515e4f09aabf0d882d9054901) {
            $par741b7424515e4f09aabf0d882d9054901 = '-';
        }

        $para2ba9002a43e4e4bbb6a7148eb52773f1 = $request->input('s');

        if (null == $para2ba9002a43e4e4bbb6a7148eb52773f1) {
            $para2ba9002a43e4e4bbb6a7148eb52773f1 = '0';
        }

        $par5a3dd495a1224d9696b3b4612797c6341 = $request->input('tl');

        if (null == $par5a3dd495a1224d9696b3b4612797c6341) {
            $par5a3dd495a1224d9696b3b4612797c6341 = '0';
        }

        $pard54aa832544b480a88a8bf1ec5980f101 = $request->input('fi');

        if ('-' == $pard54aa832544b480a88a8bf1ec5980f101) {
            $pard54aa832544b480a88a8bf1ec5980f101 = null;
        }

        if (null == $pard54aa832544b480a88a8bf1ec5980f101) {
            $pard54aa832544b480a88a8bf1ec5980f101 = '-';
        }

        $par80ed1e37ec464d68b07a9972256c482c1 = $request->input('ff');

        if ('-' == $par80ed1e37ec464d68b07a9972256c482c1) {
            $par80ed1e37ec464d68b07a9972256c482c1 = null;
        }

        if (null == $par80ed1e37ec464d68b07a9972256c482c1) {
            $par80ed1e37ec464d68b07a9972256c482c1 = '-';
        }

        $par920a511e4f004cab838a0c66239286001 = $request->input('ge');

        if (null == $par920a511e4f004cab838a0c66239286001) {
            $par920a511e4f004cab838a0c66239286001 = '0';
        }

        $pard20133d43c054c248802205c83e19b631 = $request->input('ca');

        if (null == $pard20133d43c054c248802205c83e19b631) {
            $pard20133d43c054c248802205c83e19b631 = '0';
        }

        $par6185a7056560433494dba94e9ae59107eb1ccba0317e4134adb949fa68a53578 = $request->input('p');

        if (null == $par6185a7056560433494dba94e9ae59107eb1ccba0317e4134adb949fa68a53578) {
            $par6185a7056560433494dba94e9ae59107eb1ccba0317e4134adb949fa68a53578 = '0';
        }

        $par0a0ce2af85ab462a808e0270326fb860eb1ccba0317e4134adb949fa68a53578 = $request->input('c');

        if (null == $par0a0ce2af85ab462a808e0270326fb860eb1ccba0317e4134adb949fa68a53578) {
            $par0a0ce2af85ab462a808e0270326fb860eb1ccba0317e4134adb949fa68a53578 = '0';
        }

        $par5551ae677d6b488ebd38625d0f5d9fceeb1ccba0317e4134adb949fa68a53578 = '';

        if ('-' == $par5551ae677d6b488ebd38625d0f5d9fceeb1ccba0317e4134adb949fa68a53578) {
            $par5551ae677d6b488ebd38625d0f5d9fceeb1ccba0317e4134adb949fa68a53578 = null;
        }

        if (null == $par5551ae677d6b488ebd38625d0f5d9fceeb1ccba0317e4134adb949fa68a53578) {
            $par5551ae677d6b488ebd38625d0f5d9fceeb1ccba0317e4134adb949fa68a53578 = '';
        }

        $par8fce8a73ac264e4a8f3b56d8b991b8a5eb1ccba0317e4134adb949fa68a53578 = '';

        if ('-' == $par8fce8a73ac264e4a8f3b56d8b991b8a5eb1ccba0317e4134adb949fa68a53578) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a5eb1ccba0317e4134adb949fa68a53578 = null;
        }

        if (null == $par8fce8a73ac264e4a8f3b56d8b991b8a5eb1ccba0317e4134adb949fa68a53578) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a5eb1ccba0317e4134adb949fa68a53578 = '';
        }

        $veb1ccba0317e4134adb949fa68a53578 = \App\repf782f923fd0247bd9f4010b717e52999::mtbaec03eedcbb43e6b2fad5411c22cdc1($par8c47d4e616ea43cbb7bb47f514d55c581, $par741b7424515e4f09aabf0d882d9054901, $para2ba9002a43e4e4bbb6a7148eb52773f1, $par5a3dd495a1224d9696b3b4612797c6341, $pard54aa832544b480a88a8bf1ec5980f101, $par80ed1e37ec464d68b07a9972256c482c1, $par920a511e4f004cab838a0c66239286001, $pard20133d43c054c248802205c83e19b631, $par6185a7056560433494dba94e9ae59107eb1ccba0317e4134adb949fa68a53578, $par0a0ce2af85ab462a808e0270326fb860eb1ccba0317e4134adb949fa68a53578, $par5551ae677d6b488ebd38625d0f5d9fceeb1ccba0317e4134adb949fa68a53578, $par8fce8a73ac264e4a8f3b56d8b991b8a5eb1ccba0317e4134adb949fa68a53578);

        $veb1ccba0317e4134adb949fa68a53578Ajax = \URL::to('/').'/api/baec03eedcbb43e6b2fad5411c22cdc1/'.(null == $par8c47d4e616ea43cbb7bb47f514d55c581 ? '-' : ('' == $par8c47d4e616ea43cbb7bb47f514d55c581 ? '-' : $par8c47d4e616ea43cbb7bb47f514d55c581)).'/'.(null == $par741b7424515e4f09aabf0d882d9054901 ? '-' : ('' == $par741b7424515e4f09aabf0d882d9054901 ? '-' : $par741b7424515e4f09aabf0d882d9054901)).'/'.(null == $para2ba9002a43e4e4bbb6a7148eb52773f1 ? '-' : ('' == $para2ba9002a43e4e4bbb6a7148eb52773f1 ? '-' : $para2ba9002a43e4e4bbb6a7148eb52773f1)).'/'.(null == $par5a3dd495a1224d9696b3b4612797c6341 ? '-' : ('' == $par5a3dd495a1224d9696b3b4612797c6341 ? '-' : $par5a3dd495a1224d9696b3b4612797c6341)).'/'.(null == $pard54aa832544b480a88a8bf1ec5980f101 ? '-' : ('' == $pard54aa832544b480a88a8bf1ec5980f101 ? '-' : $pard54aa832544b480a88a8bf1ec5980f101)).'/'.(null == $par80ed1e37ec464d68b07a9972256c482c1 ? '-' : ('' == $par80ed1e37ec464d68b07a9972256c482c1 ? '-' : $par80ed1e37ec464d68b07a9972256c482c1)).'/'.(null == $par920a511e4f004cab838a0c66239286001 ? '-' : ('' == $par920a511e4f004cab838a0c66239286001 ? '-' : $par920a511e4f004cab838a0c66239286001)).'/'.(null == $pard20133d43c054c248802205c83e19b631 ? '-' : ('' == $pard20133d43c054c248802205c83e19b631 ? '-' : $pard20133d43c054c248802205c83e19b631)).'/{page}/{pagesize}/{orderColumn}/{orderType}';

        // sp_recibas - sp_recibas

        $veb1ccba0317e4134adb949fa68a53578Count = \App\repf782f923fd0247bd9f4010b717e52999::mtbaec03eedcbb43e6b2fad5411c22cdc1Count($par8c47d4e616ea43cbb7bb47f514d55c581, $par741b7424515e4f09aabf0d882d9054901, $para2ba9002a43e4e4bbb6a7148eb52773f1, $par5a3dd495a1224d9696b3b4612797c6341, $pard54aa832544b480a88a8bf1ec5980f101, $par80ed1e37ec464d68b07a9972256c482c1, $par920a511e4f004cab838a0c66239286001, $pard20133d43c054c248802205c83e19b631, $par6185a7056560433494dba94e9ae59107eb1ccba0317e4134adb949fa68a53578, $par0a0ce2af85ab462a808e0270326fb860eb1ccba0317e4134adb949fa68a53578, $par5551ae677d6b488ebd38625d0f5d9fceeb1ccba0317e4134adb949fa68a53578, $par8fce8a73ac264e4a8f3b56d8b991b8a5eb1ccba0317e4134adb949fa68a53578);

        //$veb1ccba0317e4134adb949fa68a53578CountAjax =  \URL::to('/')."/api/baec03eedcbb43e6b2fad5411c22cdc1Count{ParametersAjax}/{page}/{pagesize}/{orderColumn}/{orderType}";

        // sp_recibas_title - sp_recibas_title

        $pare2e1261e0a4d4b428088dc0f612b61051 = $request->session()->get('ses5e122755c3a24f5d8789755168e9de27');

        if (null == $pare2e1261e0a4d4b428088dc0f612b61051) {
            $pare2e1261e0a4d4b428088dc0f612b61051 = '0';
        }

        $v5cbe059215b6482c8054d39c2c4eda81 = \App\repf782f923fd0247bd9f4010b717e52999::mt80329598f9434db5874500497543c494($pare2e1261e0a4d4b428088dc0f612b61051);

        $v5cbe059215b6482c8054d39c2c4eda81Ajax = \URL::to('/').'/api/80329598f9434db5874500497543c494/'.(null == $pare2e1261e0a4d4b428088dc0f612b61051 ? '-' : ('' == $pare2e1261e0a4d4b428088dc0f612b61051 ? '-' : $pare2e1261e0a4d4b428088dc0f612b61051)).'/{page}/{pagesize}/{orderColumn}/{orderType}';
        ...
        $par949ac6762f824f589aa55df91c654a401 = $request->input('t');
        ...
        $par6185a7056560433494dba94e9ae59107387a70e79818431baf6829182fb8d4ef = 0;

        if (null == $par6185a7056560433494dba94e9ae59107387a70e79818431baf6829182fb8d4ef) {
            $par6185a7056560433494dba94e9ae59107387a70e79818431baf6829182fb8d4ef = '0';
        }

        $par0a0ce2af85ab462a808e0270326fb860387a70e79818431baf6829182fb8d4ef = 0;

        if (null == $par0a0ce2af85ab462a808e0270326fb860387a70e79818431baf6829182fb8d4ef) {
            $par0a0ce2af85ab462a808e0270326fb860387a70e79818431baf6829182fb8d4ef = '0';
        }

        $par5551ae677d6b488ebd38625d0f5d9fce387a70e79818431baf6829182fb8d4ef = '';

        if ('-' == $par5551ae677d6b488ebd38625d0f5d9fce387a70e79818431baf6829182fb8d4ef) {
            $par5551ae677d6b488ebd38625d0f5d9fce387a70e79818431baf6829182fb8d4ef = null;
        }

        if (null == $par5551ae677d6b488ebd38625d0f5d9fce387a70e79818431baf6829182fb8d4ef) {
            $par5551ae677d6b488ebd38625d0f5d9fce387a70e79818431baf6829182fb8d4ef = '';
        }

        $par8fce8a73ac264e4a8f3b56d8b991b8a5387a70e79818431baf6829182fb8d4ef = '';

        if ('-' == $par8fce8a73ac264e4a8f3b56d8b991b8a5387a70e79818431baf6829182fb8d4ef) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a5387a70e79818431baf6829182fb8d4ef = null;
        }

        if (null == $par8fce8a73ac264e4a8f3b56d8b991b8a5387a70e79818431baf6829182fb8d4ef) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a5387a70e79818431baf6829182fb8d4ef = '';
        }

        $v387a70e79818431baf6829182fb8d4ef = \App\repf782f923fd0247bd9f4010b717e52999::mtd1203cac9e0a4d2b8d8d3ac5e285d428($par8e9cfc8933a449af80f5fd2fdaf0c7461, $par949ac6762f824f589aa55df91c654a401, $par6185a7056560433494dba94e9ae59107387a70e79818431baf6829182fb8d4ef, $par0a0ce2af85ab462a808e0270326fb860387a70e79818431baf6829182fb8d4ef, $par5551ae677d6b488ebd38625d0f5d9fce387a70e79818431baf6829182fb8d4ef, $par8fce8a73ac264e4a8f3b56d8b991b8a5387a70e79818431baf6829182fb8d4ef);

        $v387a70e79818431baf6829182fb8d4efAjax = \URL::to('/').'/api/d1203cac9e0a4d2b8d8d3ac5e285d428/'.(null == $par8e9cfc8933a449af80f5fd2fdaf0c7461 ? '-' : ('' == $par8e9cfc8933a449af80f5fd2fdaf0c7461 ? '-' : $par8e9cfc8933a449af80f5fd2fdaf0c7461)).'/'.(null == $par949ac6762f824f589aa55df91c654a401 ? '-' : ('' == $par949ac6762f824f589aa55df91c654a401 ? '-' : $par949ac6762f824f589aa55df91c654a401)).'/{page}/{pagesize}/{orderColumn}/{orderType}';
        ...
        // Paginador Recibas - Paginador Recibas
      $pgB3253ea2e034946eb838680708782f8cc = 0; // Page bottom
      $pgT3253ea2e034946eb838680708782f8cc = 0; // Page top
      $pgR3253ea2e034946eb838680708782f8cc = (isset($veb1ccba0317e4134adb949fa68a53578Count) ? $veb1ccba0317e4134adb949fa68a53578Count : 0); // Total rows
      $pgA3253ea2e034946eb838680708782f8cc = $par6185a7056560433494dba94e9ae59107eb1ccba0317e4134adb949fa68a53578; // Current page
      $pgS3253ea2e034946eb838680708782f8cc = $par0a0ce2af85ab462a808e0270326fb860eb1ccba0317e4134adb949fa68a53578; // Page size
      $pgH3253ea2e034946eb838680708782f8cc = 5; // Pages to show
      $pgP3253ea2e034946eb838680708782f8cc = ceil((isset($veb1ccba0317e4134adb949fa68a53578Count) ? $veb1ccba0317e4134adb949fa68a53578Count : 0) / $pgS3253ea2e034946eb838680708782f8cc); // Total pages
      $res3253ea2e034946eb838680708782f8cc = '';

        if ($pgP3253ea2e034946eb838680708782f8cc > 0 && $pgP3253ea2e034946eb838680708782f8cc >= $pgA3253ea2e034946eb838680708782f8cc) {
            $pgB3253ea2e034946eb838680708782f8cc = $pgA3253ea2e034946eb838680708782f8cc - (int) ($pgH3253ea2e034946eb838680708782f8cc / 2);

            if ($pgB3253ea2e034946eb838680708782f8cc <= 1) {
                $pgB3253ea2e034946eb838680708782f8cc = 0;
            }

            $pgT3253ea2e034946eb838680708782f8cc = $pgB3253ea2e034946eb838680708782f8cc + $pgH3253ea2e034946eb838680708782f8cc;

            if ($pgT3253ea2e034946eb838680708782f8cc >= $pgP3253ea2e034946eb838680708782f8cc) {
                $pgT3253ea2e034946eb838680708782f8cc = $pgP3253ea2e034946eb838680708782f8cc;
                $pgB3253ea2e034946eb838680708782f8cc = $pgP3253ea2e034946eb838680708782f8cc - $pgH3253ea2e034946eb838680708782f8cc;
            }

            $res3253ea2e034946eb838680708782f8cc .= '<li';
            if ($pgA3253ea2e034946eb838680708782f8cc > 1) {
                $res3253ea2e034946eb838680708782f8cc .= '';
            } else {
                $res3253ea2e034946eb838680708782f8cc .= ' class="disabled" ';
            }
            $res3253ea2e034946eb838680708782f8cc .= '>';
            if ($pgA3253ea2e034946eb838680708782f8cc > 1) {
                $res3253ea2e034946eb838680708782f8cc .= '<a href="';
                $res3253ea2e034946eb838680708782f8cc .= \URL::to('/').str_replace('{pagesize}', $pgS3253ea2e034946eb838680708782f8cc, str_replace('{pagenumber}', '1', '/recibasGrid/'.(null == $request->input('pc') ? '-' : $request->input('pc')).'/'.(null == $request->input('s') ? '-' : $request->input('s')).'/'.(null == $request->input('tl') ? '-' : $request->input('tl')).'/'.(null == $request->input('fi') ? '-' : $request->input('fi')).'/'.(null == $request->input('ff') ? '-' : $request->input('ff')).'/'.(null == $request->input('ge') ? '-' : $request->input('ge')).'/'.(null == $request->input('ca') ? '-' : $request->input('ca')).'/{pagesize}/{pagenumber}/'.(null == $request->input('t') ? '-' : $request->input('t')).''));
                $res3253ea2e034946eb838680708782f8cc .= '">';
            }
            $res3253ea2e034946eb838680708782f8cc .= str_replace('{Localization}', \Lang::get('resourceff2b12513d1a44948a7e7fbabde0697a.msg673755107d9e4f5cb0eef6837c91b302'), '<span aria-hidden="true">&laquo; {Localization}</span>');

            if ($pgA3253ea2e034946eb838680708782f8cc > 1) {
                $res3253ea2e034946eb838680708782f8cc .= '</a>';
            }
            $res3253ea2e034946eb838680708782f8cc .= '</li>';
            ...
            if ($pgA3253ea2e034946eb838680708782f8cc > 1) {
                $res3253ea2e034946eb838680708782f8cc .= '<a href="';
                $res3253ea2e034946eb838680708782f8cc .= \URL::to('/').str_replace('{pagesize}', $pgS3253ea2e034946eb838680708782f8cc, str_replace('{pagenumber}', ($pgA3253ea2e034946eb838680708782f8cc - 1), '/recibasGrid/'.(null == $request->input('pc') ? '-' : $request->input('pc')).'/'.(null == $request->input('s') ? '-' : $request->input('s')).'/'.(null == $request->input('tl') ? '-' : $request->input('tl')).'/'.(null == $request->input('fi') ? '-' : $request->input('fi')).'/'.(null == $request->input('ff') ? '-' : $request->input('ff')).'/'.(null == $request->input('ge') ? '-' : $request->input('ge')).'/'.(null == $request->input('ca') ? '-' : $request->input('ca')).'/{pagesize}/{pagenumber}/'.(null == $request->input('t') ? '-' : $request->input('t')).''));
                $res3253ea2e034946eb838680708782f8cc .= '">';
            }
            $res3253ea2e034946eb838680708782f8cc .= str_replace('{Localization}', \Lang::get('resourceff2b12513d1a44948a7e7fbabde0697a.msg9d046e3adb7647fc95991757861b6f28'), '<span aria-hidden="true">&laquo; {Localization}</span>');
            ...
            for ($i = 1; $i <= $pgP3253ea2e034946eb838680708782f8cc; ++$i) {
                if ($i > $pgB3253ea2e034946eb838680708782f8cc && $i <= $pgT3253ea2e034946eb838680708782f8cc) {
                    $res3253ea2e034946eb838680708782f8cc .= '<li';
                    if ($i == $pgA3253ea2e034946eb838680708782f8cc) {
                        $res3253ea2e034946eb838680708782f8cc .= ' class="active" ';
                    } else {
                        $res3253ea2e034946eb838680708782f8cc .= '';
                    }
                    $res3253ea2e034946eb838680708782f8cc .= '>';
                    $res3253ea2e034946eb838680708782f8cc .= '<a href="';
                    $res3253ea2e034946eb838680708782f8cc .= \URL::to('/').str_replace('{pagesize}', $pgS3253ea2e034946eb838680708782f8cc, str_replace('{pagenumber}', $i, '/recibasGrid/'.(null == $request->input('pc') ? '-' : $request->input('pc')).'/'.(null == $request->input('s') ? '-' : $request->input('s')).'/'.(null == $request->input('tl') ? '-' : $request->input('tl')).'/'.(null == $request->input('fi') ? '-' : $request->input('fi')).'/'.(null == $request->input('ff') ? '-' : $request->input('ff')).'/'.(null == $request->input('ge') ? '-' : $request->input('ge')).'/'.(null == $request->input('ca') ? '-' : $request->input('ca')).'/{pagesize}/{pagenumber}/'.(null == $request->input('t') ? '-' : $request->input('t')).''));
                    $res3253ea2e034946eb838680708782f8cc .= '">';
                    $res3253ea2e034946eb838680708782f8cc .= $i;
                    $res3253ea2e034946eb838680708782f8cc .= '</a></li>';
                }
            }

            $res3253ea2e034946eb838680708782f8cc .= '<li';
            if ($pgA3253ea2e034946eb838680708782f8cc < $pgP3253ea2e034946eb838680708782f8cc) {
                $res3253ea2e034946eb838680708782f8cc .= '';
            } else {
                $res3253ea2e034946eb838680708782f8cc .= ' class="disabled" ';
            }
            ...
            $res3253ea2e034946eb838680708782f8cc .= str_replace('{Localization}', \Lang::get('resourceff2b12513d1a44948a7e7fbabde0697a.msg6d4792f9962a46f2b37bbf9af604eda9'), '<span aria-hidden="true">{Localization} &raquo;</span>');
            ...
            if ($pgA3253ea2e034946eb838680708782f8cc < $pgP3253ea2e034946eb838680708782f8cc) {
                $res3253ea2e034946eb838680708782f8cc .= '<a href="';
                $res3253ea2e034946eb838680708782f8cc .= \URL::to('/').str_replace('{pagesize}', $pgS3253ea2e034946eb838680708782f8cc, str_replace('{pagenumber}', $pgP3253ea2e034946eb838680708782f8cc, '/recibasGrid/'.(null == $request->input('pc') ? '-' : $request->input('pc')).'/'.(null == $request->input('s') ? '-' : $request->input('s')).'/'.(null == $request->input('tl') ? '-' : $request->input('tl')).'/'.(null == $request->input('fi') ? '-' : $request->input('fi')).'/'.(null == $request->input('ff') ? '-' : $request->input('ff')).'/'.(null == $request->input('ge') ? '-' : $request->input('ge')).'/'.(null == $request->input('ca') ? '-' : $request->input('ca')).'/{pagesize}/{pagenumber}/'.(null == $request->input('t') ? '-' : $request->input('t')).''));
                $res3253ea2e034946eb838680708782f8cc .= '">';
            }
            $res3253ea2e034946eb838680708782f8cc .= str_replace('{Localization}', \Lang::get('resourceff2b12513d1a44948a7e7fbabde0697a.msga50b13adc5284e92844239ca59bf38e5'), '<span aria-hidden="true">{Localization} &raquo;</span>');
        ...
        $v3253ea2e034946eb838680708782f8cc = $res3253ea2e034946eb838680708782f8cc;
        $v3253ea2e034946eb838680708782f8ccLink = \URL::to('/').'/recibasGrid/'.(null == $request->input('pc') ? '-' : $request->input('pc')).'/'.(null == $request->input('s') ? '-' : $request->input('s')).'/'.(null == $request->input('tl') ? '-' : $request->input('tl')).'/'.(null == $request->input('fi') ? '-' : $request->input('fi')).'/'.(null == $request->input('ff') ? '-' : $request->input('ff')).'/'.(null == $request->input('ge') ? '-' : $request->input('ge')).'/'.(null == $request->input('ca') ? '-' : $request->input('ca')).'/{pagesize}/{pagenumber}/'.(null == $request->input('t') ? '-' : $request->input('t')).'';
        $v3253ea2e034946eb838680708782f8ccChange = $pgP3253ea2e034946eb838680708782f8cc.','.$pgA3253ea2e034946eb838680708782f8cc;
        $v3253ea2e034946eb838680708782f8ccCurrent = $pgS3253ea2e034946eb838680708782f8cc;
        $v3253ea2e034946eb838680708782f8ccActual = $pgA3253ea2e034946eb838680708782f8cc;
        $v3253ea2e034946eb838680708782f8ccTotal = $pgR3253ea2e034946eb838680708782f8cc;
        $v3253ea2e034946eb838680708782f8ccAjax = (isset($veb1ccba0317e4134adb949fa68a53578Ajax) ? $veb1ccba0317e4134adb949fa68a53578Ajax : '');
        $v3253ea2e034946eb838680708782f8ccOrder = $par5551ae677d6b488ebd38625d0f5d9fceeb1ccba0317e4134adb949fa68a53578.'|'.$par8fce8a73ac264e4a8f3b56d8b991b8a5eb1ccba0317e4134adb949fa68a53578;

        $arrWiths['v34dea539354d479394e3f52e84995097Ajax'] = isset($v34dea539354d479394e3f52e84995097Ajax) ? $v34dea539354d479394e3f52e84995097Ajax : '';
        $arrWiths['vb5103549474841d7b72a049be14b859b'] = isset($vb5103549474841d7b72a049be14b859b) ? $vb5103549474841d7b72a049be14b859b : '';
        $arrWiths['vb5103549474841d7b72a049be14b859bAjax'] = isset($vb5103549474841d7b72a049be14b859bAjax) ? $vb5103549474841d7b72a049be14b859bAjax : '';
        $arrWiths['v78f67fd204844d7db82b1df3826dcf4d'] = isset($v78f67fd204844d7db82b1df3826dcf4d) ? $v78f67fd204844d7db82b1df3826dcf4d : '';
        $arrWiths['v78f67fd204844d7db82b1df3826dcf4dAjax'] = isset($v78f67fd204844d7db82b1df3826dcf4dAjax) ? $v78f67fd204844d7db82b1df3826dcf4dAjax : '';
        $arrWiths['ve629324b842b4ad8831a9db90413582b'] = isset($ve629324b842b4ad8831a9db90413582b) ? $ve629324b842b4ad8831a9db90413582b : '';
        $arrWiths['ve629324b842b4ad8831a9db90413582bAjax'] = isset($ve629324b842b4ad8831a9db90413582bAjax) ? $ve629324b842b4ad8831a9db90413582bAjax : '';
        $arrWiths['veb1ccba0317e4134adb949fa68a53578'] = isset($veb1ccba0317e4134adb949fa68a53578) ? $veb1ccba0317e4134adb949fa68a53578 : '';
        $arrWiths['veb1ccba0317e4134adb949fa68a53578Count'] = isset($veb1ccba0317e4134adb949fa68a53578Count) ? $veb1ccba0317e4134adb949fa68a53578Count : '';
        $arrWiths['veb1ccba0317e4134adb949fa68a53578Ajax'] = isset($veb1ccba0317e4134adb949fa68a53578Ajax) ? $veb1ccba0317e4134adb949fa68a53578Ajax : '';
        $arrWiths['v5cbe059215b6482c8054d39c2c4eda81'] = isset($v5cbe059215b6482c8054d39c2c4eda81) ? $v5cbe059215b6482c8054d39c2c4eda81 : '';
        $arrWiths['v387a70e79818431baf6829182fb8d4ef'] = isset($v387a70e79818431baf6829182fb8d4ef) ? $v387a70e79818431baf6829182fb8d4ef : '';
        $arrWiths['v387a70e79818431baf6829182fb8d4efAjax'] = isset($v387a70e79818431baf6829182fb8d4efAjax) ? $v387a70e79818431baf6829182fb8d4efAjax : '';
        ...
        $arrWiths['v3253ea2e034946eb838680708782f8cc'] = isset($v3253ea2e034946eb838680708782f8cc) ? $v3253ea2e034946eb838680708782f8cc : '';
        $arrWiths['v3253ea2e034946eb838680708782f8ccLink'] = isset($v3253ea2e034946eb838680708782f8ccLink) ? $v3253ea2e034946eb838680708782f8ccLink : '';
        $arrWiths['v3253ea2e034946eb838680708782f8ccChange'] = isset($v3253ea2e034946eb838680708782f8ccChange) ? $v3253ea2e034946eb838680708782f8ccChange : '';
        $arrWiths['v3253ea2e034946eb838680708782f8ccCurrent'] = isset($v3253ea2e034946eb838680708782f8ccCurrent) ? $v3253ea2e034946eb838680708782f8ccCurrent : '';
        $arrWiths['v3253ea2e034946eb838680708782f8ccActual'] = isset($v3253ea2e034946eb838680708782f8ccActual) ? $v3253ea2e034946eb838680708782f8ccActual : '';
        $arrWiths['v3253ea2e034946eb838680708782f8ccTotal'] = isset($v3253ea2e034946eb838680708782f8ccTotal) ? $v3253ea2e034946eb838680708782f8ccTotal : '';
        $arrWiths['v3253ea2e034946eb838680708782f8ccAjax'] = isset($v3253ea2e034946eb838680708782f8ccAjax) ? $v3253ea2e034946eb838680708782f8ccAjax : '';
        $arrWiths['v3253ea2e034946eb838680708782f8ccOrder'] = isset($v3253ea2e034946eb838680708782f8ccOrder) ? $v3253ea2e034946eb838680708782f8ccOrder : '';
        ...
        $response = new \Illuminate\Http\Response(view('ed7d3a0faccc4166abe85798e058d44b.Index', $arrWiths)->with('title', $arrWiths['title'])->with('vSessionTimeout', \Config::get('session.lifetime') * 60));
