...
// Creado               martes, 27 de junio de 2023 17:56:19
 ...
 */
class pg6f460b6414974b14869713f5ced2bea4Controller extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        $par3c81feb3a9b84ab9acb814a923c17a031 = $request->input('a');

        if (null == $par3c81feb3a9b84ab9acb814a923c17a031) {
            $par3c81feb3a9b84ab9acb814a923c17a031 = '';
        }

        $par3743ee06de5c4a498c29d65aa7be45ba1 = $request->input('b');

        if (null == $par3743ee06de5c4a498c29d65aa7be45ba1) {
            $par3743ee06de5c4a498c29d65aa7be45ba1 = '';
        }

        $pare22ba75afbd7473fbc209bc45358882e1 = $request->session()->get('ses5e122755c3a24f5d8789755168e9de27');

        if (null == $pare22ba75afbd7473fbc209bc45358882e1) {
            $pare22ba75afbd7473fbc209bc45358882e1 = '';
        }

        $vd75a89e49e394ae9ac3b6eb15d0c96c2 = \App\repf782f923fd0247bd9f4010b717e52999::mtd499694edfc4401891d20d5a6163aa25($par3c81feb3a9b84ab9acb814a923c17a031, $par3743ee06de5c4a498c29d65aa7be45ba1, $pare22ba75afbd7473fbc209bc45358882e1);

        $vd75a89e49e394ae9ac3b6eb15d0c96c2Ajax = \URL::to('/').'/api/d499694edfc4401891d20d5a6163aa25/'.(null == $par3c81feb3a9b84ab9acb814a923c17a031 ? '-' : ('' == $par3c81feb3a9b84ab9acb814a923c17a031 ? '-' : $par3c81feb3a9b84ab9acb814a923c17a031)).'/'.(null == $par3743ee06de5c4a498c29d65aa7be45ba1 ? '-' : ('' == $par3743ee06de5c4a498c29d65aa7be45ba1 ? '-' : $par3743ee06de5c4a498c29d65aa7be45ba1)).'/'.(null == $pare22ba75afbd7473fbc209bc45358882e1 ? '-' : ('' == $pare22ba75afbd7473fbc209bc45358882e1 ? '-' : $pare22ba75afbd7473fbc209bc45358882e1)).'/{page}/{pagesize}/{orderColumn}/{orderType}';

        // sp_titulos_generales - sp_titulos_generales

        $par915f2ce45e324305adf910faaabe6120 = $request->input('c');

        if (null == $par915f2ce45e324305adf910faaabe6120) {
            $par915f2ce45e324305adf910faaabe6120 = '0';
        }

        $par6185a7056560433494dba94e9ae591077dd26240bae64fdea328cddd88560eee = 0;

        if (null == $par6185a7056560433494dba94e9ae591077dd26240bae64fdea328cddd88560eee) {
            $par6185a7056560433494dba94e9ae591077dd26240bae64fdea328cddd88560eee = '0';
        }

        $par0a0ce2af85ab462a808e0270326fb8607dd26240bae64fdea328cddd88560eee = 0;

        if (null == $par0a0ce2af85ab462a808e0270326fb8607dd26240bae64fdea328cddd88560eee) {
            $par0a0ce2af85ab462a808e0270326fb8607dd26240bae64fdea328cddd88560eee = '0';
        }

        $par5551ae677d6b488ebd38625d0f5d9fce7dd26240bae64fdea328cddd88560eee = '';

        if ('-' == $par5551ae677d6b488ebd38625d0f5d9fce7dd26240bae64fdea328cddd88560eee) {
            $par5551ae677d6b488ebd38625d0f5d9fce7dd26240bae64fdea328cddd88560eee = null;
        }

        if (null == $par5551ae677d6b488ebd38625d0f5d9fce7dd26240bae64fdea328cddd88560eee) {
            $par5551ae677d6b488ebd38625d0f5d9fce7dd26240bae64fdea328cddd88560eee = '';
        }

        $par8fce8a73ac264e4a8f3b56d8b991b8a57dd26240bae64fdea328cddd88560eee = '';

        if ('-' == $par8fce8a73ac264e4a8f3b56d8b991b8a57dd26240bae64fdea328cddd88560eee) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a57dd26240bae64fdea328cddd88560eee = null;
        }

        if (null == $par8fce8a73ac264e4a8f3b56d8b991b8a57dd26240bae64fdea328cddd88560eee) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a57dd26240bae64fdea328cddd88560eee = '';
        }

        $v7dd26240bae64fdea328cddd88560eee = \App\repf782f923fd0247bd9f4010b717e52999::mt1f2e4a280a3c490cb91d2b2e03e8c897($par915f2ce45e324305adf910faaabe6120, $par6185a7056560433494dba94e9ae591077dd26240bae64fdea328cddd88560eee, $par0a0ce2af85ab462a808e0270326fb8607dd26240bae64fdea328cddd88560eee, $par5551ae677d6b488ebd38625d0f5d9fce7dd26240bae64fdea328cddd88560eee, $par8fce8a73ac264e4a8f3b56d8b991b8a57dd26240bae64fdea328cddd88560eee);

        $v7dd26240bae64fdea328cddd88560eeeAjax = \URL::to('/').'/api/1f2e4a280a3c490cb91d2b2e03e8c897/'.(null == $par915f2ce45e324305adf910faaabe6120 ? '-' : ('' == $par915f2ce45e324305adf910faaabe6120 ? '-' : $par915f2ce45e324305adf910faaabe6120)).'/{page}/{pagesize}/{orderColumn}/{orderType}';
        ...
        $arrWiths['vd75a89e49e394ae9ac3b6eb15d0c96c2'] = isset($vd75a89e49e394ae9ac3b6eb15d0c96c2) ? $vd75a89e49e394ae9ac3b6eb15d0c96c2 : '';
        $arrWiths['v7dd26240bae64fdea328cddd88560eee'] = isset($v7dd26240bae64fdea328cddd88560eee) ? $v7dd26240bae64fdea328cddd88560eee : '';
        $arrWiths['v7dd26240bae64fdea328cddd88560eeeAjax'] = isset($v7dd26240bae64fdea328cddd88560eeeAjax) ? $v7dd26240bae64fdea328cddd88560eeeAjax : '';
        ...
        $response = new \Illuminate\Http\Response(view('6f460b6414974b14869713f5ced2bea4.Index', $arrWiths)->with('title', $arrWiths['title'])->with('vSessionTimeout', \Config::get('session.lifetime') * 60));
