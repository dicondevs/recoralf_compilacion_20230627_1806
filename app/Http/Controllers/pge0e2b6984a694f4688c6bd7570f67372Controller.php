...
/**
 * gritiporecurso - gritiporecurso.
 */
class pge0e2b6984a694f4688c6bd7570f67372Controller extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        $par0e519ef208094b78b9bdeceb5e14aafa = $request->input('tipoestimulo');

        if (null == $par0e519ef208094b78b9bdeceb5e14aafa) {
            $par0e519ef208094b78b9bdeceb5e14aafa = '0';
        }

        $par6185a7056560433494dba94e9ae59107bd698a31d32e4e40a358dcbc8f792091 = 0;

        if (null == $par6185a7056560433494dba94e9ae59107bd698a31d32e4e40a358dcbc8f792091) {
            $par6185a7056560433494dba94e9ae59107bd698a31d32e4e40a358dcbc8f792091 = '0';
        }

        $par0a0ce2af85ab462a808e0270326fb860bd698a31d32e4e40a358dcbc8f792091 = 0;

        if (null == $par0a0ce2af85ab462a808e0270326fb860bd698a31d32e4e40a358dcbc8f792091) {
            $par0a0ce2af85ab462a808e0270326fb860bd698a31d32e4e40a358dcbc8f792091 = '0';
        }

        $par5551ae677d6b488ebd38625d0f5d9fcebd698a31d32e4e40a358dcbc8f792091 = '';

        if ('-' == $par5551ae677d6b488ebd38625d0f5d9fcebd698a31d32e4e40a358dcbc8f792091) {
            $par5551ae677d6b488ebd38625d0f5d9fcebd698a31d32e4e40a358dcbc8f792091 = null;
        }

        if (null == $par5551ae677d6b488ebd38625d0f5d9fcebd698a31d32e4e40a358dcbc8f792091) {
            $par5551ae677d6b488ebd38625d0f5d9fcebd698a31d32e4e40a358dcbc8f792091 = '';
        }

        $par8fce8a73ac264e4a8f3b56d8b991b8a5bd698a31d32e4e40a358dcbc8f792091 = '';

        if ('-' == $par8fce8a73ac264e4a8f3b56d8b991b8a5bd698a31d32e4e40a358dcbc8f792091) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a5bd698a31d32e4e40a358dcbc8f792091 = null;
        }

        if (null == $par8fce8a73ac264e4a8f3b56d8b991b8a5bd698a31d32e4e40a358dcbc8f792091) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a5bd698a31d32e4e40a358dcbc8f792091 = '';
        }

        $vbd698a31d32e4e40a358dcbc8f792091Ajax = \URL::to('/').'/api/5ef7e39563104b76806ed5e7742b50e2/'.(null == $par0e519ef208094b78b9bdeceb5e14aafa ? '-' : ('' == $par0e519ef208094b78b9bdeceb5e14aafa ? '-' : $par0e519ef208094b78b9bdeceb5e14aafa)).'/{page}/{pagesize}/{orderColumn}/{orderType}';

        // Modelador Tipo Recuros Tipo Estimulo - Modelador Tipo Recuros Tipo Estimulo

        $vbd698a31d32e4e40a358dcbc8f792091Count = \App\repf782f923fd0247bd9f4010b717e52999::mt5ef7e39563104b76806ed5e7742b50e2Count($par0e519ef208094b78b9bdeceb5e14aafa, $par6185a7056560433494dba94e9ae59107bd698a31d32e4e40a358dcbc8f792091, $par0a0ce2af85ab462a808e0270326fb860bd698a31d32e4e40a358dcbc8f792091, $par5551ae677d6b488ebd38625d0f5d9fcebd698a31d32e4e40a358dcbc8f792091, $par8fce8a73ac264e4a8f3b56d8b991b8a5bd698a31d32e4e40a358dcbc8f792091);

        //$vbd698a31d32e4e40a358dcbc8f792091CountAjax =  \URL::to('/')."/api/5ef7e39563104b76806ed5e7742b50e2Count{ParametersAjax}/{page}/{pagesize}/{orderColumn}/{orderType}";
        ...
        // Tabla de datos Tipo de Recursos - Tabla de datos Tipo de Recursos
        $v500d7d5b41f8482ebc04deff5eef7483 = '';
        $v500d7d5b41f8482ebc04deff5eef7483Total = (isset($vbd698a31d32e4e40a358dcbc8f792091Count) ? $vbd698a31d32e4e40a358dcbc8f792091Count : 0);
        $v500d7d5b41f8482ebc04deff5eef7483Ajax = (isset($vbd698a31d32e4e40a358dcbc8f792091Ajax) ? $vbd698a31d32e4e40a358dcbc8f792091Ajax : '');

        $arrWiths['vbd698a31d32e4e40a358dcbc8f792091Count'] = isset($vbd698a31d32e4e40a358dcbc8f792091Count) ? $vbd698a31d32e4e40a358dcbc8f792091Count : '';
        $arrWiths['vbd698a31d32e4e40a358dcbc8f792091Ajax'] = isset($vbd698a31d32e4e40a358dcbc8f792091Ajax) ? $vbd698a31d32e4e40a358dcbc8f792091Ajax : '';
        ...
        $arrWiths['v500d7d5b41f8482ebc04deff5eef7483'] = isset($v500d7d5b41f8482ebc04deff5eef7483) ? $v500d7d5b41f8482ebc04deff5eef7483 : '';
        $arrWiths['v500d7d5b41f8482ebc04deff5eef7483Total'] = isset($v500d7d5b41f8482ebc04deff5eef7483Total) ? $v500d7d5b41f8482ebc04deff5eef7483Total : '';
        $arrWiths['v500d7d5b41f8482ebc04deff5eef7483Ajax'] = isset($v500d7d5b41f8482ebc04deff5eef7483Ajax) ? $v500d7d5b41f8482ebc04deff5eef7483Ajax : '';
        ...
        $response = new \Illuminate\Http\Response(view('e0e2b6984a694f4688c6bd7570f67372.Index', $arrWiths)->with('title', $arrWiths['title'])->with('vSessionTimeout', \Config::get('session.lifetime') * 60));
