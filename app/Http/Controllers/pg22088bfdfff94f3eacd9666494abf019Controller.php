 ...
 * envioAjax - envioAjax.
 */
class pg22088bfdfff94f3eacd9666494abf019Controller extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        $parfa6e5002c2344831b55e9ceb211f49611 = $request->session()->get('ses5e122755c3a24f5d8789755168e9de27');

        if (null == $parfa6e5002c2344831b55e9ceb211f49611) {
            $parfa6e5002c2344831b55e9ceb211f49611 = '0';
        }

        $par2d847537c7f1480c8a9b5f573e6224811 = $request->input('p1');

        if (null == $par2d847537c7f1480c8a9b5f573e6224811) {
            $par2d847537c7f1480c8a9b5f573e6224811 = '0';
        }

        $para585969a19574f98a1cb3bfada3c9e821 = $request->input('p2');

        if (null == $para585969a19574f98a1cb3bfada3c9e821) {
            $para585969a19574f98a1cb3bfada3c9e821 = '0';
        }

        $par06216042a8ef4bbc9ab74ff90178bb191 = $request->input('p3');

        if (null == $par06216042a8ef4bbc9ab74ff90178bb191) {
            $par06216042a8ef4bbc9ab74ff90178bb191 = '0';
        }

        $pardfacfa9de2c94384be8640da159a67cf1 = $request->input('p4');

        if (null == $pardfacfa9de2c94384be8640da159a67cf1) {
            $pardfacfa9de2c94384be8640da159a67cf1 = '0';
        }

        $par022620eabd92461788e8b87e6e69c3921 = $request->input('p5');

        if (null == $par022620eabd92461788e8b87e6e69c3921) {
            $par022620eabd92461788e8b87e6e69c3921 = '0';
        }

        $parc99d1140eb9447f0a7ef5ff2535e955c1 = $request->input('p6');

        if ('-' == $parc99d1140eb9447f0a7ef5ff2535e955c1) {
            $parc99d1140eb9447f0a7ef5ff2535e955c1 = null;
        }

        if (null == $parc99d1140eb9447f0a7ef5ff2535e955c1) {
            $parc99d1140eb9447f0a7ef5ff2535e955c1 = '-';
        }

        $par280e0f2c357d4da7a17c02af6e5813521 = $request->input('p7');

        if ('-' == $par280e0f2c357d4da7a17c02af6e5813521) {
            $par280e0f2c357d4da7a17c02af6e5813521 = null;
        }

        if (null == $par280e0f2c357d4da7a17c02af6e5813521) {
            $par280e0f2c357d4da7a17c02af6e5813521 = '-';
        }

        $pard14361f0dd98449b9c97657d462a5e5e1 = $request->input('p8');

        if ('-' == $pard14361f0dd98449b9c97657d462a5e5e1) {
            $pard14361f0dd98449b9c97657d462a5e5e1 = null;
        }

        if (null == $pard14361f0dd98449b9c97657d462a5e5e1) {
            $pard14361f0dd98449b9c97657d462a5e5e1 = '-';
        }

        $par9d89eb269b2942f4959fe3a52934e7be1 = $request->input('p9');

        if ('-' == $par9d89eb269b2942f4959fe3a52934e7be1) {
            $par9d89eb269b2942f4959fe3a52934e7be1 = null;
        }

        if (null == $par9d89eb269b2942f4959fe3a52934e7be1) {
            $par9d89eb269b2942f4959fe3a52934e7be1 = '-';
        }

        $par9d860c73c29c47fa8e9d5202d349c7bf1 = $request->input('p10');

        if ('-' == $par9d860c73c29c47fa8e9d5202d349c7bf1) {
            $par9d860c73c29c47fa8e9d5202d349c7bf1 = null;
        }

        if (null == $par9d860c73c29c47fa8e9d5202d349c7bf1) {
            $par9d860c73c29c47fa8e9d5202d349c7bf1 = '-';
        }

        $v22653497529042ec80f87052a9b23914 = \App\repf782f923fd0247bd9f4010b717e52999::mt928c0a1bd83e4b7ab047235a7f8be37a($parfa6e5002c2344831b55e9ceb211f49611, $par2d847537c7f1480c8a9b5f573e6224811, $para585969a19574f98a1cb3bfada3c9e821, $par06216042a8ef4bbc9ab74ff90178bb191, $pardfacfa9de2c94384be8640da159a67cf1, $par022620eabd92461788e8b87e6e69c3921, $parc99d1140eb9447f0a7ef5ff2535e955c1, $par280e0f2c357d4da7a17c02af6e5813521, $pard14361f0dd98449b9c97657d462a5e5e1, $par9d89eb269b2942f4959fe3a52934e7be1, $par9d860c73c29c47fa8e9d5202d349c7bf1);

        $v22653497529042ec80f87052a9b23914Ajax = \URL::to('/').'/api/928c0a1bd83e4b7ab047235a7f8be37a/'.(null == $parfa6e5002c2344831b55e9ceb211f49611 ? '-' : ('' == $parfa6e5002c2344831b55e9ceb211f49611 ? '-' : $parfa6e5002c2344831b55e9ceb211f49611)).'/'.(null == $par2d847537c7f1480c8a9b5f573e6224811 ? '-' : ('' == $par2d847537c7f1480c8a9b5f573e6224811 ? '-' : $par2d847537c7f1480c8a9b5f573e6224811)).'/'.(null == $para585969a19574f98a1cb3bfada3c9e821 ? '-' : ('' == $para585969a19574f98a1cb3bfada3c9e821 ? '-' : $para585969a19574f98a1cb3bfada3c9e821)).'/'.(null == $par06216042a8ef4bbc9ab74ff90178bb191 ? '-' : ('' == $par06216042a8ef4bbc9ab74ff90178bb191 ? '-' : $par06216042a8ef4bbc9ab74ff90178bb191)).'/'.(null == $pardfacfa9de2c94384be8640da159a67cf1 ? '-' : ('' == $pardfacfa9de2c94384be8640da159a67cf1 ? '-' : $pardfacfa9de2c94384be8640da159a67cf1)).'/'.(null == $par022620eabd92461788e8b87e6e69c3921 ? '-' : ('' == $par022620eabd92461788e8b87e6e69c3921 ? '-' : $par022620eabd92461788e8b87e6e69c3921)).'/'.(null == $parc99d1140eb9447f0a7ef5ff2535e955c1 ? '-' : ('' == $parc99d1140eb9447f0a7ef5ff2535e955c1 ? '-' : $parc99d1140eb9447f0a7ef5ff2535e955c1)).'/'.(null == $par280e0f2c357d4da7a17c02af6e5813521 ? '-' : ('' == $par280e0f2c357d4da7a17c02af6e5813521 ? '-' : $par280e0f2c357d4da7a17c02af6e5813521)).'/'.(null == $pard14361f0dd98449b9c97657d462a5e5e1 ? '-' : ('' == $pard14361f0dd98449b9c97657d462a5e5e1 ? '-' : $pard14361f0dd98449b9c97657d462a5e5e1)).'/'.(null == $par9d89eb269b2942f4959fe3a52934e7be1 ? '-' : ('' == $par9d89eb269b2942f4959fe3a52934e7be1 ? '-' : $par9d89eb269b2942f4959fe3a52934e7be1)).'/'.(null == $par9d860c73c29c47fa8e9d5202d349c7bf1 ? '-' : ('' == $par9d860c73c29c47fa8e9d5202d349c7bf1 ? '-' : $par9d860c73c29c47fa8e9d5202d349c7bf1)).'/{page}/{pagesize}/{orderColumn}/{orderType}';
        ...
        $arrWiths['v22653497529042ec80f87052a9b23914'] = isset($v22653497529042ec80f87052a9b23914) ? $v22653497529042ec80f87052a9b23914 : '';
        ...
        $response = new \Illuminate\Http\Response(view('22088bfdfff94f3eacd9666494abf019.Index', $arrWiths)->with('title', $arrWiths['title'])->with('vSessionTimeout', \Config::get('session.lifetime') * 60));
